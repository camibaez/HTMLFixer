...
<h3 align="center">Prepayment Interests<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="EDL0130_cd_prep_int.jsp, EDL0130"></h3>
<hr size="4">
 ...
 <table class="tableinfo">
  ...
  <table  width="100%" bgcolor="#FFFFFF" bordercolor="#FFFFFF">
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="48%"> 
        <div align="center">
          <input id="EIBSBTN" type=button name="Submit2" value="Exit" onClick="finish();">
        </div>
      </td>
    </tr>
  </table>
