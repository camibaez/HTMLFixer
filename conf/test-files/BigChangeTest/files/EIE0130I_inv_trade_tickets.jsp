...
%>
<div align="center"> 
  <h3>Trade Ticket Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_trade_tickets.jsp,EIE130I"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
			...
			<TR id="trclear">
				...
				<TD nowrap width="36%">
				<DIV align="left"><A
					href="javascript:DatePicker(document.forms[0].E01ORDIN1,document.forms[0].E01ORDIN2,document.forms[0].E01ORDIN3)"><INPUT
					type="text" readonly name="E01ORDST1" size="3" maxlength="2"
              ...
              <INPUT type="text" readonly name="E01ORDST3" size="3"
				...
				<DIV align="left"><A
					href="javascript:DatePicker(document.forms[0].E01ORDIN1,document.forms[0].E01ORDIN2,document.forms[0].E01ORDIN3)"><INPUT
					type="text" readonly name="E01ORDF15A" size="3" maxlength="2"
					...
					value="<%= invTrade.getE01ORDF15C()%>"> </A></DIV>
				</TD>
			</TR>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="1" > 
              <div align="left"> 
                <input type="text" readonly  name="E01ORDVNO" size="17" maxlength="16" value="<%= invTrade.getE01ORDVNO()%>"></div>
            </td>
                        <td nowrap colspan="2" >
				<div align="center">Pool factor: <INPUT type="text" readonly
					name="E01ORDFL7" size="17" maxlength="16"
					value="<%= invTrade.getE01ORDFL7()%>"
					<% if (invTrade.getF01ORDVNO().equals("Y")) out.print("id=\"txtchanged\""); %>></div>
				</td>
