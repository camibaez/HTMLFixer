...
<BODY >
<h3 align="center">Overdrawn Accounts Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="overdrawn_accounts_list.jsp,ESD0300"></h3>
<hr size="4">
...
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0300" >      
 ...
 %> 
  <TABLE class="tbenter" width=100% height=100%>
	  ...
	  <TD>     
      <div align="center"> 
          <p><font size="3"><b>There is no match for your search criteria</b></font></p>
        ...
        <td NOWRAP valign="top" width="100%" > 
          <table id="headTable" width="100%" >
            <tr id="trdark"> 
              ...
              <th align=CENTER nowrap > 
                <div align="center">Gross<br>Balance</div>
              </th>
              <th align=CENTER nowrap > 
                <div align="center">Net<br>Balance</div>
              </th>
              <th align=CENTER nowrap > 
                <div align="center">Available<br>Balance</div>
              </th>
            </tr>
          </table>
