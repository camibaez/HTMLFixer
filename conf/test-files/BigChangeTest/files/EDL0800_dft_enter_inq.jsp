...
alert("Debe ingresar un número de Descuento de Documento valido");
...
<h3 align="center">Discount of Documents Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="dft_enter_inq,EDL0800"></h3>
<hr size="4">
<p>&nbsp;</p>
