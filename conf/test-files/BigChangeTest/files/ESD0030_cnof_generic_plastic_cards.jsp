...
<H3 align="center">System Reference Codes - <%= userPO.getHeader21() %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_generic_plastic_cards.jsp, ESD0030"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="left"> 
                <input type="text" name="E02CNOCPC" size="6" maxlength="4" value="<%= refCodes.getE02CNOCPC().trim()%>">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
