...
if ( document.forms[0].FILENAME.value.length < 1) {
  ...
  document.forms[0].SCREEN.value = '950';	
...
<body>
 ...
 <h3 align="center">FRB OMAD Upload</h3>
<hr size="4">
 <FORM METHOD="POST" action="<%=request.getContextPath()%>/servlet/datapro.eibs.misc.JSEPR0020OMad" ENCTYPE="multipart/form-data">	
    <p><INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="950">
    </p>
