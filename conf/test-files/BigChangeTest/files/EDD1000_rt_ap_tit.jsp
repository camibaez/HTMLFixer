...
%> 
<h3 align="center">Account Holders Information<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_ap_tit,EDD1000"></h3>
<hr size="4">
<p>&nbsp;</p>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" readonly name="E04CUSNA1" size="45" maxlength="45" onFocus="this.blur();" value="<%= userPO.getHeader3().trim()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" readonly name="E06ACC" size="12" maxlength="12" value="<%= rtTit.getE06ACC().trim()%>" onFocus="this.blur();" >
              </div>
            </td>
            <td nowrap width="16%"> 
            ...
            <td nowrap width="16%"> 
              <div align="left"><b> 
                <input type="text" readonly name="E04DEAPRO" size="5" maxlength="4" onFocus="this.blur();" value="<%= userPO.getHeader1().trim()%>">
                </b> </div>
            </td>
          </tr>
        </table>
