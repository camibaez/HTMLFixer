...
function enter(){
 ...
 var NameSearch = document.forms[0].NameSearch.value
    ...
    parent.results.window.location.href="<%=request.getContextPath()%>/pages/e/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0130D?NameSearch=" + NameSearch + "@PmtVia=" + PmtVia + "'";    
...
<br>	
  <TABLE  id="tbhelp" align="center"  border="0" cellspacing="0" cellpadding="3">
    <TR> 
      <Td align="CENTER"><p><b>Bank Search</b></p></Td>
    </TR>
    <TR> 
