...
<h3 align="center">Loans Fees Table Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ln_inq_ren_rate, EDL0160"></h3>
<hr size="4">
<form >
  <p></p>
