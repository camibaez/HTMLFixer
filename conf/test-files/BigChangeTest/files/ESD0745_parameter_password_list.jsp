...
<title>Control Parameter for Password eIBS</title>
...
<h3 align="center">Control Parameter for Password eIBS<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="parameter_password_list.jsp, ESD0745"></h3>
<hr size="4">
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center"> There is no Banks. <br>Click New to add one</h4> 
      </div>
      </TD></TR>
   	</TABLE>
   	<TABLE class="tbenter">
...
%>
  ...
  <TABLE class="tableinfo" id="dataTable">
    <TR id="trdark">
      ...
      <TH ALIGN=CENTER  nowrap >Initial eIBS<br>Port Number</TH>
      <TH ALIGN=CENTER  nowrap >Monitor Port<br>Number for dIBS</TH>
      <TH ALIGN=CENTER  nowrap >Initial dIBS<br>Port Number</TH>      
    </TR>
