...
%> 
<div align="center"> 
  <h3>Trade Ticket Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_trade_tickets.jsp,EIE130A"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap  > 
              <input type="text" name="E01MEMBAL" size="17" maxlength="16" value="<%= invTrade.getE01MEMBAL()%>" onKeyPress="enterDecimal()" readonly>
            </td>
            <td nowrap  > 
          ...
          <tr id="trdark" width="17%"> 
            ...
            <td nowrap width="33%" > 
              <input type="text" readonly name="E01ORDWHF" size="3" maxlength="1" value="<%= invTrade.getE01ORDWHF().trim()%>">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <input type="text" readonly name="E01ORDIIC" readonly size="9" maxlength="9" value="<%= invTrade.getE01ORDIIC()%>" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="33%" >
            <INPUT type="text" name="E01ORDCSP" size="16" maxlength="12" value="<%= invTrade.getE01ORDCSP()%>" readonly></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td nowrap width="17%" > 
             ...
             <td nowrap colspan="4" > 
              <div align="left"> 
                <input type="text" readonly name="E01ORDQTY" size="17" maxlength="16" value="<%= invTrade.getE01ORDQTY()%>" readonly>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="4" > 
              <div align="left"> 
                <input type="text" readonly name="E01ORDPRC" size="17" maxlength="15" value="<%= invTrade.getE01ORDPRC()%>" readonly onKeyPress="enterDecimal()">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="4" > 
              <div align="left"> 
                <input type="text" readonly name="E01ORDIAM" size="17" maxlength="15" value="<%= invTrade.getE01ORDIAM()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" colspan="2" > 
              <div align="left"> 
                <input type="text" readonly name="E01ORDIAL" size="17" maxlength="15" value="<%= invTrade.getE01ORDIAL()%>" readonly onKeyPress="enterDecimal()">
              ...
              <div align="left"> </div>
					...
					<TD nowrap colspan="3">
						<INPUT type="text" name="E01ORDF11"
							size="17" maxlength="15" value="<%= invTrade.getE01ORDF11()%>" readonly>
					</TD>
			</TR>
