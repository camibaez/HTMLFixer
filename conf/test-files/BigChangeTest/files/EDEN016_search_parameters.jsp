...
<jsp:useBean id="msgSrc" class="datapro.eibs.beans.EDEN01601Message"  scope="session" />
...
<hr size="4">
 <FORM METHOD="POST" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEDEN016">	
