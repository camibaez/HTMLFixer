...
<html>
<head>
<title>Official Checks Issuance</title>
...
<% 
 	if ( !error.getERRNUM().equals("0")  ) {
  	...
  	if (userPO.getHeader19().equals("0") || userPO.getHeader19().equals("1")) {
  		out.println("<SCRIPT> initMenu();  </SCRIPT>");
  	}	
%> 

<H3 align="center">Official Checks Issuance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="of_chk_cont.jsp, EOF0115"> 
</H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="600px" height="250px" border="0" background="<%=request.getContextPath()%>/images/e/dat_check.gif">
          <tr> 
            ...
            <td nowrap width="29%"><%= userPO.getIdentifier().trim()%> </td>
          </tr>
          <tr > 
            <td nowrap width="46%"> 
            ...
            <td nowrap width="29%"> <%= Util.formatDateFull(userPO.getHeader21().trim(),userPO.getHeader22().trim(),userPO.getHeader5().trim(),userPO.getHeader6().trim(),userPO.getHeader7().trim())%> 
            </td>
          </tr>
          <tr > 
            <td nowrap height="23" width="46%"> 
              <div align="right"><font face="Arial, Helvetica, sans-serif" color="#000000"><b><i>Amount 
                :</i></b></font></div>
            </td>
            <td nowrap height="23" width="29%"> $<%= Util.addLeftChar('*',15,Util.fcolorCCY(userPO.getHeader8().trim()))%> 
            </td>
          </tr>
          <tr > 
