...
%> 
<h3 align="center"> Foreign Exchange Spot <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_sf.jsp,EFE0140B"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="85%" > 
              <input type="hidden" name="D01WKFCP2"  value="<%= fex.getD01WKFCP2()%>" >
              <%= fex.getD01WKFCP2()%></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="15%" > 
            ...
            <td nowrap colspan="3" width="85%" > <font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2"> 
              <input type="hidden" name="D01WKFCP32"  value="<%= fex.getD01WKFCP3()%>" readonly>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="85%" ><font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2"> 
              ...
              </font></font></font></font></font><%= fex.getE01WKFACC()%>
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > <%= fex.getE01WKFBRK()%> - <%= fex.getD01FEBNM1()%> </td>
            <td nowrap > 
              <div align="right">Action Taken :</div>
            </td>
            <td nowrap > <% if(fex.getE01WKFSBT().equals("PU")) out.print("Purchase");
