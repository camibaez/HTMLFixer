...
<h3 align="center">Code Search<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="our_denial_code_source_search, EDEN040"></h3>
<hr size="4">
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.ofac.JSEDEN040" target="_main" >
  <input type="hidden" name="SCREEN" value="2">
  
  <CENTER>  
	   <table  id="TBHELP" align="center" width="370" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td nowrap width="10%">Search by source :</td>
		  <td nowrap width="20%" >
		  	<input type="hidden" name="code" value="">
		  	<input type="text" name="country" value="" size="50">
		  </td>
	   	  <td nowrap align="left">
	   	  	<a href="javascript:GetSourceCode('code','desc')"><img
