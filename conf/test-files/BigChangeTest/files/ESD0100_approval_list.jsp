 ...
 function showAddInfo(idxRow){
   if (document.forms[0]["STSOFAC"+idxRow].value == "3") {
      ...
      for (var n=0;n<formLength;n++){
        ...
        if ( elemt.checked  && elementName == "ACCNUM") {
              accOfac=elemt.value;
              break;
        }
      }      
   ...
   // HG: 10/17/2006  -	If Customer Encryption is enabled, the value of CHECKENC will change with
   //					the purpose to indicate that the customer will be encrypted, Values "Y/N"
   
	if (document.forms[0].ISENCRYPT.value == "EC") { 
		document.forms[0].CHECKENC.value = document.forms[0]["ENCRYPT"+idxRow].value;
	}
  // --------- End Of Changes --------------
...
<h3 align="center">Customer Approval<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="approval_list.jsp,ESD0100"> 
  </h3>
<hr size="4">
...
<INPUT TYPE=HIDDEN NAME="ISENCRYPT" VALUE="<%= userPO.getHeader1()%>">
 ...
 <TR> 
  ...
  <TR id="trdark">  
      ...
      <% if (userPO.getHeader1().equals("EC")) { %>
      	<TH ALIGN=CENTER NOWRAP>Encrypt</TH>
      <% } %>      
   ...
   <TD nowrap ALIGN="RIGHT" valign="top">
     ...
     <Table id="tbAddInfo" >
      <tr id="trclear" >
      <% //	Word OFAC replaced for "World-Check" valid only for Bradesco Luxembourg (Added by Henry 12/06/2006) %>
         <TD  ALIGN="RIGHT"  align="center" nowrap ><b>Narrative :<% if (currUser.getH01WK3().equals("4")|| currUser.getH01WK3().equals("5")) {%><br>World-Check :<% } else { %><br>OFAC :<% } %><br>Type : <br>Country : <br>Batch :<br>Operator : </b></TD>
