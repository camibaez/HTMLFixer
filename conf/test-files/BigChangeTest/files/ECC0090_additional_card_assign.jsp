...
<body>
<h3 align="center">Debit Card Assignment<br>Additional Card<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="additional_card_assign.jsp, ECC0090">
</h3>
<hr size="4">
<% 
          ...
          <TBODY><TR id="trdark"> 
            ...
            <TD nowrap width="16%"> 
              ...
              <DIV align="left">
				...
				<A href="javascript:GetPlastic2('E03CCRNUMA', 'D', 'N')">
