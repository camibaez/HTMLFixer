...
<h3 align="center">NOW Accounts<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_tables_dda_02, ESD0205" ></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTERBW" size="4" maxlength="3" value="<%= charges.getE02RTERBW()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTECAW" size="5" maxlength="4" value="<%= charges.getE02RTECAW()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
				<SELECT name="E02RTECCF">
					<OPTION value=" "
						<% if (!(charges.getE02RTEBUS().equals("Y") || charges.getE02RTEBUS().equals("N"))) out.print("selected"); %>></OPTION>
					<OPTION value="Y"
						<%if (charges.getE02RTEBUS().equals("Y")) { out.print("selected"); }%>>Yes</OPTION>
					<OPTION value="N"
						<%if (charges.getE02RTEBUS().equals("N")) { out.print("selected"); }%>>No</OPTION>
				</SELECT>
              </div>
            </td>
          </tr>
          ...
          <TR id="trclear"> 
            ...
            <TD nowrap width="29%"> 
              <DIV align="right">Non-Local Checks Percentaje :</DIV>
            </TD>
            <TD nowrap width="31%"> 
              <DIV align="left"> 
          ...
          <TR id="trclear"> 
            <TD nowrap width="29%" height="18"> 
              <DIV align="right">Confirmation Number of Days :</DIV>
            </TD>
            <TD nowrap width="31%" height="18"> 
              <DIV align="left">
          ...
          <TR id="trdark"> 
            ...
            <TD nowrap width="18%"> 
              <DIV align="left"> 
                <INPUT type="text" name="E02RTEMAC2" size="10" maxlength="9" value="<%= charges.getE02RTEMAC()%>">
              </DIV>
            </TD>
          </TR>
        </TBODY></TABLE>
            ...
            <td nowrap colspan="4"> 
              <div align="left"> 
                ...
                <select name="E02RTEFFA">
                  ...
                  <option value="M" <%if (charges.getE02RTEFFA().equals("M")) { out.print("selected"); }%>>Multiply by Rate
                  </option>
                </select>
              </div>
              </td>
