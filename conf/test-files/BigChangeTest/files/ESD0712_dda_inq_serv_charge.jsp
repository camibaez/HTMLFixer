...
<h3 align="center">Detail Account Charge Table Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="dda_inq_serv_charge, ESD0712"></h3>
<hr size="4">
<form >
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td width="17%"> 
              <input type="text" name="E01RTEMKL" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMKL().trim()%>">
            </td>
            <td width="17%"> 
                <div align="right">Rate Limit (1) :</div>
            </td>
            <td width="17%">
              <input type="text" name="E01RTEMKR" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMKR().trim()%>">
            </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (1) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAP1" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAP1().trim()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td width="17%"> 
            ...
            <td width="17%">
              <input type="text" name="E01RTEMB1" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMB1().trim()%>">
            </td>
            <td width="17%"> 
                <div align="right">Rate Limit (2) :</div>
            </td>
            <td width="17%">
              <input type="text" name="E01RTEMR1" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMR1().trim()%>">
            </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (2) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAP2" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAP2().trim()%>">
            </td>            
          </tr>
          <tr id="trdark">
            <td width="17%"> 
            ...
            <td width="17%">
              <input type="text" name="E01RTEMB2" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMB2().trim()%>">
            </td>
            <td width="17%"> 
                <div align="right">Rate Limit (3) :</div>
            </td>
            <td width="17%">
              <input type="text" name="E01RTEMR2" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMR2().trim()%>">
            </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (3) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAP3" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAP3().trim()%>">
            </td>            
          </tr>
          <tr id="trclear">
            <td width="17%"> 
            ...
            <td width="17%">
              <input type="text" name="E01RTEMB3" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMB3().trim()%>">
            </td>
            <td width="17%"> 
                <div align="right">Rate Limit (4) :</div>
            </td>
            <td width="17%">
              <input type="text" name="E01RTEMR3" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMR3().trim()%>">
            </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (4) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAP4" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAP4().trim()%>">
            </td>            
          </tr>
          <tr id="trdark">
            <td width="17%"> 
              ...
              <td width="17%">
                <input type="text" name="E01RTEMB4" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMB4().trim()%>">
              </td>
            <td width="17%"> 
                <div align="right">Rate Limit (5) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMR4" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMR4().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (5) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAP5" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAP5().trim()%>">
            </td>              
          </tr>
          <tr id="trclear">
            <td width="17%"> 
                <div align="right">Balance Limit (6) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMB5" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMB5().trim()%>">
              </td>
            <td width="17%"> 
                <div align="right">Rate Limit (6) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMR5" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMR5().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (6) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAP6" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAP6().trim()%>">
            </td>              
          </tr>          
          <tr id="trdark">
            <td width="17%"> 
                <div align="right">Balance Limit (7) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMB6" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMB6().trim()%>">
              </td>
            <td width="17%"> 
                <div align="right">Rate Limit (7) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMR6" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMR6().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (7) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAP7" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAP7().trim()%>">
            </td>              
          </tr>          
          <tr id="trclear">
            <td width="17%"> 
                <div align="right">Balance Limit (8) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMB7" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMB7().trim()%>">
              </td>
            <td width="17%"> 
                <div align="right">Rate Limit (8) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMR7" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMR7().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (8) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAP8" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAP8().trim()%>">
            </td>              
          </tr>
          <tr id="trdark">
            <td width="17%"> 
                <div align="right">Balance Limit (9) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMB8" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMB8().trim()%>">
              </td>
            <td width="17%"> 
                <div align="right">Rate Limit (9) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMR8" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMR8().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (9) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAP9" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAP9().trim()%>">
            </td>              
          </tr>          
          <tr id="trclear">
            <td width="17%"> 
                <div align="right">Balance Limit (10) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMB9" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMB9().trim()%>">
              </td>
            <td width="17%"> 
                <div align="right">Rate Limit (10) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMR9" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMR9().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (10) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAPX" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAPX().trim()%>">
            </td>              
          </tr>          
          <tr id="trdark">
            <td width="17%"> 
                <div align="right">Balance Limit (11) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMBX" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMBX().trim()%>">
              </td>
            <td width="17%"> 
                <div align="right">Rate Limit (11) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMRX" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMRX().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (11) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAPY" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAPY().trim()%>">
            </td>              
          </tr>          
          <tr id="trclear">
            <td width="17%"> 
                <div align="right">Balance Limit (12) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMBY" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMBY().trim()%>">
              </td>
            <td width="17%"> 
                <div align="right">Rate Limit (12) :</div>
            </td>
              <td width="17%">
                <input type="text" name="E01RTEMRY" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEMRY().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right">A.P.Y. (12) :</div>
            </td>
            <td width="16%">
              <input type="text" name="E01RTEAPZ" size="11" maxlength="9" value="<%= ddaServCharge.getE01RTEAPZ().trim()%>">
            </td>              
          </tr>          
          <tr id="trdark">
            <td width="17%"> 
            ...
            <td width="17%">
              <input type="text" name="E01RTEBTY" size="3" maxlength="2" value="<%= ddaServCharge.getE01RTEBTY().trim()%>">
            </td>
            <td width="17%"> 
                <div align="right">Interest Type Calculation :</div>
            </td>
            <td width="17%">
                <input type="text" name="E01RTECAML" size="3" maxlength="1" value="<%= ddaServCharge.getE01RTECAM().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right"></div>
            </td>
		  ...
		  <tr id="trclear">
            ...
            <td width="17%">
              <input type="text" name="E01RTEABA" size="3" maxlength="3" value="<%= ddaServCharge.getE01RTEABA().trim()%>">
            </td>
            <td width="17%"> 
                <div align="right">Interest Reversal :</div>
            </td>
            <td width="17%">
                <input type="text" name="E01RTEOMP" size="3" maxlength="1" value="<%= ddaServCharge.getE01RTEOMP().trim()%>">
              </td>
            <td width="16%"> 
                <div align="right"></div>
            </td>
