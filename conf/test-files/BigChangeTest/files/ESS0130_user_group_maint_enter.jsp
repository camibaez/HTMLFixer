...
if (action != "0001" && document.forms[0].E01USEUID.value.length < 1) {
  alert("A valid user group must be entered");
...
<H3 align="center">User Group Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="user_group_maint_enter, ESS0130"></H3>
