...
%> 
<h3 align="center">Account Holders <%= userPO.getHeader4().trim()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="dft_tit.jsp,EDL0800"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <td nowrap width="26%"> 
              <div align="center"> Indentification</div>
            </td>
            <td nowrap width="18%"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="9%"> 
              <div align="center"> 
                <input type="text" name="E06CU<%= name %>" size="9" maxlength="9" value="<%= lnTit.getField("E06CU"+name).getString().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="47%"> 
              <div align="center"> 
            ...
            <td nowrap width="18%"> 
              <div align="center"> 
                <input type="text" name="E06TY<%= name %>" size="2"  maxlength="1" value="<%= lnTit.getField("E06TY"+name).getString().trim()%>" readonly>
              </div>
            </td>
          </tr>
          <%}%> 
