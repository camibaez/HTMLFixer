...
<BODY>
<H3 align="center">Letter Of Credit Maintenance [Commissions]<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_commissi.jsp, ELC0510"></H3>
<HR size="4">
			...
			<TR id="trdark">
				...
				<DIV align="left"><B><INPUT type="text" name="E04LCMACC" size="12"
					maxlength="12" value="<%=msgLC.getE04LCMACC().trim()%>" readonly> </B>
						...
						<TR id="trclear">
				<TD nowrap width="16%">
				<DIV align="right"><B>Issuance Date :</B></DIV>
				</TD>
				<TD nowrap width="20%">
				...
				<TD nowrap width="16%"><DIV align="right"><B>Amount (Base Currency) :</B></DIV>
				</TD>
				<TD nowrap width="16%">
		...
		<tr>
			...
			<table border="0" cellspacing="0" width="100%">
					<tr id="trdark">
						...
						<td nowrap align="center" width="15%"><b>Paid By</b></td>
					...
					<tr id="trclear">
						...
						<td nowrap width="15%">
							<select name="E04LCMP04"  >
								...
								<option value="B" <%if(msgLC.getE04LCMP04().equals("B")) out.print("selected");%>>Beneficiary</option>
								<option value="W" <%if(msgLC.getE04LCMP04().equals("W")) out.print("selected");%>>Waive</option>
							</select></td>
						<td nowrap width="26%"></td>
						<td nowrap width="12%"></td>
					</tr><tr id="trdark">
						<td align="right">Advising Amendment :</td>
						<td nowrap width="17%" align="center">
						...
						<td nowrap width="15%">
							<select name="E04LCMP05">
								<option value="A">Applicant</option>
								<option value="B" <%if(msgLC.getE04LCMP05().equals("B")) out.print("selected");%>>Beneficiary</option>
								<option value="W" <%if(msgLC.getE04LCMP05().equals("W")) out.print("selected");%>>Waive</option>
							</select></td>
						<td nowrap width="26%"></td>
						<td nowrap width="12%"></td>
					</tr><tr id="trclear">
						<td align="right">Discrepancy :</td>
						<td nowrap width="17%" align="center">
						...
						<td nowrap width="15%">
							<select name="E04LCMP06">
								<option value="A">Applicant</option>
								<option value="B" <%if(msgLC.getE04LCMP06().equals("B")) out.print("selected");%>>Beneficiary</option>
								<option value="W" <%if(msgLC.getE04LCMP06().equals("W")) out.print("selected");%>>Waive</option>
							</select></td>
						<td nowrap width="26%"></td>
						<td nowrap width="12%"></td>
					</tr>
					<tr id="trdark">
						<td align="right">Extension of Validity :</td>
						<td nowrap width="17%" align="center">
						...
						<td nowrap width="15%">
							<select name=E04LCMP07>
								<option value="A">Applicant</option>
								<option value="B" <%if(msgLC.getE04LCMP07().equals("B")) out.print("selected");%>>Beneficiary</option>
								<option value="W" <%if(msgLC.getE04LCMP07().equals("W")) out.print("selected");%>>Waive</option>
							</select></td>
						<td nowrap width="26%"></td>
						<td nowrap width="12%"></td>
					</tr>
