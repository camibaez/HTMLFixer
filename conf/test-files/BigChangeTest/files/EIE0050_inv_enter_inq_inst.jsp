...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0308P" >
  ...
  <h3 align="center">Instruments Inquiry</h3>
          ...
          <tr> 
            <td> 
              ...
              <table width="100%">
	              <tr id="trdark"> 
    	              <td valign="middle" align="center" colspan="3" height=33> 
        	          <div align="left"><b>Additional Search Options :&nbsp; &nbsp; &nbsp;</b>
        	          <a href="javascript:Options('H')">Hide</a>
        	          </div>
                  	  </td>
                  </tr>
                  <tr id="trclear"> 
                ...
                <tr id="trclear"> 
                  ...
                  <td nowrap width="20%" colspan="2">
						...
						<INPUT type="radio" name="CPREFINST"
							onclick="document.forms[0].PREFINST.value=' '" checked>ALL <INPUT
