    ...
    <tr > 
      <td> 
        ...
        <table width="100%">
          ...
          <tr>
            <td width="9%">&nbsp;</td>
            <td width="91%">Deal Number : <%= datapro.eibs.master.Util.justifyRight(cdFinish.getE10DEAACC().trim(),9)%> 
          ...
          <tr>
            <td width="9%">&nbsp;</td>
            <td width="91%"> 
              <div align="left"> In favor of : <%= cdFinish.getE10CUSNA1().trim()%>, and a face value of $ <%= Util.fcolorCCY(cdFinish.getE10DEAOAM().trim())%> </div>
            </td>
          </tr>
          <tr>
            <td height="35" width="9%">&nbsp;</td>
            <td height="35" width="91%"> <%= cdFinish.getE10LETOAM().trim()%></td>
          </tr>
           <tr>
            <td width="9%">&nbsp;</td>
            <td height="91%" width="9%"><div align="left">Interest : <%= Util.fcolorCCY(cdFinish.getE10DEARTE().trim()) %> Net Amount : <%=  Util.fcolorCCY(cdFinish.getE10DEAOAM().trim()) %></div></td>
          </tr>
          <tr>
            <td width="9%">&nbsp;</td>
          ...
          <tr>
            <td width="9%">&nbsp;</td>
            <td width="91%"> 
              <div align="center">The Deal has been processed successfully, please wait...</div>
            </td>
          </tr>
        </table>
