...
<h3 align="center"> Activity Control <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_inquiry, EDL0160"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              <div align="center"><b>Expected</b></div>
            </td>
            <td nowrap width="26%"> 
              <div align="center"><b>Real</b></div>
            </td>
            <td nowrap width="26%"> 
              <div align="center"><b>Variation (%)</b></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="25%"> 
              <div align="right">Checks Deposits :</div>
            </td>
            <td nowrap width="23%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="25%"> 
              <div align="right">Paid Checks :</div>
            </td>
            <td nowrap width="23%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="25%"> 
              <div align="right">Outgoing Trasnfers :</div>
            </td>
            <td nowrap width="23%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="25%"> 
              <div align="right">Incoming Transfers :</div>
            </td>
            <td nowrap width="23%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap> 
              <div align="center"><b>Balances </b></div>
            </td>
          ...
          <tr id="trclear"> 
            <td nowrap width="25%"> 
              <div align="right">Available Average :</div>
            </td>
            <td nowrap width="23%"> 
              <div align="right"> 
