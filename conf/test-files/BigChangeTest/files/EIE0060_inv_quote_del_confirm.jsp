...
<meta http-equiv="Refresh" CONTENT="5;url='<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0308Q?SCREEN=100'">
    ...
    <tr > 
      <td> 
        <table width="100%" height="100%">
          ...
          <td align=center> This quote has 
            been succesfully deleted.</td>
          </tr>
        </table>
      </td>
    </tr>
