<html>
<head>
<title>Routes Maintenance Credit Proposal</title>
...
document.forms[0].available.selectedIndex=-1;
	...
	if (document.forms[0].LAN.value == 'S') {
		...
		alert("Select up to 24 formula codes");
	}
...
function goConfirm(opt) {
	...
	case  "2":  //ok = confirm(msg1 + " Actualizar " + msg2);
	            //document.forms[0].SCREEN.value="600";
	 break;   
	case  "3":  ok = confirm(msg1 + " Delete " + msg2);
...
<H3 align="center">Route Maintenance and Detail<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="path_maintenance.jsp, EDP0708"></H3>
...
<h4>  
      ...
      <% if(userPO.getHeader16().equals("2")) {out.print(" Modifify");} %>
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
		<TABLE id="tbenter" align="center" style="width: 100%" border="0">
							<tr id="trdark">
								<td	nowrap width="33%">
									<div align="right">Route Code :</div>
								</td>
								<td nowrap align="left" width="67%">
									...
									<A href="javascript:GetCodeDescCNOFCPC('E01DPPRUT','E01DPPRUD','48')">
							...
							<TR id="trclear">
								<td nowrap width="33%">
									<DIV align="right">Sequence Activity:</DIV>
								</TD>
								<td nowrap align="left" width="67%">
									<INPUT type="text" 
							...
							<tr id="trdark">
								<td nowrap width="33%">
								<DIV align="right">Activity Code</DIV>
								</td>
								<td nowrap align="left" width="67%">
									...
									<A href="javascript:GetCodeDescCNOFCPC('E01DPPACT','E01DPPACD','P2')">
							...
							<TR id="trclear">
								<td nowrap width="33%">
								<DIV align="right">Code Area/Dept. </DIV>
								</TD>
								<td nowrap align="left" width="67%">
									...
									<%  if(!userPO.getHeader16().equals("3")){ %>
									<A href="javascript:GetCodeDescCNOFCPC('E01DPPTAR','E01DPPTAD','2B')">
							...
							<tr id="trclear">
								...
								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>								
									<option value="0004"
										<%if (brnDetails.getE01DPPTAC().equals("0004")) { out.print("selected"); }%>>Start</option>	
									<option value="0001" 
									   <%if (brnDetails.getE01DPPTAC().equals("0001")) { out.print("selected"); }%>>Process Activity</option>
									<option value="0003"
										<%if (brnDetails.getE01DPPTAC().equals("0003")) { out.print("selected"); }%>>Route Ends</option>
								</SELECT>
								</td>
							</tr>
							...
							<tr id="trdark">
								<td nowrap width="33%">
								<DIV align="right">Approve/Deny/Postpone:</DIV>
								</td>
								<td nowrap align="left" width="67%">
								...
								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>
									...
									<option value="0001" 
									   <%if (brnDetails.getE01DPPSAC().equals("0001")) { out.print("selected"); }%>>Approve</option>
									<option value="0002"
										<%if (brnDetails.getE01DPPSAC().equals("0002")) { out.print("selected"); }%>>Deny</option>
									<option value="0003"
										<%if (brnDetails.getE01DPPSAC().equals("0003")) { out.print("selected"); }%>>Postpone</option>	
								</SELECT>
								Maximum Amount Authorized to Approve:
				 <INPUT type="text" name="E01DPPMAA" size="20" maxlength="20" value="<%= brnDetails.getE01DPPMAA().trim()%>" 
							...
							<tr id="trclear">
								<td nowrap width="33%">
								<DIV align="right">Process Type :</DIV>
								</td>
								<td nowrap align="left" width="67%">
								<SELECT name="E01DPPPRO" 
								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>								
									<option value="1" 
									   <%if (brnDetails.getE01DPPPRO().equals("1")) { out.print("selected"); }%>>Interactive</option>
									<option value="2"
							...
							<tr id="trdark">
								<td	nowrap width="33%">
									<div align="right">Status of the Proposal :</div>
								</td>
								<td nowrap align="left" width="67%">
									...
									<A href="javascript:GetCodeDescCNOFCPC('E01DPPEST','E01DPPTED','37')">
									<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0"></A>
								</td>
							</tr>
							...
							<tr id="trclear">
								<td	nowrap width="33%">
   									<DIV align="right">User Comment</DIV>
								</td>
								...
								<td nowrap align="left" width="67%">
              						<SELECT name="E01DPPCOM"
										...
										<OPTION value="1"
											<%if (brnDetails.getE01DPPCOM().equals("1")) { out.print("selected"); }%>>Required</OPTION>
										<OPTION value="2" 
...
--%>
										<OPTION value="5" 
											<%if (brnDetails.getE01DPPCOM().equals("5")) { out.print("selected"); }%>>Optional</OPTION>			
									</SELECT>     						
								</td>
							</tr>
							...
							<tr id="trdark">
								...
								<td nowrap align="left" width="67%">
									...
									<SELECT name="E01DPPPTR"
										...
										<OPTION value="3" 
											<%if (brnDetails.getE01DPPPTR().equals("3")) { out.print("selected"); }%>>Generate Numbering</OPTION>	
										<OPTION value="2" 
											<%if (brnDetails.getE01DPPPTR().equals("2")) { out.print("selected"); }%>>Build Contract (Interfase)</OPTION>
										</SELECT>
									</td>
							</tr>
<%--				
...
--%>
							<tr id="trclear">
								<td nowrap width="33%">
								<DIV align="right">Documents Required :</DIV>
								</td>
								<td nowrap align="left" width="67%">
								<SELECT name="E01DPPFG3"
	    								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>	
										<OPTION value="" 
											<%if (brnDetails.getE01DPPFG3().equals("")) { out.print("selected"); }%>>Required</OPTION>
										<OPTION value="1"
											<%if (brnDetails.getE01DPPFG3().equals("1")) { out.print("selected"); }%>>Optional</OPTION>
										</SELECT>
								</td>
							</tr>
							...
							<tr id="trdark">
								<td nowrap width="33%">
								<DIV align="right">Allow recommended amount for this activity :</DIV>
								</td>
								<td nowrap align="left" width="67%">
								<SELECT name="E01DPPFG2"
	    								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>	
										<OPTION value="" 
											<%if (brnDetails.getE01DPPFG2().equals("")) { out.print("selected"); }%>></OPTION>
										<OPTION value="1"
											<%if (brnDetails.getE01DPPFG2().equals("1")) { out.print("selected"); }%>>Yes</OPTION>
										<OPTION value="0"
							...
							<TR id="trclear">
								<td nowrap width="33%">
									<DIV align="right">Days to Alert :</DIV>
								</TD>
								<td nowrap align="left" width="67%">
									<INPUT type="text" 
      ...
      <td nowrap> 
		...
		<TABLE id="tbenter" align="center" style="width: 100%" border="0">
							...
							<TR id="trclear">
								...
								<TD nowrap width="40%">
										<DIV align="left">Next Activities</DIV>
