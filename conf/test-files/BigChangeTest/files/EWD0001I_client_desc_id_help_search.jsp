...
//	parent.results.window.location.href="<%=request.getContextPath()%>/pages/e/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/pages/e/EWD0001I_client_desc_id_help_helpmessage.jsp?NameSearch=" + NameSearch + "@Type=" + Type + "@FromRecord=" + FromRecord + "'";
    parent.results.window.location.href="<%=request.getContextPath()%>/pages/e/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0001I?NameSearch=" + NameSearch + "@Type=" + Type + "@FromRecord=" + FromRecord + "'";
										...
										<TR>
											...
											<TABLE id="TBHELP0" align="center" width="140" border="0"
												...
												<TBODY>
													...
													<TR>
														<TD nowrap></TD>
														<TD nowrap><INPUT type="radio" name="Type" value="W"> By
														Word</TD>
													</TR>
													<TR>
													...
													<TR>
														<TD nowrap></TD>
														<TD nowrap><INPUT type="radio" name="Type" value="9"> By
														Word</TD>
													</TR>
												</TBODY>
											</TABLE>
