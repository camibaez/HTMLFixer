...
function goAction(op) {
	if (op == "3") {
      ok = confirm("Confirm delete this record:");
	  if (ok) 
	       {
...
<BODY>
<h3 align="center">Structuring Statement</h3>
<P align="center">
...
%> 
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%"> <div align="center">Code Group</div> </th>
            <th align=CENTER nowrap width="25%"> <div align="center">Description </div> </th>
            <th align=CENTER nowrap width="10%"> <div align="center">Code</div> </th>
            <th align=CENTER nowrap width="25%"> <div align="center">Description </div> </th>
            <th align=CENTER nowrap width="5%"> <div align="center">Seq.</div> </th>
            <th align=CENTER nowrap width="5%"> <div align="center">Type</div> </th>
            <th align=CENTER nowrap width="25%"> <div align="left">Financial Variable</div> </th>
           </tr>
          <%
  ...
  <%
		...
		int pos = EDP070301Help.getFirstRec() - 20;
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0703?SCREEN=200&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
        }
  %>
  </TD>
  ...
  <%
		...
		int pos = EDP070301Help.getLastRec();
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0703?SCREEN=200&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
        }
  %> 
 </TD>
 </TR>
