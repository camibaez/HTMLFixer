...
%>
<BODY>
<h3 align="center">Transactions Parameters<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_param_list.jsp, ECD0004"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0004" >
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="8%"><div align="center">Card Type</div></th>
            <th align=CENTER nowrap width="30%">Trans. Type</th>
            <th align=CENTER nowrap width="30%">Local/Other/Intl.</th>
            <th align=CENTER nowrap width="30%">Device</th>
            <th align=CENTER nowrap width="10%">Net</th>
            <th align=CENTER nowrap width="8%"><div align="center">Max. Trs./Day</div></th>
            <th align=CENTER nowrap width="8%"><div align="center"> Max. Amt./Trs.</div></th>
            <th align=CENTER nowrap width="8%"><div align="center">Fee</div></th>
          </tr>
     	<%
        appList.initRow(); 
