...
<SCRIPT Language="Javascript">
   var dc0140_trn_inquiry = "<A HREF=EDC0140_coll_payment_inquiry.jsp>Basic Information</A><BR>"+
					        "<A HREF=EDC0140_coll_payment_conf.jsp>Accounting Applications</A><BR>";
...
<H3 align="center">Collection Payments
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="coll_payment_conf.jsp, EDC0140"></H3>
<HR size="4">
<BR>
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0"	class="tableinfo">
	<TBODY>
		<TR id="trdark">
			...
			<TD nowrap width="20%">
			<DIV align="left"><INPUT type="text" name="E01DCMBNK" readonly 	size="4" maxlength="2" value="<%=msg01.getE01DCMBNK().trim()%>"></DIV>
			</TD>
			<TD nowrap width="16%">
			<DIV align="right"><B>Collection Number:</B></DIV>
			</TD>
			<TD nowrap width="16%">
			<DIV align="left"><B> <INPUT type="text" name="E01DCMACC" size="12" maxlength="12" value="<%=msg01.getE01DCMACC().trim()%>" readonly> </B></DIV>
			</TD>
		</TR>
		<TR id="trclear">
			<TD nowrap width="16%">
		...
		<TR id="trdark">
			...
			<TD nowrap width="16%">
			<DIV align="left"><B> <INPUT type="text" name="E01DCMTYP" size="20" maxlength="16" value="<%=msg01.getE01DCMTYP().trim()%>"> </B></DIV>
			</TD>
			<TD nowrap width="16%">
			<DIV align="right"><B>Product DSescription:</B></DIV>
			</TD>
			<TD nowrap width="16%">
			<DIV align="left"><B> <INPUT type="text" name="E01DSCPRO" size="30" maxlength="30" value="<%=msg01.getE01DSCPRO().trim()%>" readonly> </B></DIV>
			</TD>
		</TR>
	</TBODY>
</TABLE>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  <TR id="trdark">
     <TD align="center" width="5%"><B>Agency</B></TD>
     <TD align="center" width="5%"><B>Currency</B></TD>
     <TD align="center" width="10%"><B>Ledger Account</B></TD>
     <TD align="center" width="15%"><b>Account Number</b></TD>
     <TD align="center" width="5%"><B>Transaction Code</B></TD>
     <TD align="center" width="40%"><B>Description</B></TD>
     <TD align="center" width="15%"><B>Debit</B></TD>
     <TD align="center" width="15%"><B>Credit</B></TD>
  </TR>
 <% datapro.eibs.beans.JBDC0060_trnsgl BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS01());
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS02());
   if (BDC0060.getTRNAMT()>0){
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;   
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS03());
   if (BDC0060.getTRNAMT()>0){ 
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true; 
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS04());
   if (BDC0060.getTRNAMT()>0){ 
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true; 
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS05());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true; 
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS06());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true; 
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS07());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true; 
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS08());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS09());
   if (BDC0060.getTRNAMT()>0){ 
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS10());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS11());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS12());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
...
<% } 
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS13());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
...
<% } 
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS14());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
...
<% } 
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS15());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
...
<% } 
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS16());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
...
<% } 
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS17());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS18());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS19());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS20());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
 ...
 <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS21());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
   %> 	  
	   ...
	   <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS22());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
   %> 	  
    ...
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS23());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
   %> 	  
    ...
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS24());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
   %> 	  
    ...
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS25());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
   %> 	  
    ...
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS26());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
   %> 	  
    ...
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS27());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
   %> 	  
    ...
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS28());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
   %> 	  
    ...
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS29());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
   %> 	  
	   ...
	   <%}
    BDC0060 = new  datapro.eibs.beans.JBDC0060_trnsgl(msg02.getE02TRNS30());
   if (BDC0060.getTRNAMT()>0){  
       TotalDeb +=  BDC0060.getTRNTYP().equals("D")?BDC0060.getTRNAMT():0;
       TotalCre +=  BDC0060.getTRNTYP().equals("C")?BDC0060.getTRNAMT():0;
       glnzero = !glnzero?Double.valueOf(BDC0060.getTRNGLN()).longValue()==0:true;        
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  <TR id="trdark">
     ...
     <TD align="center" width="10%"><B><INPUT type="text" name="TOTCRE" value="<%= fmtDouble(TotalDeb)  %>" size="17" maxlength="17" readonly></B></TD>
     <TD align="center" width="10%"><B><INPUT type="text" name="TOTDEB" value="<%= fmtDouble(TotalCre)  %>" size="17" maxlength="17" readonly></B></TD>
  </TR>
</TABLE>
<BR>

<DIV align="center">
	<INPUT id="EIBSBTN" type=button name="Submit" value="Print" onclick="javascript:eIBSPrint()">
</DIV>
