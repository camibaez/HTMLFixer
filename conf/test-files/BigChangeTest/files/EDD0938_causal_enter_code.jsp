...
<h3 align="center">Service Charges Table/Clearing<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="causal_enter_code,EDD0938"></h3>
<hr size="4">
  ...
  <table class="tableinfo">
    <tr id="trdark"> 
      <td nowrap align="center" width="40%"> 
        <div align="right">Causal code :</div>
      </td>
