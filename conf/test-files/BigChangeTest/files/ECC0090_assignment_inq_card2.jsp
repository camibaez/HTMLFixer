...
<body>
<h3 align="center">Assignments Inquiry<BR>Detail - Additional Card<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="assignment_inq_card2.jsp, ECC0090"></h3>
<hr size="4">
<% 
...
%>
  <table class="tableinfo">
	...
	<td align="center">
      ...
      <B>Secondary Accounts</B><br><SELECT size="5" name="AccSList" id="AccSList"
...
<br>
  <div align="center"> 
	   <INPUT type="button" name="EIBSBTN" id="EIBSBTN" value="Back" onclick="javascript:goAction()">
  </div>
</form>
</body>
</html>
