...
<h3 align="center">Customer Related<img
...
<TABLE id=tbhelp style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-color: #0b23b5; border-style: solid solid solid solid; filter: progid : DXImageTransform . Microsoft . dropshadow(OffX=3, OffY=3, Color='gray', Positive='true')">
	...
	<tr id="trclear">
		...
		<TD ALIGN=center nowrap colspan="2"><input id="EIBSBTN" type=button
			name="Submit" value="Submit" onClick="javascript:goAction(600)"></TD>
...
<TABLE class="tbenter" width="100%" align="center">
	<TBODY>
		<TR>
			...
			<TD class="TDBKG" width="30%">
			<DIV align="center"><A href="javascript:goAction(700)"><B>Delete</B></A></DIV>
			</TD>
		</TR>
	</TBODY>
</TABLE>
...
<table id=cfTable class="tableinfo">
  <tr> <td NOWRAP valign="top" width="100%">
      <table id="headTable" width="100%">
		...
		%>
		<tr>
		  <td NOWRAP align=CENTER width="10%"><input type="radio"  name="CUPCUR" value="<%=msgList.getE01CUPCUR()%>" <%=chk%>></td>
