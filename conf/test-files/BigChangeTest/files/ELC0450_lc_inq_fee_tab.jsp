...
<h3 align="center">Letter Of Credit Inquiry [Service Charges]
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_inq_fee_tab.jsp, ELC0450"></h3>
<hr size="4">
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="10%"> 
              <div align="center"><b><b>G/L Account</b></b></div>
            </td>
            <td width="20%"> 
