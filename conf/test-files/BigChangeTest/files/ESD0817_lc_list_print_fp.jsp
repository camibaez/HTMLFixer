...
<%
	if ( cifList.getNoResult() ) {
   		out.print("<center><h4>There is no match for your search</h4></center>");
	}
	else {
%>
  <h3 align="center">Account Statement<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_list_print.jsp,ESD0817"> 
  </h3>
  <hr size="4">
  <BR>
      ...
      <td > 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td  width="13%"> 
              <div align="right"><%= lcBalances.getE02CIFCCY().trim()%> &nbsp;-&nbsp;<%= Util.fcolorCCY(lcBalances.getE02AMOUN1().trim())%></div>
            </td>
          </tr>
          <tr id="trdark"> 
            <td  width="30%" nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td  width="32%" nowrap><%= lcBalances.getE02CUSFAX().trim()%></td>
            <td  width="25%" nowrap> 
              <div align="right"><b>Issue Date :</b></div>
            </td>
            <td  width="15%"> 
              <div align="right"><%= Util.formatDate(lcBalances.getE02DATEA1(),lcBalances.getE02DATEA2(),lcBalances.getE02DATEA3())%></div>
            </td>
          </tr>
          <tr id="trdark"> 
            <td  width="30%"> 
            ...
            <td  width="32%" nowrap><a href="mailto:<%= lcBalances.getE02CUSIAD().trim()%>" target="body"><%= lcBalances.getE02CUSIAD().trim()%></a></td>
            <td  width="25%" nowrap> 
