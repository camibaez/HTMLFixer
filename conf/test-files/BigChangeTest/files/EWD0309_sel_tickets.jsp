...
<BODY>
<h3 align="center">Trade Tickets Management<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel_tickets.jsp, EWD0309"></h3>
<hr size="4">
 ...
 %> </p>
  ...
  <TABLE class="tbenter" width="100%" >
    <TR>
      <TD > 
        <div align="center"> 
          <p><b>There is no match for your search criteria, please select one 
