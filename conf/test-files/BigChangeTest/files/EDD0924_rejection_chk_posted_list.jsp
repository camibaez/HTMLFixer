...
<h3 align="center">Return Items<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rejection_chk_posted_list.jsp,EDD0924"></h3>
<hr size="4">
...
<INPUT TYPE=HIDDEN NAME="FlagMov" VALUE="0">
  <h4 style="text-align:center">Posted Items Rejection</h4>
