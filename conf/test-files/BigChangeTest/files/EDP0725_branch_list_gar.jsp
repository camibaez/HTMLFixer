...
<BODY>
<h3 align="center">Guarantees<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="branch_list_gar.jsp, EDP0725"></h3>
<hr size="4">
        ...
        <div align="center"> 
          ...
          <table class="tbenter" width=100% align=center>
            <tr> 
              ...
              <td class=TDBKG width="30%"> 
                <div align="center"><a href="javascript:goCancel()"><b>Exit</b></a></div>
              </td>
            </tr>
          </table>
          <p>&nbsp;</p>
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      <td class=TDBKG width="20%"><div align="center"><a href="javascript:goAction(1)"><b>New</b></a></div></td>
	  <td class=TDBKG width="20%"><div align="center"><a href="javascript:goAction(2)"><b>Modify</b></a></div></td>
	  <td class=TDBKG width="20%"><div align="center"><a href="javascript:goAction(3)"><b>Delete</b></a></div></td>
      <td class=TDBKG width="20%"><div align="center"><a href="javascript:goAction(4)"><b>Guarantee</b></a></div></td>
      <td class=TDBKG width="20%"><div align="center"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Exit</b></a></div></td>
    </tr>
  </table>
  <br>
        ...
        <table id="headTable0" width="100%">
		 ...
		 %>
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="5%"><div align="center">Sequence</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Type</div></th>
            <th align=CENTER nowrap width="15%"><div align="center">Identification</div></th>
            <th align=CENTER nowrap width="35%"><div align="center">Description</div></th>
            <th align=CENTER nowrap width="25%"><div align="center">Appraise</div></th>
           </tr>
          <%
				firstTime=false;		
				}
