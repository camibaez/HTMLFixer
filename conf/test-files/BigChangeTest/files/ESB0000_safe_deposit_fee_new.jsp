...
<H3 align="center">Safe Deposit Box Fees New<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_fee_new, ESB0000"></H3>
<hr size="4">
