...
%>
  <h4>Commissions/Custody Tables</h4>
  <TABLE class="tableinfo" align="center" style="width:'95%'">
    <TR id="trdark"> 
      <TH ALIGN=CENTER  nowrap width="20%">Table Type</TH>
      <TH ALIGN=CENTER  nowrap width="20%">Table Code</TH>
      <TH ALIGN=CENTER  nowrap width="60%">Narrative</TH>
    </TR>
    <%               
                ewd0312Help.initRow();
