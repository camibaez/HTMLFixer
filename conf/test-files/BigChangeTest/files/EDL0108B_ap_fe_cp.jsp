...
<body nowrap>
<h3 align="center">Commercial Papers - Approval<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ap_fe_cp.jsp,EDL0108B"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%"> 
				<input type="text" name="E02DLIOAC" size="15" maxlength="13" value="<%= deal.getE02DLIOAC().trim()%>" readonly>
            </td>
          </tr>
        </table>
      </td>
