 ...
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080" >
  <% 
   if ( userPO.getOption().equals("CLIENT_P") ) {
  			...
  			out.println("<INPUT TYPE=HIDDEN NAME=\"SCREEN\" VALUE=\"11\">");
  	}
  	%>
        ...
        <table  cellpadding="3" cellspacing="0" width="100%" border="0" align="center">
          ...
          <tr> 
            ...
            <td nowrap width="50%"> 
              ...
              <input type="radio" readonly="readonly" name="CE09INV" value="1" onClick="document.forms[0].E09INV.value='1'"
			  <%if(marketing.getE09INV().equals("1")) out.print("checked");%> DISABLED>
          ...
          <tr> 
            ...
            <td nowrap width="50%"> 
			  ...
			  <%if(marketing.getE09INV().equals("2")) out.print("checked");%> DISABLED>
          ...
          <tr> 
            ...
            <td nowrap width="50%"> 
			  ...
			  <%if(marketing.getE09RSG().equals("1")) out.print("checked");%> DISABLED>
              High</td>
          </tr>
          <tr> 
            <td nowrap width="50%"> 
            ...
            <td nowrap width="50%"> 
			  ...
			  <%if(marketing.getE09RSG().equals("2")) out.print("checked");%> DISABLED>
              Medium </td>
          </tr>
          <tr> 
            <td nowrap width="50%"> 
            ...
            <td nowrap width="50%"> 
              <input type="radio" name="CE09RSG" value="2" onClick="document.forms[0].E09RSG.value='2'"
			  <%if(marketing.getE09RSG().equals("3")) out.print("checked");%> DISABLED>
              None</td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap wrap > 
        <table cellpadding="3" cellspacing="0" width="100%" border="0" align="center">
          <tr id="trdark"> 
            ...
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09CTV" value="<%= marketing.getE09CTV().trim()%>" size="20" maxlength="20">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Favorite Sport :</div>
            </td>
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09DPA" size="20" maxlength="20" value="<%= marketing.getE09DPA().trim()%>">
            </td>
          </tr>
          <tr> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09CNT" size="20" maxlength="20" value="<%= marketing.getE09CNT().trim()%>">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Current Sport :</div>
            </td>
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09DPP" size="20" maxlength="20" value="<%= marketing.getE09DPP().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09RD1" value="<%= marketing.getE09RD1().trim()%>" size="20" maxlength="20">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Favorite Newspaper :</div>
            </td>
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09PER" size="20" maxlength="20" value="<%= marketing.getE09PER().trim()%>">
            </td>
          </tr>
          <tr> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09RD2" value="<%= marketing.getE09RD2().trim()%>" size="20" maxlength="20">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Social Club :</div>
            </td>
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09CLB" size="20" maxlength="20" value="<%= marketing.getE09CLB().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09PTP" value="<%= marketing.getE09PTP().trim()%>" size="20" maxlength="20">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Cultural Event :</div>
            </td>
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09EVC" size="20" maxlength="20" value="<%= marketing.getE09EVC().trim()%>">
            </td>
          </tr>
          <tr> 
            ...
            <td nowrap width="25%" rowspan="4"> 
              <input type="text" readonly name="E09OBR" size="20" maxlength="20" value="<%= marketing.getE09OBR().trim()%>">
            </td>
            <td nowrap width="25%" rowspan="4"> 
              <div align="right">Languages :</div>
            </td>
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09LN1" size="20" maxlength="15" value="<%= marketing.getE09LN1().trim()%>">
            </td>
          </tr>
          <tr> 
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09LN2" size="20" maxlength="15" value="<%= marketing.getE09LN2().trim()%>">
            </td>
          </tr>
          <tr> 
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09LN3" size="20" maxlength="15" value="<%= marketing.getE09LN3().trim()%>">
            </td>
          </tr>
          <tr> 
            <td nowrap width="25%"> 
              <input type="text" readonly name="E09LN4" size="20" maxlength="15" value="<%= marketing.getE09LN4().trim()%>">
            </td>
          </tr>
        </table>
      </td>
        ...
        <table cellpadding="3" cellspacing="0" width="100%" border="0" align="center">
          <tr id="trdark"> 
            ...
            <td nowrap width="26%"> 
			  ...
			  <%if(marketing.getE09INT().equals("Y")) out.print("checked");%> DISABLED>
              Yes 
              <input type="radio" name="CE09INT" value="N" onClick="document.forms[0].E09INT.value='N'"
			  <%if(marketing.getE09INT().equals("N")) out.print("checked");%> DISABLED>
              No </td>
          ...
          <tr> 
            ...
            <td nowrap width="26%"> 
              <select name="E09NVG" DISABLED>
                ...
                <option value="1" <% if (marketing.getE09NVG().equals("1")) out.print("selected"); %>>Microsoft 
                Internet Explorer</option>
                <option value="2" <% if (marketing.getE09NVG().equals("2")) out.print("selected"); %>>Netscape 
                Navigator</option>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="26%"> 
			  ...
			  <%if(marketing.getE09CIN().equals("Y")) out.print("checked");%> DISABLED>
              Yes 
              <input type="radio" name="CE09CIN" value="N" onClick="document.forms[0].E09CIN.value='N'"
			  <%if(marketing.getE09CIN().equals("N")) out.print("checked");%> DISABLED>
              No </td>
            <td nowrap width="26%">&nbsp;</td>
          </tr>
          <tr> 
            ...
            <td nowrap width="26%"> 
			  ...
			  <%if(marketing.getE09DCI().equals("Y")) out.print("checked");%> DISABLED>
              Yes 
              <input type="radio" name="CE09DCI" value="N" onClick="document.forms[0].E09DCI.value='N'"
			  <%if(marketing.getE09DCI().equals("N")) out.print("checked");%> DISABLED>
              No </td>
            <td nowrap width="26%">&nbsp;</td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr> 
            ...
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PFI"  onClick="document.forms[0].E09PFI.value='X'"
				<%if(marketing.getE09PFI().equals("X")) out.print("checked");%> DISABLED>
              Finance </td>
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PCE"  onClick="document.forms[0].E09PCE.value='X'"
				<%if(marketing.getE09PCE().equals("X")) out.print("checked");%> DISABLED>
              Science </td>
          </tr>
          <tr> 
            <td nowrap width="48%"> 
            ...
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PTE"  onClick="document.forms[0].E09PTE.value='X'"
				<%if(marketing.getE09PTE().equals("X")) out.print("checked");%> DISABLED>
              Technology</td>
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PCO"  onClick="document.forms[0].E09PCO.value='X'"
				<%if(marketing.getE09PCO().equals("X")) out.print("checked");%> DISABLED>
              Computer</td>
          </tr>
          <tr> 
            <td nowrap width="48%"> 
            ...
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PEL"  onClick="document.forms[0].E09PEL.value='X'"
				<%if(marketing.getE09PEL().equals("X")) out.print("checked");%> DISABLED>
              Electronic</td>
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PNE"  onClick="document.forms[0].E09PNE.value='X'"
				<%if(marketing.getE09PNE().equals("X")) out.print("checked");%> DISABLED>
              Business </td>
          </tr>
          <tr> 
            <td nowrap width="48%"> 
            ...
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PCI"  onClick="document.forms[0].E09PCI.value='X'"
				<%if(marketing.getE09PCI().equals("X")) out.print("checked");%> DISABLED>
              Movies and TV</td>
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PAU"  onClick="document.forms[0].E09PAU.value='X'"
				<%if(marketing.getE09PAU().equals("X")) out.print("checked");%> DISABLED>
              Cars </td>
          </tr>
          <tr> 
            <td nowrap width="48%"> 
            ...
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PDE"  onClick="document.forms[0].E09PDE.value='X'"
				<%if(marketing.getE09PDE().equals("X")) out.print("checked");%> DISABLED>
              Sports </td>
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PFO"  onClick="document.forms[0].E09PFO.value='X'"
				<%if(marketing.getE09PFO().equals("X")) out.print("checked");%> DISABLED>
              Forums</td>
          </tr>
          <tr> 
            <td nowrap width="48%"> 
            ...
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PFA"  onClick="document.forms[0].E09PFA.value='X'"
				<%if(marketing.getE09PFA().equals("X")) out.print("checked");%> DISABLED>
              Family</td>
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09PMU"  onClick="document.forms[0].E09PMU.value='X'"
				<%if(marketing.getE09PMU().equals("X")) out.print("checked");%> DISABLED>
              Music </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="48%"> 
          ...
          <tr> 
            ...
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09CIV"  onClick="document.forms[0].E09CIV.value='X'"
				<%if(marketing.getE09CIV().equals("X")) out.print("checked");%> DISABLED>
              Investments </td>
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09CLI"  onClick="document.forms[0].E09CLI.value='X'"
				<%if(marketing.getE09CLI().equals("X")) out.print("checked");%> DISABLED>
              Books </td>
          </tr>
          <tr> 
            <td nowrap width="48%"> 
            ...
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09CTE"  onClick="document.forms[0].E09CTE.value='X'"
				<%if(marketing.getE09CTE().equals("X")) out.print("checked");%> DISABLED>
              Technology</td>
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09CPA"  onClick="document.forms[0].E09CPA.value='X'"
				<%if(marketing.getE09CPA().equals("X")) out.print("checked");%> DISABLED>
              Flights Tickets</td>
          </tr>
          <tr> 
            <td nowrap width="48%"> 
            ...
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09CRE"  onClick="document.forms[0].E09CRE.value='X'"
				<%if(marketing.getE09CRE().equals("X")) out.print("checked");%> DISABLED>
              Magazines</td>
            <td nowrap width="26%"> 
              <input type="checkbox" name="E09CVI"  onClick="document.forms[0].E09CVI.value='X'"
				<%if(marketing.getE09CVI().equals("X")) out.print("checked");%> DISABLED>
              Videos </td>
          </tr>
          <tr> 
            ...
            <td nowrap width="26%" height="26"> 
              <input type="checkbox" name="E09CAU"  onClick="document.forms[0].E09CAU.value='X'"
				<%if(marketing.getE09CAU().equals("X")) out.print("checked");%> DISABLED>
              Cars </td>
            <td nowrap width="26%" height="26"> 
              <input type="checkbox" name="E09CTR"  onClick="document.forms[0].E09CTR.value='X'"
				<%if(marketing.getE09CTR().equals("X")) out.print("checked");%> DISABLED>
              Other</td>
          </tr>
        </table>
      </td>
