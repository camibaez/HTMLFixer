...
<body bgcolor="#FFFFFF"><H3 align="center">Account Master Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="gledger_enter_inquiry,EGL0340"></H3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEGL0340">
  ...
  <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
    ...
    <tr> 
      ...
      <td width="50%"> 
        <div align="left"> 
          <input type="text" name="E01GLMGLN" onKeypress="enterInteger()" size="17" maxlength="12" value="<%= gLedger.getE01GLMGLN().trim()%>">
