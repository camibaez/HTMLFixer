...
<H3 align="center">Our Denial List Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="our_denial_maint, EDEN020"></H3>
<hr size="4">
...
--%>
                <a href="javascript:GetCodeCNOFC('E01DOCCD','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></a>
                <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  >
              </div>
            </td>
           </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="75%"> 
              <div align="left"> 
                ...
                <a href="javascript:DatePicker(document.forms[0].E01DODT13,document.forms[0].E01DODT12,document.forms[0].E01DODT11)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"></a> 
                <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  >
                &nbsp;(YY/MM/DD)
              </div>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="75%"> 
              <div align="left"> 
                ...
                <a href="javascript:DatePicker(document.forms[0].E01DODT23,document.forms[0].E01DODT22,document.forms[0].E01DODT21)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"></a> 
                &nbsp;(YY/MM/DD)
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="75%"> 
              <div align="left"> 
                ...
                <a href="javascript:DatePicker(document.forms[0].E01DODT33,document.forms[0].E01DODT32,document.forms[0].E01DODT31)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"></a> 
                &nbsp;(YY/MM/DD)
              </div>
            </td>
          </tr>
