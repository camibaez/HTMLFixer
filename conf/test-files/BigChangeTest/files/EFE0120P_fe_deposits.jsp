...
%> 
<h3 align="center"> Deposits <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ln_basic.jsp,EDL0150"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap >&nbsp;</td>
            <td nowrap >
              <div align="right">Date :<%= Util.formatDate(fex.getE01FESDD1(),fex.getE01FESDD2(),fex.getE01FESDD3())%>04/02/02</div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
            ...
            <INPUT type="radio" name="CE01FESSBT" value="PU" onclick="document.forms[0].E01FESSBT.value='PU'"></td>
                        <td nowrap > 
              <input type="hidden" name="E01FESSBT" value="<%= fex.getE01FESSBT()%>"> Overnight Date</td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
