...
<HEAD>
<TITLE>
Retail Account Daily Balances Inquiry
</TITLE>
...
<%
	if ( cifList.getNoResult() ) {
        ...
        out.print("<br>");
        out.print("<br>");
   		out.print("<center><h3>There is no match for your search criteria</h3></center>");

	}
	else {
%>
  <h3 align="center">Daily Balance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="rt_inq_day_bal.jsp,EDD0092" width="35" height="34"> 
  </h3>
  <hr size="4">
<h4></h4>
  ...
  <TABLE class="tableinfo">
    <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER  nowrap >Uncollected Amount</TH>
      <TH ALIGN=CENTER  nowrap > 
        <div align="center">Hold Amount</div>
      </TH>
      <TH ALIGN=CENTER  nowrap > 
        <div align="center">Net Balance</div>
      </TH>
    </TR>
    <%
                cifList.initRow();
