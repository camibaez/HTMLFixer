...
<html>
<head>
<title>Evaluation Credit Scoring</title>
...
<H3 align="center">Assessment Summary Credit Scoring<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="evaluation_credit_scoring.jsp, EDP0886"></H3>
<P align="center">
</P>
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
		...
		<TABLE id="tbenter" align="center" style="width: 100%" border="0">
			...
			<TR id="trdark">
				<td nowrap width="25%">
					<DIV align="right">Customer from : </DIV>
				</TD>
				<td nowrap align="left" width="25%">
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
		...
		<TABLE id="tbenter" align="center" style="width: 100%" border="0">
			...
			<tr id="trclear">
				<td nowrap width="25%">
					<DIV align="right">Receiving Office :</DIV>
				</td>
				<td nowrap align="left" width="25%">
				...
				<td nowrap width="25%">
					<DIV align="right">Business Executive : </DIV>
				</TD>
				<td nowrap align="left" width="25%">
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
		<TABLE id="tbenter" align="center" style="width: 100%" border="0">
			...
			<TR id="trclear">
				<td nowrap width="33%">
					<DIV align="right">Monthly Financial Debt :</DIV>
				</TD>
				<td nowrap align="left" width="67%">
			...
			<tr id="trdark">
				<td nowrap width="33%">
					<DIV align="right">Current Debt :</DIV>
				</td>
				<td nowrap align="left" width="67%">
    ...
    <tr > 
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="33%">Credit Application</th>
            <th align=CENTER nowrap width="33%">Default</th>
            <th align=CENTER nowrap width="33%">Policies</th>
           </tr>
          <tr> 
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
		<TABLE id="tbenter" align="center" style="width: 100%" border="0">
			<tr id="trdark">
				<td	nowrap width="50%">
					<div align="right">Total Punctuation Credit Scoring :</div>
				</td>
			...
			<TR id="trclear">
				<td nowrap width="50%">
					<DIV align="right">Risk Rating :</DIV>
				</TD>
				<td nowrap align="right" width="50%">
			...
			<TR id="trdark">
				<td nowrap width="50%">
					<DIV align="right">Probability of Default :</DIV>
				</TD>
				<td nowrap align="right" width="50%">
			...
			<TR id="trclear">
				<td nowrap width="50%">
					<DIV align="right">Specifies Provision :</DIV>
				</TD>
				<td nowrap align="right" width="50%">
			...
			<TR id="trdark">
				<td nowrap width="50%">
					<DIV align="right">Recommendation for Credit Scoring :</DIV>
				</TD>
				<td nowrap align="right" width="50%">
			...
			<TR id="trclear">
				<td nowrap width="50%">
					<DIV align="right">Maximum Amount to Grant by Income :</DIV>
				</TD>
				<td nowrap align="right" width="50%">
			...
			<TR id="trdark">
				<td nowrap width="50%">
					<DIV align="right">Recommended Amount Credit Scoring :</DIV>
				</TD>
				<td nowrap align="right" width="50%">
  ...
  <table  id=cfTable class="tableinfo">
    <tr > 
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="50%">Credit Analyst</th>
            <th align=CENTER nowrap width="50%">Credit Manager</th>
           </tr>
          <tr> 
            <td NOWRAP  align=CENTER width="33%"> 
