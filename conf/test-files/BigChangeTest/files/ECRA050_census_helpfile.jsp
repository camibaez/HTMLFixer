...
<TITLE>Census Tract Codes Help</TITLE>
...
<TABLE  id="mainTable" class="tableinfo" ALIGN=CENTER style="width:'95%'">
   <TR> 
	...
	<TABLE id="headTable" >
	   <TR id="trdark">  
		<TH ALIGN=CENTER NOWRAP>					
			<a href="#" class="sortheader" onclick="ts_resortTable(this,'dataTable');return false;">Census Code<span class="sortarrow">&nbsp;&nbsp;&nbsp;</span></a>
		</TH>
		<TH ALIGN=CENTER NOWRAP>
    ...
    <table id="dataTable" > 
		<%      Socket s = null;
				...
				int rows = 0;
              	...
              	try
               	...
               	try
               	{
               		msgHelp = (ECRA05001Message)mc.getMessageRecord("ECRA05001");
					msgHelp.setH01USERID(msgUser.getH01USR());
					msgHelp.setH01PROGRM("ECRA050");
               	...
               	try
               	{
					...
					if (newmessage.getFormatName().equals("ELEERR")) 
					{
                  	...
                  	else if (newmessage.getFormatName().equals("ECRA05001")) 
                  	{
                  		...
                  		{
                  	   		//newmessage = mc.receiveMessage();                  	  
                            msgHelp =  (ECRA05001Message)newmessage;
		...
		%>
           	<tr>
           		<td nowrap><A HREF="javascript:a('<%=msgHelp.getE01CRUCET().trim()%>')" > <%=msgHelp.getE01CRUCET().trim()%> </a></td>
           		<td nowrap><A HREF="javascript:a('<%=msgHelp.getE01CRUCET().trim()%>')" > <%=msgHelp.getE01CRUDSC().trim()%> </a></td>
	        </tr>               
    	<%           	
    	       				rows++;
    	       				newmessage = mc.receiveMessage();
