...
<html>
<head>
<title>System reference code</title>
...
<BODY>
<h3 align="center">System Reference Codes - <%= userPO.getHeader21() %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_reference_list.jsp, ESD0030"></h3>
<hr size="4">
		 ...
		 %>
          <tr> 
            <td NOWRAP  align=CENTER width="5%"> 
              <input type="radio" name="CURRCODE" <%=chk%> value="<%= ESD003002Help.getCurrentRow() %>"
			  >
            </td>
            <td NOWRAP  align=CENTER width="20%"><%= msgList.getE02CNORCD() %></td>
