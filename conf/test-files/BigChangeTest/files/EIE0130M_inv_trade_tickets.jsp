...
%>
<div align="center"> 
  <h3>Trade Ticket Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_trade_tickets.jsp,EIE130M"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="4" >
              <div align="right"><a href="javascript:GetInvestmentsByCustomer(document.forms[0].E01ORDCUN.value,'E01ORDPRF','E01ORDIIC','E01ORDICN','E01ORDSCY','E01ORDCUC','E01ORDCCN','E01ORDPTY','E01ORDVNO','E01ORDQTY','E01ORDCSP','E01ORDSYM','E01ORDISI','E01ORDATY','E01ORDLP2','E01ORDLP1','E01ORDLP3')">Investments 
                by Customer<img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a><a href="javascript:GetInvestmentsByCustomer(document.forms[0].E01ORDCUN.value,'E01ORDPRF','E01ORDIIC','E01ORDICN','E01ORDSCY','E01ORDCUC','E01ORDCCN','E01ORDPTY','E01ORDVNO','E01ORDQTY','E01ORDCSP','E01ORDSYM','E01ORDISI','E01ORDATY','E01ORDLP2','E01ORDLP1','E01ORDLP3')"> 
                </a></div>
            </td>
          </tr>
          <tr id="trdark"> 
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
			...
			<TR id="trclear">
				...
				<TD nowrap width="36%">&nbsp;<INPUT type="text" readonly
					name="E01ORDST10" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDST1()%>">
              <INPUT type="text" readonly name="E01ORDST20" size="3"
					maxlength="2" value="<%= invTrade.getE01ORDST2()%>">
              <INPUT type="text" readonly name="E01ORDST30" size="3"
					maxlength="2" value="<%= invTrade.getE01ORDST3()%>">
            </TD>
				<TD nowrap width="14%">Delivery Date : </TD>
				<TD nowrap width="33%"><INPUT type="text" readonly name="E01ORDF15A"
