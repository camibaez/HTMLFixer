...
<h3 align="center">Deleting Payment Orders </h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.transfer.JSEDD0670">
  ...
  <p>Note : This option is going to delete the selected transaction, please be
    careful. </p>
    ...
    <tr id="trdark">
      ...
      <td nowrap align="center" width="60%">
        <div align="left">
          ...
          <a href="javascript:GetCNTRLPRF('E01FEETYP')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a></div>
      </td>
    </tr>
    <tr id="trclear">
