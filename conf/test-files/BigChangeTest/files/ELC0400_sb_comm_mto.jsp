...
<h3 align="center">Stand By Letter Of Credit <%= (userPO.getPurpose().equals("NEW") ? "New" : "Maintenance") %> [Commissions]
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="sb_comm_mto.jsp, ELC0400"></h3>
<hr size="4">
					...
					<tr id="trclear">
						...
						<td nowrap width="15%">
							<select name="E04LCMP04"  >
								...
								<option value="B" <%if(msg.getE04LCMP04().equals("B")) out.print("selected");%>>Beneficiary</option>
								<option value="W" <%if(msg.getE04LCMP04().equals("W")) out.print("selected");%>>Wave</option>
							</select></td>
						...
						<td nowrap width="15%">
							<select name="E04LCMP05">
								<option value="A">Applicant</option>
								<option value="B" <%if(msg.getE04LCMP05().equals("B")) out.print("selected");%>>Beneficiary</option>
								<option value="W" <%if(msg.getE04LCMP05().equals("W")) out.print("selected");%>>Wave</option>
							</select></td>
						<td nowrap width="26%"></td>
						<td nowrap width="12%"></td>
					</tr><tr id="trclear">
						...
						<td nowrap width="15%">
							<select name="E04LCMP06">
								<option value="A">Applicant</option>
								<option value="B" <%if(msg.getE04LCMP06().equals("B")) out.print("selected");%>>Beneficiary</option>
								<option value="W" <%if(msg.getE04LCMP06().equals("W")) out.print("selected");%>>Wave</option>
							</select></td>
						<td nowrap width="26%"></td>
						<td nowrap width="12%"></td>
					</tr>
					<tr id="trdark">
						...
						<td nowrap width="15%">
							<select name=E04LCMP07>
								<option value="A">Applicant</option>
								<option value="B" <%if(msg.getE04LCMP07().equals("B")) out.print("selected");%>>Beneficiary</option>
								<option value="W" <%if(msg.getE04LCMP07().equals("W")) out.print("selected");%>>Wave</option>
							</select></td>
						<td nowrap width="26%"></td>
						<td nowrap width="12%"></td>
					</tr>
