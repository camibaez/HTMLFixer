...
%> 
<h3 align="center"> Foreign Exchange Forward - Confirmation Ticket</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="21%" ><%= Util.formatDate(fex.getE01FESDD1(),fex.getE01FESDD2(),fex.getE01FESDD3())%></td>
            <td nowrap width="23%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="21%" ><%= fex.getE01FESBRK()%> - <%= fex.getD01FEBNM1()%></td>
