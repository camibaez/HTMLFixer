...
%>
<h3 align="center">Special Codes of <%= userPO.getHeader4().trim()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_codes.jsp,EDL0150" ></h3>
<hr size="4">
    ...
    <tr >
      <td nowrap >
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">
            <td nowrap width="30%">
              <div align="right">Basil Index :</div>
            </td>
            <td nowrap width="70%">
