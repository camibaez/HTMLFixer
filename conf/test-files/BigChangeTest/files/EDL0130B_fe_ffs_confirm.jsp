...
<h3 align="center"><%= !currUser.getH01WK3().equals("1") ?"Overnight Funds ":"Federal Funds "%>- Back Office - Confirmation</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="25%" ><% if(deal.getE11DLSSBT().equals("SL")) out.print("Sale");
