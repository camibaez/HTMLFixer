...
<h3 align="center">Correspondant Bank Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="correspondant_bank_enter.jsp,ESD0010"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="19%">
              ...
              <a href="javascript:GetSwiftId('E01SWI')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a>
            </td>
          </tr>
          <tr id="trclear">
