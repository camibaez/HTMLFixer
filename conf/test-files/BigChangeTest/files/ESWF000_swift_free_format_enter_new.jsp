...
<body bgcolor="#FFFFFF">
<H3 align="center"> SWIFT Free Formats <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="swift_free_format_approval_list,ESWF010"></H3>
