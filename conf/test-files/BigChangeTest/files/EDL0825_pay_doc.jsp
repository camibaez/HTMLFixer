...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0825">
  ...
  <table class="tableinfo" cellpadding="2" cellspacing="0">
    <tr id="trdark">
	  <td align="right" width="20%" nowrap> <b> Account : </b></td>
	  <td align="left" nowrap><%= payDoc.getE01DEAACC() %><b> - </b><%= payDoc.getE01CUSNA1() %> </td>
      <td nowrap align="left"> <b> Document No. : </b><%= payDoc.getE01SELNDR() %> 
      </td> 
    </tr> 
	<tr id="trdark">
	  <td align="right" width="20%"> <b>Acceptant : </b></td>
  ...
  <table width="100%">
    <tr> 
      <td id=trdark width="20%" nowrap></td>	  
      <td id=trdark width="40%" nowrap align="center">To Pay</td>
      <td id=trdark width="40%" nowrap  align="center">Paid</td>
    </tr>
    <tr> 
      <td  width="20%" nowrap>  
    ...
    <tr> 
      <td width="20%" nowrap>  
        <div align="right"><b>Penalty Interest : </b></div>
      </td>
	  <td width="40%" nowrap align="right"> 
		<%= payDoc.getE01TRNMOR()%> 
      </td>
    ...
    <% if (payDoc.getH01FLGWK3().equals("R")) {%> 
     <tr> 
      <td width="20%" nowrap>  
        <div align="right"><b>Revaluation : </b></div>
      </td>
	  <td width="40%" nowrap align="right"> 
		<%= payDoc.getE01TRNREA()%> 
      </td>
    ...
    <tr>
      <td width="100%" colspan="3" nowrap>  
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr> 
		      <td width="20%" nowrap>  
		        <div align="right"><b>Pending Interest : </b></div>
		      </td>
			  <td width="40%" nowrap align="right"> 
				<%= payDoc.getE01TRNINT()%> 
		      </td>
    ...
    <tr> 
      <td  width="20%" nowrap>  
        <div align="right"><b>Commission : </b></div>
      </td>
	  <td width="40%" nowrap align="right"> 
		<%= payDoc.getE01TRNCOM() %> 
      </td>
  ...
  <table width="100%" >
	<tr>
		...
		<tr>
            <td nowrap width="20%">
               <div align="right">Return Interest :</div>
            </td>  
			<td nowrap> 
               	<INPUT type="radio" name="E01DEVINT" value="Y" onClick="devIntClick('Y')" <% if(payDoc.getE01DEVINT().equals("Y")) out.print("checked");%>>Yes
            ...
            <td nowrap width="30%"> 
              <div align="center"> 
                <input type="text" name="E01PAGOAC" size="16" maxlength="16" value="<%if (payDoc.getE01MANPAG().equals("Y")) out.print(payDoc.getE01PAGOAC().trim()); else if (!(docData.getPAGOAC()==null)) out.print(docData.getPAGOAC().trim());%>"
                 oncontextmenu="showPopUp(accountHelp,this.name,document.forms[0].E01PAGOBK.value,'','','','RT')">
              </div>
            </td>
