      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" >
              <input type="text" readonly name="E01WKFMA1" size="3" maxlength="2" value="<%= fex.getE01WKFMA1()%>" 
			  >
              <input type="text" readonly name="E01WKFMA2" size="3" maxlength="2" value="<%= fex.getE01WKFMA2()%>" 
			  >
              <input type="text" readonly name="E01WKFMA3" size="3" maxlength="2" value="<%= fex.getE01WKFMA3()%>" 
			  >
            </td>
            <td nowrap >&nbsp;</td>
            <td nowrap >&nbsp;</td>
