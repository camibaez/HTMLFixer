...
<BODY>
<h3 align="center">Safe Deposit Box Locations<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_types, EWB0010"></H3>
<hr size="4">
     	...
     	%>
					<TR>
						<TD nowrap align="CENTER"><a 
							href="javascript:enter('<%=Util.formatCell(msgPart.getE01SBTTYP())%>','<%=Util.formatCell(msgPart.getE01SBTDSC())%>')">
							<%=Util.formatCell(msgPart.getE01SBTTYP())%>
						</TD>
						<TD nowrap align="CENTER"><a 
							href="javascript:enter('<%=Util.formatCell(msgPart.getE01SBTTYP())%>','<%=Util.formatCell(msgPart.getE01SBTDSC())%>')">
							<%=Util.formatCell(msgPart.getE01SBTDSC())%>
						</TD>
					</TR>
					<%}%>
				</TBODY>
