...
<BODY>
<H3 align="center">Commercial Letters Of Credit Approval Inquiry [Credit Conditions]
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="lc_details.jsp, ELC0525"></H3>
...
<FORM method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0525" >
  ...
  <INPUT NAME="msg050002" TYPE=HIDDEN VALUE="ELC050002" readonly="readonly">
      ...
      <TD nowrap><TABLE cellpadding="2" cellspacing="0" width="100%" border="0">
          <TBODY>
            <TR id="trdark">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMID1" type="text" onKeyPress="enterInteger()" value="<%= (msg050002.getE02LCMID1().trim().equals("0") ? "":msg050002.getE02LCMID1().trim())%>" size="2" maxlength="2" readonly="readonly">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMEX1" type="text" onKeyPress="enterInteger()" value="<%= (msg050002.getE02LCMEX1().trim().equals("0") ? "":msg050002.getE02LCMEX1().trim())%>" size="2" maxlength="2" readonly="readonly">
            ...
            <TR id="trclear">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMSD1" type="text" onKeyPress="enterInteger()" value="<%= (msg050002.getE02LCMSD1().trim().equals("0") ? "":msg050002.getE02LCMSD1().trim())%>" size="2" maxlength="2" readonly="readonly">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMCN1" type="text" onKeyPress="enterInteger()" value="<%= (msg050002.getE02LCMCN1().trim().equals("0") ? "":msg050002.getE02LCMCN1().trim())%>" size="2" maxlength="2" readonly="readonly">
            ...
            <TR id="trdark">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMCCY" type="text" disabled value="<%= msg050002.getE02LCMCCY().trim()%>" size="4" maxlength="4" readonly="readonly"></TD>
              <TD nowrap width="27%" align="right">Foreign Exchange Rate: </TD>
              <TD nowrap width="27%"><INPUT name="E02LCMOFX" type="text" disabled="disabled" value="<%= msg050002.getE02LCMOFX().trim()%>" size="12" maxlength="11" readonly="readonly">              </TD>
            </TR>
            <TR id="trclear">
              <TD nowrap width="25%" align="right">Cost Center: </TD>
              <TD nowrap width="27%"><INPUT name="E02LCMCCN" type="text" disabled value="<%= msg050002.getE02LCMCCN().trim()%>" size="9" maxlength="8" readonly="readonly">
                 </TD>
              <TD nowrap width="27%" align="right">Original Amount: </TD>
              <TD nowrap width="27%"><INPUT name="E02LCMOAM" type="text" value="<%= msg050002.getE02LCMOAM().trim()%>" size="17" maxlength="16" disabled="disabled">
                <IMG src="<%=request.getContextPath()%>/images/Check.gif"
						alt="Mandatory Field"  border="0"></TD>
            </TR>
            <TR id="trdark">
              <TD nowrap width="25%" align="right">About Clause: </TD>
              <TD nowrap width="27%"><INPUT name="E02LCMABC" type="radio" disabled value="Y" readonly="readonly" <% if(msg050002.getE02LCMABC().equals("Y")) out.print("checked");%>>
                Yes
                <INPUT name="E02LCMABC" type="radio" disabled value="N" readonly="readonly" <% if(msg050002.getE02LCMABC().equals("N")) out.print("checked");%>>
                No
                &nbsp; &nbsp; &nbsp; About Percentage:
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMITR" type="text" value="<%= msg050002.getE02LCMITR().trim()%>" size="4" maxlength="4" readonly="readonly">
                 </TD>
            </TR>
            <TR id="trclear">
              ...
              <TD nowrap width="27%"><SELECT name="E02LCMTNR" disabled>
                  <OPTION value=" "></OPTION>
                  <OPTION value="S" <% if(msg050002.getE02LCMTNR().equals("S")) out.print("selected");%>>Sight Payment</OPTION>
                  <OPTION value="A" <% if(msg050002.getE02LCMTNR().equals("A")) out.print("selected");%>>Acceptance</OPTION>
                  <OPTION value="M" <% if(msg050002.getE02LCMTNR().equals("M")) out.print("selected");%>>Mixed Payment</OPTION>
                  <OPTION value="D" <% if(msg050002.getE02LCMTNR().equals("D")) out.print("selected");%>>Deferred Payment</OPTION>
                  <OPTION value="N" <% if(msg050002.getE02LCMTNR().equals("N")) out.print("selected");%>>Negotiation</OPTION>
                </SELECT>
                <IMG src="<%=request.getContextPath()%>/images/Check.gif"
						alt="Mandatory Field" border="0"></TD>
              <TD nowrap width="27%"align="right">Confirmed: </TD>
              <TD nowrap width="27%"><INPUT name="E02LCMCNF" type="radio" value="Y" disabled <% if(msg050002.getE02LCMCNF().equals("Y")) out.print("checked");%>>
                Yes
            ...
            <TR id="trdark">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMTRN" type="radio" disabled value="Y" readonly="readonly" <% if(msg050002.getE02LCMTRN().equals("Y")) out.print("checked");%>>
                Yes
            ...
            <TR id="trclear">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMPSH" type="radio" disabled value="Y" readonly="readonly" <% if(msg050002.getE02LCMPSH().equals("Y")) out.print("checked");%>>
                Yes
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMTSH" type="radio" disabled value="Y" readonly="readonly" <% if(msg050002.getE02LCMTSH().equals("Y")) out.print("checked");%>>
                Yes
            ...
            <TR id="trdark">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMBRK" type="text"  disabled onKeyPress="enterDecimal()" value="<%= msg050002.getE02LCMBRK().trim()%>" size="17" maxlength="16" readonly="readonly"></TD>
              <TD nowrap width="27%" align="right"> Cash Collateral Percentage :</TD>
              <TD nowrap width="27%"><INPUT name="E02LCMCPE" type="text" disabled="disabled" onKeyPress="enterDecimal()" value="<%= msg050002.getE02LCMCPE().trim()%>" size="17" maxlength="16" readonly="readonly"></TD>
            </TR>
            <TR id="trclear">
              <TD nowrap width="25%" align="right">Cash Collateral Amount: </TD>
              <TD nowrap width="27%"><INPUT name="E02LCMCAM" type="text" disabled="disabled" onKeyPress="enterDecimal()" value="<%= msg050002.getE02LCMCAM().trim()%>" size="17" maxlength="16" readonly="readonly">              </TD>
              <TD nowrap width="27%" align="right">Cash Collateral Account: </TD>
              <TD nowrap width="27%"><TABLE id="trclear">
                  <TBODY>
                    <TR>
                      <TD rowspan="2"><INPUT name="E02LCMCCA" type="text" disabled="disabled" value="<%= msg050002.getE02LCMCCA().trim()%>" size="17" maxlength="16" readonly="readonly"></TD>
                  </TBODY>
                </TABLE></TD>
            </TR>
            <TR id="trdark">
              <TD nowrap width="25%" align="right">Commissions Table: </TD>
              <TD nowrap width="27%"><INPUT name="E02LCMTAR" type="text" value="<%= msg050002.getE02LCMTAR().trim()%>" size="2" maxlength="2" readonly="readonly">
                 
				<IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatory Field"  border="0"></TD>
              <TD align="right">Our Charges For Account of: </TD>
              <TD nowrap><SELECT name="E02LCMAOB" disabled>
                  <OPTION value=" "></OPTION>
                  <OPTION value="A" <% if(msg050002.getE02LCMAOB().equals("A")) out.print("selected");%>>Aplicant</OPTION>
                  <OPTION value="B" <% if(msg050002.getE02LCMAOB().equals("B")) out.print("selected");%>>Beneficiary</OPTION>
                </SELECT>
                <IMG src="<%=request.getContextPath()%>/images/Check.gif"
						alt="Mandatory Field"  border="0"></TD>
            </TR>
            <TR id="trclear">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMSRF"  type="text" disabled value="<%= msg050002.getE02LCMSRF().trim()%>" size="17" maxlength="16" readonly="readonly">              </TD>
            </TR>
            <TR id="trdark">
              <TD nowrap width="25%" align="right">Opening Comm. at Issuance: </TD>
              <TD nowrap width="27%"><INPUT name="E02LCMOCI" type="radio" disabled  value="Y" readonly="readonly" <% if(msg050002.getE02LCMOCI().equals("Y")) out.print("checked");%>>
                Yes
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMACI" type="radio" disabled  value="Y" readonly="readonly" <% if(msg050002.getE02LCMACI().equals("Y")) out.print("checked");%>>
                Yes
            ...
            <TR id="trclear">
              ...
              <TD nowrap width="27%"><INPUT name="E02LCMPLE" type="text" value="<%= msg050002.getE02LCMPLE().trim()%>" size="29" maxlength="29" readonly="readonly">
                <IMG src="<%=request.getContextPath()%>/images/Check.gif"
						alt="Mandatory Field"  border="0"></TD>
            ...
            <TR id="trdark">
              ...
              <TD nowrap width="27%" colspan="3">              <SELECT name="E02LCMAPR" disabled>
						...
						name="E02LCMST3" type="text" value="<%= msg050002.getE02LCMST3().trim()%>" size="40" maxlength="35" readonly="readonly"></TD>
            </TR>
				<TR id="trclear">
				  <TD align="right" nowrap>Place of Taking in Charge/Place of Receipt: </TD>
				  <TD nowrap colspan="3"><INPUT name="E02LCMPLR" type="text"
						value="<%= msg050002.getE02LCMPLR().trim()%>" size="65" maxlength="65" readonly="readonly"></TD>
		    </TR>
				<TR id="trclear">
              <TD nowrap width="25%" align="right">Place of Loading/Airport of Departure: </TD>
              <TD nowrap width="27%" colspan="3"><INPUT name="E02LCMPOL" type="text" value="<%= msg050002.getE02LCMPOL().trim()%>" size="65" maxlength="65" readonly="readonly"></TD>
            </TR>
            <TR id="trdark">
            ...
            <TR id="trclear">
              ...
              <TD nowrap width="27%" colspan="3"><INPUT name="E02LCMPLD" type="text" value="<%= msg050002.getE02LCMPLD().trim()%>" size="65" maxlength="65" readonly="readonly"></TD>
            </TR>
            <TR id="trdark">
              ...
              <TD align="left" nowrap><INPUT name="E02LCMDWI" type="text" value="<%= msg050002.getE02LCMDWI().trim()%>" size="14" maxlength="12" readonly="readonly">
           	...
           	<TR id="trclear">
				  <TD width="25%" align="right" nowrap>Generate Swift Message: </TD>
