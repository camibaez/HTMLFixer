...
function ShowNew(x,y) {	 
    ...
    enterNew.filters[0].Play();
	document.forms[0].E01LOCLOC.focus();
}
...
function SetType() {	 
	 var myYear = document.forms[0].E01LOCLOC.value;

	 if (true) {
	 	document.forms[0].E01LOCLOC.onkeypress = "";
     	errorMsg.style.visibility="hidden";
	 } else {
	 	document.forms[0].E01LOCLOC.onkeypress="";
	 	document.forms[0].E01LOCLOC.value="";
...
<h3 align="center">Safe Deposit Box Locations<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_locations_list, ESB0030"></H3>
<hr size="4">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<tr id="trdark"> 
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          <input type="text" name="E01LOCLOC" size="4" maxlength="3" onchange="SetType()">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01LOCLOC())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01LOCNME())%></TD>
		</TR>    		
    	<%}%>    
     </TABLE>
    </TD>
