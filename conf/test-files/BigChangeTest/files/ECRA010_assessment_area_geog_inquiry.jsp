<html>
<head>
<title>Assessment Area Inquiry</title>
...
<H3 align="center">Assessment Area Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="assessment_area_inquiry, ECRA010"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<TR id=trclear>
	      <td nowrap> 
            ...
            <td nowrap > 
              <input type="radio" name="E02CRGIEF" value="+" <% if (msgPart.getE02CRGIEF().equals("+")) out.print("checked"); %> readonly>
              Include 
              <input type="radio" name="E02CRGIEF" value="-" <% if (msgPart.getE02CRGIEF().equals("-")) out.print("checked"); %> readonly>
              Exclude 
             </td>
		...
		<TR id=trdark>
	      ...
	      <td nowrap colspan="3"><div align="left">
	      	<input type="text" name="E02CRGSTC" size="3" maxlength="2" value="<%= msgPart.getE02CRGSTC() %>" readonly>
      	    <a href="javascript:GetCodeCNOFC_St_FIPS('E02CRGSTC','D02STCDSC','27')"></a>
		...
		<TR id=trclear>
	      ...
	      <td nowrap colspan="3"><div align="left">
	      	<input type="text" name="E02CRGCTC" size="4" maxlength="3" value="<%= msgPart.getE02CRGCTC() %>" readonly>
      	    <a href="javascript:GetCodeCounty('E02CRGCTC','',document.forms[0].E02CRGSTC.value)"></a>
		...
		<TR id=trdark>
	      ...
	      <td nowrap colspan="3"><div align="left">
	      	<input type="text" name="E02CRGMSA" size="6" maxlength="5" value="<%= msgPart.getE02CRGMSA() %>" readonly>
      	    <a href="javascript:GetCodeMSA('E02CRGMSA','D02MSADSC', document.forms[0].E02CRGCTC.value)"></a>
		...
		<TR id=trclear>
	      ...
	      <td nowrap colspan="3"><div align="left">
	      	<input type="text" name="E02CRGCET" size="7" maxlength="6" value="<%= msgPart.getE02CRGCET() %>" readonly>
      	    <a href="javascript:GetCodeCensus('E02CRGCET','D02CETDSC')"></a>
