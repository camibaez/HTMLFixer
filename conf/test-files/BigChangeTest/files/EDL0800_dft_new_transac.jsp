...
<h3 align="center">Transactions<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="dft_new_transac,EDL0800"></h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap colspan="2"> 
              <div align="right">LOAN VALUE :</div>
            </td>
          ...
          <tr id="trclear"> 
            <td nowrap colspan="2"> 
              <div align="right">PREPAID INTERESTS :</div>
            </td>
            <td nowrap colspan="3" width="56%"> 
