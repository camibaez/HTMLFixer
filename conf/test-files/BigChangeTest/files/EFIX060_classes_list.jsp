...
function goAction(op) {
	...
	{
		var z = 0;
		var radi = document.getElementsByTagName('input');
		for (var x = 0; x < radi.length; x++)
		{
			if (radi[x].type === 'radio' && radi[x].checked)
				z++;
		}
		if (z > 0)
...
<BODY>
<h3 align="center">Fixed Assets Classes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="classes_list.jsp, EFIX060"></h3>
<hr size="4">
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%">Number</th>
		 ...
		 %>
          <tr> 
            <td NOWRAP  align=CENTER width="10%"> 
              <input type="radio" name="CURRCODE" value="<%= EFIX06001Help.getCurrentRow() %>">
            </td>
            <td NOWRAP  align=CENTER width=\"10%\"> 
