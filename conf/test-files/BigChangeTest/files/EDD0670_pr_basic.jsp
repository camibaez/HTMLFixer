...
<SCRIPT Language="Javascript">
 ...
 function Checking2(){
  ...
  alert("This option is not valid for  Swift MT - 103");
  return;
  }
...
<h3 align="center">Payment Orders <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="pr_basic.jsp,EDD0670" ></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.transfer.JSEDD0670">
  ...
  <table class="tableinfo">
    ...
    <tr id="trclear">
      ...
      <td nowrap align="center" width="60%">
        <div align="left">
          ...
          <a href="javascript:GetCurrency('E01CCY','')"> <img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0">
          </a> </div>
      </td>
    </tr>
    <tr id="trdark">
      ...
      <td nowrap align="center" width="60%">
        <div align="left">
          ...
          <a href="javascript:GetCustomerDescId('E01CUSNUM','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0" ></a></div>
      </td>
    </tr>
    <tr id="trclear">
      <td nowrap align="center" width="40%">
      ...
      <td nowrap align="center" width="60%">
        <div align="left">
          ...
          onBlur="document.forms[0].E01POSDAC.value = this.value" >
          <a href="javascript:GetAccount('E01ACCNUM','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a></div>
      </td>
    </tr>
    <tr id="trdark">
      <td nowrap align="center" width="40%">
      ...
      <td nowrap align="center" width="60%">
        <div align="left">
          <p>
            ...
            <a href="javascript:GetCode('E01OPTYPE','STATIC_pr_operation_types.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
        </div>
      </td>
    </tr>
    <tr id="trclear">
      ...
      <td nowrap align="center" width="60%">
        <div align="left">
          <select name="E01PODTYP">
            <option value="2" <% if(prBasic.getE01PODTYP().equals("2")) out.print("selected");%>>Swift
            Format MT-103 </option>
            <option value="3" <% if(prBasic.getE01PODTYP().equals("3")) out.print("selected");%>>Swift
            Format MT-200</option>
            <option value="4" <% if(prBasic.getE01PODTYP().equals("4")) out.print("selected");%>>Swift
            Format MT-202</option>
            <option value="5" <% if(prBasic.getE01PODTYP().equals("5")) out.print("selected");%>>Telex</option>
			<option value="F" <% if(prBasic.getE01PODTYP().equals("F")) out.print("selected");%>>FED</option>
          </select>
        </div>
      </td>
    </tr>
    <tr id="trdark">
      <td nowrap align="center" width="40%">
        <div align="right">Commission Type :</div>
      </td>
      <td nowrap align="center" width="60%">
        <div align="left">
          <input type="text" name="E01FEETYP" size="3" maxlength="2" onKeyPress="enterInteger()" value="<%= prBasic.getE01FEETYP()%>">
          <a href="javascript:GetCNTRLPRF('E01FEETYP','DESCRIPTION')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a>
          <input type="text" name="DESCRIPTION" size="15" maxlength="15" onKeyPress="enterInteger()">
        </div>
      </td>
    </tr>
    <tr id="trclear">
      <td nowrap align="center" colspan="2">
        <div align="left"><b>Stand Alone Orders</b></div>
      </td>
    </tr>
    <tr id="trdark">
      <td nowrap align="center" width="40%">
  ...
  <table class="tableinfo" >
    ...
    <tr id="trclear">
      ...
      <td nowrap width="10%" >
        <input type="text" name="E01FLD23B" size="6" maxlength="4" value="<%= prBasic.getE01FLD23B()%>">
        <a href="javascript:GetCode('E01FLD23B','STATIC_tr_operations.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a>
      </td>
      <td nowrap width="20%" >
      ...
      <td nowrap colspan="3" width="40%" >
        ...
        Our
        <input type="radio" name="CE01POSCHB" value="S"
			  onClick="document.forms[0].E01POSCHB.value=' ';document.forms[0].E01POSCHO.value='S'"
              <%if(prBasic.getE01POSCHO().equals("S")) out.print("checked");%>>
        Share</td>
    </tr>
    <tr id="trdark">
      <td nowrap width="30%" >
      ...
      <td nowrap width="10%" >
        <input type="text" name="E01FLD23E" size="6" maxlength="4" value="<%= prBasic.getE01FLD23E()%>">
        <a href="javascript:GetCode('E01FLD23E','STATIC_tr_instructions.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a>
      </td>
      <td nowrap width="20%" >&nbsp;</td>
      <td nowrap colspan="3" width="40%" >&nbsp;</td>
    </tr>
  </table>
  <br>
  <table class="tableinfo">
