...
%>
<H3 align="center"><% if (userPO.getPurpose().equals("NEW")) out.print("Retail Account Opening");
   else if (userPO.getPurpose().equals("MAINTENANCE")) out.print("Retail Account Maintenance");
   else out.print("");%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_new, EDD0000"></H3>
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark">
            ...
            <td nowrap width="20%" >
              <div align="left">
                ...
                <a href="javascript:GetCustomerDescId('E01ACMCUN','E01CUSNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a></div>
            </td>
            <td nowrap width="16%" >
          ...
          <tr id="trdark">
            ...
            <td nowrap width="20%">
              <div align="left">
                <input type="text" name="E01ACMACC" size="15" maxlength="9" readonly value="<% if (rtBasic.getE01ACMACC().trim().equals("999999999")) out.print("NEW ACCOUNT"); else out.print(rtBasic.getE01ACMACC().trim()); %>">
              </div>
            </td>
            <td nowrap width="16%">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="26%">
              <select name="E01ACMRCD">
                ...
                <option value="D" <% if (rtBasic.getE01ACMRCD().equals("D")) out.print("selected"); %>>Debit Reference
                </option>
                <option value="C" <% if (rtBasic.getE01ACMRCD().equals("C")) out.print("selected"); %>>Credit Reference
                </option>
                <option value="A" <% if (rtBasic.getE01ACMRCD().equals("A")) out.print("selected"); %>>Both Reference
                </option>
              </select>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap width="19%">
              <input type="text" name="E01ACMWHF" size="2" maxlength="1" value="N">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="26%" height="19">
			  ...
			  <%if(rtBasic.getE01ACMPTF().equals("N")) out.print("checked");%> checked>
              No </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="29%" height="19">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="19%" height="19">
              <input type="text" size="2" maxlength="1" value="<% if(rtBasic.getE01ACMWLF().trim().equals("")) {out.print("N");}
				else {out.print(rtBasic.getE01ACMWLF().trim());}%>" name="E01ACMWLF">
            ...
            <td nowrap width="26%" height="19">
              <input type="text" size="2" maxlength="1" value="<% if(rtBasic.getE01ACMWNF().trim().equals("")) {out.print("N");}
				else {out.print(rtBasic.getE01ACMWNF().trim());}%>" name="E01ACMWNF">
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            <td nowrap width="30%">
              <div align="right">Services Charges :</div>
            </td>
            <td nowrap width="18%"> 
              <input type="radio" name="E01ACMSCF" value="Y" onClick="document.forms[0].E01ACMSCF.value='Y'" <%if(rtBasic.getE01ACMSCF().equals("Y")) out.print("checked");%>>Yes
              <input type="radio" name="E01ACMSCF" value="N" onClick="document.forms[0].E01ACMSCF.value='N'" <%if(rtBasic.getE01ACMSCF().equals("N")) out.print("checked");%>>No 
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear">
            <td nowrap width="30%">
              <div align="right"> Account Statement Printed Cycle :</div>
            </td>
            <td nowrap width="18%">
            ...
            <td nowrap width="24%">
			  ...
			  <%if(rtBasic.getE01ACMCSF().equals("N")) out.print("checked");%> checked>
              No </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="30%" height="23">
              <div align="right">Type of Account Statement :</div>
            </td>
          ...
          <tr id="trclear">
            ...
            <td nowrap width="18%" height="23">
              <select name="E01ACMF04">
                ...
                <option value="2" <%if (rtBasic.getE01ACMF04().equals("2") || (!rtBasic.getE01ACMF04().equals("1") && !rtBasic.getE01ACMF04().equals("3"))) out.print("selected"); %>>Send copies and waive charges</option>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="21%">
              ...
              <a href="javascript:GetCode('E01ACMTCB','STATIC_rt_checkbook_type.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a>
            </td>
            <td nowrap width="26%">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="18%">
              <select name="E01AFIIDS">
                <option value="" <% if (rtBasic.getE01AFIIDS().equals("") || 
                	(!rtBasic.getE01AFIIDS().equals("N") 
                	&& !rtBasic.getE01AFIIDS().equals("1") 
                	&& !rtBasic.getE01AFIIDS().equals("2") 
                	&& !rtBasic.getE01AFIIDS().equals("3") 
                	&& !rtBasic.getE01AFIIDS().equals("4") 
                	&& !rtBasic.getE01AFIIDS().equals("5") 
                	&& !rtBasic.getE01AFIIDS().equals("6") 
                	&& !rtBasic.getE01AFIIDS().equals("7")
                	&& !rtBasic.getE01AFIIDS().equals("8")
                	&& !rtBasic.getE01AFIIDS().equals("9"))) out.print("selected"); %>></option>
                <option value="N" <%if (rtBasic.getE01AFIIDS().equals("N")) out.print("selected"); %>>No Initial Deposit</option>
                <option value="1" <%if (rtBasic.getE01AFIIDS().equals("1")) out.print("selected"); %>>Cash Deposit</option>
                <option value="2" <%if (rtBasic.getE01AFIIDS().equals("2")) out.print("selected"); %>>Wire</option>
                <option value="2" <%if (rtBasic.getE01AFIIDS().equals("2")) out.print("selected"); %>>Wire</option>
                <option value="3" <%if (rtBasic.getE01AFIIDS().equals("3")) out.print("selected"); %>>Check</option>
                <option value="4" <%if (rtBasic.getE01AFIIDS().equals("4")) out.print("selected"); %>>Internal</option>
                <option value="5" <%if (rtBasic.getE01AFIIDS().equals("5")) out.print("selected"); %>>External Transfer</option>
                <option value="6" <%if (rtBasic.getE01AFIIDS().equals("6")) out.print("selected"); %>>Traveler Checks</option>
                <option value="7" <%if (rtBasic.getE01AFIIDS().equals("7")) out.print("selected"); %>>Other</option>
                <option value="8" <%if (rtBasic.getE01AFIIDS().equals("8")) out.print("selected"); %>>Loan Proceeds</option>
                <option value="9" <%if (rtBasic.getE01AFIIDS().equals("9")) out.print("selected"); %>>Mixed Deposit</option>
              </select>
            <td nowrap width="18%">
          </tr>
        </table>
    ...
    <div id="dataDiv" class="scbarcolor" style="height:60; overflow-y :scroll; z-index:0" >
     <table id="dataTable" >
          ...
          <tr id="trclear")>
            <td nowrap>
                <div align="center">
                  <input type="text" name="E01OFFOP<%= name %>" size="2" maxlength="2" value="<%= rtBasic.getField("E01OFFOP"+name).getString().trim()%>" onKeypress="enterInteger()">
            ...
            <td nowrap width="5%" >
              <div align="center">
                <input type="text" name="E01OFFBK<%= name %>" size="2" maxlength="2" value="<%= rtBasic.getField("E01OFFBK"+name).getString().trim()%>" onKeypress="enterInteger()">
              </div>
            </td>
            <td nowrap  >
              <div align="center">
