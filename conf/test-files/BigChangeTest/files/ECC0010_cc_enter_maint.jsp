...
<H3 align="center">Credit Cards Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_enter_maint, ECC0010"></H3>
  ...
  <table class="tbenter" HEIGHT="75%" width="100%" border="0">
    ...
    <tr> 
      <td nowrap ALIGN=CENTER> 
        ...
        <a href="javascript:GetAccount('E01CCMACC','','94','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a> 
			<br>
 <div align="center"> 
