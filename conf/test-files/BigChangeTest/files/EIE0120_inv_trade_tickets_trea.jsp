...
%>
<div align="center"> 
  <h3>Treasury - Trade Completion<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_trade_tickets_trea.jsp,EIE0120"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <input type="text"  name="E01ORDHCY" size="3" maxlength="3" value="<%= invTrade.getE01ORDHCY()%>" disabled >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              ...
              <a href="javascript:GetCode('E01ORDWHF','STATIC_cd_taxes.jsp')"></a> 
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" >
               <INPUT type="text" disabled name="E01ORDFL7" size="17" maxlength="16" value="<%= invTrade.getE01ORDFL7()%>">              
            </td>  
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <input type="text" disabled name="E01ORDIIC" size="9" maxlength="9" value="<%= invTrade.getE01ORDIIC()%>" >
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" disabled name="E01ORDVNO" size="17" maxlength="16" value="<%= invTrade.getE01ORDVNO()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" disabled name="E01ORDQTY" size="17" maxlength="16" value="<%= invTrade.getE01ORDQTY()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" disabled name="E01ORDPRC" size="17" maxlength="15" value="<%= invTrade.getE01ORDPRC()%>" onKeyPress="enterDecimal()">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" > 
              <div align="left"> 
                <input type="text" disabled name="E01ORDIAL" size="17" maxlength="15" value="<%= invTrade.getE01ORDIAL()%>" onKeyPress="enterDecimal()">
            ...
            <td nowrap width="33%" > 
              <div align="left"> 
                <input type="text" disabled name="E01ORDDYS" size="4" maxlength="3" value="<%= invTrade.getE01ORDDYS()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark">
            ...
            <td nowrap width="36%" colspan="3"> 
              <input type="text" disabled name="E01ORDWH1" size="17" maxlength="15" value="<%= invTrade.getE01ORDWH1()%>" onKeyPress="enterDecimal()">
            </td>
           </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" name="E01ORDTBK" size="17" maxlength="15" value="<%= invTrade.getE01ORDTBK()%>" onKeyPress="enterDecimal()" disabled> </div>
            </td>
          </tr> 
          <tr id="trdark">
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="3" > 
              <input type="text" disabled name="E01ORDTVL" size="17" maxlength="15" value="<%= invTrade.getE01ORDTVL()%>" onKeyPress="enterDecimal()" disabled>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap colspan="4" > 
          ...
          <tr id="trdark">
            <td nowrap width="17%" > 
              <div align="right"> Balance in <%= invTrade.getE01ORDHCY()%> :  </div>
            </td> 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr>
            ...
            <td nowrap width="27%" >
              <input type="radio" name="E01ORDFL1" value="F" <%if(invTrade.getE01ORDFL1().equals("F")) out.print("checked");%>>Free of Payment 
           ...
           <tr>
            ...
            <td nowrap width="27%" >               
              <input type="radio" name="E01ORDFL1" value="A" <%if(invTrade.getE01ORDFL1().equals("A")) out.print("checked");%>>Against Payment
            </td>
          </tr>
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="17%" > 
              <div align="right"> Ticket Notes :</div>
            </td>
            <td nowrap colspan="3" > 
