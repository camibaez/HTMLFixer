...
%> 
<H3 align="center">Retail Accounts - Interest Payment Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cancel_basic.jsp, EDD1150"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="22%" height="38"> 
			  ...
			  <%if(rtCancel.getE01NPGINT().equals("Y")) out.print("checked");%> disabled >
              Yes 
              <input type="radio" name="CE01NPGINT" value="N" 			
			  <%if(rtCancel.getE01NPGINT().equals("N")) out.print("checked");%> disabled>
              No </td>
            ...
            <td nowrap width="26%" height="38"> 
			  ...
			  <%if(rtCancel.getE01NPGOVD().equals("N")) out.print("checked");%> disabled >
              Yes 
              <input type="radio" name="CE01NPGOVD" value="Y" 			  
			  <%if(rtCancel.getE01NPGOVD().equals("Y")) out.print("checked");%> disabled>
              No </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="22%" height="19"> 
              <input type="text" name="E01NARRAT" size="35" maxlength="30" value="<%= rtCancel.getE01NARRAT().trim()%>" readonly>
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="22%" height="19"> 
              <input type="text" name="E01ACMOFC" size="5" maxlength="3" value="<%= rtCancel.getE01ACMOFC().trim()%>" readonly>
