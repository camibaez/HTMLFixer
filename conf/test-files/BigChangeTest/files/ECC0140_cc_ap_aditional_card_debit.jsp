      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E01CCRPRIM" size="21" maxlength="20" value="Debit" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
              <div align="right"></div>
            ...
            <td nowrap width="16%"> 
              	<input type="text" name="E01TARTY2" size="15" maxlength="14" value="Debit Card" readonly>
            </td>
          </tr>    
          <tr id="trdark"> 
            <td nowrap width="16%" > 
              <div align="right"><b>Main Customer : </b></div>
            </td>
            <td nowrap width="20%" > 
              <div align="left"> 
            ...
            <td nowrap width="16%" > 
              <div align="right"><b>Main Customer's Name : </b></div>
            </td>
            <td nowrap colspan="3" > 
              <div align="left"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="16%" > 
              <div align="right"><b>Additional Customer : </b></div>
            </td>
            <td nowrap width="20%" > 
              <div align="left"> 
            ...
            <td nowrap width="16%" > 
              <div align="right"><b>Additional Customer's Name</b></div>
            </td>
            <td nowrap colspan="3" > 
              <div align="left"> 
...
--%>           
            ...
            <td nowrap width="23%"> 
	           <input type="text" readonly name="E01CCRIST" size="31" maxlength="30" 
	           	value="<% 
				if		(msgCC.getE01CCRIST().equals("I")) out.print("Inactive");
				else if	(msgCC.getE01CCRIST().equals("A")) out.print("Active");
	           	else out.print("");	%>" >	
	        </td>
...
<%--
            <td nowrap width="25%"> 
              <div align="right">Free Transactions : </div>
            </td>
            <td nowrap width="27%"> 
