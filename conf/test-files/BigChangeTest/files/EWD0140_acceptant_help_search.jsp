...
//	if (NameSearch.length > 0){
    ...
    parent.results.window.location.href="<%=request.getContextPath()%>/pages/e/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0140?NameSearch=" + NameSearch + "@FromRecord=" + FromRecord + "'";
...
<FORM Action="javascript:enter()">
  ...
  <TABLE  id="tbhelp" align="center" width="447" border="0" cellspacing="0" cellpadding="0">
    <TR> 
      <Td align="CENTER"><b>Acceptants Search</b></Td>
    </TR>
    <TR>
      <TD align="CENTER">&nbsp;</TD>
    </TR>
