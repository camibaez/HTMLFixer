...
<body>
<h3 align="center">Debit Card Assignment<BR>Primary Card Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_assign_inq.jsp, ECC0090"></h3>
<hr size="4">
<% 
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECC0090">
  ...
  <INPUT TYPE=HIDDEN NAME="E01PRICUN" VALUE="<%= userPO.getCusNum().trim()%>">
