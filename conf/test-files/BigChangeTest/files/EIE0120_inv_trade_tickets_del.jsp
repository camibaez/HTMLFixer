...
<meta http-equiv="Refresh" CONTENT="5;url='<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0309?SCREEN=1'">
    ...
    <tr > 
      <td> 
        <table width="100%" height="100%">
          ...
          <td align=center> The ticket number <b><%= userPO.getIdentifier()%></b> 
