...
<%
 String title = "Refinancing";
 if (msg01.getH01OPECOD().equals("3")) title = "Discount Acceptance";
%>
...
<H3 ALIGN="center">Letter of Credit Negotiation/Payment [<%= title %>]
	<IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left" NAME="EIBS_GIF" ALT="lc_nego_ref_readonly.jsp, ELC0560"></H3>
<HR SIZE="4">
...
<TABLE CLASS="tableinfo" CELLSPACING="0" CELLPADDING="2" WIDTH="100%" BORDER="0">
  ...
  <tr id="trclear">
    	<td width="230" height="24" align="left" valign="top" nowrap>
        	...
        	<input name="E01CONCDD" type="text" value="<%=msg01.getE01CONCDD()%>" size="25" maxlength="25" readonly="readonly"></td>
	    ...
	    <td width="128" height="24" align="center" valign="top" nowrap><input name="E01CUSGLN" type="text" value="<%= msg01.getE01CUSGLN()%>" size="20" maxlength="16" readonly="readonly"></td>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <tr id="trclear">
	    ...
	    <td nowrap valign="top" height="24" align="center" width="61"><input name="E01DEBBR2" type="text" value="<%=msg01.getE01DEBBR2()%>" size="6" maxlength="3" readonly="readonly" ></td>
	    ...
	    <td nowrap align="center" valign="top" height="24" width="128"><input name="E01DEBGL2" type="text" value="<%=msg01.getE01DEBGL2()%>" size="20" maxlength="16" readonly="readonly"></td>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <tr id="trclear">
    	<td width="230" height="24" align="left" valign="top" nowrap>
        	...
        	<input name="E01CONCCD" type="text" value="<%= msg01.getE01CONCCD()%>" size="25" maxlength="25" readonly="readonly"></td>
	    ...
	    <td nowrap valign="top" height="24" align="center" width="61"><input name="E01PMTBRN" type="text" value="<%= msg01.getE01PMTBRN()%>" size="6" maxlength="3" readonly="readonly" ></td>
	    ...
	    <td nowrap align="center" valign="top" height="24" width="128"><input name="E01PMTGLN" type="text" value="<%= msg01.getE01PMTGLN()%>" size="20" maxlength="16" readonly="readonly"></td>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <tr id="trclear">
    	<td width="230" height="24" align="left" valign="top" nowrap>
        	...
        	<input name="E01CONCBD" type="text"  value="<%=msg01.getE01CONCBD()%>" size="25" maxlength="25" readonly="readonly"></td>
	    ...
	    <td nowrap valign="top" height="24" align="center" width="61"><input name="E01CRPBRN" type="text" value="<%=msg01.getE01CRPBRN()%>" size="6" maxlength="3" readonly="readonly" ></td>
	    ...
	    <td nowrap align="center" valign="top" height="24" width="128"><input name="E01CRPGLN" type="text" value="<%=msg01.getE01CRPGLN()%>" size="20" maxlength="16" readonly="readonly"></td>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<TR id="<%out.print((i++%2==0 ? "trdark" : "trclear"));%>">
		...
		<TD nowrap align="left">
		    <INPUT type="text" name="E01CRPBID" size="16" maxlength="12"  value=<%=msg01.getE01CRPBID()%> readonly="readonly">
		</TD>
	</TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
		<TD align="right">Commission Debit to Beneficiary Account :</TD>
		<TD nowrap align="left">
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  <TD nowrap align="right">Cancel Unused Balance :</TD>
	  <TD nowrap align="left">
	  ...
	  <TD nowrap align="right">Cash Collateral :</TD>
	  <TD nowrap align="left">
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  <TD align="right" nowrap>Floating Rates Table:</TD>
	  <TD nowrap><INPUT name="E01BNKFLT" type="text" value="<%= msg01.getE01BNKFLT().trim()%>" size="2" maxlength="2" readonly="readonly">
          <SELECT name="E01INTTYP" disabled="disabled">
            <OPTION value=""> </OPTION>
            <OPTION value="FP" <% if(msg01.getE01INTTYP().equals("FP")) out.print("selected");%>>Primary Rate</OPTION>
            <OPTION value="FS" <% if(msg01.getE01INTTYP().equals("FS")) out.print("selected");%>>Secondary Rate</OPTION>
        </SELECT></TD>
	  <TD height="24" align="right" valign="top" nowrap>Rate / Over Rate </TD>
	  <TD height="24" align="left" valign="top" nowrap><INPUT type="text" name="E01INTRTE" value="<%=msg01.getE01INTRTE()%>" size="10" maxlength="9" onKeyPress="enterDecimal(6)"></TD>
    </TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  <TD height="24" align="right" valign="top" nowrap>Interest Type:</TD>
	  <TD height="24" align="left" valign="top" nowrap>
	  	<INPUT type="text" name="E01INTFLG" value="<%=msg01.getE01INTFLG()%>" size="1" maxlength="1" readonly="readonly"></TD>
	  <TD nowrap align="right">Interest Pre-Payment </TD>
	  <TD nowrap>
	  	<INPUT type="radio" name="E01DISCNT" value="Y" <% if(msg01.getE01DISCNT().equals("Y")) out.print("checked");%> disabled="disabled">Yes
	    <INPUT type="radio" name="E01DISCNT" value="N" <% if(msg01.getE01DISCNT().equals("N")) out.print("checked");%> disabled="disabled">No </TD>
	</TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  <TD align="right" nowrap>Interest Rate for Delay:</TD>
	  <TD nowrap><INPUT type="text" name="E01PENINT" value="<%=msg01.getE01PENINT()%>" size="9" maxlength="7" readonly="readonly"></TD>
	  <TD height="24" align="right" valign="top" nowrap>Factor / Percent</TD>
	  <TD height="24" align="left" valign="top" nowrap><SELECT name="E01PENFLG" disabled="disabled">
        <OPTION value=""> </OPTION>
        <OPTION value="F" <% if(msg01.getE01PENFLG().equals("%")) out.print("selected");%>>Fix Amount</OPTION>
        <OPTION value="%" <% if(msg01.getE01PENFLG().equals("%")) out.print("selected");%>>Percent</OPTION>
      </SELECT></TD>
    </TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  <TD align="right" nowrap>Calculation Normal Interest:</TD>
	  <TD nowrap>
	  <SELECT name="E01INCLTP" disabled="disabled">
          <OPTION value=""> </OPTION>
          <OPTION value="1" <% if(msg01.getE01INCLTP().equals("1")) out.print("selected");%>>Capital Outstanding</OPTION>
          <OPTION value="2" <% if(msg01.getE01INCLTP().equals("2")) out.print("selected");%>>Capital Original</OPTION>
          <OPTION value="3" <% if(msg01.getE01INCLTP().equals("3")) out.print("selected");%>>Capital Outstanding - Principal Due</OPTION>
          <OPTION value="N" <% if(msg01.getE01INCLTP().equals("N")) out.print("selected");%>>Not Interes</OPTION>
      </SELECT>
	  </TD>
	  <TD align="right" nowrap>Calculation Delay Interest:</TD>
	  <TD nowrap><SELECT name="E01PNCLTP" disabled="disabled">
          <OPTION value=""> </OPTION>
          <OPTION value="1" <% if(msg01.getE01PNCLTP().equals("1")) out.print("selected");%>>Capital Principal Due</OPTION>
          <OPTION value="2" <% if(msg01.getE01PNCLTP().equals("2")) out.print("selected");%>>Capital Original</OPTION>
          <OPTION value="3" <% if(msg01.getE01PNCLTP().equals("3")) out.print("selected");%>>Capital Outstanding</OPTION>
          <OPTION value="4" <% if(msg01.getE01PNCLTP().equals("4")) out.print("selected");%>>Capital Due + Interes Due</OPTION>
          <OPTION value="N" <% if(msg01.getE01PNCLTP().equals("N")) out.print("selected");%>>Not Interes</OPTION>
      </SELECT></TD>
	</TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  <TD align="right" nowrap>Interest Payment Cycle</TD>
	  <TD nowrap><INPUT type="text" name="E01INPDYS" value="<%=msg01.getE01INPDYS()%>" size="3" maxlength="3" readonly="readonly"></TD>
	  <TD height="24" align="right" valign="top" nowrap>Next Interest Payment Date</TD>
	  <TD height="24" align="left" valign="top" nowrap>
	  	<INPUT name="E01NXIPDM" type="text" value="<%=msg01.getE01NXIPDM()%>" size="2" maxlength="2" readonly="readonly">
        <INPUT type="text" name="E01NXIPDD" size="2" maxlength="2" value="<%=msg01.getE01NXIPDD()%>" readonly="readonly">
        <INPUT type="text" name="E01NXIPDY" size="2" maxlength="2" value="<%=msg01.getE01NXIPDY()%>" readonly="readonly">
      </TD>
    </TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
      <TD align="right" nowrap>Principal Payment Cycle</TD>
	  <TD nowrap><INPUT name="E01PRPDYS" type="text" value="<%=msg01.getE01PRPDYS()%>" size="3" maxlength="3" readonly="readonly"></TD>
	  <TD height="24" align="right" valign="top" nowrap>Next Principal Payment Date</TD>
	  <TD height="24" align="left" valign="top" nowrap>
	  	<INPUT name="E01NXPPDM" type="text" value="<%=msg01.getE01NXPPDM()%>" size="2" maxlength="2" readonly="readonly"">
        <INPUT type="text" name="E01NXPPDD" size="2" maxlength="2" value="<%=msg01.getE01NXPPDD()%>" readonly="readonly"">
        <INPUT type="text" name="E01NXPPDY" size="2" maxlength="2" value="<%=msg01.getE01NXPPDY()%>" readonly="readonly"">
      </TD>
    </TR>
	<TR id="trclear">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01CNFCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01AMDCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01AAMCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01DISCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01EOVCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01POSCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01COUCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01SWFCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    <TD align="left">Additinal Swift</TD>
	    ...
	    <TD align="center">
	    	<SELECT name="E01TLXCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01CANCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01PMCCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01WTRCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01RMBCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    <TD align="left">	<% if(msg01.getE01LCCFL1().equals("Y"))  out.print("Convenio ALADI"); else out.print("Stamps"); %></TD>
	    ...
	    <TD align="center">
	    	<SELECT name="E01ALDCPB" disabled="disabled">
		    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
...
<%if (msg01.getE01OPCODE().equals("5")) { %>
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
	    ...
	    <TD align="center">
	    	<SELECT name="E01BRKPBY" disabled="disabled">
...
if (msg01.getE01OPCODE().equals("3")) { %>
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
		...
		<TD align="center">
			<INPUT type="text" name="E01CRPACP" value="<%=msg01.getE01CRPACP()%>" readonly="readonly"></TD>
			<TD align="center">
				<SELECT name="E01ACCCPB" disabled="disabled">
			    	<% if (msg01.getE01CRPPBY().equals("A")) { %>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
		<TD align="left">Discount Acceptance</TD><TD align="center">
		<INPUT type="text" name="E01DSCAMN" value="<%=msg01.getE01DSCAMN()%>" readonly="readonly"></TD>
		<TD align="center">
			<SELECT name="E01DSCPBY" disabled="disabled">
				<OPTION value="A" <%if(msg01.getE01DSCPBY().equals("A")) out.print("selected");%>>Applicant</OPTION>
				<OPTION value="B" <%if(msg01.getE01DSCPBY().equals("B")) out.print("selected");%>>Beneficiary</OPTION>
				<OPTION value="W" <%if(msg01.getE01DSCPBY().equals("W")) out.print("selected");%>>Wave</OPTION>
			</SELECT>
		</TD>
		<TD align="center"></TD>
		<TD align="center"></TD>			
...
if (msg01.getE01OPCODE().equals("3")) {%>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
		<TD align="left">Discount Acceptance</TD>
		<TD align="center"><INPUT type="text" name="E01DSCAMN" value="<%=msg01.getE01DSCAMN()%>" readonly="readonly"></TD>
		<TD align="center">
			<SELECT name="E01DSCPBY" disabled="disabled">
				<OPTION value="A" <%if(msg01.getE01DSCPBY().equals("A")) out.print("selected");%>>Applicant</OPTION>
				<OPTION value="B" <%if(msg01.getE01DSCPBY().equals("B")) out.print("selected");%>>Beneficiary</OPTION>
