...
<h3 align="center">Projection of Financial Statements<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="EDP0755_client_financial_proj_main.jsp,EDP0755"></h3>
<hr size="4">
          ...
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%"> 
             ...
             <th align=CENTER nowrap width="8%"> 
            	<div align="center">% Projec.<BR>
	            	<%=Edp075501.getE01DPPFY1().trim()%>/
   		         	<%=Edp075501.getE01DPPFM1().trim()%>
            	</div>
            </th>
             <th align=CENTER nowrap width="10%"> 
            	<div align="center">Amount Projec.<BR>
	            	<%=Edp075501.getE01DPPFY1().trim()%>/
   		         	<%=Edp075501.getE01DPPFM1().trim()%>
            	</div>
            </th>
...
<div align="center"> 
		<INPUT id="EIBSBTN" type="submit" name="Submit0" value="Submit" 
