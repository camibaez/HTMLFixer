...
%>
<BODY>
<h3 align="center">Stock Control<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_commissions_list.jsp, ECD0006"> </h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0006" >
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="30%">Card Type</th>
            <th align=CENTER nowrap width="30%">Min. Stock</th>
            <th align=CENTER nowrap width="10%"><div align="center">Max. Stock</div></th>
          </tr>
     	<%
        appList.initRow(); 
