	       ...
	       // valida formula
			...
			if (j2 != 0) {
				...
				if (document.forms[0].LAN.value == 'S') {
					...
					alert("Error in formula. They lack or they exceed parenthesis");
				}
...
<H3 align="center">Maintenance Financial Formulas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="financial_index_maintenance.jsp, EDP0710"></H3>
      ...
      <td nowrap> 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="1">
          <tr id="trdark"> 
				...
				<td nowrap width="40%" align="right" valign="top">Select 
				Logic Operator : <SELECT name="OPERATOR" size="6">
					<OPTION value="(">(</OPTION>
					<OPTION value="+">+</OPTION>
					<OPTION value="-">-</OPTION>
					<OPTION value="*">*</OPTION>
          ...
          <tr id="trclear"> 
            ...
            <td align="right"> 
            	Select<BR>Financial <BR>Variable :
			</td>
          ...
          <tr id="trdark"> 
            ...
            Among Value Constant:<INPUT type="text" name="CONSTANTE" size="13" maxlength="15"
					value="<%= "" %>"
					<% if(userPO.getHeader16().equals("3")){out.print("readonly");} %>>
			<TD nowrap width="6%" align="center">
       ...
       <table cellspacing="0" cellpadding="2" width="100%" border="0">
           <tr id="trdark"> 
            <td nowrap width="16%" height="19"> 
              <div align="right">Applies to type Format:</div>
            </td>
            <td nowrap height="19" colspan="3">
			<SELECT name="E01DPILGT" >
					...
					<OPTION value="1"
						<%if (brnDetails.getE01DPILGT().equals("1")) { out.print("selected"); }%>>Customer Corporate</OPTION>
					<OPTION value="2"
						<%if (brnDetails.getE01DPILGT().equals("2")) { out.print("selected"); }%>>Customer Personal</OPTION>
			</SELECT>
			</TD>	
		  </tr>
  		</table> 
