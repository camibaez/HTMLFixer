<html>
<head>
<title>Safe Deposit Locations</title>
...
<H3 align="center">Safe Deposit Box Locations Enter New<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_locations_enter_new, ESB0030"></H3>
<hr size="4">
  ...
  <table class="tableinfo">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      <td nowrap width="40%"> 
	        <div align="right">Location Number : </div>
	      </td>
	      <td nowrap width="60%"> 
