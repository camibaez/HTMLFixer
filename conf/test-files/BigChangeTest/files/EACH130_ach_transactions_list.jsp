...
<h3 align="center">ACH Transactions<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
...
<TABLE class="tbenter"> 
	<TR>
		<TD align="CENTER" class="TDBKG" width="33%">
			<a href="javascript:goNew()"><b>New<br>Transaction</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="33%"><a href="javascript:goProcess()"><b>Submit<br>Updates</b></a>
      	</TD>
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center"> There are no defined Transactions .</h4> 
      </div>
      </TD></TR>
   	</TABLE>
<%
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    ...
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="5%"><b>Code<BR> </b></td>
		<td NOWRAP align="center" width="20%"><b>Description<BR> </b></td>
		<td NOWRAP align="center" width="10%"><b>Type</b></td>
		<td NOWRAP align="center" width="5%"><b>DB<BR>or<BR>CR</b></td>
		<td NOWRAP align="center" width="5%"><b>With<BR>Amount</b></td>
		<td NOWRAP align="center" width="10%"><b>Return <BR>
		Code</b></td>
		<td NOWRAP align="center" width="10%"><b>IBS Code<BR>/ Hold Days</b></td>
		<td NOWRAP align="center" width="30%"><b>IBS  Account Types Allowed</b></td>
	</TR>
    <TR id=trdark>
		<td NOWRAP align="center" width="5%"></td>
		<td NOWRAP align="center" width="5%"><IMG src="<%=request.getContextPath()%>/images/Check.gif"
			alt="Mandatory Field" align="bottom">
		</td>
		...
		<td NOWRAP align="center" width="10%"><B><IMG src="<%=request.getContextPath()%>/images/Check.gif"
				alt="Mandatory Field" align="bottom"></B>
		</td>
		...
		<TD nowrap align="center" width="10%" valign="top">
			<SELECT name="E01ACTTYP_<%= EACH130List.getCurrentRow() %>" <%= disabled %>>
			  <OPTION <%= msgList.getE01ACTTYP().trim().equals("T")?"Selected":""%> value="T">Transaction</OPTION>
			  <OPTION <%= msgList.getE01ACTTYP().trim().equals("R")?"Selected":""%> value="R">Return</OPTION>
			  <OPTION <%= msgList.getE01ACTTYP().trim().equals("P")?"Selected":""%> value="P">Prenotification</OPTION>
			</SELECT>
		</TD> 
		<TD nowrap align="center" width="5%" valign="top">
		...
		<TD nowrap align="center" width="30%" valign="top">
			<INPUT type="CHECKBOX" name="E01ACTAT1_<%= EACH130List.getCurrentRow() %>" <%= disabled %> 
				value="Y" <% if (msgList.getE01ACTAT1().equals("DDA")) out.print(" checked"); %>>Check
			<INPUT type="CHECKBOX" name="E01ACTAT2_<%= EACH130List.getCurrentRow() %>" <%= disabled %> 
				value="Y" <% if (msgList.getE01ACTAT2().equals("SAV")) out.print(" checked"); %>>Savings
			<INPUT type="CHECKBOX" name="E01ACTAT3_<%= EACH130List.getCurrentRow() %>" <%= disabled %> 
				value="Y" <% if (msgList.getE01ACTAT3().equals("LNS")) out.print(" checked"); %>>Loans<BR>
		<INPUT type="CHECKBOX" name="E01ACTAT4_<%= EACH130List.getCurrentRow() %>" <%= disabled %> 
				value="Y" <% if (msgList.getE01ACTAT4().equals("CCR")) out.print(" checked"); %>>CR Card
			<INPUT type="CHECKBOX" name="E01ACTAT5_<%= EACH130List.getCurrentRow() %>" <%= disabled %> 
				value="Y" <% if (msgList.getE01ACTAT5().equals("GLN")) out.print(" checked"); %>>GL
		Account</TD>
	</TR>
       <% 
       	 i++; 
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25">
       <%
    	if ( EACH130List.getShowPrev() ) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH130?SCREEN=1&FromRecord=" + pos + "\" > <img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
    	} %>
      </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> 
    	...
    	if (EACH130List.getShowNext()) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH130?SCREEN=1&FromRecord=" + pos +  "\" ><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
	    } %>
  </TD>
 </TR>
 </TABLE>
