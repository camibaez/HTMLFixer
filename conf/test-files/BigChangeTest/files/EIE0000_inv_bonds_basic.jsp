...
%>
<div align="center">
  <h3>Bonds Commissions <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_bonds_basic.jsp,EIE0000"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="66%" > 
              <input type="text" name="E01COMCUN" readonly size="12" maxlength="9" value="<%= invComm.getE01COMCUN().trim()%>">
              <input type="text" name="D01DESCDE" readonly size="25" maxlength="25" value="<%= invComm.getD01DESCDE()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="34%" > 
