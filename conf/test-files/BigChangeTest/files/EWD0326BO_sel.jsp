...
<script language="JavaScript">
  function goAction(op) {
		  ...
		  if(document.forms[0].acc.value == '' && op==2){
             alert("A valid account must be selected"); 
             return; 
          }
...
<h3 align="center">Back Office Maintenance Selection<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel.jsp,EWD0326BO"></h3>
<hr size="4">
<%
 ...
 <TR > 
  ...
  <table id="headTable" width="100%" >
    <tr id="trdark"> 
      ...
      <th align=CENTER nowrap >Counterparty <br>
        Name</th>
      <th align=CENTER nowrap > 
