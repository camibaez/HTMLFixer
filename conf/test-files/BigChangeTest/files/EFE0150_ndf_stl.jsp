...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ndf_stl.jsp,EFE0150"> 
</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEWD0333M" >
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <input type="hidden" name="E01FEMACC"  value="<%= fra.getE01FEMACC()%>" readonly>
              <%= fra.getE01FEMACC()%></td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap> 
        ...
        <tr>	
            ...
            <td nowrap colspan="2">                  
                    ...
                    <input type="text" name="E01FEMNRT" size="11" maxlength="10" value="<%= fra.getE01FEMNRT() %>"  >                  
