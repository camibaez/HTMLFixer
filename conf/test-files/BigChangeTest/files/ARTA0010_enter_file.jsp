...
<body>
 ...
 <h3 align="center">Import File Loans<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="file_enter, ARTA0010"></h3>
<hr size="4">
 <FORM METHOD="POST" action="<%=request.getContextPath()%>/servlet/datapro.eibs.misc.JSARTA000B" ENCTYPE="multipart/form-data">	
