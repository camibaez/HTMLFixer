...
// Type "N" is replaced by "5" (Customer Number) in order to send customers not portfolio  
// Type "I" is replaced by "6" (Identification)               
// Type "K" is replaced by "7" (Social Security Name)           
// Type "S" is replaced by "8" (Short Name)                     
// Type "W" is replaced by "9" (Word)  
...
function typeClick(value){
  if (value == "N" || value == "I" || value == "K" || value == "S" || value == "W"){    
...
<h3 align="center">Customer Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="client_inq_both_enter_search, ESD0080"></h3>
<hr size="4">
	 ...
	 <td nowrap>
	   <table  id="TBHELP" align="center" width="250" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <td nowrap><input type="radio" name="Type" value="N" checked onclick="typeClick('N')">PIN Number</td>		
		</tr>
		<tr>
		  <td nowrap ></td>
		...
		<tr>
		  <td nowrap ></td>
		  <td nowrap><input type="radio" name="Type" value="K" onclick="typeClick('K')">Social Security Number</td>
		</tr>		
		<% } %>
		<tr>
		  <td nowrap ></td>
		...
		<tr>
		  <td nowrap ></td>
		  <td nowrap><input type="radio" name="Type" value="W" onclick="typeClick('W')">Word</td>
		</tr>
	   </table>
	 </td>
	 <td nowrap>
