...
%> 
<h3 align="center">Special Instructions<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_inq_special_inst,EDD0000"></h3>
<hr size="4">
    ...
    <tr > 
      <td> 
        <p align="center"> 
          ...
          <input type="text" name="EE5SC" size="80" maxlength="80" value="<%= rtInst.getEE5DSC().trim()%>"  readonly>
