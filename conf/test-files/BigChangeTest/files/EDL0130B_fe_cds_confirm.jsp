...
<h3 align="center">Certificate of Deposit - Back Office - Confirmation</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear">
            ...
            <td nowrap width="25%" >
              <div align="left"><%= Util.formatDate(deal.getE11DEAOD1(),deal.getE11DEAOD2(),deal.getE11DEAOD3())%></div>
            </td>
            <td nowrap width="20%" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="25%" > 
              <div align="left"><% if(deal.getE11DLSSBT().equals("SL")) out.print("Issue");
          ...
          <tr id="trclear"> 
            ...
            <td nowrap align="right" width="20%">Account Number :</td>
