...
<h3 align="center">Securities &amp; Investments Sales/Purchase Approval <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cp_ap_trade.jsp,EDL0105B"></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0105B" onsubmit="javascript:this.disabled = true;">
