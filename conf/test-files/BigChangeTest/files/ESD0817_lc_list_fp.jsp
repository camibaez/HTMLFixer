...
function PrintPreview() {
  ...
  %>
  CenterWindow('<%=request.getContextPath()%>/servlet/datapro.eibs.trade.JSESD0817?SCREEN=4&Pos=' + pos,600,500,4);
}
...
%> 
<h3 align="center">Account Statement <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_list_fp.jsp, ESD0817"> 
  </h3>
  <hr size="4">
<FORM>
<%
...
%>
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td  width="15%" height="15" nowrap> 
              <div align="left"><%= lcBalances.getE02CIFCCY().trim()%> &nbsp;-&nbsp; <%= Util.fcolorCCY(lcBalances.getE02AMOUN1().trim())%></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td  width="32%"> 
            ...
            <td  width="15%"> 
              <div align="left"><%= Util.fcolorCCY(lcBalances.getE02AMOUN2().trim())%></div>
            </td>
          </tr>
          <tr id="trdark"> 
            <td  width="32%" nowrap> 
            ...
            <td  width="25%" nowrap> 
              <div align="right"><b>Utilized Amount :</b></div>
            </td>
            <td  width="15%"> 
              <div align="left"><%= Util.fcolorCCY(lcBalances.getE02AMOUN3().trim())%></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td  width="32%" nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td  width="28%" nowrap> 
              <div align="left"><a href="mailto:<%= lcBalances.getE02CUSIAD().trim()%>" target="body"><%= lcBalances.getE02CUSIAD().trim()%></a></div>
            </td>
            <td  width="25%" nowrap> 
              <div align="right"><b>Expiration Date :</b></div>
            </td>
            <td  width="15%"> 
              <div align="left"><%= Util.formatDate(lcBalances.getE02DATEB1(),lcBalances.getE02DATEB2(),lcBalances.getE02DATEB3())%></div>
            </td>
          </tr>
        </table>
      </td>
  ...
  <TABLE class="tableinfo">
    <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER nowrap >Org. Bank</TH>
      <TH ALIGN=CENTER nowrap >Org. Branch</TH>
    </TR>
    <%
                cifList.initRow();
