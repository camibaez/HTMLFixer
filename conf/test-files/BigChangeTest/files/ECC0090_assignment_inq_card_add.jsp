...
<body>
<h3 align="center">Assignments Inquiry<BR>Detail - Additional Card<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="assignment_inq_card_add.jsp, ECC0090"></h3>
<hr size="4">
<% 
...
%>
	...
	<TR>
      <TD> 
	      <div align="center"><font size="3"><b>Customer
		don't have related accounts </b></font></div>
      </TD>
     </TR>
   	</TABLE>
<%
