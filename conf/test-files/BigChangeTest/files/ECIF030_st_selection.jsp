...
<h3 align="center"> Account Statement<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="st_selection,ECIF030"> 
</h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap height="143"> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap width="32%"> 
              <div align="right"><b>Transaction Selection :</b></div>
            </td>
            <td nowrap width="3%">&nbsp;</td>
            <td nowrap width="23%"> 
              <input type="radio" name="E01HISCYC" value="C">
              <b>This Cycle</b></td>
            <td nowrap width="10%"> 
              <div align="right"></div>
            </td>
            <td nowrap width="32%"> 
              <input type="radio" name="E01HISCYC" value="H" checked>
              <b>History </b></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="32%"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="32%"> 
              <div align="right"><b>Select Checks from :</b></div>
            </td>
            <td nowrap width="3%">&nbsp;</td>
            <td nowrap width="23%"> 
              <div align="left"> 
                <input type="text" name="E01FRCHKN" size="9" maxlength="9" onkeypress="enterInteger()">
              </div>
            </td>
            <td nowrap width="10%"> 
              <div align="right"><b>to :</b></div>
            ...
            <td nowrap width="32%"> 
              <div align="left"> 
                <input type="text" name="E01TOCHKN" size="9" maxlength="9" onkeypress="enterInteger()">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
