    ...
    <tr > 
      <td width="50%" height="100%"> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" height="100%">
          ...
          <tr id="trdark"> 
            <td  width="16%" nowrap > 
              <div align="right"><b>Names :</b> </div>
            </td>
            <td  nowrap> <%= Util.concatBR(new String[] {stBalances.getE02LGNA01(),stBalances.getE02LGNA02(),stBalances.getE02LGNA03(),stBalances.getE02LGNA04(),stBalances.getE02LGNA05(),stBalances.getE02LGNA06(),stBalances.getE02LGNA07(),stBalances.getE02LGNA08(),stBalances.getE02LGNA09(),stBalances.getE02LGNA10()})%> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td  width="16%" nowrap > 
            ...
            <td  nowrap> <%= Util.concatBR(new String[] {stBalances.getE02CUMMA2(),stBalances.getE02CUMMA3(),stBalances.getE02CUMMA4(),stBalances.getE02CUMMA5()})%> 
          </tr>
          <tr id="trdark"> 
            <td  width="16%" nowrap > 
