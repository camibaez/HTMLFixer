...
<H3 align="center">Letters Of Credit Negotiation and Payment Confirmation
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  <TR id="trdark">
    ...
    <TD align="center"><B>Equivalents</B></TD>
    </TR>
	  ...
	  <TR >
	    ...
	    <TD align="center"><INPUT name="E02EQVDRW" type="text" value="<%=msg.getE02EQVDRW()%>" size="15" maxlength="13" readonly></TD>
	  	  ...
	  	  <TR>
	    <TD align="left">Commissions By Applicant</TD>
	  ...
	  <TR>
	    <TD align="left">Commissions By Beneficiary</TD>
	  ...
	  <TR>
	    <TD align="left">Taxes By Applicant</TD>
	    <TD align="center"><INPUT type="text" name="E02DEBCY2" value="<%=msg.getE02DEBCY2()%>" size="15" maxlength="13" readonly></TD>	    
