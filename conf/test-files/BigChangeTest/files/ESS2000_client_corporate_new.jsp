...
<body>
 ...
 <h3 align="center">New Internet Corporate User<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="client_corporate_new, ESS2000"></h3>
<hr size="4">
