...
if ( document.forms[0].E01BTHKEY.value.length < 1) {
  alert("A valid user number must be entered");
...
<H3 align="center">User's Access Profile<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="user_access_enter, ESD0007"></H3>
