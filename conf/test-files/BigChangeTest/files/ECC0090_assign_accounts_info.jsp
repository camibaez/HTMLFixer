...
<body>
<h3 align="center">Debit Card Assignment<BR>Primary Card Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="assign_accounts_info.jsp, ECC0090"></h3>
<hr size="4">
<% 
