...
%> 
<h3 align="center"> Foreign Exchange Non Deliverable Forwards (Back Office)</h3>
<hr size="4">
        ...
        <table cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
              <a href="javascript:GetClassFex('E01FESCLS','NFR','<%= fex.getE01FESCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="right">Primary Account :</div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap > 
              <div align="right">Derivated Account :</div>
            </td>
            <td nowrap > 
              <div align="center"> 
