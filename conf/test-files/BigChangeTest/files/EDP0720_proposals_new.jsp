...
function goAction(op) {
	...
	case  2: document.forms[0].opt.value = op;
	       ...
	       document.forms[0].submit();
		break;   
	case  3: ok = confirm("The Selected Record Will Be deleted. Please Confirm");
	  if (ok) 
	       {
...
document.forms[0].optH.value = op;
   switch (op) {
    case 1 :{    
              //ingreso 
			  if (document.forms[0].E01CUSCUN.value == 0) {
				alert('The Customer Number is mandatory \n\n');
			  } else {
...
<% 
  ...
  //     
%>
<H3 align="center">New Credit Proposal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="proposals_new.jsp, EDP0720">
</H3>
      ...
      <td>
		...
		<tr id="trdark"> 
			...
			<tr id="trdark">
				...
				<td width="15%">
				 <div align="right">Date Opening :</div>
				</td>
			...
			<tr id="trdark">
				...
				<td width="20%" align="right">Branch Opening:</td>
				<td width="30%">
          ...
          <tr id="trdark"> 
            ...
            <td width="20%" align="right">Purpose
		    </td>
			...
			<A href="javascript:GetCodeDescCNOFC('E01PLPCN2','E01PLPRE2','PD')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0">
			</A>
			<% } %>
			...
			<% if(userPO.getHeader16().equals("5")){out.print("readonly");}%>
	   		...
	   		<% if(!userPO.getHeader16().equals("5")) {%>
			<A href="javascript:GetCodeDescCNOFC('E01PLPCN3','E01PLPRE3','PD')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0">
			</A>
			<% } %>
    ...
    <tr > 
      <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td width="20%"> 
              <div align="right">Birth Date/Constitution :</div>
            </td>
            <td width="30%">
