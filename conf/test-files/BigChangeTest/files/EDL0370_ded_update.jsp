...
<SCRIPT LANGUAGE="JavaScript">
  ...
  if (tb != null) { 
    ...
    if (actCode == "N") {
      if (tb.rows.length == 2) {
       if (tb.rows[1].cells.length < 4) tb.deleteRow(1);
      } 
      tb.insertRow();
      ...
      tb.rows[idx].cells[2].innerHTML = "<div align=center><a href='javascript:getDeduct(&#39;" + loan + "&#39;,&#39;" + cod + "&#39;" + ")'><%= deduct.getE01DLICPA().trim() %></a></div>";
      tb.rows[idx].cells[3].innerHTML = "<div align=center><a href='javascript:getDeduct(&#39;" + loan + "&#39;,&#39;" + cod + "&#39;" + ")'><%= deduct.getE01DLIFAC().trim() %></a></div>";            
      ...
      if (tb.rows.length == 1) {
       ...
       tb.rows[1].cells[0].colSpan = 4;
       tb.rows[1].cells[0].innerHTML = "<h5 align=center>There are not assigned deductions</h5>";
      ...
      tb.rows[row].cells[2].innerHTML = "<div align=center><a href='javascript:getDeduct(&#39;" + loan + "&#39;,&#39;" + cod + "&#39;" + ")'><%= deduct.getE01DLICPA().trim() %></a></div>";
      tb.rows[row].cells[3].innerHTML = "<div align=center><a href='javascript:getDeduct(&#39;" + loan + "&#39;,&#39;" + cod + "&#39;" + ")'><%= deduct.getE01DLIFAC().trim() %></a></div>";            
      }
     tb.refresh();
  }
  top.close();
...
<%
   datapro.eibs.beans.JBListRec dedList = (datapro.eibs.beans.JBListRec) session.getAttribute("ded");
   
   try {
   	  dedList.removeRow(row - 1);
