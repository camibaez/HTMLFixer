...
<body>
<h3 align="center">New Check<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="rdc_maint.jsp,EDD1200">
</h3>
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark">
            ...
            <td nowrap  >
              <input type="text" name="E01WTRSEQ" size="2" maxlength="2" readonly value="<%= msgCh.getE01WTRSEQ().trim()%>">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
           <tr id="trdark">
            ...
            <td nowrap width="23%">
				<input type="text" name="E01ACMACC" size="12" maxlength="9" value="<%= msgCh.getE01ACMACC().trim()%>" onKeypress="enterInteger()">
            ...
            <td nowrap width="27%">
            	<input type="text" name="E01AMOUNT" size="17" maxlength="16" value="<%= msgCh.getE01AMOUNT().trim()%>" onKeypress="enterDecimal()">
            	<img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0" >
            </td>
          </tr>
           <tr id="trclear">
            ...
            <td nowrap width="23%">
				<input type="text" name="E01TRNCDE" size="3" maxlength="2" value="<%= msgCh.getE01TRNCDE().trim()%>" >
            ...
            <td nowrap width="27%">
              <input type="text" name="E01NUMCHK" size="11" maxlength="10" value="<%= msgCh.getE01NUMCHK().trim()%>" onKeypress="enterInteger()">
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0" >
 			</td>
          </tr>
