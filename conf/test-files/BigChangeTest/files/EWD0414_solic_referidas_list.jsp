...
<BODY >
<h3 align="center">Módulo de Solicitudes - Solicitudes Referidas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="solic_referidas_list.jsp,EWD0414"> 
  </h3>
<hr size="4">
   ...
   <TABLE class="tbenter">
    <TR>
      <TD ALIGN=CENTER width="25%" class=TDBKG>
  			<a href="javascript:enterOperationDetails('3')" >Enviar<br>a Reparo</a>
      </TD>
      <TD ALIGN=CENTER width="25%" class=TDBKG>
  			<a href="javascript:enterOperationDetails('4')" >Rechazar</a>
      </TD>
       <TD ALIGN=CENTER width="25%" class=TDBKG>
  			<a href="javascript:goAction('5')" >Revisada</a>
      </TD>     
      <TD ALIGN=CENTER width="25%" class=TDBKG>
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="20%"> 
              <div align="center">Referido por</div>
            </th>            
          ...
          <tr> 
            ...
            <td NOWRAP  align=CENTER width=\"20%\"><A HREF="javascript:showInqSolicitud('<%=msgList.getSWDRQN()%>','<%=msgList.getSWDTYP()%>','<%=msgList.getSWDCLS()%>')"><%= msgList.getSWDON2() %></A></td>
          </tr>
          <%}%>
        </table>
  </table>
