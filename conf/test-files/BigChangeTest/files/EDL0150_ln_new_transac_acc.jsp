...
<h3 align="center">Loans Transactions<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_new_transac_acc,EDL0150"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left">
                <input type="text" name="E30DEAACC" size="12" maxlength="9" value="<%= lnGenTran.getE30DEAACC().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%"> 
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30TRNPRI" value="<%= lnGenTran.getE30TRNPRI().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap colspan="2"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30TRNINT" value="<%= lnGenTran.getE30TRNINT().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>          
          <%
		 ...
		 %> 
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT01" value="<%= lnGenTran.getE30PAMT01().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
		   }
		 ...
		 %> 
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT02" value="<%= lnGenTran.getE30PAMT02().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
		 ...
		 %> 
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT03" value="<%= lnGenTran.getE30PAMT03().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT04" value="<%= lnGenTran.getE30PAMT04().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT05" value="<%= lnGenTran.getE30PAMT05().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT06" value="<%= lnGenTran.getE30PAMT06().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%" height="20"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT07" value="<%= lnGenTran.getE30PAMT07().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT08" value="<%= lnGenTran.getE30PAMT08().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT09" value="<%= lnGenTran.getE30PAMT09().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT10" value="<%= lnGenTran.getE30PAMT10().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT11" value="<%= lnGenTran.getE30PAMT11().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT12" value="<%= lnGenTran.getE30PAMT12().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
           }
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT13" value="<%= lnGenTran.getE30PAMT13().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT14" value="<%= lnGenTran.getE30PAMT14().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <%
          }
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30PAMT15" value="<%= lnGenTran.getE30PAMT15().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" name="E30DEAOD1" size="2" maxlength="2" value="<%= lnGenTran.getE30DEAOD1().trim()%>" readonly >
              <input type="text" name="E30DEAOD2" size="2" maxlength="2" value="<%= lnGenTran.getE30DEAOD2().trim()%>" readonly >
              <input type="text" name="E30DEAOD3" size="2" maxlength="2" value="<%= lnGenTran.getE30DEAOD3().trim()%>" readonly >             
            </td>
          </tr>		    		    
          <tr id="trclear"> 
            <td nowrap colspan="2"> 
            ...
            <td nowrap colspan="3" width="56%"> 
              <input type="text" size="15" maxlength="13" name="E30TRNTOT" value="<%= lnGenTran.getE30TRNTOT().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
        </table>
      </td>
    ...
    <div id="dataDiv" class="scbarcolor" style="height:60; overflow-y :scroll; z-index:0" >
     <table id="dataTable" >
          ...
          <tr id="trclear">
            <td nowrap > 
              <div align="center"> 
                <input type="text" name="E30OFFOP<%= name %>" value="<%= lnGenTran.getField("E30OFFOP"+name).getString().trim()%>" size="2" maxlength="2">
            ...
            <td nowrap > 
                <div align="center"> 
                  <input type="text" name="E30OFFAC<%= name %>" size="12" maxlength="9"  value="<%= lnGenTran.getField("E30OFFAC"+name).getString().trim()%>"
                oncontextmenu="showPopUp(accountHelp,this.name,document.forms[0].E30DEABNK.value,'','','','RT')">
                </div>
            </td>
            <td nowrap  > 
              <div align="center"> 
                  <input type="text" name="E30OFFAM<%= name %>" size="15" maxlength="13"  value="<%= lnGenTran.getField("E30OFFAM"+name).getString().trim()%>" onKeypress="enterDecimal()">
              </div>
            </td>
          </tr>
    ...
    <table id="footTable"> 		
          <tr id="trdark"> 
            ...
            <td nowrap align="center"><b><i><strong> 
              ...
              <input type="text" name="E30OFFEQV" size="15" maxlength="13" readonly value="<%= lnGenTran.getE30OFFEQV().trim()%>">
                </strong></i></b>
            </td>
          </tr>
        </table>
