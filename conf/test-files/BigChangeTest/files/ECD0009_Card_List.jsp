...
//<!-- Hide from old browsers
  ...
  function query(codigoPlastico){
    var page = "<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0009?SCREEN=2&E01CDRTBL="+codigoPlastico;
...
<h3 align="center">Card Control<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="Card_List.jsp, ECD0009">
</h3>
<hr size="4">

<form name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0009" >
 ...
 <table class="tbenter" width="100%" align="center">
    <tr> 
      <td class="TDBKG" width="25%"> 
        <div align="center" style="cursor:hand" onClick="create()"><a><b>New</b></a></div>
      </td>
      <td class="TDBKG" width="25%"> 
        <div align="center" ><a href="javascript:edit()"><b>Maintenance</b></a></div>
      </td>
      <td class="TDBKG" width="25%"> 
        <div align="center" style="cursor:hand" onClick="del()"><a><b>Delete</b></a></div>
      </td>
      <td class="TDBKG" width="25%"> 
...
%>
      ...
      <div align="center"> <font size="3"><b> </b></font>No records found</div>
      </TD></TR>
   		</TABLE>
<%
	}
...
%>
  ...
  <TABLE class="tableinfo" style="width:95%" ALIGN=CENTER>
    <TR id="trdark"> 
      <TH ALIGN=CENTER  nowrap >Card Code</TH>
     ...
     ecd0009List.initRow();               
       ...
       %>             
        ...
        <TR>
		  ...
		  <td NOWRAP >
          	<a href="javascript:query('<%=msgHelp.getE01CDRTBL()%>')">
										<%="D".equals(msgHelp.getE01CDRDOC())?Util.formatCell("Debit"):Util.formatCell("Crédito")%></a>
		  </td>
