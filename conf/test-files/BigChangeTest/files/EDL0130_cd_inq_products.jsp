<html>
<head>
<title>Certificates Products Inquiry</title>
...
<h3 align="center"> Time Deposit Product Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="products_inq_cd.jsp, ESD0711"></h3>
<hr size="4">
<form>
    ...
    <tr >
      <td >
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            <td width="50%">
              <div align="right">Floating Rate and Type Table : </div>
            </td>
            <td width="50%">
          ...
          <tr id="trclear">
            ...
            <td width="50%">
              ...
              <a href="javascript:showCDRates('<%= cdProdInq.getE11APCCCY().trim()%>','<%= cdProdInq.getE11APCCDT().trim()%>');"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
          </tr>
          <tr id="trdark">
            <td width="50%">
              <div align="right">Accrual Base Calculation :</div>
            </td>
            <td width="50%">
          ...
          <tr id="trdark">
            <td width="50%">
              <div align="right">Days until Certificate Expires :</div>
            </td>
            <td width="50%">
          ...
          <tr id="trclear">
            <td width="50%">
              <div align="right">Exclude Non-Residents :</div>
            </td>
            <td width="50%">
