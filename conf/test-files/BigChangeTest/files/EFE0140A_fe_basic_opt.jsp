...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ln_basic.jsp,EDL0150">
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="38%" > <% if(fex.getE01WKFOPT().equals("1")) out.print("American");
						                else out.print("European");%> </td>
            <td nowrap width="16%" > 
