...
<body>
<h3 align="center">Branch Stock<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_inv_stock_enter.jsp, ECD0003"> 
</h3>
<hr size="4">
<% 
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0003" >
  ...
  <br>
  <div align="center"> 
		<INPUT id="EIBSBTN" type="submit" name="Enviar" value="Submit" >
  </div>
  </form>
</body>
</html>
