<html>
<head>
<title>Maintenance Financial Statement</title>
...
document.forms[0].available.selectedIndex=-1;
	...
	if (document.forms[0].LAN.value == 'S') {
		...
		alert("Select maximum 5 formulas codes");
	}
}
}
...
<H3 align="center">Maintenance Financial Statement<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="financial_maintenance.jsp, EDP0703"></H3>
...
<div id="AMT" style="position:absolute; visibility:hidden; left : 0px; top : -50px; z-index:3; filter:progid:DXImageTransform.Microsoft.Fade(duration=1.0,overlap=1.0)}" onclick="cancelBub()">
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
						...
						<TBODY>
							<TR id="trclear">
								...
								<td nowrap width="30%">
									...
									<TBODY>
										<TR>
											<TD align="left">Add to this row :</TD>
										</TR>
										<TR>
										...
										<TR>
											<TD>Subtracted from this row :</TD>
										</TR>
										<TR>
  ...
  <h4><% if(userPO.getHeader16().equals("2")){out.print("Code to Modify:");} else {out.print("Code to Create:"); } %> </h4> 
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trdark">
								<td nowrap width="30%">
									<div align="right">Code Group :</div>
								</td>
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								<td nowrap width="30%">
									<DIV align="right">Code Number :</DIV>
								</TD>
								<td nowrap align="left" width="100%">
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								<td nowrap width="30%">
								<DIV align="right">Sequence of Calculation :</DIV>
								</TD>
								<td nowrap align="left" width="70%">
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trdark">
								<td nowrap width="30%">
								<DIV align="right">Type row :</DIV>
								</td>
								<td nowrap align="left" width="70%">
								<SELECT name="E01DPXLIN">
									<option value=" " > </option>
									<option value="1"
										<%if (brnDetails.getE01DPXLIN().equals("1")) { out.print("selected"); }%>>1 Title</option>
									<option value="2"
										<%if (brnDetails.getE01DPXLIN().equals("2")) { out.print("selected"); }%>>2 Detail</option>
									<option value="3"
										<%if (brnDetails.getE01DPXLIN().equals("3")) { out.print("selected"); }%>>3 Calculate</option>
								</SELECT>
								</td>
							</tr>
						</TBODY>
				...
				<TR>
					...
					<TABLE id="opTable" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="clear">
								<td nowrap width="9%">
      				   		<TD ALIGN=LEFT class=tdbkg width="119"><a href="javascript:goAction(1)"><b>Calculation Formula</b></a>
							</td>
								<td nowrap align="left" width="70%">
...
--%>				
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trdark">
								<td nowrap width="30%">
								<DIV align="right">Account Classification :</DIV>
								</td>
								<td nowrap align="left" width="70%">
								<SELECT name="E01DPXCAC">
									...
									<option value="1" 
									   <%if (brnDetails.getE01DPXCAC().equals("1")) { out.print("selected"); }%>>Assets</option>
									<option value="2"
										<%if (brnDetails.getE01DPXCAC().equals("2")) { out.print("selected"); }%>>Liabilities</option>
									<option value="3" 
										<%if (brnDetails.getE01DPXCAC().equals("3")) { out.print("selected"); }%>>Patrimony</option>	
									<option value="4" 
										<%if (brnDetails.getE01DPXCAC().equals("4")) { out.print("selected"); }%>>Income</option>
									<option value="5" 
										<%if (brnDetails.getE01DPXCAC().equals("5")) { out.print("selected"); }%>>Expenditures</option>
									<option value="6" 
										<%if (brnDetails.getE01DPXCAC().equals("6")) { out.print("selected"); }%>>Debtor</option>	
									<option value="7" 
										<%if (brnDetails.getE01DPXCAC().equals("7")) { out.print("selected"); }%>>Creditors</option>	
									<option value="8" 
										<%if (brnDetails.getE01DPXCAC().equals("8")) { out.print("selected"); }%>>Others DB</option>	
									<option value="9" 
										<%if (brnDetails.getE01DPXCAC().equals("9")) { out.print("selected"); }%>>Others CR</option>	
								</SELECT>
								</td>
							</tr>
						</TBODY>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trclear">
								<td nowrap width="30%">
									<DIV align="right">Number of Lines Memos :</DIV>
								</TD>
								<td nowrap align="left" width="70%">
