...
%>
<H3 align="center">World Check Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ofac_inq, EDEN000"></H3>
<% } else { %>
<H3 align="center">Office of Foreign Assets Control<br>OFAC Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ofac_inq, EDEN000"></H3>
<% } %>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="75%" > 
              <div align="left"> 
                <input type="text" name="SWDCOU" size="10" maxlength="10" value="<%= msgHelp.getSWDCOU().trim()%>" readonly>
              </div>
            </td>
           </tr>
          <tr id="trdark"> 
			...
			<TR>
				<TD nowrap width="25%" align="right"><B>State :</B></TD>
				<TD nowrap width="75%">
			...
			<TR>
				...
				<DIV align="right"><B>Further Information :</B>:</DIV></TD>
          ...
          <tr id="trclear"> 
            <td nowrap width="25%"> 
              <div align="right"><B>Entered Date :</B></div>
				</td>
            <td nowrap width="75%">
          ...
          <tr id="trdark"> 
           <td nowrap width="25%"> 
              <div align="right"><b>Vol/Page :</b></div>
            </td>
            <td nowrap width="75%"> 
              <div align="left"> 
