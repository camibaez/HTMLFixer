...
function SetCodeType() {	 
	 ...
	 if (type == "5") {
	 	document.forms[0].CODEN.maxLength = 3;
	 	document.forms[0].CODEN.onkeypress=enterInteger;
	 	document.forms[0].CODEN.value="";
     	numericLabel.style.visibility="visible";
     
     } else if (type == "7") {	
	 	document.forms[0].CODEN.maxLength = 2;
	 	document.forms[0].CODEN.onkeypress = "";
     	numericLabel.style.visibility="hidden";
...
<BODY>
<h3 align="center">Brokers Table Management<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel_broker.jsp,EWD0306P"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0306P" >
  <input type=HIDDEN name="SCREEN" value="2">
  <input type=HIDDEN name="CODE" value="">
  <input type=HIDDEN name="E01FEBTYP" value="">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<tr id="trclear"> 
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          <select name="TYPE" onchange="SetCodeType()">
            <option value=" "></option>
            <option value="1">Booth</option>
            <option value="2">Broker</option>
            <option value="3">Custodian</option>
            <option value="4">Issuer</option>
            <option value="5">Insurance Company</option>
            <option value="6">Lawyer</option>
            <option value="7">Insurance Agent</option>
            <option value="8">Referred by</option>
          </select>
        </div>
      </td>
    </tr>
	<tr id="trdark"> 
      <td align=CENTER width="25%"> 
        ...
        <div id="numericLabel" align="left" style="visibility:hidden;">(Numeric)</div>
      </td>
      <td align=CENTER width="75%"> 
        <div align="left"> 
