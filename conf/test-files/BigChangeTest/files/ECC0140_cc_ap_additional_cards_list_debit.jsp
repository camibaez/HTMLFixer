          ...
          document.forms[0].submit();
      	 ...
      	 if ( ok ) {
			document.forms[0].submit();
      			...
      			alert("A valid card must be selected before this operation");	   
           }
	 }
...
%> 
<h3 align="center">Debit Card<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="cc_ap_additional_cards_list_debit.jsp , ECC0140"></h3>
<hr size="4">
...
%> 
      ...
      <TD> 
        <div align="center"> 
              ...
              <td nowrap> 
                <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
                  <tr id="trdark"> 
                    ...
                    <td nowrap width="20%" > 
                      <div align="left"><b> 
                        <input type="text" readonly name="E01CCRCUN" size="9" maxlength="9" value="<%= userPO.getHeader6().trim()%>" >
                        </b> </div>
                    </td>
                    <td nowrap width="16%" > 
                    ...
                    <td nowrap > 
                      <div align="left"><font face="Arial"><font face="Arial"><font size="2"> 
                        <input type="text" name="E01CUSNA1" size="45" maxlength="45" readonly value="<%= userPO.getHeader7().trim()%>">
                        </font></font></font></div>
                    </td>
                  </tr>
                  <tr id="trdark"> 
                    ...
                    <td nowrap width="20%"> 
                      <div align="left"> 
                        <input type="text" name="E01CCRCRA" size="12" maxlength="12" value="<%= userPO.getHeader5().trim()%>" readonly>
                      </div>
                    </td>
                    <td nowrap width="16%"> 
                    ...
                    <td nowrap width="16%"> 
                      <div align="left"><b> 
                        <input type="text" name="E01TARTYP" size="15" maxlength="14" value="Debit Card" readonly>
                        </b> </div>
                    </td>
                  </tr>
                </table>
          ...
          <p>&nbsp;</p>
          <p><font size="3"><b>This account has no Additional Debit Cards</b></font></p>
          <p>&nbsp; </p>
        </div>
      </TD></TR>
   		</TABLE>
...
%>
              ...
              <td nowrap> 
                <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
                  <tr id="trdark"> 
                    ...
                    <td nowrap width="20%" > 
                      <div align="left"><b> 
                        <input type="text" readonly name="E01PRICUN" size="9" maxlength="9" value="<%= userPO.getHeader6().trim()%>" >
                        </b> </div>
                    </td>
                    <td nowrap width="16%" > 
                      <div align="right"><b>Customer Name : </b> </div>
                  ...
                  <tr id="trdark"> 
                    ...
                    <td nowrap width="16%"> 
                      <div align="left"><b> 
                        <input type="text" name="E01TARTYP" size="15" maxlength="14" value="Tarjeta de Debito" readonly>
                        </b> </div>
                    </td>
                  </tr>
                </table>
  ...
  <table class="tbenter" width="100%">
    <tr> 
      <td align=CENTER> <a href="javascript:goAction(2)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','<%=request.getContextPath()%>/images/e/INQUIRY_OVER.gif',1)"><img name="Image2" border="0" src="<%=request.getContextPath()%>/images/e/INQUIRY.gif" ></a></td>
    </tr>
  </table>
  <center>
        ...
        <td NOWRAP valign="top"> 
          <table id="headTable">
            <tr id="trdark"> 
              ...
              <TH align=CENTER nowrap> 
               Customer</TH>
              <TH align=CENTER nowrap>Issue Date</TH>
