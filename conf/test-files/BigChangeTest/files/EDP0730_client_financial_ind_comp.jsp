...
<script language="Javascript1.1" src="<%=request.getContextPath()%>/pages/e/javascripts/optMenu.jsp"> </SCRIPT><SCRIPT language="JavaScript">
...
<h3 align="center">Financial Indices<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="creditproposal_financial_ind_comp.jsp,EDP0730"></h3>
<hr size="4">
          ...
          <tr id="trdark"> 
            <th align=CENTER nowrap width="5%">&nbsp;
             ...
             <th align=CENTER nowrap width="20%"> 
            	<div align="center">Financial Index
            	</div>
            </th>
             <th align=CENTER nowrap width="20%"> 
