...
<BODY>
<h3 align="center">Internet Banking Parameters Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="previsions_list.jsp, EDL0522"></h3>
<hr size="4">
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%">Bank Number</th>
            <th align=CENTER nowrap width="10%"><div align="center">Description</div></th>
          </tr>
          <%
          ...
          <tr> 
            ...
            <td NOWRAP  align=CENTER width=\"10%\"><%= msgList.getE01INTBNK() %></td>
            <td NOWRAP  align=CENTER width=\"10%\"><%= msgList.getE01INTDSC() %></td>
          </tr>
          <%}%>
        </table>
  </table>
