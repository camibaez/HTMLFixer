...
<BODY>
<H3 align="center">Import Letter Of Credit Maintenance [Basic Information]<IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" alt="lc_opening_import.jsp, ELC0510"></H3>
<HR size="4">
<FORM method="post"
...
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo" id="trclear">
    ...
    <TR id="">
      ...
      <TD nowrap><SELECT name="E01LCMAF2">
          <OPTION value=" "
								...
								selected></OPTION>
          <OPTION value="C" <%if (msgLC.getE01LCMAF2().equals("C")) out.print("selected");%>>Customer</OPTION>
          ...
          <IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatory Field" border="0"> <A href="javascript: GetCustomerDetailsLC('E01LCMAPA','E01LCMAP1','E01LCMAP2','E01LCMAP3','E01LCMAP4','E01LCMAP5','E01LCMAP6','E01LCMAP7','')">
		  <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF2.selectedIndex = 1"
			border="0"></A>Customer or <A
							href="javascript: GetAccByClient('E01LCMAPA','','RT','','E01LCMAP1')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help"
  ...
  <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
    ...
    <TR id="">
      ...
      <TD nowrap><SELECT name="E01LCMAF3">
          ...
          <A href="javascript: GetCustomerDetailsLC('E01LCMBAC','E01LCMBN1','E01LCMBN2','E01LCMBN3','E01LCMBN4','E01LCMBN5','E01LCMBN6','E01LCMBN7','')">
			  <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF3.selectedIndex = 1"
			border="0"></A> Customer or <A href="javascript: GetAccByClient('E01LCMBAC','','RT','','E01LCMBN1')">
		     <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF3.selectedIndex = 2" border="0">
		  </A> Account</TD>
    </TR>
    <TR id="">
      <TD align="right"> Name :</TD>
  ...
  <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
    ...
    <TR id="">
      <TD width="35%" align="right" nowrap="nowrap">Customer Number:</TD>
      <TD align="left" nowrap><P>
        <INPUT type="text" name="E01LCMCBC" size="12" maxlength="12" value="<%=msgLC.getE01LCMCBC()%>"> 
        <A href="javascript: GetCustomerDetailsLC('E01LCMCBC','E01LCMCA1','E01LCMCA2','E01LCMCA3','E01LCMCA4','E01LCMCA5','E01LCMCA6','E01LCMCA7','C')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></A></P>
      </TD>
    </TR>
    <TR id="">
      <TD nowrap="nowrap" align="right">Swift BIC :</TD>
      <TD align="left"><INPUT type="text" name="E01LCMCAI" size="12" maxlength="12" value="<%=msgLC.getE01LCMCAI()%>">
  ...
  <TABLE width="100%" border="0" align="center" cellpadding="2"  cellspacing="0" class="tableinfo">
    ...
    <TR id="">
      ...
      <TD align="left" nowrap><INPUT name="E01LCMCOR" type="text" id="E01LCMCOR" value="<%=msgLC.getE01LCMCOR()%>" size="12" maxlength="12">
          <A href="javascript: GetCustomerDetailsLC('E01LCMCOR','E01LCMCB1','E01LCMCB2','E01LCMCB3','E01LCMCB4','E01LCMCB5','E01LCMCB6','E01LCMCB7','4')">
		   <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></A> Line of Credit  :
  ...
  <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
    ...
    <TR id="">
	  ...
	  <A href="javascript: GetCustomerDetailsLC('E01LCMRBA','E01LCMRB1','E01LCMRB2','E01LCMRB3','E01LCMRB4','E01LCMRB5','E01LCMRB6','E01LCMRB7','5')"> 
	  <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></A>Customer or 
	  <A href="javascript: GetAccByClient('E01LCMRBA','','RT','','E01LCMRB1')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0">
	  </A> Account </TD>
    </TR>
    <TR id="">
      <TD nowrap="nowrap" align="right">Swift BIC : </TD>
  ...
  <TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
    ...
    <TR id="">
      ...
      <TD nowrap><SELECT name="E01LCMAF4">
          <OPTION value=""></OPTION>
          <OPTION value="C" <%if (msgLC.getE01LCMAF4().equals("C")) out.print("selected");%>>Customer</OPTION>
          <OPTION value="A" <%if (msgLC.getE01LCMAF4().equals("A")) out.print("selected");%>>Account</OPTION>
        </SELECT>
          <INPUT type="text" name="E01LCMABA" size="12" maxlength="12" value="<%=msgLC.getE01LCMABA()%>">
          <A href="javascript: GetCustomerDetailsLC('E01LCMABA','E01LCMAB1','E01LCMAB2','E01LCMAB3','E01LCMAB4','E01LCMAB5','E01LCMAB6','E01LCMAB7','C')">
          <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF4.selectedIndex = 1"  border="0">
          </A> Customer or <A href="javascript: GetAccByClient('E01LCMABA','','RT','','E01LCMAB1')"> 
          <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF4.selectedIndex = 2"  border="0">
          </A> Account</TD>
    </TR>
    <TR id="">
      <TD width="35%" align="right" nowrap>Swift BIC :</TD>
      <TD align="left" nowrap><INPUT type="text" name="E01LCMABI" size="12" maxlength="12" value="<%=msgLC.getE01LCMABI()%>">
        <A href="javascript:GetSwiftIdDesc('E01LCMABI','','','')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help"  border="0"></A> </TD>
    </TR>
    <TR id="">
    ...
    <TR id="">
      ...
      <TD align="left" nowrap><INPUT type="text" name="E01LCMAB2" size="45" maxlength="35" value="<%=msgLC.getE01LCMAB2()%>">      </TD>
    </TR>
    <TR id="">
      <TD nowrap></TD>
      <TD align="left" nowrap><INPUT type="text" name="E01LCMAB3" size="45" maxlength="35" value="<%=msgLC.getE01LCMAB3()%>">      </TD>
    </TR>
    <TR id="">
      <TD nowrap></TD>
      <TD align="left" nowrap><INPUT type="text" name="E01LCMAB4" size="45" maxlength="35" value="<%=msgLC.getE01LCMAB4()%>">      </TD>
    </TR>
    <TR id="">
      ...
      <TD align="left" nowrap><INPUT type="text" name="E01LCMAB5" size="2" maxlength="2" value="<%=msgLC.getE01LCMAB5()%>">
        ...
        <A href="javascript:GetCodeCNOFC('E01LCMAB7','03')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></A></TD>
    </TR>
  </TABLE>
  <BR>
  <BR>
