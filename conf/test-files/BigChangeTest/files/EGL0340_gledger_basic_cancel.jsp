...
%> 
<H3 align="center">General Ledger Account Master File Deletion<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="gledger_basic.jsp, EGL0340"></H3>
<hr size="4">
