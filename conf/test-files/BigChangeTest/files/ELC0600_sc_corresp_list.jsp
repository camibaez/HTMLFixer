...
<H3 align="center">Table of Commissions and Expenses of Letters of Credit<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sc_corresp_list.jsp, ELC0600"></H3>
<HR size="4">
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <DIV align="center"> <H4 style="text-align:center"><B>There not results to your search</B>.<BR>Click &lt;<B>New</B>&gt; to create one</H4> 
      </DIV>
      </TD></TR>
   	</TABLE>
   	<TABLE class="tbenter">
...
%>
  ...
  <TABLE class="tbenter">
    <TR>
      ...
      <TD ALIGN=CENTER class="TDBKG" width="33%">
  		<A href="javascript:goMaint()">Maintenance</A>
      </TD>   
      <TD ALIGN=CENTER class="TDBKG" width="33%"><A href="javascript:goDelete()">Delete</A>
      </TD>               
      <TD ALIGN=CENTER class="TDBKG" width="34%"><A href="<%=request.getContextPath()%>/pages/background.jsp">Exit</A>
      </TD>
    </TR>
  </TABLE>
  </CENTER>
