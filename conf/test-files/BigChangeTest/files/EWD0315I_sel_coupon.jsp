...
<BODY>
<h3 align="center">Coupon Payment Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel_instruments.jsp, EWD0308"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0315I" >
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      ...
      <td class=TDBKG width="53%"> 
        <div align="center"><a href="javascript:goAction(2)"><b>ProRate</b></a></div>
      </td>
      <td class=TDBKG width="53%"> 
