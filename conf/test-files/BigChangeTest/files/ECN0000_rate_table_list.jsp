...
<h3 align="center">Interest Rate VS Term/Amount<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rate_table_list.jsp, ECN0000"></h3>
<hr size="4">
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center"> There is no interest table on the system <br>Click New to add one</h4> 
      </div>
      </TD></TR>
   	</TABLE>
   	<TABLE class="tbenter">
    <TR>
      <%if (userPO.getPurpose().equals("READONLY")) {%>
		  <TD ALIGN=CENTER class="TDBKG" width="50%">&nbsp;</TD>      
      <%} else {%>
...
%>
    ...
    <TR>
      <%if (userPO.getPurpose().equals("READONLY")) {%>
	      <TD ALIGN=CENTER class="TDBKG" width="25%">
	  		<a href="javascript:goAction('D')">Detail</a>
	      </TD>      
      <%} else {%>   
	      <TD ALIGN=CENTER class="TDBKG" width="25%">
	  		<a href="javascript:goAction('N')">New</a>
	      ...
	      <TD ALIGN=CENTER class="TDBKG" width="25%">
	  		<a href="javascript:goAction('C')">Copy</a>
	      </TD>
	      <TD ALIGN=CENTER class="TDBKG" width="25%">
  ...
  <TABLE class="tableinfo" id="dataTable">
    <TR id="trdark">
      ...
      <TH ALIGN=CENTER  nowrap >Table Code</TH>
