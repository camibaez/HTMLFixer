...
%>
<h3 align="center">Foreign Currency Control Parameters<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fex_paramenters.jsp, EFE0200">
</h3>
<hr size="4">
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear">
            <td nowrap width="46%" >
              <div align="right">Days to be transfer to Spot :</div>
            </td>
            <td nowrap width="54%" >
          ...
          <tr id="trdark">
            <td nowrap width="46%" >
              <div align="right">Spot Re-evaluation:</div>
            </td>
            <td nowrap width="54%" >
              <div align="left">
          ...
          <tr id="trdark">
            <td nowrap width="46%" >
              <div align="right">Automatic Generation
                :</div>
            </td>
            <td nowrap width="54%" >
              <div align="left">
          ...
          <tr id="trclear">
            <td nowrap width="46%" >
              <div align="right">Position update at Transaction Date :</div>
            </td>
            <td nowrap width="54%" >
              <div align="left">
          ...
          <tr id="trdark">
            <td nowrap width="46%" >
              <div align="right">Position/Counter-Value Bridge Account :</div>
            </td>
            <td nowrap width="54%" >
              <div align="left">
                <input type="text" name="E01FEPEGL" size="17" maxlength="16" value="<%= fix.getE01FEPEGL()%>" >
              	<a href="javascript:GetLedger('E01FEPEGL',document.forms[0].E01FEPBNK.value,'','91')">
          ...
          <tr id="trclear">
            <td nowrap width="46%" >
              <div align="right">Daily Limits :</div>
            </td>
            <td nowrap width="54%" >
              <div align="left">
