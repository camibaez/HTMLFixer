...
<tr>
   <th nowrap id="THHELP">Inquiry type</th>
</tr>
<tr> 
	<td nowrap><input type="radio" name="Type" value="S" checked>Short Name</td>
</tr>
<tr>
	<td nowrap><input type="radio" name="Type" value="I">Identification</td>
</tr>
<tr>
	<td nowrap><input type="radio" name="Type" value="A">Account</td>
</tr>
<tr>
	<td nowrap><input type="radio" name="Type" value="C">Customer Number</td>
</tr>
<tr>
	<td nowrap><input type="radio" name="Type" value="U">User/Entity</td>
</tr>
