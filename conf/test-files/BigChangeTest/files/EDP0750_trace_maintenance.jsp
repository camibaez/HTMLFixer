<html>
<head>
<title>INquiry Tracing Credit Proposal</title>
...
<H3 align="center">Detail Activity<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="trace_maintenance.jsp, EDP0750"></H3>
...
<h4>  
      Detalle Propuesta a 
      <% if(userPO.getHeader16().equals("1")) {out.print(" New");} %>
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								<td nowrap width="33%">
									<DIV align="right">Activity Sequence :</DIV>
								</TD>
								<td nowrap align="left" width="67%">
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								<td nowrap width="33%">
								<DIV align="right">Amount Recommended</DIV>
								</TD>
							<td nowrap align="left" width="67%">
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trdark">
								<td nowrap width="33%">
								<DIV align="right">Begin Date </DIV>
								</TD>
								<td nowrap align="left" width="67%">
			...
			--%>
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trdark">
								<td nowrap width="33%">Comments :
								</td>
								<td width="67%" align="center">
									<TEXTAREA name="E01DPSCOM" maxlength="800" rows="10" cols="80" Value="<%= brnDetails.getE01DPSCOM().trim()%>"
									<%  if(userPO.getHeader17().equals("1")){out.print("readonly");}  
									%>>
									</TEXTAREA>
								</td>
