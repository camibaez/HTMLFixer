...
<h3 align="center">Foreign Exchange Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_enter_maint, EDL0130"></h3>
<hr size="4">
  ...
  <table class="tbenter" height="75%" width="100%" border="0">
    <tr>
        ...
        <INPUT type="text" name="E01WKFACC" size="12" maxlength="9" onkeypress="enterInteger()">
              <a href="javascript:GetFexAcc('E01WKFACC')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
		<p align="center">&nbsp; </p>
		<p align="center">
