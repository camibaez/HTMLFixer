...
%> 
<H3 align="center">Approval

<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_aprobacion.jsp, ECH0000"></H3>
  ...
  <TABLE class="tbenter">
    <TR>
      <TD ALIGN=CENTER class=TDBKG>
  			<a href="javascript:goAction('A')" id="linkApproval">Approve</a>
      </TD>
      <TD ALIGN=CENTER class=TDBKG>
  			<a href="javascript:enterReason('R')" id="linkReject">Reject</a>
      </TD>
      <TD ALIGN=CENTER class=TDBKG>
  			<a href="javascript:checkClose()">Exit</a>
      </TD>
     </TR>
  </TABLE>
      ...
      <td nowrap> 
       <div id="dataDiv1" class="scbarcolor" >
        <table id="dataTable" cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap>Selection</td>
            <td nowrap>Account</td>
            <td nowrap>Customer</td>
            <td nowrap>Checkstubs<br>Type</td>
            <td nowrap>Amount</td>
            <td nowrap>Date</td>
            <td nowrap>Time</td>
            <td nowrap>Rejection<br>Reason</td>
            <td nowrap>Delivery <br>Agency</td>
          </tr>
	      <%
	      rtBasic.initRow();
