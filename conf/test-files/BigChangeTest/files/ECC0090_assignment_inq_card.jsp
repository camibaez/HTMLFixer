...
<body>
<h3 align="center">Assignment Inquiry<BR>Detail - Primary Card<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="assignment_inq_card.jsp, ECC0090"></h3>
<hr size="4">
<% 
...
%>
	...
	<TR>
      <TD> 
	      <div align="center"> <font size="3"><b>Customer don't have accounts related </b></font></div>
      </TD>
     </TR>
   	</TABLE>
<%
...
%>
  <table class="tableinfo">
    <tr>
      ...
      <td align="center"><B>Secondary Accounts</B><br>
        <select size="5" name="AccSList" id="AccSList" onclick="document.forms[0].AccSList.multiple = false" onBlur="document.forms[0].AccSList.multiple = true">
          ...
          <% } %>
          <% if (aux2 == 0) { %>
          <option value="X">There are not accounts assigned</option>
          <% } %>
        </select></td>
    </tr>
  </table>
...
<br>
  <div align="center"> 
	   <INPUT type="submit" name="EIBSBTN" id="EIBSBTN" value="Back">
  </div>
</form>
</body>
</html>
