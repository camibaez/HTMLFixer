<html>
<head>
<title>Collection Tariff Inquiry</title>
...
<h3 align="center">Collection Tariff Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="products_inq_ln.jsp, ESD0711"></h3>
<hr size="4">
    ...
    <tr > 
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td width="48%"> 
              <div align="right">Documentaries :</div>
            </td>
            <td width="7%">&nbsp;</td>
            <td width="8%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td width="48%"> 
              <div align="right">Second Notice :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trdark"> 
            <td width="48%"> 
              <div align="right">Additional Notification :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trclear"> 
            <td width="48%"> 
              <div align="right">Returned / Not Paid :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trclear"> 
            <td width="48%"> 
              <div align="right">Payment Notice :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trdark"> 
            <td width="48%"> 
              <div align="right">Endorse Doc / Transport :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trclear"> 
            <td width="48%"> 
              <div align="right">Indemnity Letter :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trdark"> 
            <td width="48%"> 
              <div align="right">Expired / Delayed :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trclear"> 
            <td width="48%"> 
              <div align="right">Postage - Certificates :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trclear"> 
            <td width="48%"> 
              <div align="right">Courier - International :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trclear"> 
            <td width="48%"> 
              <div align="right">Fax - International :</div>
            </td>
            <td width="7%"> 
          ...
          <tr id="trdark"> 
            <td width="48%"> 
              <div align="right"> S.W.I.F.T. Message :</div>
            </td>
            <td width="7%"> 
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGCC" value="<%= colProdInq.getE01RCOGCC().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGCD" value="<%= colProdInq.getE01RCOGDC().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGRD" value="<%= colProdInq.getE01RCOGRD().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGEV" value="<%= colProdInq.getE01RCOGEV().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGPP" value="<%= colProdInq.getE01RCOGPP().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGPR" value="<%= colProdInq.getE01RCOGPR().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td width="48%"> 
              <div align="right">Notifications :</div>
            </td>
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGTR" value="<%= colProdInq.getE01RCOGTR().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGUI" value="<%= colProdInq.getE01RCOGUI().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGAM" value="<%= colProdInq.getE01RCOGAM().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGAP" value="<%= colProdInq.getE01RCOGAP().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGED" value="<%= colProdInq.getE01RCOGED().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGLI" value="<%= colProdInq.getE01RCOGLI().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGPD" value="<%= colProdInq.getE01RCOGPD().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGWT" value="<%= colProdInq.getE01RCOGWT().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGPO" value="<%= colProdInq.getE01RCOGPO().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td width="48%"> 
              <div align="right">Messages, Courier :</div>
            </td>
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGCR" value="<%= colProdInq.getE01RCOGCR().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGFX" value="<%= colProdInq.getE01RCOGFX().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGTX" value="<%= colProdInq.getE01RCOGTX().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="18%"> 
              <div align="center"> 
                <input type="text" readonly name="E01RCOGSW" value="<%= colProdInq.getE01RCOGSW().trim()%>" size="18" maxlength="12">
              </div>
            </td>
            <td width="34%"> 
              <div align="center"> 
