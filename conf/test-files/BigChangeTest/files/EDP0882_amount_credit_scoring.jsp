<html>
<head>
<title>Assessment Amounts Credit Scoring</title>
...
<H3 align="center">Assessment AmountsCredit Scoring<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="amount_credit_scoring.jsp, Edp088201"></H3>
<P align="center">
</P>
...
<br>
  ...
  <h4>Credit Financial Calculations</h4>
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
		...
		<TABLE id="tbenter" align="center" style="width: 100%" border="0">
			<tr id="trclear">
				<td	nowrap width="33%">
					<div align="right">Application Number (Proposal) :</div>
				</td>
			...
			<tr id="trdark">
				<td	nowrap width="33%">
					<div align="right">Loan Requested - Product :</div>
				</td>
				<td nowrap align="left" width="67%">
			...
			<TR id="trclear">
				<td nowrap width="33%">
					<DIV align="right">Annual lending rate : </DIV>
				</TD>
				<td nowrap align="left" width="67%">
			...
			<TR id="trdark">
				<td nowrap width="33%">
					<DIV align="right">Annual lending rate with Capt. Monthly : </DIV>
				</TD>
				<td nowrap align="left" width="67%">
			...
			<TR id="trclear">
				<td nowrap width="33%">
					<DIV align="right">Capital + Interest : </DIV>
				</TD>
				<td nowrap align="left" width="67%">
...
<h4>Leverage the applicant's current institution</h4>
...
<table  class="tableinfo">
  ...
  <table  id=mainTable class="tableinfo">
   ...
   <TABLE id="headTable1" NOWRAP>
          <tr id="trdark"> 
            <th align=CENTER nowrap width="20%">Product</th>
            <th align=CENTER nowrap width="15%"> <div align="center">Amount</div> </th>
            <th align=CENTER nowrap width="10%"> <div align="center">Annual Rate </div> </th>
            <th align=CENTER nowrap width="10%"> <div align="center">Monthly Rate </div> </th>
            <th align=CENTER nowrap width="10%"> <div align="center">Term</div> </th>
            <th align=CENTER nowrap width="15%"> <div align="center">Payment</div> </th>
	      </tr>
	</TABLE>
...
<h4>Applicant's Current Leverage with Other Institutions</h4>
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
		...
		<TABLE id="tbenter" align="center" style="width: 100%" border="0">
			<tr id="trdark">
				<td	nowrap width="33%">
					<div align="right">Maximum for Debt Service:</div>
				</td>
			...
			<tr id="trclear">
				<td	nowrap width="33%">
					<div align="right">Monthly Income Available for Debt :</div>
				</td>
				<td nowrap align="left" width="10%">
				</td>
				<td nowrap align="left" width="57%">
			...
			<tr id="trdark">
				<td	nowrap width="33%">
					<div align="right">Debt can be ordered :</div>
				</td>
				<td nowrap align="left" width="10%">
				</td>
				<td nowrap align="left" width="57%">
    ...
    <tr > 
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="40%">Grant Amount with Real Warranty </th>
            <th align=CENTER nowrap width="20%"> 
              <div align="center">Default</div>
            </th>
            <th align=CENTER nowrap width="20%"> 
              <div align="center">Policies</div>
            </th>
  ...
  <table  id=cfTable class="tableinfo">
    <tr > 
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="40%">Grant Amount without Real Warranty </th>
            <th align=CENTER nowrap width="20%"> 
              <div align="center">Default</div>
            </th>
            <th align=CENTER nowrap width="20%"> 
...
<div align="center"> 
		<TD ALIGN=CENTER width="24%" class=tdbkg><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Exit</b></a>
