...
<H3 align="center"><%=title %> - Country Codes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="our_denial.jsp, EDEN030"></H3>
<hr size="4">
      ...
      <td nowrap> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="35%" align="left">
				<INPUT type="text" name="E01DNCDE" size="11" maxlength="11" value="<%= EDEN030Record.getE01DNCDE().trim()%>" <%=read%> >            	
			</td>
            <td nowrap width="15%" align="right">Description :</td>
			<td nowrap width="35%" align="left"> 
				<INPUT type="text" name="E01DNCDS" id="E01DTCDSC" size="60" value="<%= EDEN030Record.getE01DNCDS().trim()%>"> 
			</td>
		</tr>		
        </table>
      </td>
