...
<table class="tbenter" align=center height="72%" >
    ...
    <TD align=center valign=top>
      <table class="tbenter">
        <tr>
          ...
          <td align="center"><font color="red" face="Arial, Helvetica, sans-serif" size="3"><b>WARNING</b></font>
          </td>
          <td width="75" align="center">
			<img src="<%=request.getContextPath()%>/images/warning.gif">
		  </td>
 ...
 <TR valign=top height="2%">
	...
	<td nowrap>Make a request to main office</td>
 </TR>
 
</table>
<p align="center">
	<input id="EIBSBTN" type=submit name="Submit" value="Close" onclick="top.close()">
</p>
