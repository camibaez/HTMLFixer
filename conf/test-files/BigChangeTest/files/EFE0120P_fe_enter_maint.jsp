    ...
    <tr>
      <td nowrap align="center">
        <table class="tableinfo">
          ...
          <tr id="trclear">
            <td width="36%">
              <div align="right">Currency / Classification :</div>
            </td>
            <td width="64%">
          ...
          <tr id="trdark">
            <td width="36%" height="2">
              <div align="right">Counterparty Name :</div>
            </td>
            <td width="64%" height="2">
              <input type="text" name="E01FESCUN" size="9" maxlength="9">
              <input type="text" name="E01FESNA1" size="45" maxlength="45">
              <a href="javascript:GetCustomerDescId('E01FESCUN','E01FESNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
          </tr>
          <tr id="trclear">
        ...
        <p><input type=image class="imgfilter" name="Submit" src="<%=request.getContextPath()%>/images/e/bt_submit.gif"
