...
<BODY>
<h3 align="center">Instruments Management<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel_instruments.jsp, EWD0308Q"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0308Q" >
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      <td class=TDBKG width="52%"> 
        <div align="center"><a href="javascript:goAction(2)"><b>Select Instrument</b></a></div>
      </td>
