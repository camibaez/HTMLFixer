...
%>
<h3 align="center"> Payment Interface Details<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="payments_basic.jsp,EPR0015">
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap >
              ...
              <a href="javascript:GetAccount('E01PRCACC','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a></td>
            <td nowrap >
          ...
          <tr id="trdark">
            ...
            <td nowrap >
              ...
              <a href="javascript:GetLedger('E01PRCSDG','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
            <td nowrap >
              <div align="right"></div>
            </td>
