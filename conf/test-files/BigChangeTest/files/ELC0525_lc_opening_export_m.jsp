...
<H3 align="center">Export Commercial Letter Of Credit Approval Inquiry [Basic Information]
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_opening_export_m.jsp, ELC0525"></H3>
<HR size="4">
<FORM>
<BR>
      ...
      <TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
          ...
          <TR id="">
            ...
            <TD nowrap><SELECT name="E01LCMAF1" disabled>
                <OPTION value=" "></OPTION>
<OPTION value="C" <%if (msg051001.getE01LCMAF1().equals("C")) out.print("selected");%>>CIF</OPTION>
                <OPTION value="A" <%if (msg051001.getE01LCMAF1().equals("A")) out.print("selected");%>>DDA</OPTION>
              </SELECT>
                <INPUT name="E01LCMIBA" type="text" value="<%=msg051001.getE01LCMIBA()%>" size="12" maxlength="12" readonly="readonly">
                </TD>
          </TR>
          <TR id="">
            <TD align="right">Swift Code :</TD>
            <TD align="left" nowrap><INPUT name="E01LCMIBI" type="text" value="<%=msg051001.getE01LCMIBI()%>" size="14" maxlength="12" readonly="readonly">
             </TD>
          </TR>
          <TR id="">
            <TD align="right">Name :</TD>
            <TD align="left" nowrap><INPUT name="E01LCMIB1" type="text" value="<%=msg051001.getE01LCMIB1()%>" size="45" maxlength="35" readonly="readonly">
              </TD>
          </TR>
          <TR id="">
            <TD align="right">Address :</TD>
            <TD align="left"><INPUT name="E01LCMIB2" type="text" value="<%=msg051001.getE01LCMIB2()%>" size="45" maxlength="35" readonly="readonly">
            </TD>
          </TR>
          <TR id="">
            <TD></TD>
            <TD align="left"><INPUT name="E01LCMIB3" type="text" value="<%=msg051001.getE01LCMIB3()%>" size="45" maxlength="35" readonly="readonly"></TD>
          </TR>
          <TR id="">
            <TD></TD>
            <TD align="left"><INPUT name="E01LCMIB4" type="text" value="<%=msg051001.getE01LCMIB4()%>" size="45" maxlength="35" readonly="readonly">
            </TD>
          </TR>
          <TR id="">
            <TD align="right" valign="bottom">State :</TD>
            <TD align="left" valign="bottom" nowrap><INPUT name="E01LCMIB5" type="text" value="<%=msg051001.getE01LCMIB5()%>" size="2" maxlength="2" readonly="readonly">
              Zip Code :
              <INPUT name="E01LCMIB6" type="text" value="<%=msg051001.getE01LCMIB6()%>" size="11" maxlength="10" readonly="readonly">
              Country :
              <INPUT name="E01LCMIB7" type="text" value="<%=msg051001.getE01LCMIB7()%>" size="4" maxlength="4" readonly="readonly">
               </TD>
          </TR>
      </TABLE>
	 <BR>
