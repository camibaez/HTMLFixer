...
<H3 align="center">Bank Branch Access Authorization<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bank_branch_access, ESD0008"></H3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.security.JSESD0008">
  ...
  <table class="tableinfo"  cellspacing="0" cellpadding="2" width="100%" border="0">
    <tr id="trdark">
      <td nowrap width="40%">
      	<div align="right"> User Identification :</div>
      </td>
      <td nowrap width="60%">
    ...
    <tr id="trdark">
      ...
      <td nowrap width="60%">
        <input type="radio" name="E01DBAALL" value="*" <%= chkAll%> > All Branches
      </td>
    </tr>
    <tr id="trclear">
      <td nowrap width="40%">
      ...
      <td nowrap width="60%">
        <input type="radio" name="E01DBAALL" value="N" <%= chkSlt%> > Select Branch
    	<input type="text" name="E01DBABRN" size="5" maxlength="4" value="<%= user.getE01DBABRN().trim()%>" onkeypress="enterInteger()">
    	<a href="javascript:GetBranch('E01DBABRN','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"  ></a>
