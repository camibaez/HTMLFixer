...
%>
<div align="center">
  <h3>Stocks / Mutual Funds Commissions Inquiry <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_stocks_basic.jsp,EIE0000"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="66%" > 
              ...
              <%= invComm.getE01COMTYP()%> - <% if(invComm.getE01COMTYP().equals("BND")) out.print("BONDS");
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRI1" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRI1()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRF1" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRF1()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRI2" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRI2()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRF2" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRF2()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRI3" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRI3()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRF3" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRF3()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRI4" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRI4()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRF4" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRF4()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRI5" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRI5()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRF5" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRF5()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRI6" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRI6()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRF6" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRF6()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRI7" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRI7()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRF7" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRF7()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRI8" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRI8()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRF8" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRF8()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRI9" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRI9()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
                <input type="text" readonly  name="E01COMRF9" size="16" maxlength="15" onKeyPress="enterDecimal()" value="<%= invComm.getE01COMRF9()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center"> 
