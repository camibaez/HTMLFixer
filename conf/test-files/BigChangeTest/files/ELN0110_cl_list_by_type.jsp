...
<script language="javascript">
  function goAction(op) {
	...
	if ( ok ) {
	   ...
	   var pg = "<%=request.getContextPath()%>/servlet/datapro.eibs.credit.JSELN0110?SCREEN=4&opt=" + op + "&CUS_LINE=" + ln;
  ...
  <table class="tableinfo">
    <tr> 
      ...
      <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
        <tr id="trdark"> 
          <TD ALIGN=RIGHT WIDTH=20%> Type of Line :</TD>
