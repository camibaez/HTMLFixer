...
<html>
<head>
<title>Proposal Guarantees</title>
...
<BODY>
<h3 align="center">Credit Proposals<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="branch_list.jsp, EDP0725"></h3>
<hr size="4">
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      <td class=TDBKG width="30%"> 
        <div align="center"><a href="javascript:goAction(1)"><b>Guarantee</b></a></div>
     </td>
      <td class=TDBKG width="30%"> 
        <div align="center"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Exit</b></a></div>
      </td>
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%"><div align="center">Proposal #</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Customer ID</div></th>
            <th align=CENTER nowrap width="35%"><div align="center">Name</div></th>
           </tr>
          <%
  ...
  <%
		...
		int pos = EDP072501Help.getFirstRec() - 20;
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0725?SCREEN=100&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
        }
  %>
  </TD>
  ...
  <%
		...
		int pos = EDP072501Help.getLastRec();
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0725?SCREEN=100&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
      }
  %> 
 </TD>
 </TR>
