...
<html>
<head>
<title>Customer Profitability</title>
...
<h3 align="center">Profitability by Customers at <% if (profit.getE01SELMTH().equals("Y")) out.print(" Current Year");%> 
  <% if (profit.getE01SELMTH().equals("M")) out.print(" Last Month");%> <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cif_profit.jsp,ECP001"></h3>
<hr size="4">
      ...
      <td nowrap height="36"> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap height="31" bordercolor="#000000"> 
              <div align="center"><b>Averages</b></div>
            </td>
            <td nowrap height="31" bordercolor="#000000"> 
              <div align="center"><b>Interest</b></div>
            </td>
            <td nowrap height="31" bordercolor="#000000"> 
              <div align="center"><b>Cost / <br>
                Yield</b></div>
            </td>
            <td nowrap height="31" bordercolor="#000000"> 
              <div align="center"><b>Net <br>
                Profit</b></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="28%" bordercolor="#000000" height="31"> 
              <div align="right">Investments (Terms) :</div>
            </td>
          ...
          <tr id="trdark"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Commercial Loans :</div>
            </td>
          ...
          <tr id="trclear"> 
            <td nowrap width="28%" bordercolor="#000000" height="35"> 
              <div align="right">Acceptances Discounted : </div>
            </td>
          ...
          <tr id="trclear"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right"> Installment Loans :</div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Investments (24 Hours) : </div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Demand Deposit Accounts :</div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Interest Bearing Accounts :</div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Investments (Term) :</div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Time Deposits :</div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Investment (24 Hours) :</div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Net Revenue From Funds:</div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Fee Income :</div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
          ...
          <tr id="trdark"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right">Operational Cost :</div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"></div>
            </td>
          ...
          <tr id="trclear"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right"><b>Net Customer Profit / Loss :</b></div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"></div>
            </td>
          ...
          <tr id="trdark"> 
            <td nowrap width="28%" bordercolor="#000000"> 
              <div align="right"><b>Profitability :</b></div>
            </td>
            <td nowrap width="26%" height="22" bordercolor="#000000" > 
              <div align="center"></div>
            </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="33%"> 
        <div align="center"> <% if( profit.getE01SELMTH().trim().equals("M")) {%> 
          <input id="EIBSBTN_LARGE" type=button name="Button" value="Show Current Year" onClick="javascript:previousYear()">
          <%}%> <% if( profit.getE01SELMTH().trim().equals("Y")) {%> 
          <input id="EIBSBTN_LARGE" type=button name="Button2" value="Show Last Month" onClick="javascript:previousMonth()">
          <%}%> </div>
      </td>
      <td width="33%">
        <div align="center">
          <input id="EIBSBTN" type=button name="Button22" value="Services Fee" onClick="javascript:showServices('<%= profit.getE01CUSNUM()%>')">
        </div>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
