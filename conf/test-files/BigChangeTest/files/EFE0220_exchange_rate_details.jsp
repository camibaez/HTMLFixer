...
<H3 align="center">Exchange Rate Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="exchange_rate_details.jsp, EFE0220"></H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEFE0220" >
  <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="600">
  <INPUT TYPE=HIDDEN NAME="H01FLGWK1" value="<%= rates.getH01FLGWK1()%>">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap height="19">
              <div align="left">
                <input type="text" name="E01RATCLM" maxlength="11" size="12" value="<%= rates.getE01RATCLM().trim()%>" >
              </div>
            </td>
            <td nowrap height="19">
            </td>
