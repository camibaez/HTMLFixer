...
function getQuote(code, paysecu) {
...
function getParams(code,paysecu) {   

	document.forms[0].CODE.value = code;
	document.forms[0].PAYSECU.value = paysecu;

//function getParams(code,paysecu, date1,date2,date3) {   
...
src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cp_sel_payment.jsp, EDL0106"></h3>
<hr size="4">
