...
function CheckNum(){
	if (document.forms[0].E01PRICUN.value.length < 1){
		alert("Customer number not valid");
...
<h3 align="center">Debit Card Assignment<br><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="assign_accounts.jsp, ECC0090">
</h3>
<hr size="4">
