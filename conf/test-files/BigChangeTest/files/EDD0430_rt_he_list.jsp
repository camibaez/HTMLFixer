...
<body> 
<!--
<h3 align="center">Overdraft Protection<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="tr_he_list.jsp,EDD0430"></h3>
<hr>
-->
 ...
 <TR > 
  ...
  <TABLE id="headTable1" >
	  ...
	  <TH ALIGN=CENTER NOWRAP>Original Amount</TH>
