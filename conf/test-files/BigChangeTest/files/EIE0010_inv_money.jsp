...
<H3 align="center">Money Launder Parameters<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="inv_money, EIE0010"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%"> 
              <div align="center"> 
                <input type="text" name="E06LDMPPN" size="5" maxlength="5" value="<%=cdMoney.getE06LDMPPN().trim()%>" onKeyPress="enterInteger()">
              </div>
            </td>
            <td nowrap width="26%"> 
              <div align="center"> 
                <input type="text" name="E06LDMPPC" size="7" maxlength="5" value="<%=cdMoney.getE06LDMPPC().trim()%>" onKeyPress="enterDecimal()">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="19%"> 
              <div align="center"> 
                <input type="text" name="E06LDMPSN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMPSN().trim()%>" onKeyPress="enterInteger()">
              </div>
            </td>
            <td nowrap width="26%"> 
              <div align="center"> 
                <input type="text" name="E06LDMPSC" size="7" maxlength="5" value="<%= cdMoney.getE06LDMPSC().trim()%>" onKeyPress="enterDecimal()">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="19%" height="23"> 
              <div align="center"> 
                <input type="text" name="E06LDMPIN" size="5" maxlength="5" value="<%= cdMoney.getE06LDMPIN().trim()%>" onKeyPress="enterInteger()">
              </div>
            </td>
            <td nowrap width="26%" height="23"> 
              <div align="center"> 
                <input type="text" name="E06LDMPIC" size="7" maxlength="5" value="<%= cdMoney.getE06LDMPIC().trim()%>" onKeyPress="enterDecimal()">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="19%" height="19"> 
              <div align="center"> 
                <input type="text" name="E06LDMPON" size="5" maxlength="5" value="<%= cdMoney.getE06LDMPON().trim()%>" onKeyPress="enterInteger()">
              </div>
            </td>
            <td nowrap width="26%" height="19"> 
              <div align="center"> 
                <input type="text" name="E06LDMPOC" size="7" maxlength="5" value="<%= cdMoney.getE06LDMPOC().trim()%>" onKeyPress="enterDecimal()">
              </div>
            </td>
          </tr>
