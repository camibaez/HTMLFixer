...
<h3 align="center">BP Parameters<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center">There are no parameters.</h4> 
      </div>
      </TD></TR>
   	</TABLE>
<%
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable" width=100%>
  	<TR id=trdark>
		...
		<td NOWRAP align="center" width="65%" colspan="5"><B>ACCOUNTING INFO</B></td>
		
	</TR>
    
    <TR id=trdark>
		<td NOWRAP align="center" width="5%"><b>Delete</b></td>
		<td NOWRAP align="center" width="5%"><b>Bank</b></td>
		<td NOWRAP align="center" width="15%"><b>Maximum Amount<BR>for Automatic<BR>Bill Approval<BR></b></td>
		<td NOWRAP align="center" width="10%"><b>Advanced Days<BR>for Payment<BR>Generation</B></td>
		<td NOWRAP align="center" width="5%"><b>Tr.<BR>Code</b></td>
		<td NOWRAP align="center" width="5%"><b>Batch</b></td>
		<td NOWRAP align="center" width="20%" colspan=2><b>Withholding</b></td>
		<td NOWRAP align="center" width="35%"><b>GL Accounts<BR>for Payment Via</b></td>
    ...
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="10%">GL Account</td>
		<td NOWRAP align="center" width="10%">Percentage</td>
		...
		<td NOWRAP align="center" width="10%" valign="top">
		<INPUT type="text" name="E01BPAGLW_<%= EBP0180List.getCurrentRow() %>" value="<%= msgList.getE01BPAGLW() %>" size="13" maxlength="12"
 				onkeypress="enterInteger()"	<%= read %>>
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25">
       <%
    	if ( EBP0180List.getShowPrev() ) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.bpa.JSEBP0180?SCREEN=1&FromRecord=" + pos + "\" > <img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
    	} %>
      </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> 
    	...
    	if (EBP0180List.getShowNext()) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.bpa.JSEBP0180?SCREEN=1&FromRecord=" + pos +  "\" ><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
	    } %>
  </TD>
 </TR>
 </TABLE>
