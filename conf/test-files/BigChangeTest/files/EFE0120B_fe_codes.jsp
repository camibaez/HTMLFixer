...
%>
<h3 align="center">Back Office Special Codes <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fe_codes.jsp,EFE0120B" width="35" ></h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="70%">
              ...
              <a href="javascript:GetCodeDescCNOFC('E02OFC','D02OFC','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"></a> </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="30%" >
            ...
            <td nowrap width="70%">
              ...
              <a href="javascript:GetCodeDescCNOFC('E02OF2','D02OF2','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a> </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="3%">
            ...
            <td nowrap width="70%">
              ...
              <a href="javascript:GetCodeDescCNOFC('E02GEC','D02GEC','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a> </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="3%">
            ...
            <td nowrap width="70%">
              ...
              <a href="javascript:GetCodeDescCNOFC('E02GRC','D02GRC','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a> </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="30%">
            ...
            <td nowrap width="70%">
              ...
              <a href="javascript:GetCodeDescCNOFC('E02INC','D02INC','09')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a> </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="30%">
            ...
            <td nowrap width="70%">
              ...
              <a href="javascript:GetCodeDescCNOFC('E02BUC','E02BUC','12')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="30%">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="70%">
              ...
              <input type="text" name="D02UC4" size="40" maxlength="35" value="<%= lnCodes.getD02UC4().trim()%>" >
