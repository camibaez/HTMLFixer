...
<body nowrap onLoad="MM_preloadImages('<%=request.getContextPath()%>/images/e/New_over.gif','<%=request.getContextPath()%>/images/e/approve_over.gif','<%=request.getContextPath()%>/images/e/reject_over.gif','<%=request.getContextPath()%>/images/e/delete_over.gif')">
<% 
...
%> 
<h3 align="center">Swift Free Formats <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="swf_Free_List.jsp,ESWF00001"> 
</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSESWF010" >
  ...
  %>
	  <table class="tbenter" width="13%" height="59">
	    <tr>
		  <TD ALIGN=CENTER class=TDBKG>
		    <div align=center>
		  	  <a href="javascript:goAction(1)"><b>New</b></a>
		  	</div>
		  </TD>
            <TD ALIGN=CENTER class=TDBKG> <div align=center> <a href="javascript:goAction(6)"><b>Copy</b></a> </div> 
		  <TD ALIGN=CENTER class=TDBKG>
		    <div align=center>
	  ...
	  <TABLE class="tbenter" width=100%  height=75%>
   		<TR>
        <TD> 
        <div align="center"> <b>There are no results for your search criteria</b> 
        </div>
      </TD></TR>
   		</TABLE>
  <%   		
  ...
  <table class="tbenter" width="13%" height="59">
    <tr> 
      <TD ALIGN=CENTER class=TDBKG> <div align=center> <a href="javascript:goAction(1)"><b>New</b></a> </div> 
      </TD>
      <TD ALIGN=CENTER class=TDBKG> <div align=center> <a href="javascript:goAction(2)"><b>Maintenance</b></a> </div> 
      </TD>
      <TD ALIGN=CENTER class=TDBKG> <div align=center> <a href="javascript:goAction(6)"><b>Copy</b></a> </div> 
      </TD>
      <TD ALIGN=CENTER class=TDBKG> <div align=center> <a href="javascript:goAction(8)"><b>Logs</b></a> </div> 
      </TD>
      <TD ALIGN=CENTER class=TDBKG> <div align=center> <a href="javascript:goAction(3)"><b>Inquiry</b></a> </div> 
      </TD>
      <TD ALIGN=CENTER class=TDBKG> <div align=center> <a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Exit</b></a> </div> 
      </TD>
    </tr>
  </table>
  <h4></h4>
