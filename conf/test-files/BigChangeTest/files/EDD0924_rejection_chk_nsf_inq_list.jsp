...
<INPUT TYPE=HIDDEN NAME="ACTSTS" VALUE="0">
 <h4 style="text-align:center">Non-Sufficient Funds & Uncollected Items Inquiry -- Officer Code : <% if ( dataCR.getOfficer().trim().equals("")) {out.print("All");} else {out.print(dataCR.getOfficer());} %></h4>
...
%>
  ...
  %> 
     		<TR> 
                ...
                <input type="text" name="OPTION_<%= accList.getCurrentRow() %>" readonly value="<% if(accList.getRecord(17).equals("")) out.print("");
              				else if(accList.getRecord(17).equals("0002")) out.print("Return All");
              				else if(accList.getRecord(17).equals("0003")) out.print("Pay All");
              				else if(accList.getRecord(17).equals("0012")) out.print("Return All w/o Charges");
							else if(accList.getRecord(17).equals("0013")) out.print("Pay All w/o Charges");%>" size="24">
                ...
                <input type="HIDDEN" name="CURACC_<%= accList.getCurrentRow() %>" value="<%= accList.getRecord(0) %>">
      			...
      			<TD ALIGN=RIGHT NOWRAP><DIV NOWRAP><a href="javascript:radioClick('RECNUM',<%= accList.getCurrentRow() %>)"><%= datapro.eibs.master.Util.fcolorCCY(accList.getRecord(3)) %></a></DIV></TD>
      			...
      			<TD ALIGN=CENTER NOWRAP><DIV NOWRAP><a href="javascript:radioClick('RECNUM',<%= accList.getCurrentRow() %>)"><% if (accList.getRecord(8).equals("001")) out.print("NSF"); else if (accList.getRecord(8).equals("002")) out.print("UNC"); %></a></DIV></TD>
     		</TR>
  <% 
                    }
                }
  ...
  %> 
     		<TR> 
              ...
              <TD ALIGN=Left NOWRAP>
                ...
                <input type="text" name="OPTION_<%=j%><%=k%>" readonly value="<% if(chkList.getRecord(17).equals("")) out.print("");
              				else if(chkList.getRecord(17).equals("0002")) out.print("Return");
              				else if(chkList.getRecord(17).equals("0003")) out.print("Pay");
              				else if(chkList.getRecord(17).equals("0004")) out.print("Change");
              				else if(chkList.getRecord(17).equals("0012")) out.print("Return w/o Charges");
							else if(chkList.getRecord(17).equals("0013")) out.print("Pay w/o Charges");%>" size="20">
				...
				<img name="IMGREM<%=j%><%=k%>" src="<%=request.getContextPath()%>/images/e/info.gif" alt="More Information" align="absmiddle" border="0" onclick="ShowComments(<%=j%>,<%=k%>)"
				 <% if (chkList.getRecord(22) == null || chkList.getRecord(22).trim().equals("")) out.print("style=\"display:none;\""); %>>
				</DIV>
			  </TD>
      			<TD ALIGN=CENTER NOWRAP><div nowrap><a href="javascript:radioClick('RECNUM<%=j%>',<%= k %>)"><%= chkList.getRecord(2) %></a></DIV></TD>
      			<TD ALIGN=RIGHT NOWRAP><div nowrap><a href="javascript:radioClick('RECNUM<%=j%>',<%= k %>)"><%= datapro.eibs.master.Util.fcolorCCY(chkList.getRecord(3)) %></a></DIV></TD>      
      			<TD ALIGN=CENTER NOWRAP><div nowrap><a href="javascript:radioClick('RECNUM<%=j%>',<%= k %>)">
				...
				%></a></DIV></TD>
      			<TD ALIGN=CENTER NOWRAP><div nowrap><a href="javascript:radioClick('RECNUM<%=j%>',<%= k %>)"><%= chkList.getRecord(5) %></a></DIV></TD>
      			<TD ALIGN=LEFT NOWRAP><div nowrap><a href="javascript:radioClick('RECNUM<%=j%>',<%= k %>)"><%= chkList.getRecord(6) %></a></DIV></TD>
      			<TD ALIGN=CENTER NOWRAP><div nowrap><a href="javascript:radioClick('RECNUM<%=j%>',<%= k %>)"><% if (chkList.getRecord(7).equals("1")) { out.print("Incleaning");}
