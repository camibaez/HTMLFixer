...
<body>
<h3 align="center">Debit Card Assignment<BR>Additional Card Replacement<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_replace2.jsp, ECC0090"></h3>
<hr size="4">
<% 
		...
		<TR>
			...
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0"
				...
				<TBODY>
					...
					<TR id="trclear">
						<TD nowrap width="16%">
							<DIV align="right"><B>New Card Number:</B></DIV>
						</TD>
						<TD nowrap width="20%">
							<DIV align="left">
