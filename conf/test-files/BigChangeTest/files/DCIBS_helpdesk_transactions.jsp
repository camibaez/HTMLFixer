...
%>
<H3 align="center">DCIBS Entity Transaction Inquiry <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="DCIBS_helpdesk_users.jsp, DCIBS"></H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/com.datapro.eibs.internet.JSTransfersList" >
          ...
          <tr id="trclear">
            ...
            <td nowrap colspan="3" width="70%">
            	...
            	<SELECT NAME="TYPE">
		          ...
		          <option value="5">External Transfer ( USA )</option>
		          <option value="6">External Transfer ( International )</option>
       			 </SELECT>
              	</div>
            </td>          
          </tr>
