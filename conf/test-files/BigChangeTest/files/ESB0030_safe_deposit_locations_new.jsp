<html>
<head>
<title>Safe Deposit Locations New</title>
...
<H3 align="center">Safe Deposit Box Locations New<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_locations_new, ESB0030"></H3>
<hr size="4">
				...
				<TBODY>
					<TR id="trdark">
						...
						<TD nowrap width="60%"><INPUT type="text" name="E01LOCLOC"
							size="4" maxlength="3" value="<%= userPO.getHeader1() %>"
							readonly></TD>
					</TR>
					<TR id="trclear">
						<TD>
