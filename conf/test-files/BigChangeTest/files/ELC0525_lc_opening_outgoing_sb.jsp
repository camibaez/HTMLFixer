...
<BODY>
<H3 align="center">Import Stand By Letter Of Credit Approval Inquiry [Basic Information]
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"	name="EIBS_GIF" alt="lc_opening_outgoing_sb.jsp, ELC0525"></H3>
<HR size="4">

<FORM method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0525">
<INPUT NAME="SCREEN" TYPE=HIDDEN VALUE="4002" readonly="readonly">
<INPUT NAME="MSG" TYPE=HIDDEN VALUE="ELC040001" readonly="readonly">
<INPUT NAME="E01LCMATY" TYPE=HIDDEN VALUE="<%=msg.getE01LCMATY().trim()%>" readonly="readonly">
  ...
  <TR id="">
    ...
    <TD align="left"><INPUT name="E01LCMAP5" type="text"
      ...
      <INPUT
							...
							value="<%=msg.getE01LCMAP7()%>" size="4" maxlength="4" readonly="readonly">
       </TD>
  </TR>
</TABLE>
<BR>
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF3" disabled>
        ...
        <INPUT name="E01LCMBAC" type="text" value="<%=msg.getE01LCMBAC()%>" size="12" maxlength="12" readonly="readonly">
         </TD>
  </TR>
  <TR id="">
    <TD width="35%" align="right"> Name :</TD>
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT name="E01LCMCBC" type="text" value="<%=msg.getE01LCMCBC()%>" size="12" maxlength="12" readonly="readonly">
      </TD>
  </TR>
  <TR id="">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT name="E01LCMCA5" type="text" value="<%=msg.getE01LCMCA5()%>" size="2" maxlength="2" readonly="readonly">
      ...
      Country :
      <INPUT name="E01LCMCA7" type="text" value="<%=msg.getE01LCMCA7()%>" size="3" maxlength="7" readonly="readonly">
      </TD>
  </TR>
</TABLE>
<BR>
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD  align="left" nowrap><INPUT name="E01LCMRBA" type="text" value="<%=msg.getE01LCMRBA()%>" size="12" maxlength="12" readonly="readonly">
          </TD>
  </TR>
  <TR id="">
...
<TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF4" disabled>
        <OPTION value=""></OPTION>
        <OPTION value="C" <%if (msg.getE01LCMAF4().equals("C")) out.print("selected");%>>CIF</OPTION>
        <OPTION value="A" <%if (msg.getE01LCMAF4().equals("A")) out.print("selected");%>>DDA</OPTION>
      </SELECT>
        <INPUT name="E01LCMABA" type="text" value="<%=msg.getE01LCMABA()%>" size="12" maxlength="12" readonly="readonly">
         </TD>
  </TR>
  <TR id="">
    <TD width="35%" align="right" nowrap>Swift Code :</TD>
    <TD align="left" nowrap><INPUT name="E01LCMABI" type="text" value="<%=msg.getE01LCMABI()%>" size="12" maxlength="12" readonly="readonly">
       </TD>
  </TR>
  <TR id="">
    <TD align="right" nowrap>Name :</TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB1" type="text" value="<%=msg.getE01LCMAB1()%>" size="45" maxlength="35" readonly="readonly">
        <IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" border="0"></TD>
  </TR>
  <TR id="">
    <TD align="right" nowrap>Address :</TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB2" type="text" value="<%=msg.getE01LCMAB2()%>" size="45" maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD nowrap></TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB3" type="text" value="<%=msg.getE01LCMAB3()%>" size="45" maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD nowrap></TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB4" type="text" value="<%=msg.getE01LCMAB4()%>" size="45" maxlength="35" readonly="readonly">    </TD>
  </TR>
  <TR id="">
    <TD align="right" valign="bottom" nowrap>State :</TD>
    <TD align="left" nowrap><INPUT name="E01LCMAB5" type="text" value="<%=msg.getE01LCMAB5()%>" size="2" maxlength="2" readonly="readonly">
      Zip Code :
      <INPUT name="E01LCMAB6" type="text" value="<%=msg.getE01LCMAB6()%>" size="11" maxlength="10" readonly="readonly">
      Country :
      <INPUT name="E01LCMAB7" type="text" value="<%=msg.getE01LCMAB7()%>" size="4" maxlength="4" readonly="readonly">
      </TD>
  </TR>
</TABLE>
