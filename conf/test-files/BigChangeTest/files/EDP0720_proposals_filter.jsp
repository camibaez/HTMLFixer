...
<h3 align="center">Credit Proposal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="proposals_filter,EDP0720"></h3>
<hr size="4">
...
--%>      
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
            ...
            <A href="javascript:GetCodeDescCNOFCPC('E01FILEST','D01FILEST','37')">
            <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0">
        </td>                  
      </tr>
      ...
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
			           <input type="text" name="E01FILRUT" size="5" maxlength="4" readonly>
			              <a href="javascript:GetCodeDescCNOFCPC('E01FILRUT','','48')">
