...
<body>
 ...
 <h3 align="center">Maintenance Internet Personal User<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="client_personal_maint, ESS2000"></h3>
<hr size="4">
