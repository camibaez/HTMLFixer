...
function goSearch() {
  window.location.href="<%=request.getContextPath()%>/pages/e/EWD0050_helpfile_USFL1.jsp?codeflag=" + document.forms[0].codFlag.value + "&FromRecord=0&SelNew=" + document.forms[0].SelNew.value + "&SelOld=" + document.forms[0].SelOld.value; 
}
//-->
</script>
<STYLE>
...
<INPUT TYPE=HIDDEN NAME="codFlag" VALUE="">
		<%
				...
				int posIni = 0;
                 ...
                 try {
               	...
               	try
               	{
               		msgHelp = (EWD0050DSMessage)mc.getMessageRecord("EWD0050DS");
               	...
               	{
               	  e.printStackTrace();
               	  out.println("Send Special User Codes Help error " + e);
               	}
               	...
               	try
               	{
                	newmessage = mc.receiveMessage();
                 	rows = 1;
                 	if (newmessage.getFormatName().equals("EWD0050DS")) 
                 	{
                        msgHelp =  (EWD0050DSMessage)newmessage;
                        out.println("<h4>"+msgHelp.getEWDTDS().trim()+"</h4>");
			%>
			  <table id="TBHELP">
				<tr>
 			   ...
 			   <TR> 
  				...
  				<TABLE id="headTable" >
  				   <TR id="trdark">  
      					...
      					<TH ALIGN=CENTER NOWRAP>					
      						<a href="#" class="sortheader" onclick="ts_resortTable(this,'dataTable');return false;">Refer.<span class="sortarrow">&nbsp;&nbsp;&nbsp;</span></a>
      					</TH>
      					<TH ALIGN=CENTER NOWRAP>
                  	...
                  	while(true)
                  	{
                  		...
                  		if (newmessage.getFormatName().equals("EWD0050DS")) 
                  		{
                            ...
                            selOld = msgHelp.getEWDSHO().trim();
           					...
           					out.println("<td ALIGN=CENTER nowrap><noBR><A HREF=\"javascript:a('" + myCode + "')\">"  + myCode1 + "</a></noBR></td>");
	 ...
	 <TABLE  class="tbenter" WIDTH="88%" ALIGN=CENTER>
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25"> <%
        if ( posIni > 30 ) {
      			int pos = posIni - 31;
      			   out.print("<A HREF=\""+request.getContextPath()+"/pages/e/EWD0050_helpfile_USFL1.jsp?codeflag=" + codeflag + "&FromRecord=" + pos + "&SelNew=" + selNew + "&SelOld=" + selOld + "\" > <img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
        } %>
      </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT  height="25"> <%       
        if (marker.equals("+")) {
      			int pos = posEnd;
      			out.print("<A HREF=\""+request.getContextPath()+"/pages/e/EWD0050_helpfile_USFL1.jsp?codeflag=" + codeflag + "&FromRecord=" + pos + "&SelNew=" + selNew + "&SelOld=" + selOld + "\" ><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
