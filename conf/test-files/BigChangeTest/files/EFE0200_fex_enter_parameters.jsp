...
<H3 align="center">Foreign Currency Control Parameters<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fex_enter_parameters.jsp, EFE0200"></H3>
