...
<BODY>
<H3 align="center">Transfer
	Commission for Letter of Credit<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_commissi.jsp, ELC0510"></H3>
<HR size="4">
        ...
        <td nowrap><table cellspacing="0" cellpadding="2" width="100%" border="0">
            <tbody>
              <tr id="trdark0">
                ...
                <td nowrap width="16%"><div align="right"><b>Number of Letter of Credit:</b></div></td>
              ...
              <tr id="trclear0">
                ...
                <td nowrap width="16%"><div align="right"><b>Product Code:</b></div></td>
                <td nowrap width="16%"><div align="left"><b>
		...
		<tr>
			...
			<table border="0" cellspacing="0" width="100%">
					<tr id="trdark">
						...
						<td nowrap align="center" width="15%"><b>Beneficiary</b></td>
						<td nowrap align="center" width="26%"></td>
						<td nowrap align="center" width="12%"></td>
					</tr>
					<tr id="trclear">
						<td align="right">Transfer Commission:</td>
						...
						<td nowrap width="15%">
							<select name="E05LCTP01"  >
								<option value="A">First Beneficiary</option>
								<option value="B" <%if(msgLC.getE05LCTP01().equals("B")) out.print("selected");%>>Second Beneficiary</option>
								<option value="W" <%if(msgLC.getE05LCTP01().equals("W")) out.print("selected");%>>None</option>
							</select></td>
						<td nowrap width="26%"></td>
						<td nowrap width="12%"></td>
					</tr><tr id="trdark">
						<td align="right">Swift Commission:</td>
						<td nowrap width="17%" align="center">
						...
						<td nowrap width="15%">
							<select name="E05LCTP03">
								<option value="A">First Beneficiary</option>
								<option value="B" <%if(msgLC.getE05LCTP03().equals("B")) out.print("selected");%>>Second Beneficiary</option>
								<option value="W" <%if(msgLC.getE05LCTP03().equals("W")) out.print("selected");%>>None</option>
							</select></td>
						<td nowrap width="26%"></td>
						<td nowrap width="12%"></td>
					</tr>
