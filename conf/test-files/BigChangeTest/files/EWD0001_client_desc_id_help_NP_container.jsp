...
<frameset  rows="105,*" cols="*"> 
  <frame name="query" src="<%=request.getContextPath()%>/pages/e/EWD0001_client_desc_id_help_search_NP.jsp" marginwidth=0 marginheight=0 scrolling="auto" frameborder="0">
