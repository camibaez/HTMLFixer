...
<BODY>
<h3 align="center">Transaction Details<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="position_inquiry.jsp, EIE0300"></h3>
<hr size="4">
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trclear">
            <td nowrap width="14%">
              <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].CODE.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" alt="Help" border="0" >
                Instrument :</a> </div>
            </td>
            <td nowrap colspan="3">
