<html>
<head>
<title>Retail Account Products Inquiry</title>
...
<h3 align="center">Retail Account Product Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="products_inq_dda, ESD0711"></h3>
<hr size="4">
...
<form>
    ...
    <tr >
      <td >
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear">
            <td width="37%">
              <div align="right">Description Account: </div>
            </td>
            <td width="63%">
          ...
          <tr id="trdark">
            <td width="37%">
              <div align="right">Account Qualification: </div>
            </td>
            <td width="63%">
              ...
              <a href="javascript:showDDAServCharge('<%= ddaProdInq.getE03APCBNK().trim()%>','<%= ddaProdInq.getE03APCTYP().trim()%>','<%= ddaProdInq.getE03APCTAR().trim()%>');"><img src= "<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"></a>
            </td>
          </tr>
          <tr id="trclear">
            <td width="37%">
  ...
  <br><div align="center">
    <input id="EIBSBTN" type=button name="Submit" value="Close" onClik="top.close();">
  </div>
</form>
</body>
</html>
