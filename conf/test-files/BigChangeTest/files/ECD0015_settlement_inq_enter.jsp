...
function validate() {
	if (document.forms[0].SEL[0].checked == false &&
		...
		if (document.forms[0].SEL[0].checked == true) {
			...
			document.forms[0].E01CCRCCY.value = "";
...
<body>
<h3 align="center">Clearing Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="settlement_inq_enter.jsp, ECD0015"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<TD nowrap width="50%" colspan="2"> 
              <DIV align="left">
              	<SELECT name="E01CCRSTS" onclick="document.forms[0].SEL[2].click()">
					...
					<OPTION value="P" <% if (msgCD.getE01CCRSTS().equals("P")) { out.println("selected"); }%>>Pending</OPTION>
					<OPTION value="C" <% if (msgCD.getE01CCRSTS().equals("C")) { out.println("selected"); }%>>Matching</OPTION>
				</SELECT> 
			  </DIV>
			...
			<TD nowrap width="50%" colspan="2"> 
              <DIV align="left">
              	<SELECT name="E01CCRSTP" onclick="document.forms[0].SEL[3].click()">
					...
					<OPTION value="P" <% if (msgCD.getE01CCRSTP().equals("P")) { out.println("selected"); }%>>Pending</OPTION>
					<OPTION value="C" <% if (msgCD.getE01CCRSTP().equals("C")) { out.println("selected"); }%>>Cleared</OPTION>
					<OPTION value="A" <% if (msgCD.getE01CCRSTP().equals("A")) { out.println("selected"); }%>>Adjusted</OPTION>
				</SELECT> 
			  </DIV>
          ...
          <TR id="trclear"> 
			...
			<TD nowrap width="50%" colspan="2"> 
              <DIV align="left">
                <INPUT type="text" name="E01CCRCCY" size="4" maxlength="3" value="<%= msgCD.getE01CCRCCY() %>" onclick="document.forms[0].SEL[5].click()">
              	<a href="javascript:GetCurrency('E01CCRCCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0" onclick="document.forms[0].SEL[5].click()"></a> 
			  </DIV>
          ...
          <TR id="trdark">
            <TD nowrap width="25%"> 
              <DIV align="right">Trans. Date From :</DIV>
            </TD>
            <TD nowrap width="25%"> 
              <DIV align="left"> 
            ...
            <TD nowrap width="25%"> 
              <DIV align="right">Trans. Date To :</DIV>
            </TD>
            <TD nowrap width="25%"> 
              <DIV align="left"> 
