...
<h3 align="center"> Loans Interest Calculator<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_cal.jsp, EDL0290"></h3>
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="28%" >
              <input type="text" name="E01DEAACC" size="14" maxlength="9" value="<%= calcLoans.getE01DEAACC().trim()%>"  onkeypress="enterInteger()">
            ...
            <td nowrap colspan="2" >Customer Number :
              <input type="text" name="E01DEACUN" size="10" maxlength="9" value="<%= calcLoans.getE01DEACUN().trim()%>"  onkeypress="enterInteger()">
      ...
      <td nowrap >
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap  >
              <input type="text" name="E01DYSNME" readonly size="10" maxlength="9" value="<%= calcLoans.getE01DYSNME().trim()%>"  onkeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap >
