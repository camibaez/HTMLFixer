...
<H3 align="center">Loans Prepayment<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_ap_payment_det.jsp , EDL0140"> 
</H3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear">
		   <td nowrap colspan="2"> 
            ...
            <td nowrap colspan="3"> 
              <input type="text" readonly size="15" maxlength="15" name="E02PAGABO" value="<%= lnCancelDet.getE02PAGABO().trim()%>">
            </td>
           </tr>
          <tr id="trdark">
		   <td nowrap colspan="2"> 
            ...
            <td nowrap colspan="3"> 
              <input type="text" readonly size="15" maxlength="15" name="E02PAGERL" value="<%= lnCancelDet.getE02PAGERL().trim()%>">
            </td>
           </tr>
		 ...
		 %> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3"> 
              <input type="text"  readonly size="15" maxlength="15" name="E02NPYLCH" value="<%= lnCancelDet.getE02NPYLCH().trim()%>">
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            <td nowrap colspan="5" align=center><b>Payment Account</b></td>
          </tr>
