...
<% 		
	...
	} else if (userPO.getOption().equals("GL")) {
%>
...
<h3 align="center">MaintenanceHistory<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="db_change_list.jsp, ESS0240"></h3>
<hr size="4">
<FORM  >
...
<table class="tableinfo">
	  <tr > 
	    <td> 
	      <table cellspacing="0" cellpadding="2" width="100%" class="tbhead" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
	        <tr>   
	            <td nowrap width="15%" align="right"> General Ledger : </td>
        ...
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="30%"> 
              <div align="center">Field Description</div>
            </th>
