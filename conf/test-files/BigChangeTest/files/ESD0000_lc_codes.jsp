...
<SCRIPT Language="Javascript">
	...
	builtNewMenu(<%= ( userPO.getOption().equals("lc_maint") ? "lc_maint":"lc_opening" )%>);
...
%>
<h3 align="center">Letter Of Credit [Special Codes]<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_codes.jsp,ESD0000"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <TBODY><TR id="trdark"> 
            ...
            <TD nowrap width="20%"> 
              <DIV align="left"> 
                <INPUT type="text" name="E02ACC" size="14" maxlength="12" value="<%= lcCodes.getE02ACC().trim()%>" readonly>
              </DIV>
            </TD>
            <TD nowrap width="16%"> 
      ...
      <td nowrap height="43"> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" height="118">
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02OFC" size="5" maxlength="4" value="<%= lcCodes.getE02OFC().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%" height="37"> 
              <input type="text" name="E02OF2" size="5" maxlength="4" value="<%= lcCodes.getE02OF2().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02INC" size="5" maxlength="4" value="<%= lcCodes.getE02INC().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02BUC" size="5" maxlength="4" value="<%= lcCodes.getE02BUC().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02GEC" size="5" maxlength="4" value="<%= lcCodes.getE02GEC().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02GRC" size="5" maxlength="4" value="<%= lcCodes.getE02GRC().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02ORG" size="5" maxlength="4" value="<%= lcCodes.getE02ORG().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02DST" size="5" maxlength="4" value="<%= lcCodes.getE02DST().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02UC1" size="5" maxlength="4" value="<%= lcCodes.getE02UC1().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02UC2" size="5" maxlength="4" value="<%= lcCodes.getE02UC2().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02UC3" size="5" maxlength="4" value="<%= lcCodes.getE02UC3().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02UC4" size="5" maxlength="6" value="<%= lcCodes.getE02UC4().trim()%>">
