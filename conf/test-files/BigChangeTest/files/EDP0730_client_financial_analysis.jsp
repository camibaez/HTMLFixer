...
function goConfirm(opt) {
    ...
    if (confirm("Confirm create/modify this record")) {
...
<h3 align="center">Quantitative Aspects - Financial Indicators</h3>
<hr size="4">
 ...
 <TR > 
  <TD NOWRAP >
   <TABLE id="headTable" width="100%" cellpading=0 cellspacing=0>
    ...
    <tr id="trdark"> 
      <td align="right"  >
         <b>Period Financial Statement :</b>
      </td>
      <td nowrap > 
...
<TABLE  class="tableinfo"> 
	...
	<div align="center"> 		
       ...
       <input id="EIBSBTN" type="button" name="Submit" value="Submit" onclick="goConfirm('1')"> 
	    <% }; %> 
