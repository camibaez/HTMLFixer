...
<h3 align="center">ACH Entry Classes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
...
<TABLE class="tbenter"> 
	<TR>
		<TD align="CENTER" class="TDBKG" width="33%"><a href="javascript:goNew()"><b>New<br>Entry Class</b></a>
      	</TD>
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center"> There are no Entry Classes.</h4> 
      </div>
      </TD></TR>
   	</TABLE>
<%
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    ...
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="5%"><b>Entry <BR>
		Class</b></td>
		<td NOWRAP align="center" width="30%"><b>Description<BR> </b></td>
		<td NOWRAP align="center" width="10%"><b>Outgoing<BR>
		Approval<BR>Required </b></td>
		<td NOWRAP align="center" width="10%"><b> Incoming Debits<BR>
		Authorization<BR>Required </b></td>
		<td NOWRAP align="center" width="10%"><b>Addenda<BR> </b></td>
		<td NOWRAP align="center" width="10%"><b>Number of<BR> Addenda</b></td>
		<td NOWRAP align="center" width="10%"><b>Maximum Amout<BR>per Transaction</b></td>
		<td NOWRAP align="center" width="10%"><b>Default<BR> Company</b></td>
	</TR>
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="10%"><b><IMG src="<%=request.getContextPath()%>/images/Check.gif"
				alt="Mandatory Field" align="bottom"><B></B></b></td>
		...
		<TD nowrap align="center" width="10%" valign="top">
			<SELECT name="E01ACEADR_<%= EACH120List.getCurrentRow() %>" <%= disabled %>>
			  <OPTION <%= msgList.getE01ACEADR().trim().equals("0")?"Selected":""%> value="O">Optional</OPTION>
			  <OPTION <%= msgList.getE01ACEADR().trim().equals("M")?"Selected":""%> value="M">Mandatory</OPTION>
			</SELECT>
		</TD> 
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25">
       <%
    	if ( EACH120List.getShowPrev() ) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH120?SCREEN=1&FromRecord=" + pos + "\" > <img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
    	} %>
      </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> 
    	...
    	if (EACH120List.getShowNext()) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH120?SCREEN=1&FromRecord=" + pos +  "\" ><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
	    } %>
  </TD>
 </TR>
 </TABLE>
