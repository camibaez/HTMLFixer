...
%>
<h3 align="center">Instruments Quotes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel_instruments.jsp, EWD0308"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0060" >
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            <td nowrap width="14%" > 
              <div align="right">Instrument Code :</div>
            </td>
            <td nowrap width="9%" > 
 ...
 %> 
  <TABLE class="tbenter" width="100%" height="50%" >
    <tr>
      <TD > 
        <div align="center"> 
          <p><b>This instrument has no quotes defined at this time, please select 
        ...
        <table id="headTable" width="100%" >
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap > 
              <div align="center">Quote Date</div>
            </th>
            <th align=CENTER nowrap >Time</th>
            <th align=CENTER nowrap > 
              <div align="center">MID <BR>Price</div>
            </th>
			<th align=CENTER nowrap > 
              <div align="center">Prior Close <br>MID Price</div>
            </th>
			<th align=CENTER nowrap > 
              <div align="center">Prior Close <BR>
                Bid Price</div>
            </th>
			<th align=CENTER nowrap > 
              <div align="center">Prior Close <BR>
