...
<jsp:useBean id= "msgCD" class= "datapro.eibs.beans.ECD002901Message"  scope="session" />
...
<body>
<h3 align="center">Debit Card Renewal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_renewal_detail.jsp, ECD0029"></h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="16%"> 
              	<input type="text" name="E01CCRCID" size="16" maxlength="15" value="<%= userPO.getIdentifier().trim()%>" readonly>
            </td>
            <td nowrap width="16%"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" name="E01PRINA1" size="36" maxlength="35" value="<%= userPO.getCusName().trim()%>" readonly>
              </div>
            </td>
          </tr>    
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E01PRICUN" size="10" maxlength="10" value="<%= userPO.getCusNum().trim()%>" readonly>
			  </div>
            </td>
            <td nowrap width="16%" > 
			...
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
				<TBODY>
					<TR id="trdark">
						...
						<TD nowrap width="16%">
							<DIV align="left">
								<INPUT type="text" name="E02CCRBRN" size="4" maxlength="3" value="<%= userPO.getHeader3().trim()%>" readonly>
							</DIV>
						</TD>
					</TR>
					<TR id="trclear">
			...
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
				<TBODY>
					<TR id="trdark">
						...
						<TD nowrap width="16%">
							<DIV align="left">
								<INPUT type="text" name="E01CCRBRN" size="4" maxlength="3" value="" readonly>
								<a href="javascript:GetBranch('E01CCRBRN','')">
						...
						<TD nowrap width="20%">
							<DIV align="left">
								<INPUT type="text" name="E01CCRNEW" size="21" maxlength="20" value="" readonly>
						        <a href="javascript:GetPlastic3('E01CCRNEW','',document.forms[0].E01CCRBRN.value,'','2')">     
								<img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absbottom" border="0"  ></a>
							</DIV>
						</TD>
					</TR>
  ...
  <table class="tableinfo">
    <tr>
      ...
      while (accList.getNextRow()) {
      	ECD002902Message msgAcc = (ECD002902Message) accList.getRecord();
      %>
