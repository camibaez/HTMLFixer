...
<h3 align="center">Savings Account<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_tables_dda_04, ESD0205" ></h3>
<hr size="4">
        ...
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          ...
          <TR id="trdark"> 
            <TD nowrap width="22%" height="34"> 
              <DIV align="right">Mininum Balance Charge 2 :</DIV>
            </TD>
          ...
          <TR id="trclear"> 
            <TD nowrap width="22%"> 
              <DIV align="right">Charges for Extra Withdrawals :</DIV>
            </TD>
            <TD nowrap width="18%"> 
              <DIV align="left"> 
            ...
            <TD nowrap width="29%"> 
              <DIV align="right">Number of Free Withdrawals :</DIV>
            </TD>
            <TD nowrap width="31%"> 
              <DIV align="left"> 
          ...
          <TR id="trdark"> 
            <TD nowrap width="22%"> 
              <DIV align="right">Inactive Accounts Charges :</DIV>
            </TD>
            <TD nowrap width="18%"> 
              <DIV align="left"> 
          ...
          <TR id="trclear"> 
            <TD nowrap width="22%"> 
              <DIV align="right">Dormant Accounts Charges :</DIV>
            </TD>
            <TD nowrap width="18%"> 
              <DIV align="left"> 
          ...
          <TR id="trdark"> 
            <TD nowrap width="22%"> 
              <DIV align="right"> Non-Local Checks Max/Charges :</DIV>
            </TD>
            <TD nowrap width="18%"> 
              <DIV align="left"> 
          ...
          <TR id="trclear"> 
            <TD nowrap width="22%"> 
              <DIV align="right"> Non-Local Checks Min/Charges :</DIV>
            </TD>
            <TD nowrap width="18%"> 
              <DIV align="left"> 
            ...
            <TD nowrap width="31%"> 
              <DIV align="left"> 
                <INPUT type="text" name="E02RTEGPS" size="4" maxlength="3" value="<%= charges.getE02RTEGPS()%>">
                **</DIV>
            </TD>
          </TR>
          <TR id="trdark"> 
         ...
         <TR id="trclear"> 
          ...
          <TR id="trdark"> 
            <TD nowrap width="22%" height="33"> 
              <DIV align="right">Minimum Withdrawal Amount :</DIV>
            </TD>
            ...
            <TD nowrap width="29%" height="33"> 
              <DIV align="right">Minimum Opening Balance :</DIV>
            </TD>
          ...
          <TR id="trclear"> 
            ...
            <TD nowrap width="29%"> 
              <DIV align="right">Confirmation Limit Amount :</DIV>
            </TD>
            <TD nowrap width="31%"> 
              <DIV align="left"> 
          ...
          <TR id="trdark"> 
            <TD nowrap width="22%"> 
              <DIV align="right">Minimum Cancellation Days :</DIV>
            </TD>
            <TD nowrap width="18%"> 
              <DIV align="left"> 
            ...
            <TD nowrap width="29%"> 
              <DIV align="right">Months of History :</DIV>
            </TD>
            <TD nowrap width="31%"> 
              <DIV align="left"> 
            ...
            <TD nowrap width="18%"> 
              <DIV align="left"> 
                <SELECT name="E02RTEPSB">
                  ...
                  <OPTION value="Y" <%if (charges.getE02RTEPSB().equals("Y")) { out.print("selected"); }%>>Yes</OPTION>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          <tr id="trdark"> 
            ...
            <td nowrap width="17%"> 
              <div align="right">Interest Method : </div>
            </td>
            <td nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3"> 
              ...
              <select name="E02RTEFFL">
                ...
                <option value="A" <%if (charges.getE02RTEFFL().equals("A")) { out.print("selected"); }%>>Add to Base Rate 
                </option>
                <option value="S" <%if (charges.getE02RTEFFL().equals("S")) { out.print("selected"); }%>>Subtract from Base Rate 
                </option>
                <option value="M" <%if (charges.getE02RTEFFL().equals("M")) { out.print("selected"); }%>>Multiply by Base Rate 
                </option>
              </select>
            </td>
          </tr>
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          <tr id="trdark"> 
            <td nowrap colspan="2"> 
              <div align="right"> Overdraft Base Rate :</div>
            </td>
            <td nowrap width="9%"> 
              <div align="left"> 
            ...
            <td nowrap colspan="4"> 
              <div align="left"> 
                ...
                <select name="E02RTEFFA">
                  ...
                  <option value="S" <%if (charges.getE02RTEFFA().equals("S")) { out.print("selected"); }%>>Substract from Base Rate 
                  </option>
