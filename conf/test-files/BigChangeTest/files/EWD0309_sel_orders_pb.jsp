...
function goAction(op) {
	...
	if (op==3) {
	okdel = confirm("Are you sure you want delete this Ticket?");
    if ( okdel ) { 		 
...
<BODY>
<h3 align="center">Private Banking - Trade Tickets Selection<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel_orders_pb.jsp, EWD0309"></h3>
<hr size="4">

<div id="reason"
	style="position: absolute; top: 20px; left: 20px; visibility: hidden; width: 450px">
    ...
    <tr> 
      <td width="50%" align=LEFT> <%
        if ( EWD0309Help.getShowPrev() ) {
      			...
      			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.invest.JSEWD0309?SCREEN=1&Pos=" + pos +"\"><IMG border=\"0\" src=\""+request.getContextPath()+"/images/e/previous_records.gif\" ></A>");
        }
   %> </td>
      <td width="50%" align=RIGHT> <% 
        if ( EWD0309Help.getShowNext() ) {
      			int pos = EWD0309Help.getLastRec();
      			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.invest.JSEWD0309?SCREEN=1&Pos=" + pos +"\"><IMG border=\"0\" src=\""+request.getContextPath()+"/images/e/next_records.gif\" ></A>");
        }
  %> </td>
    </tr>
  </table>
