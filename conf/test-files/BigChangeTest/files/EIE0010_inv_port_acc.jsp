...
<h3 align="center">Cash Accounts<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="inv_port_acc, EIE0010"></h3>
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark">
            ...
            <td nowrap width="20%" >
              <div align="left">
                <input type="hidden" name="E01PCACUN" size="9" maxlength="9" value="<%= invAcc.getE01PCACUN().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%" >
              <div align="right"><b></b> </div>
            ...
            <td nowrap >
              <div align="left">
                <input type="hidden" name="E01CUSNA1" size="45" maxlength="45" value="<%= invAcc.getE01CUSNA1().trim()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trdark">
...
%>
		...
		<%--	  <a href="javascript:showRetAccountHolders(document.forms[0].E01PCAAC<%= name %>.value)"><img src="<%=request.getContextPath()%>/images/accountholder.gif" alt="click for account holders" align="absbottom" border="0" > </a> --%>
              ...
              <a href="javascript:GetAccount('E01PCAAC<%= name %>','','RA','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"></a>
              <% } else { %> <%-- <a href="javascript:showRetAccountInq(document.forms[0].E01PCAAC<%= name %>.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" alt="click for account inquiry" align="absbottom" border="0" > </a> --%>
        <%--      <a href="javascript:showRetAccountHolders(document.forms[0].E01PCAAC<%= name %>.value)"><img src="<%=request.getContextPath()%>/images/accountholder.gif" alt="click for account holders" align="absbottom" border="0" ></a>  --%>
