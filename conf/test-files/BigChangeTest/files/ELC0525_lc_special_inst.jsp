...
<SCRIPT LANGUAGE="javascript">
	...
	<% 
		...
		if (userPO.getOption().equals("5104")) {
			menu_option = "lc_apr_cc_maint";
		}
		if (userPO.getOption().equals("4004")) {
...
<BODY bgcolor="#FFFFFF">
<h3 align="center"><%= title %> Letter Of Credit Approval Inquiry [Special Instructions]
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="lc_special_inst.jsp, ELC0525"></h3>
<HR size="4">
<FORM>
<BR>
      ...
      <TD nowrap> 
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <TR id="trdark"> 
            ...
            <TD nowrap width="20%"> 
              <DIV align="left">
                <INPUT type="text" name="E05ACC" size="14" maxlength="12" value="<%= msgESD000005.getE05ACC().trim()%>" readonly>
              </DIV>
            </TD>
            <TD nowrap width="16%"> 
            ...
            <TD nowrap width="16%"> 
              <DIV align="left"><B>
                <INPUT type="text" name="E02PRO" size="4" maxlength="4" readonly value="<%= userPO.getProdCode() %>"><BR>
                </B> </DIV>
            </TD>
          </TR>
        </TABLE>
