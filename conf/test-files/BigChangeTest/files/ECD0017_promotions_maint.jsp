...
<body>
<h3 align="center">Promotions Control<BR>Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="promotions_maint.jsp, ECD0017"> 
</h3>
<hr size="4">
<% 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                ...
                <input type="text" name="E01CDPIN1" size="3" maxlength="2" value="<%= msgCD.getE01CDPINI().substring(3,5) %>">
                <input type="text" name="E01CDPIN2" size="3" maxlength="2" value="<%= msgCD.getE01CDPINI().substring(1,3) %>">
                <input type="text" name="E01CDPIN3" size="3" maxlength="2" value="<%= msgCD.getE01CDPINI().substring(0,1) %>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                ...
                <input type="text" name="E01CDPFI1" size="3" maxlength="2" value="<%= msgCD.getE01CDPFIN().substring(3,5) %>">
                <input type="text" name="E01CDPFI2" size="3" maxlength="2" value="<%= msgCD.getE01CDPFIN().substring(1,3) %>">
                <input type="text" name="E01CDPFI3" size="3" maxlength="2" value="<%= msgCD.getE01CDPFIN().substring(0,1) %>">
