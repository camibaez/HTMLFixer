...
function Options(Type) {
	if (Type == 'S') {
	document.forms[0].E01FESHEF.value='Y'
	divAddOpt.style.display = "";
	};
	else {
	document.forms[0].E01FESHEF.value='N'
	divAddOpt.style.display = "none";
	};
}

function hedgedNUM(){
var Number = trim(document.forms[0].E01FESHEM.value);
	...
	if (Number > 0){
		...
		document.forms[0].E01FESHEM.focus();
		return false;
	}
}
...
%>
<h3 align="center"> Foreign Exchange Forward <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_forward.jsp,EFE0120P">
</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEFE0120P" onsubmit="return(hedgedNUM());">
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark">
            ...
            <td nowrap colspan="2" width="139">
              <input type="text" name="E01FESEXR" size="11" maxlength="11" value="<%= fex.getE01FESEXR().trim()%>" >
          ...
          <tr id="trclear">
            ...
            <td nowrap align="right" width="86">Value Date :</td>
            <td nowrap colspan="2" width="139">
          ...
          <tr id="trdark">
	          ...
	          <td nowrap>
	              <input type="hidden" name="E01FESHEF" value="<%= fex.getE01FESHEF()%>">
    	          <input type="radio" name="CE01FESHEF" value="Y" onClick="javascript:Options('S')" <%if(fex.getE01FESHEF().equals("Y")) out.print("checked");%>> Yes
               	  <input type="radio" name="CE01FESHEF" value="N" onClick="javascript:Options('H')" <%if(fex.getE01FESHEF().equals("N")) out.print("checked");%>> No
              </td>
			  <td nowrap colspan="3">
			  	  <div id="divAddOpt" style="display:none">
			  	  	Deal Number : <input type="text" name="E01FESHEM" size="12" maxlength="9" onKeyPress="enterInteger()" value="<%= fex.getE01FESHEM() %>">
                  		<a href="javascript:GetAccount('E01FESHEM','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
                  </div>
          ...
          <tr id="trclear">
            <td nowrap height="23">
              <div align="right">Dealer :</div>
				...
				<td nowrap colspan="4" height="23"><%= fex.getE01FESDID().trim()%> -
				<%= fex.getD01FEGDSC().trim()%></td>
			</tr>
          <tr id="trdark">
            <td nowrap height="42">
              <div align="right">Payment Type :</div></td>
				<td nowrap colspan="4" height="42"><input type="hidden"
					name="E01FESTIN" value="<%= fex.getE01FESTIN()%>"> <input
					type="radio" name="CE01FESTIN" value="S"
					onClick="document.forms[0].E01FESTIN.value='S'"
					<%if(fex.getE01FESTIN().equals("S")) out.print("checked");%>>
				Standard <input type="radio" name="CE01FESTIN" value="C"
					onClick="document.forms[0].E01FESTIN.value='C'"
					<%if(fex.getE01FESTIN().equals("C")) out.print("checked");%>> CLS</td>
			</tr>
        </table></td>
    </tr>
  </table>
