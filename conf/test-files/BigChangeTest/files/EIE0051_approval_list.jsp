     ...
     for(var n=0;n<formLength;n++)
     {
      ...
      if ( ok ) {          
         document.forms[0].submit();
 		 ...
 		 alert("Select instrument before this operation");	   
      }
...
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  ...
  <h3 align="center">Instrument Approval<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="approval_list.jsp,EIE0051"> 
  </h3>
<hr size="4">
    ...
    <TD NOWRAP valign="top" width="100%" >
        <TABLE id="headTable" >
          <TR id="trdark"> 
			...
			<TH ALIGN=CENTER NOWRAP>Instrument <br> Type</TH>
