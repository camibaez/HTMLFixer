...
<body bgcolor="#FFFFFF">
<H3 align="center"> Treasury - Calculators<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fe_enter_new,EFE0120P"></H3>
