...
<h3 align="center">Beneficiaries<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="inv_port_bene, EIE0010"></h3>
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark">
            ...
            <td nowrap>
              <div align="left">
                <input type="text" name="E01DEACCY" size="35" maxlength="35" value="<%= userPO.getHeader1().trim()%>" readonly>
              </div>
            </td>
          </tr>
        </table>
