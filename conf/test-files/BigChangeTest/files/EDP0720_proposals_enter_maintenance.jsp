...
<H3 align="center">New Credit Proposal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="proposals_enter_maintenance.jsp, EDP0720">
</H3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0720" >
  ...
  <input type=HIDDEN name="E01DPPDXX" value="PROPOSAL OPENING"> 
<%--
    ...
    <tr > 
      <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td width="15%"> 
              <div align="right">Credit Object :</div>
            </td>
            <td width="30%">
	   				<input type="text" name="E01PLPCN2" size="5" maxlength="4" value="<%= msgRT.getE01PLPCN2().trim()%>" 
					<% if(userPO.getHeader16().equals("5")){out.print("readonly");}%>
	   				...
	   				<% if(!userPO.getHeader16().equals("5")) {%>
					<A href="javascript:GetCodeDescCNOFCPC('E01PLPCN2','E01PLPRE2','PD')">
            ...
            <td width="60%"> 
              Credit Destination :
					...
					<% if(userPO.getHeader16().equals("5")){out.print("readonly");}%>
	   				...
	   				<% if(!userPO.getHeader16().equals("5")) {%>
					<A href="javascript:GetCodeDescCNOFCPC('E01PLPCN3','E01PLPRE3','38')">
