...
<h3 align="center">Process Reports<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="report_demand.jsp, EDD0924"></h3>
<hr size="4">
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center"> There are no parameters to send.</h4> 
      </div>
      </TD></TR>
   	</TABLE>
<%
  ...
  <TABLE class="tableinfo" id="dataTable">
    ...
    <%
       ...
       %>        
          ...
          <TR id=trdark>
          <td NOWRAP align="center" ><b>Parameter</b></td>		  
		  <td NOWRAP align="center" ><b>Value</b></td>
          <td NOWRAP align="center" ><b>Comment</b></td>		  		  		  
		</TR>
