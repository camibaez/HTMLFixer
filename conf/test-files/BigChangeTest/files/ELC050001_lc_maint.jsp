...
<jsp:useBean id="lcABasic" class="datapro.eibs.beans.ELC050001Message"  scope="session" />
...
<jsp:directive.page import = "datapro.eibs.master.Util" />
<SCRIPT> document.write(myNavAid.div) </SCRIPT>
...
<form method="post">
  ...
  <table cellspacing="0" cellpadding="2" width="101%" border="1" bordercolor="#000000">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="27%" height="23">
              <div align="right">Instrucciones de Confirmacion:</div>
            </td>
          ...
          <tr id="trclear">
            ...
            <td nowrap height="19" width="18%">
              ...
              S&iacute;
              <input type="radio" name="E01LCMTRN" value="2"<%if (!client.getE02TRN().equals("1")) out.print("checked"); %>>
              No </td>
            <td nowrap width="27%" height="19">
...
if (lcABasic.getE01LCMAOB().equals("A")) out.print("APLICANTE");
          ...
          <tr id="trdark">
            ...
            <td nowrap width="27%" height="19">
              <p align="right">Retenci&oacute;n de Pago :</p>
            </td>
            <td nowrap width="30%" height="19">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="27%" height="36">
              <div align="right">Referencia Otro Banco :</div>
            </td>
  ...
  <table cellspacing="0" cellpadding="2" width="100%" border="1" bordercolor="#000000" height="26">
    <tr bordercolor="#FFFFFF">
      <td nowrap height="10">
