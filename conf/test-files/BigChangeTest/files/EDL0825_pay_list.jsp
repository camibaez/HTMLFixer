...
<h3 align="center">Payment Documents List<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="pay_list,EDL0825"></h3>
<hr size="4">  
  ...
  <table class="tableinfo" id="trdark">
    <tr id="trdark">
      ...
      <% if (request.getParameter("OPT").equals("LN")) { out.println("Account");}
        		 else { out.println("Acceptant");} %>
      </th>
    </tr>
    <tr id="trclear">
      <td align="center" nowrap width="50%">
       <% if (request.getParameter("OPT").equals("LN")) { out.print("<b>Number : </b>"+docList.getRecord(7));}
        		 else { out.print("<b>Identification : </b>"+docList.getRecord(1));} %>
      </td>
      
      <td align="center" nowrap width="50%">
       <% if (request.getParameter("OPT").equals("LN")) { out.println("<b>Customer : </b>"+docList.getRecord(9));}
        		 else { out.println("<b>Name : </b>"+docList.getRecord(2));} %>
      </td>
    </tr>   
  </table>
  <BR>
