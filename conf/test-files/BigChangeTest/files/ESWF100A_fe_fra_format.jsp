      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <input type="text" readonly  name="E01SWFSID" size="15" maxlength="12" value="<%= swift.getE01SWFSID()%>" 
			  >
            </td>
            <td nowrap > 
            ...
            <td nowrap > 
              <input type="text" readonly  name="E01SWFRID" size="15" maxlength="12" value="<%= swift.getE01SWFRID()%>" 
			  >
              <input type="text" readonly  name="E01SWFRNM" size="40" maxlength="35" value="<%= swift.getE01SWFRNM()%>" 
			  >
            </td>
          </tr>
        </table>
    ...
    <tr id="trdark" > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <select disabled  name="E01SWFOBO">
            ...
            <td nowrap width="22%" > 
              <div align="right"> <select disabled  name="E01SWFINO" >
          ...
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <select disabled  name="E01SWFORO">
            ...
            <td nowrap width="22%" > 
              <div align="right"> <select disabled  name="E01SWFBBO">
          ...
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <select disabled  name="E01SWFSCO">
            ...
            <td nowrap width="22%" > 
              <div align="right"> <select disabled  name="E01SWFBCO">
          ...
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <select disabled  name="E01SWFRBO">
