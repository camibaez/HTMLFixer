...
<H3 align="center">Stand By Letter Of Credit <%= (userPO.getPurpose().equals("NEW") ? "New" : "Maintenance") %> [Special Codes]
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sb_codes.jsp,ESD0000"></H3>
<HR size="4">
