...
function closeEnter(){
      document.getElementById("enterACC")enterACC.style.visibility="hidden";
...
function ShowEnterAcc(evt) {	 
     ...
     var x=event.clientX + document.body.scrollLeft - enterACC.clientWidth;
	 cancelBub(evt);
...
function ShowEnterPar(evt) {	 
     ...
     eval('enterPAR.style.pixelLeft=' + x);
...
<BODY>
 <FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXESD0711" >
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<TR>
	  <TD ALIGN=right nowrap>
          ...
          <input type="text" maxlength=9 size=11 name="accnum" onKeyPress="enterInteger()" value="<%= accnum %>">
      </TD>
      <TD ALIGN=Left nowrap>
	     <img name="Image1" border="0" src="<%=request.getContextPath()%>/images/e/apply_on.gif" onclick="javascript:goNewPAR()"> 
	  </TD>
   </TR>
 </TABLE>
</div>

<div id="enterPAR" style="position:absolute; visibility:hidden; left:25px; top:-50px; z-index:3; filter:progid:DXImageTransform.Microsoft.Fade(duration=1.0,overlap=1.0)" onclick="cancelBub()">
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	border-color: #0b23b5;
	border-style : solid solid solid solid;
	filter:progid:DXImageTransform.Microsoft.dropshadow(OffX=3, OffY=3, Color='gray', Positive='true');">
 ...
 %>
         ...
         <table cellspacing="0" cellpadding="2" width="100%" border="1">
           <tr>
             <td nowrap> 
               <table cellspacing="0" cellpadding="2" class="tbhead" width="100%" align="center">
						<tr><td align=left colspan=5 > <%=typeCode %>  - <%= title %> </td></tr>
                </table>
              </td>
            </tr>
         </table>
...
<SCRIPT language="JavaScript">
	 ...
	 if ( getMSIEVer() < 5.5 ) {
		document.getElementById("enterACC").style.filter="blendTrans(duration=1)"; 
	 }
     resizeDoc();
 	...
 	if (document.getElementById("eibsNew")) 
 		document.getElementById("eibsNew").onclick=ShowEnterAcc;
 		
 	document.getElementById("enterPAR").onclick=cancelBub;
 	if (document.getElementById("eibsParam")) 
 		document.getElementById("eibsParam").onclick=ShowEnterPar;
