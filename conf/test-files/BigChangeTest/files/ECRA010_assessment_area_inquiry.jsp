...
<H3 align="center">Assessment Area<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="assessment_area_inquiry, ECRA010"></H3>
<hr size="4">
	      ...
	      <td nowrap> 
	        <div align="right">Description : </div>
				...
				<div align="left"><input type="text" name="E01CRAADS" size="50"
					maxlength="50" value="<%= msgPart.getE01CRAADS() %>" readonly> <img
					src="<%=request.getContextPath()%>/images/Check.gif"
					alt="mandatory field" align="absbottom" border="0"></div>
				</td>
			</tr>
	        ...
	        <div align="right">Military Personnel Assessment Area : </div>
				...
				<div align="left">
					<INPUT type="checkbox" name="E01CRAMPF"	value="<%= msgPart.getE01CRAMPF()%>" 
						...
						onclick="getValue()" readonly disabled>
				</div>
				</td>
		</tr>
		 <TR>
