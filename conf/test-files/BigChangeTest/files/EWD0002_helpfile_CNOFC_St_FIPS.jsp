...
function goSearch() {
  window.location.href="<%=request.getContextPath()%>/pages/e/EWD0002_helpfile_CNOFC_St_FIPS.jsp?codeflag=" + document.forms[0].codFlag.value + "&FromRecord=0&SelNew=" + document.forms[0].SelNew.value + "&SelOld=" + document.forms[0].SelOld.value; 
}
//-->
</script>
<STYLE>
...
<INPUT TYPE=HIDDEN NAME="codFlag" VALUE="">
  				   ...
  				   <TR id="trdark">  
      					...
      					<TH ALIGN=CENTER NOWRAP>
  	 					...
  	 					<TH ALIGN=LEFT NOWRAP>
      						<a href="#" class="sortheader" onclick="ts_resortTable(this,'dataTable');return false;">FIPS Code<span class="sortarrow">&nbsp;&nbsp;&nbsp;</span></a>
      					</TH>
          			   </TR>
       			</TABLE>
			...
			<%               	
                  	...
                  	while(true)
                  	{
                  		...
                  		if (newmessage.getFormatName().equals("EWD0002DS")) 
                  		{
                            ...
                            myFIPS = msgHelp.getEWDF02().trim();
                            selOld = msgHelp.getEWDSHO().trim();
                             	
           					out.println("<tr><td nowrap><A HREF=\"javascript:a('" + myFIPS + "')\">" + myCode + "</a></td>");
           					out.println("<td nowrap><NOBR><A HREF=\"javascript:a('" + myFIPS +"', '" + myDesc + "')\">"  + myDesc + "</a></td>");
           					out.println("<td nowrap><NOBR><A HREF=\"javascript:a('" + myFIPS +"', '" + myDesc + "')\">"  + myFIPS + "</a></td></tr>");           					
    	       				rows++;
	 ...
	 <TABLE  class="tbenter" WIDTH="88%" ALIGN=CENTER>
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25"> <%
        if ( posIni > 30 ) {
      			int pos = posIni - 31;
      			   out.print("<A HREF=\""+request.getContextPath()+"/pages/e/EWD0002_helpfile_CNOFC_St_FIPS.jsp?codeflag=" + codeflag + "&FromRecord=" + pos + "&SelNew=" + selNew + "&SelOld=" + selOld + "\" > <img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
        } %>
      </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT  height="25"> <%       
        if (marker.equals("+")) {
      			int pos = posEnd;
      			out.print("<A HREF=\""+request.getContextPath()+"/pages/e/EWD0002_helpfile_CNOFC_St_FIPS.jsp?codeflag=" + codeflag + "&FromRecord=" + pos + "&SelNew=" + selNew + "&SelOld=" + selOld + "\" ><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
