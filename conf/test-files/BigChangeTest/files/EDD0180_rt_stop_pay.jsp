...
%> 
<h3 align="center">Stop Payments<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="rt_stop_pay.jsp , EDD0180"></h3>
<hr size="4">
...
%> 
      ...
      <TD> 
        <div align="center"> 
          ...
          <p>&nbsp;</p>
          <p><font size="3"><b>This account has no Stop Payments issued, please 
...
%>
  ...
  <table class="tbenter" width="100%">
    <tr> 
      ...
      <td align=CENTER> <a href="javascript:goAction(3)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','<%=request.getContextPath()%>/images/e/delete_over.gif',1)"><img name="Image3" border="0" src="<%=request.getContextPath()%>/images/e/delete.gif" ></a></td>
      <td align=CENTER><a href="javascript:goAction(4)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','<%=request.getContextPath()%>/images/e/print_over.gif',1)"><img name="Image4" border="0" src="<%=request.getContextPath()%>/images/e/print.gif" ></a></td>
 ...
 <TR> 
   <TD NOWRAP valign="top" width="100%" >
    ...
    <TR> 
      ...
      <TD ALIGN=CENTER NOWRAP><%= Util.formatDate(stop.getRecord(3),stop.getRecord(4),stop.getRecord(5)) %></TD>
