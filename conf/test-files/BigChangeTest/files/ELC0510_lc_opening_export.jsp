...
<BODY>
<H3 align="center">Export Commercial Letter Of Credit Maintenance [Basic Information]<IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" alt="lc_opening_export.jsp, ELC0510"></H3>
<HR size="4">
<FORM method="post"
...
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo" id="trclear">
  ...
  <TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
      ...
      <TR id="">
        ...
        <TD nowrap><SELECT name="E01LCMAF2">
            ...
            <INPUT type="text" name="E01LCMAPA" size="12"
							maxlength="12" value="<%=msgLC.getE01LCMAPA()%>">            <A href="javascript: GetCustomerDetailsLC('E01LCMAPA','E01LCMAP1','E01LCMAP2','E01LCMAP3','E01LCMAP4','E01LCMAP5','E01LCMAP6','E01LCMAP7','')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF2.selectedIndex = 1"
    ...
    <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
      <TR id="trdark">
        <TD colspan="2" align="center" valign="middle"><FONT size="medium"><B>Beneficary</B></FONT></TD>
      </TR>
      <TR id="">
        <TD width="35%" align="right">Customer or Account Number :</TD>
        <TD nowrap><SELECT name="E01LCMAF3">
            ...
            <A href="javascript: GetCustomerDetailsLC('E01LCMBAC','E01LCMBN1','E01LCMBN2','E01LCMBN3','E01LCMBN4','E01LCMBN5','E01LCMBN6','E01LCMBN7','')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF3.selectedIndex = 1"
			border="0"></A> Customer or <A
							href="javascript: GetAccByClient('E01LCMBAC','','RT','','E01LCMBN1')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help"
    ...
    <TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
      ...
      <TR id="">
        ...
        <TD nowrap><SELECT name="E01LCMAF1">
            ...
            <A href="javascript: GetCustomerDetailsLC('E01LCMIBA','E01LCMIB1','E01LCMIB2','E01LCMIB3','E01LCMIB4','E01LCMIB5','E01LCMIB6','E01LCMIB7','C')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF3.selectedIndex = 1"
			border="0"></A> Customer or <A href="javascript: GetAccByClient('E01LCMIBA','','RT','','E01LCMIB1')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF1.selectedIndex = 2" border="0"></A> Account</TD>
      </TR>
      <TR id="">
        ...
        <TD align="left" nowrap><INPUT type="text" name="E01LCMIBI" size="14" maxlength="12" value="<%=msgLC.getE01LCMIBI()%>">
          <A href="javascript:GetSwiftIdDesc('E01LCMIBI','','','')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help"  border="0"></A></TD>
      </TR>
      <TR id="">
        <TD align="right">Name :</TD>
    ...
    <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
      ...
      <TR id="">
        ...
        <TD align="left" nowrap><INPUT type="text" name="E01LCMCBC" size="12" maxlength="12" value="<%=msgLC.getE01LCMCBC()%>">
          <A href="javascript: GetCustomerDetailsLC('E01LCMCBC','E01LCMCA1','E01LCMCA2','E01LCMCA3','E01LCMCA4','E01LCMCA5','E01LCMCA6','E01LCMCA7','C')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></A></TD>
      </TR>
      <TR id="">
        ...
        <TD align="left"><INPUT type="text" name="E01LCMCAI" size="12" maxlength="12" value="<%=msgLC.getE01LCMCAI()%>">
          <A href="javascript:GetCorrespondentDescIdSwift('E01LCMCAI','','E01LCMCBC','1')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help"
						border="0"></A> </TD>
      </TR>
      <TR id="">
        <TD align="right"> Name :</TD>
    ...
    <TABLE width="100%" border="0" align="center" cellpadding="2"  cellspacing="0" class="tableinfo">
      ...
      <TR id="">
        ...
        <TD align="left" nowrap><INPUT name="E01LCMCOR" type="text" id="E01LCMCOR" value="<%=msgLC.getE01LCMCOR()%>" size="12" maxlength="12">
            <A href="javascript: GetCustomerDetailsLC('E01LCMCOR','E01LCMCB1','E01LCMCB2','E01LCMCB3','E01LCMCB4','E01LCMCB5','E01LCMCB6','E01LCMCB7','4')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></A> Line of Credit :
