...
<html>
<head>
<title>Credit Card Approval Inquiry</title>
...
<body>
<h3 align="center">Credit Card Approval Inquiry
 <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="cc_inq_app_card.jsp, ECC0010"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
			...
			<td nowrap width="30%">
  				<input type="text" id="CARD_NAME" name="E01CCMCNN" size="30" maxlength="26" value="<%= ccNew.getE01CCMCNN().trim()%>" readonly>
			</td>
			<td nowrap width="20%"><div align="right">Second Line Embossing :</div></td>
			<td nowrap width="30%">
  				<input type="text" name="E01CCMCNM" size="30" maxlength="26" value="<%= ccNew.getE01CCMCNM().trim()%>" readonly>
			</td>
          </tr>           
   			<tr id="trdark">
            <td nowrap width="25%"> 
