...
<%
	if ( ewd0001Help.getNoResult() ) {
		...
		if (userPO.getHeader1().equals("*")) {
			sMsg = "This User don't have allow see this Customer.";
		} else {
...
%>
  ...
  <TABLE class="tableinfo" align="center" style="width:'95%'">
    <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER  nowrap width="40%">Short Name</TH>
		<TH align="CENTER" nowrap width="15%">City</TH>
		<TH align="CENTER" nowrap width="15%">Country</TH>
