...
%> 
<h3 align="center">MT 210 Notice to Receive<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_sw_format.jsp, ESF210"> 
</h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap > 
              <div align="right">Transaction Reference Number 20 :</div>
            </td>
          ...
          <tr id="trclear"> 
            <td nowrap width="21%" > 
              <div align="right">Amount 32 B :</div>
            </td>
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap > 
              <div align="right">Intermediary 56 :</div>
            </td>
            <td nowrap > 
              <div align="right"> 
            ...
            <td nowrap > 
              <div align="right">Ordering Bank 52 :</div>
            </td>
            <td nowrap > 
