 ...
 function checkSelection(op) {
  ...
  var nWarn = 0;
     if (op == 'D' || op == 'R') {               
		   ...
		   if (nChk == 0) alert("Select an account before this operation ");
		   else if ( nChk == 2) alert("Select only one account to do this operation ");
		   else {
		   ...
		   if (nChk == 0) alert("Select an account before this operation ");
		   else if (nWarn > 0 && nChk > 1) alert("Accounts with Warnings must be approval one by one");
		   else {
		      var wFlg = "";
		      var oFlg = "";
		      if (clName.length > 0) {
...
<BODY>
<h3 align="center">Approvals<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="approval_list.jsp,ESD0140">
</h3>
<hr size="4">
...
<INPUT TYPE=HIDDEN NAME="OFAFL" VALUE="">
 ...
 <TR > 
  ...
  <TABLE class="tbenter">
    <TR> 
      <TD class="TDBKG" ALIGN=CENTER width="25%"><a href="javascript:checkSelection('A')" id="linkApproval">Approval<br>Selection</a></TD>
      <TD class="TDBKG" ALIGN=CENTER width="25%"><a href="javascript:checkSelection('R')" id="linkReject">Reject</a></TD>
      <TD class="TDBKG" ALIGN=CENTER width="25%"><a href="javascript:checkSelection('D')">Delete</a></TD>
