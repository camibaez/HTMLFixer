...
function goAction(op) {
	...
	CenterNamedWindow('','popup1',575,450,1);	
	document.forms[0].target = 'popup1';
...
<BODY>
<h3 align="center">Anti Money Launder - Exceptions Inquiry</h3>
<hr size="4">
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%"> 
              <div align="center">Exception Type</div>
            </th>
          </tr>
          <%
		 ...
		 %>
          <TR> 
            <TD NOWRAP  ALIGN=CENTER width="10%"> 
              <input type="radio" name="CURRCODE" value="<%= ELD010003Help.getCurrentRow() %>">
            </TD>
            <TD NOWRAP  ALIGN=CENTER width=\"10%\"><%= msgList.getE03LDEBDY() %></td>
            <TD NOWRAP  ALIGN=CENTER width=\"10%\"><%= msgList.getE03LDEBDM() %></td>
