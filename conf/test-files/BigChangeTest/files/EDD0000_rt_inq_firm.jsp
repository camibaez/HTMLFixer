...
<h3 align="center">Signers<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_firm.jsp, EDD0000"></h3>
<hr size="4">
          ...
          <tr id="trdark"> 
            ...
            <td width="23%" nowrap> 
              <input type="text" name="E<%= name %>4FL1" readonly value="<% if(rtFirm.getField("E" + name + "4FL1").getString().equals("1")) out.print("Individual");
              				else if(rtFirm.getField("E" + name + "4FL1").getString().equals("2")) out.print("Joint");
