...
%>
<H3 align="center">Fixed Assets Locations<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="locations_details.jsp, EDFIX050"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <input type="text" name="E01LOCLOC" size="5" maxlength="3"  value="<%= loc.getE01LOCLOC().trim()%>" >
            </td>
            <td nowrap width="16%" > 
