...
<BODY>
<h3 align="center">Official Checks Parameters<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="check_parameter_list.jsp, EOF0000"></h3>
<hr size="4">
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%">Format</th>
            <th align=CENTER nowrap width="10%"> 
              <div align="center">Description</div>
            </th>
            <th align=CENTER nowrap width="10%"> 
              <div align="center">General Ledger <br>Checks to be Printed</div>
            </th>
            <th align=CENTER nowrap width="10%"> 
              <div align="center">General Ledger<br> Printed Checks</div>
            </th>
