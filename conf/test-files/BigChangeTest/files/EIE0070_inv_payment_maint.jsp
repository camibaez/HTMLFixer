...
%>
<div align="center">
  <h3>Coupon Maintenance Payment Schedule <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_payment_maint.jsp,EIE0070">
  </h3>
</div>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0070" >
  ...
  <table  class="tableinfo">
    <tr id="trdark">
      <td nowrap width="29%" >
        <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].E01SCHIIC.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" alt="Help" border="0" >
          Instrument :</a></div>
      </td>
      <td nowrap width="71%" >
    ...
    <tr id="trclear">
      <td nowrap width="29%" >
        <div align="right"><a href="javascript:GetSymbolInfo(document.forms[0].D01ISISYM.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" alt="Help" border="0" >
          Symbol :</a></div>
      </td>
      <td nowrap width="71%" >
        <div align="left">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap colspan="3" width="82%">
             <input type="text" name="D01PAYDSC" size="15" maxlength="15" readonly value="<%= invTrade.getD01PAYDSC()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="18%" >
            ...
            <td nowrap colspan="3" width="82%" >
              ...
              Percentage <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  ></td>
          </tr>
          <tr id="trdark">
            <td nowrap width="18%" >
          ...
          <tr id="trclear">
            ...
            <td nowrap colspan="3" width="82%" >
            	...
            	<a href="javascript:DatePicker(document.forms[0].E01SCHDE1,document.forms[0].E01SCHDE2,document.forms[0].E01SCHDE3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"></a>
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="18%" >
  ...
  <table  class="tableinfo">
    <tr >
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <%if (invTrade.getD01ISIPTY().equals("EQT") || invTrade.getD01ISIPTY().equals("ACD")){%> <%}%>
          <tr id="trdark">
            <td nowrap width="18%" >
              <div align="right">Status :</div>
            </td>
            <td nowrap colspan="3" width="82%" >
              <input type="text" name="D01STSDSC" size="15" maxlength="15" readonly value="<%= invTrade.getD01STSDSC()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="18%" >
