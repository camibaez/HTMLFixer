...
<body>
<h3 align="center">Debit Card Assignment<BR>Primary Card Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="assign_accounts_det.jsp,ECC0090"></h3>
<hr size="4">
<% 
	...
	<TR>
      <TD> 
	      <div align="center"> <font size="3"><b> <FONT size="3"><B><FONT
			size="3"><B>Customer don't have related accounts </B></FONT></B></FONT></b></font></div>
      </TD>
     </TR>
   	</TABLE>
<%
