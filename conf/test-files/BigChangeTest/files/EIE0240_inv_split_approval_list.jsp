     ...
     for(var n=0;n<formLength;n++)
     {
      ...
      if ( ok ) {          
         document.forms[0].submit();
 		 ...
 		 alert("Select Split before this operation");	   
      }
...
<INPUT type=HIDDEN name="appcode" value="201">
  <h3 align="center">Split Approval<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="inv_split_approval_list.jsp,EIE0240"> 
  </h3>
<hr size="4">
    ...
    <TD NOWRAP valign="top" width="100%" >
        <TABLE id="headTable" >
          <TR id="trdark"> 
            ...
            <TH ALIGN=CENTER NOWRAP>Split <br> Number</TH>
            <TH ALIGN=CENTER NOWRAP>Instrument</TH>
            <TH ALIGN=CENTER NOWRAP>Description</TH>
            <TH ALIGN=CENTER NOWRAP>Record <br> Date</TH>
