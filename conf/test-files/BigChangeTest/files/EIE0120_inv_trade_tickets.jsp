...
%>
<div align="center"> 
  <h3>Trade Tickets Input<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_trade_tickets.jsp,EIE0120"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap width="17%" > 
             ...
             <%  
                String typtra = "Multiple  Sale";                 

                String tratyp = invTrade.getE01ORDTRN();
                if (invTrade.getE01ORDTRN().equals("1")) {
                	 typtra = "Purchase";
                	  }
                if (invTrade.getE01ORDTRN().equals("2")) { 
                	 typtra = "Sale" ;
                	 }
                if (invTrade.getE01ORDTRN().equals("3")) { 
                	 typtra = "Transfer In" ;
                	 }                	
                if (invTrade.getE01ORDTRN().equals("4")) { 
                	 typtra = "Transfer Out" ;
                	 }                	                 	  
                if (invTrade.getE01ORDTRN().equals("5")) {
                	 typtra = "Multiple Purchase";
                	 }                	 
                if (invTrade.getE01ORDTRN().equals("6")) { 
                	 typtra = "Multiple  Sale" ;
                	 }                
            %>
             <%= typtra %> </b><img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  >
             </div>
             </td>
