...
function ShowHelpCode(cboName, divName, dscName) {
	...
	if (v == '3') {
		...
		if (v == 'P') {
			...
			document.forms[0][dscName].value = 'Interest';
			document.forms[0][dscName].readOnly = true;
		} else if (v == 'L') {
			document.forms[0][dscName].value = 'Late Fees';
			document.forms[0][dscName].readOnly = true;
		} else {
			document.forms[0][dscName].readOnly = false;
		}
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0155" >
  ...
  <h3 align="center">Payment Details<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ln_crn_pay_det_new.jsp , EDL0155"> 
  </h3>
  <hr size="4">

<h4></h4>

 <input TYPE=HIDDEN name="E02DLPACC" value="<%= userPO.getIdentifier().trim()%>"> 
    ...
    <tr >      
      <td align=CENTER  nowrap >
          <select name="E02TYPE01" onChange="javascript:ShowHelpCode('E02TYPE01','HLPCODE1','E02DESC01')">
            ...
            <option value="L" >Late Charges</option>
            <option value="1" >Commissions</option>
            <option value="2" >Taxes</option>
            <option value="3" >Escrow/Deductions</option>
            <option value="4" >Sales Tax</option>
          </select>   
        </td>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="37%" height="18" >Pay Amount : <input type="text" name="E02TOAMNT" size="17" maxlength="16" value="0.00" ></td>
            <td nowrap width="4%" height="18" >&nbsp;</td>
            <td nowrap width="36%" height="18" > 
              <div align="left">Amount Paid :<input type="text" name="E02TOPAID" size="17" maxlength="16" value="0.00" ></div>
            </td>
          </tr>
        </table>
      </td>
