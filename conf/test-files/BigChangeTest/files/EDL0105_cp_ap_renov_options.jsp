...
%> 
<h3 align="center">Roll-Over Instructions <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cp_ap_renov_options,EDL0105"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text"  name="E08DEAACC" size="12" maxlength="9" value="<%= userPO.getIdentifier().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td>
        <table cellpadding=2 cellspacing=0 align=center width=100% bordercolor="#000000">
          <tr id="trdark"> 
            ...
            <td height="46" colspan="2" > Cancellation Option. Principal and Interest will be paid to a General Ledger Account<input type="hidden" name="E08DDDFLV" value="">. </td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
            <td colspan="2" >&nbsp;</td>
          ...
          <tr id="trdark"> 
            ...
            <td height="36" colspan="2" >Cancellation Option. Principal and Interest will be paid to a DDA Saving, NOW or MMK. </td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
            <td colspan="2" >&nbsp;</td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" > 
              <p>Interest will be paid in 
                ...
                to a<input type="hidden" name="E08HHHFLG" value=""> Account (Retail, Savings, etc.) , or to a
                Certificate. Principal will be cancelled at maturity to previous account.</p>
            </td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" > Interest will be paid in 
              ...
              to a General Ledger. Principal will be cancelled at maturity to previous account.</td>
          </tr>
          <tr id="trclear"> 
            <td width=39></td>
            <td colspan="2" >&nbsp;</td>
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" >Principal and Interest will be paid based on schedule of payments 
              	...
              	, and will be paid to a General Ledger, or to a Retail Account. </td>
          </tr>
        </table>
      </td>
    </tr>
