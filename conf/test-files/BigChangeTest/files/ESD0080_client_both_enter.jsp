...
<frameset  rows="250,*" cols="*" border=0> 
  <frame name="query" src="<%=request.getContextPath()%>/pages/e/ESD0080_client_both_enter_search.jsp" marginwidth=5 marginheight=10 scrolling="no" frameborder="0">
