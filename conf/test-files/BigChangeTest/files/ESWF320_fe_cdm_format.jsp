...
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSESWF0130M" >
            ...
            <tr > 
              <td nowrap> 
                <table cellpadding=2 cellspacing=0 width="100%" border="0">
                  ...
                  <tr id="trdark"> 
                    <td nowrap width="17%" > 
                      <div align="right">Type of Event 22 B :</div>
                    </td>
                    <td nowrap colspan="2" > 
                      <div align="left"></div>
            ...
            <tr > 
              <td nowrap> 
                <table cellpadding=2 cellspacing=0 width="100%" border="0">
                  ...
                  <tr id="trclear"> 
                    <td nowrap width="22%" > 
                      <div align="right">Party's A Role 17 R :</div>
                    </td>
                  ...
                  <tr id="trclear"> 
                    <td nowrap width="22%" > 
                      <div align="right">Interest Amount 34 E :</div>
                    </td>
                    <td nowrap width="32%" > 
                    ...
                    <td nowrap width="18%" > 
                      <div align="right">Maturity Date 30 P :</div>
                    </td>
                    <td nowrap width="28%"> 
                  ...
                  <tr id="trdark"> 
                    <td nowrap width="22%" > 
                      <div align="right">Interest Rate 37 G :</div>
                    </td>
                    <td nowrap width="32%" > 
                      <div align="left"> <%= swift.getE02SWFRTE()%> </div>
                    </td>
                    <td nowrap align="right" width="18%"> 
                      <div align="right">Next Interest Due Date 30 X :</div>
                    </td>
                    <td nowrap width="28%"> 
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap width="54%" > 
              <div align="left">New Sequence 15 C : <%= swift.getE02SWFSQC()%></div>
            </td>
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap width="54%" > 
              <div align="left">New Sequence 15 D :<%= swift.getE02SWFSQD()%></div>
            </td>
            <td nowrap width="46%" >&nbsp; </td>
          </tr>
          <tr id="trdark"> 
