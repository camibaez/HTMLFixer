...
<%
		...
		if (session == null || session.getAttribute("currUser") == null) {
			...
			Object menuSecurity = session.getAttribute("AccessSecurity");
			Object mainMenu = session.getAttribute("mainMenu");
			Object subMenu = session.getAttribute("subMenu");
      ...
      <table width="350" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr> 
          <td colspan="3" height="50"> 
            <div align="center"><font face="Tahoma, Arial, Garamond, Futura Lt BT, Futura XBlk BT, Futura Md BT, FuturaBlack BT" size="4" color="#000099"><b><font color="#0066CC" size="3">The 
              System is preparing the option for you.</font> </b></font></div>
          </td>
        </tr>
      </table>
