...
<html>
<head>
<title>Table Percentaje to Grant</title>
...
<h3 align="center">Table Percentaje to Grant
  ...
  <table  id=cfTable class="tableinfo">
    <tr > 
      <td NOWRAP valign="top" width="100%"> 
        ...
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="40%">Percentaje to Grant With Real Guarantee</th>
  ...
  <table  id=cfTable class="tableinfo">
    <tr > 
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="40%">Percentaje to Grant Without Real Guarantee</th>
            <th align=CENTER nowrap width="20%"> 
              <div align="center">Default</div>
            </th>
            <th align=CENTER nowrap width="20%"> 
