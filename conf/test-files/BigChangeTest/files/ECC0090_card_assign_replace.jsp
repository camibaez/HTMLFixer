...
<body>
<h3 align="center">Debit Card Assignment<BR>Primary Card Replacement<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_assign_replace.jsp, ECC0090"></h3>
<hr size="4">
<% 
