...
<h3 align="center">TELLER TRANSACTIONS<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="teller_transaction_100.jsp, EDD0330"></h3>
<hr size="4">
...
<p><input type=HIDDEN name="PAGE_NAME" value="EDD0330_teller_transaction_100.jsp"></p>
  ...
  <% 
  	...
  	if (msgData.getRecordCount() > 0) {
    	...
    	if (!msgData.getError().equals("000")) { 
	    	...
	    	data = "ACCOUNT TYPE: " + msgData.getDDAPTY().toString();			
	    	data = data + "\r"; //Line feed and Carriage return
	    	data = data + "CUSTOMER NAME: " + msgData.getDDACNM().toString();	
	    	data = data + "\r"; //Line feed and Carriage return						 						
	    	data = data + "PRINCIPAL BALANCE: " + msgData.getDDAPSG().toString() + Util.fmtCCY(msgData.getDDAPRI().toString());
	    	data = data + " " + msgData.getDDACCY().toString();
	    	data = data + "\r"; //Line feed and Carriage return						 						
	    	data = data + "GROSS BALANCE: " + msgData.getDDAGSG().toString() + Util.fmtCCY(msgData.getDDAGRS().toString());
	    	data = data + " " + msgData.getDDACCY().toString();
	    	data = data + "\r"; //Line feed and Carriage return						 						
