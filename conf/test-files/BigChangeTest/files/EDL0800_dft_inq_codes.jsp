...
%> 
<h3 align="center">Classification Codes <%= userPO.getHeader4().trim()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="dft_codes.jsp,EDL0800" ></h3> 
<hr size="4">
    ...
    <tr > 
      <td nowrap > 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap width="30%"> 
              <div align="right">Principal Officer :</div>
            </td>
            <td nowrap width="70%"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="30%"> 
              <div align="right">User Code 6 :</div>
            </td>
            <td nowrap width="70%"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="30%"> 
              <div align="right">User Code 7 :</div>
            </td>
            <td nowrap width="70%"> 
