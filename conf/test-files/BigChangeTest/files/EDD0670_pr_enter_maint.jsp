...
<h3 align="center">Payment Orders Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="pr_enter_maint.jsp,EDD0670"></h3>
<hr size="4">
    ...
    <tr id="trdark">
      ...
      <td nowrap align="center" width="60%">
        <div align="left">
          ...
          <a href="javascript:GetCustomerDescId('E01CUSNUM','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0" width="18" height="22" ></a></div>
      </td>
    </tr>
    <tr id="trclear">
      <td nowrap align="center" width="40%">
    ...
    <tr id="trdark">
      ...
      <td nowrap align="center" width="60%">
        <div align="left">
          ...
          <a href="javascript:GetCNTRLPRF('E01FEETYP','TMP')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a></div>
