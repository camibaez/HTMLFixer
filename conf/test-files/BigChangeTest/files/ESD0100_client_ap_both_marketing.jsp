...
<form>
  <h3 align="center">Marketing<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_ap_both_marketing, ESD0100" ></h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap wrap >
        <table cellpadding="3" cellspacing="0" width="100%" border="0" align="center">
          ...
          <tr id="trdark"> 
            <td nowrap width="48%"> 
              <div align="right">What kind of sites do you like to visit ? </div>
            </td>
            <td nowrap width="26%">&nbsp; </td>
            <td nowrap width="26%">&nbsp; </td>
          </tr>
