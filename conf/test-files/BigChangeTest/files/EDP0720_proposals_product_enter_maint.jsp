...
<h3 align="center">Product Detail<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="proposals_product_enter_maint.jsp,EDP0720"></h3>
			...
			<TR id="trclear">
			   ...
			   <TD width="15%" align="right">
				...
				<TD width="20%" align="left">  
				  Type: <INPUT type="text" name="E01PLTTYP" size="5" maxlength="4" value="" readonly value="<%= msgList.getE01PLTTYP().trim()%>">	  
	            </TD>		

				<td nowrap width="20%" align="left">
			          Route: <input type="text" name="E01PLTCN1" size="5" maxlength="4" readonly>
			              <a href="javascript:GetCodeDescCNOFCPC('E01PLTCN1','','48')">
