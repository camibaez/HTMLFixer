...
<H3 align="center">Clausulas<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="lc_clauses_help_list.jsp, EWP0010"></H3>
<HR size="4">
...
<TABLE  id="mainTable" class="tableinfo" border="0" cellspacing="0" cellpadding="2">
	<TR id="trdark">
		...
		<TH ALIGN=CENTER nowrap width="25%">Text</TH>						
		<TH ALIGN="left" nowrap width="50%">Description</TH>						
	</TR>
	<% 
		String s1, s2, s3;
        jbList.initRow(); 
