...
<h3 align="center">Line of Credits - Incidence<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cif_position.jsp,ECIF010"></h3>
<hr size="4">
  <form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEWD0324">
<% 
      ...
      <div align="center"> 
          ...
          <table class="tbenter" width="100%">
            <tr> 
              ...
              <td align=CENTER> <a href="<%=request.getContextPath()%>/pages/background.jsp" onClick="top.close()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image52','','<%=request.getContextPath()%>/images/e/exit_over.gif',1)"><img name="Image52" border="0" src="<%=request.getContextPath()%>/images/e/exit.gif" ></a></td>
            </tr>
          </table>
          <p>&nbsp; </p>
        </div>
  ...
  <center>
    <table class="tableinfo">
      <tr id="trclear"> 
        ...
        <th align=CENTER nowrap > 
          <div align="center">Tenor <br> From</div>
        </th>
		<th align=CENTER nowrap > 
          <div align="center">Tenor <br> To</div>
        </th>
        <th align=CENTER nowrap > 
          <div align="center">Percentage 
            </div>
        </th>
      </tr>
      <tr> <%
