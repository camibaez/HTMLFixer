...
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  <h3 align="center">Approve Internet New Users and Changes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="status_list.jsp,ESS2040"> 
  </h3>
<hr size="4">

 <TABLE class="tbenter">
    <TR> 
      <TD ALIGN=CENTER width="100%" class=TDBKG> <a href="javascript:goSubmit()">Continue</a> 
      </TD>
    </TR>
  </TABLE>
