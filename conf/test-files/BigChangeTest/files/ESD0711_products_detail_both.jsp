...
<%
	...
	// out.println("<tr><td colspan=5>" +  appCode + "&nbsp;" + typeCode + "&nbsp;" + "</td></tr>");
  	...
  	if ( displayTypes ) {
			...
			out.println("<td align=center width=40>Type</td>");
			out.println("<td align=center width=40>Currency</td>");
			out.println("<td align=center width=80>Marketing Name</td>");
			...
			out.println("<tr>");
			out.println("<td align=center width=10> </td>");
			out.println("<td align=center width=40>Product</td>");
			out.println("<td align=center width=40>Bank</td>");
			out.println("<td align=center width=40>Currency</td>");
			out.println("<td align=center width=80>Marketing</td>");
			out.println("<td align=center>Description</td>");
			out.println("</tr>");
   }
                  	   ...
                  	   if (newmessage.getFormatName().equals("ESD071102")) {
                              ...
                              msgHelp =  (ESD071102Message)newmessage;
           						   ...
           						   if ( msgHelp.getE02OPERAC().equals("*") ) {
           							...
           							out.println("<td width=30>" + msgHelp.getE02APCBNK().trim() + "</td>"); // Bank Code
