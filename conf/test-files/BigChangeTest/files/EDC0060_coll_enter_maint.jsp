...
<HTML>
<HEAD>
<TITLE>Payment Settlement / Collection Payments</TITLE>
...
<SCRIPT Language="Javascript">
  function helpAcc(tipo,fldst,fld1,fld2){
    ...
    if(tipo=='G'){
       if(fld2==''){
          alert("Select Settlement Currency");
          return;
       } 
...
<SCRIPT Language="javascript">
  function fcvalida(){
     if(document.forms[0].E01DCMACC.value == "0.00"){ 
        alert("Amount of Payment is mandatory");
        return false;
     }
     if(document.forms[0].E01TIPOPE.value == "0"){ 
        alert("Operation Type is mandatory");
        return false;
     }
     
     if(document.forms[0].E01TIPOPE.value == "4" && document.forms[0].E01CONDCA.value == "X"){ 
        alert("Condition of Cancellation us Mandatory");
        return false;
     }
...
<H3 align="center">Payment Settlement / Collection Payments<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="coll_enter_maint.jsp, EDC0060"></H3>
<HR size="4">
...
<table class="tableinfo">
    ...
    <TR id="trdark"> 
      ...
      <TD nowrap width="50%">
	    <div align="left">
    	    ...
    	    <A href="javascript:GetAccount('E01DCMACC','','CL','')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" align="absbottom"></A>
    	</div>
      </TD>
    </TR>
      ...
      <TD nowrap width="50%">
	    <div align="left">
    	    <select name="E01TIPOPE">
				...
				<option value="3" <%= dcPag.getE01TIPOPE().equals("3")?"selected":"" %>>Collec./Commission</option>
				<option value="4" <%= dcPag.getE01TIPOPE().equals("4")?"selected":"" %>>Cancellation</option>								
			</select>
    ...
    <TR id="trclear"> 
      <TD nowrap width="50%">
      	<div align="right">Condition of Cancellation :</div>
      </TD>
      <TD nowrap width="50%">
	    <div align="left">
...
<table class="tableinfo">
	<tr>
		...
		<TR id="trdark">
			...
			<TD width="664">
				<SELECT name="E01REMVIA">
					...
					<OPTION value="2" 	<%= dcPag.getE01REMVIA().equals("2")?"selected":"" %>>Retail Account</OPTION>
					<OPTION value="3"	<%= dcPag.getE01REMVIA().equals("3")?"selected":"" %>>G/L Account</OPTION>
		...
		<TR id="trclear">
			<TD width="670">
				<DIV align="right">Settlement Currency :</DIV>
			</TD>
			<TD width="664">
		...
		<TR id="trdark">
			<TD width="670">
				<DIV align="right">Settlement Account Number :</DIV>
			</TD>
			<TD width="664">
				<DIV align="left"><INPUT type="text" name="E01REMACC" size="17" maxlength="16" value="<%=dcPag.getE01REMACC()%>">
				<A href="javascript: helpAcc((document.forms[0].E01REMVIA.value == '2' ?'A': 'G'),'E01REMACC','<%=currUser.getE01UBK() %>',document.forms[0].E01REMCCY.value)">
...
<table class="tableinfo">
	<tr>
		...
		<TR id="trdark">
			...
			<TD width="663">
				<SELECT name="E01PAGVIA">
					<OPTION value=" " selected></OPTION>
					<OPTION value="2"	<%= dcPag.getE01PAGVIA().equals("2")?"selected":"" %>>Retail Account</OPTION>
					<OPTION value="3"	<%= dcPag.getE01PAGVIA().equals("3")?"selected":"" %>>G/L Account</OPTION>
				</SELECT>
				<IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" border="0" align="absmiddle">
			</TD>
		</TR>
		...
		<TR id="trdark">
			<TD width="671">
				<DIV align="right">Principal Payment Account Number :</DIV>
			</TD>
			<TD width="663">
				<DIV align="left"><INPUT type="text" name="E01PAGACCP" size="18"
				maxlength="16" value="<%=dcPag.getE01PAGACCP()%>"> <A
				href="javascript: helpAcc((document.forms[0].E01PAGVIA.value == '2' ?'A': 'G'),'E01PAGACCP','<%=currUser.getE01UBK() %>',document.forms[0].E01PAGCCY.value)">
				<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ."
				border="0" align="absbottom"></A></DIV>
			</TD>
		</TR>
		<TR id="trclear">
			<TD width="671">
				<DIV align="right">Commission/Taxes Payment Account Number :</DIV>
			</TD>
			<TD width="663">
				<DIV align="left"><INPUT type="text" name="E01PAGACCC" size="18"
				maxlength="16" value="<%=dcPag.getE01PAGACCC()%>"> <A
				href="javascript: helpAcc((document.forms[0].E01PAGVIA.value == '2' ?'A': 'G'),'E01PAGACCC','<%=currUser.getE01UBK() %>',document.forms[0].E01PAGCCY.value)">
			<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ."
				border="0" align="absbottom"></A></DIV>
			</TD>
		</TR>
