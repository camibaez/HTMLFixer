...
function enter(){
 ...
 var NameSearch = document.forms[0].NameSearch.value
    ...
    parent.results.window.location.href="<%=request.getContextPath()%>/pages/e/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0130?NameSearch=" + NameSearch + "@PmtVia=" + PmtVia + "'";    
