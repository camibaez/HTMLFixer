...
function goAction(op) {
	...
	if (op == "3") {
      ok = confirm("Confirm delete record.");
	  if (ok) 
	       {
...
<BODY>
<h3 align="center">Format Codes <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="format_list.jsp, EDP0702"></h3>
<hr size="4">
