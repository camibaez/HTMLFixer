...
<INPUT TYPE=HIDDEN NAME="E01IMFCDE" VALUE="">
  <h3 align="center">Confirmations and Alerts Messages <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="Affiliation_List.jsp,ESS2060"> 
  </h3>
<hr size="4">

 <TABLE class="tbenter">
    <TR> 
      <TD ALIGN=CENTER width="50%" class=TDBKG> <a href="javascript:goSubmit('120')">New</a> 
      <TD ALIGN=CENTER width="50%" class=TDBKG> <a href="javascript:goSubmit('110')">Maintenance</a> 
      </TD>
    </TR>
  </TABLE>
      ...
      <td NOWRAP valign="top" width="100%" colspan="1"> 
        <table id="headTable" width="100%">
          <tr id="trdark">  
		      ...
		      <TH ALIGN=CENTER width=10%>Language</TH>		      
