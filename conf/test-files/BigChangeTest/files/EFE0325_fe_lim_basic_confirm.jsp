      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="63%" > <%= fex.getE01FEOCCY().trim()%> - <%= Util.fcolorCCY(fex.getE01FEOLIM())%> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="37%" > 
            ...
            <td nowrap width="63%" ><%= Util.fcolorCCY(fex.getE01FEOUTI())%></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="37%" > 
              <div align="right">Settlement Date :</div>
            </td>
            <td nowrap width="63%" > <%= Util.formatDate(fex.getE01FEODT1(),fex.getE01FEODT2(),fex.getE01FEODT3())%> 
            </td>
          </tr>
        </table>
      </td>
