...
<%-- jsf:pagecode language="java" location="/JavaSource/pagecode/pages/e/EDL0106_cp_payment_chang.java" --%><%-- /jsf:pagecode --%>
...
<% 
 ...
 %>
<div align="center"> 
  <h3>Maintenance Payment Date <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_payment_maint.jsp,EDL0106"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap colspan="3" width="78%">
              ...
              <td nowrap colspan="3" width="78%">
                 <div align="right">Sequential :</div>
              </td>
              <td nowrap colspan="3" width="78%">
              <div align="left">
                 <div align="left"> <%= userPO.getIdentifier1().trim()%> </div>                
               </div>
