...
<H3 align="center">Teller Messages<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="Cust_ap_teller_instructions, ESD0090"></H3>
<hr size="4">
...
> 
 ...
 height="23"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="10%"
 height="23"> 
              <div align="center"> <input type="checkbox" disabled name="E01SFLG06" value="X" <%if(instructions.getE01SFLG06().equals("X")) out.print("checked");%>>
              </div>
            </td>
            <td nowrap width="45%"
 height="23"> 
 ...
 height="23"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="10%"
 height="23"> 
              <div align="center"> <input type="checkbox" disabled name="E01SFLG07" value="X" <%if(instructions.getE01SFLG07().equals("X")) out.print("checked");%>>
              </div>
            </td>
            <td nowrap width="45%"
 height="23"> 
 ...
 height="23"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="10%"
 height="23"> 
              <div align="center"> <input type="checkbox" disabled name="E01SFLG08" value="X" <%if(instructions.getE01SFLG08().equals("X")) out.print("checked");%>>
              </div>
            </td>
            <td nowrap width="45%"
 height="23"> 
 ...
 height="23"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="10%"
 height="23"> 
              <div align="center"> <input type="checkbox" disabled name="E01SFLG09" value="X" <%if(instructions.getE01SFLG09().equals("X")) out.print("checked");%>>
              </div>
            </td>
            <td nowrap width="45%"
 height="23"> 
