...
<body>
<h3 align="center">Debit Card Assignment<br>New Assignment -  Primary Card<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_assign_new.jsp, ECC0090"> 
</h3>
<hr size="4">
<% 
		...
		<TR>
			...
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
				<TBODY>
					<TR id="trdark">
						<TD nowrap width="16%">
						<DIV align="right">Card Number: 
		</DIV>
						</TD>
						<TD nowrap width="20%" colspan="3">
							<DIV align="left">
								<INPUT type="text" name="E01CCRNUM" size="21" maxlength="16" value="">
								<A href="javascript:GetPlastic2('E01CCRNUM','D','N','<%= currUser.getH01USR() %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absbottom" border="0" ></A>
							</DIV>
						</TD>
					</TR>
					<TR id="trclear">
