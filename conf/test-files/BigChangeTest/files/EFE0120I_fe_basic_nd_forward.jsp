...
%> 
<h3 align="center"> Inquiry of Non Deliverable Forwards <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_nd_forward.jsp, EFE0120I"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2"> 
              <input type="text" readonly  name="E01FESEXR" size="11" maxlength="11" value="<%= fex.getE01FESEXR().trim()%>" >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="4" ><%= fex.getE01FESDID().trim()%> - <%= fex.getD01FEGDSC().trim()%> 
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap >
