...
<h3 align="center">Call Accounts<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_tables_dda_05, ESD0205" ></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
		  ...
		  <TR id="trdark"> 
            ...
            <TD nowrap width="29%"> 
              <DIV align="right">Non-Local Checks Percentage :</DIV>
            </TD>
            <TD nowrap width="31%"> 
              <DIV align="left"> 
          ...
          <TR id="trdark"> 
            ...
            <TD nowrap width="29%"> 
              <DIV align="right">Openig Minimum Balance :</DIV>
            </TD>
            <TD nowrap width="31%"> 
              <DIV align="left"> 
          ...
          <TR id="trclear"> 
            <TD nowrap width="22%">
              <DIV align="right">Call Days :</DIV>
            </TD><TD nowrap width="18%">
              <DIV align="left">
                <INPUT type="text" name="E02RTENDH" size="4" maxlength="3" value="<%= charges.getE02RTENDH()%>">
              </DIV>
            </TD><TD nowrap width="29%">
              <DIV align="right">Call Limit Amount :</DIV>
            </TD><TD nowrap width="31%">
              <DIV align="left">
                <INPUT type="text" name="E02RTEMAC" size="17" maxlength="15" value="<%= charges.getE02RTEMAC()%>">
              </DIV>
            </TD>
          </TR>
          <TR id="trdark"> 
