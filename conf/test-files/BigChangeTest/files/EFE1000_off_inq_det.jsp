...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSETL0510" >
  ...
  <h3 align="center">Official Checks Stop Payments<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="off_inq_det.jsp, EFE1000"></h3>
  <hr size="4">
  <BR>
  ...
  <p align="center"> 
    <input id="EIBSBTN" type=submit name="Submit" value="Stop Payment">
  </p>
  </FORM>
