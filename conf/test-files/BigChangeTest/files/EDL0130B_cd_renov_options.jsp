...
%>
<h3 align="center">Redemption <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_renov_options,EDL0130B"></h3>
<hr size="4">
      ...
      <td>
        <table cellpadding=2 cellspacing=0 align=center width=100% bordercolor="#000000">
          <tr id="trdark">
            ...
            <td height="46" colspan="2" width="650" > When Deal matures cancel
              the Deposit plus Interest payable to the General Ledger number
          ...
          <tr id="trdark">
            ...
            <td height="36" colspan="2" width="650" >When Deal matures cancel
              the Deposit crediting to the Account number
