 ...
 <tr > 
      <td > 
          <table cellspacing=0 cellpadding=2 width="100%" border="0">
          	<tr id="trdark">
          		<td nowrap  width="25%">
          			<div align="right">C�digo de Transacci�n :</div>
          		</td>
              	<td nowrap width="25%"> 
            ...
            <tr id="trclear"> 
              	<td nowrap  > 
                	<div align="right">Cuenta de Cr�dito :</div>
              	</td>
              	<td nowrap > 
                	<div align="left"> 
            ...
            <tr id="trdark"> 
            	...
            	<TD nowrap>
					<div align="left"> 
              			...
              			<%if(msgPart.getE01PRAACG().equals("Y") && msgPart.getE01PRAACG().equals("Y")) out.print("checked");%> >S� 
            ...
            <tr id="trdark"> 
				<TD nowrap>
					<div align="right">Aprobaci�n Finanzas : </div>
				</TD>
				<TD nowrap>
					<div align="left"> 
              			<input type="radio" name="E01PRAFAP" value="Y"
              			<%if(msgPart.getE01PRAFAP().equals("Y") && msgPart.getE01PRAFAP().equals("Y")) out.print("checked");%> >S� 
			...
			<tr id="trdark"> 
			    <td nowrap  > 
                	<div align="right"> Monto M�nimo  : </div>
                </td>
                <td nowrap > 
                	<div>
            ...
            <tr id="trclear"> 
				<TD nowrap>
					<div align="right">Liberaci�n de Pagos : </div>
				</td>
				<TD nowrap>
					<div>
              			<input type="radio" name="E01PRAOAP" value="Y"
              			<%if(msgPart.getE01PRAOAP().equals("Y") && msgPart.getE01PRAOAP().equals("Y")) out.print("checked");%> >S� 
            ...
            <tr id="trdark"> 
              	<td nowrap > 
                	<div align="right">N�mero de Firmas :</div>
              	</td>
              	<td nowrap > 
                	<div align="left"> 
