...
<jsp:useBean id="msgOff" class="datapro.eibs.beans.ELN018701Message" scope="session"/>
...
%>
<h3 align="center">Offering Memorandum<br>Detail<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="offering_memo_ap_inq.jsp, ELN0187"></h3>
<hr size="4">
