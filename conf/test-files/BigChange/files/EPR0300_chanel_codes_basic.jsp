...
<h3 align="center">Transfer Channel<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="chanel_codes_basic.jsp, EPR0300"> </h3>

<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEPR0300">
...
<table class="tableinfo" width="570">
	<tr id="trdark">
		<td nowrap width="35%">
		<div align="right">Channel Code :</div>
		</td>
	...
	<tr id="trdark">
		<td nowrap width="35%">
		<div align="right">SWIFT Code :</div>
		</td>
    ...
    <tr id="trclear"> 
		<td nowrap  > 
        	<div align="right">Session Code :</div>
		</td>
		<TD nowrap>
			<div align="left"> 
    ...
    <tr id="trdark">
		<td nowrap width="194">
		<div align="right">Enabled? :</div>
		</td>
		<td nowrap width="65%">
		<div align="left">
		<input type="radio" name="E01PRCFL1" value="Y"
		<%if(msgPart.getE01PRCFL1().equals("Y") && msgPart.getE01PRCFL1().equals("Y")) out.print("checked");%> >Yes 
...
<H4><br>Outgoing Messages Parameters<br></H4>       
       <table class="tableinfo">
            <tr id="trdark"> 
              	<td nowrap  > 
                	<div align="right">Credit Account (Release) :</div>
              	</td>
              	<td nowrap > 
                	<div align="left"> 
                  		<input type="text" name="E01PRCDBK" size="2" maxlength="2" value="<%= msgPart.getE01PRCDBK().trim()%>" >
                  		<input type="text" name="E01PRCDBR" size="4" maxlength="3"  value="<%= msgPart.getE01PRCDBR().trim()%>" onkeypress="enterInteger()"
                  		oncontextmenu="showPopUp(branchHelp,this.name,document.forms[0].E01PRCDBK.value,'','','','')">
                		<input type="text" name="E01PRCDCY" size="3" maxlength="3" value="<%= msgPart.getE01PRCDCY().trim()%>"  
                		oncontextmenu="showPopUp(currencyHelp,this.name,document.forms[0].E01PRCDBK.value,'','','','')"> 
                		<input type="text" name="E01PRCDGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCDGL().trim()%>" onkeypress="enterInteger()" 
                		oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E01PRCDBK.value,document.forms[0].E01PRCDCY.value,'','','')">
                	</div>
              	</td>
            </tr>   
            <tr id="trclear"> 
              	<td nowrap > 
                	<div align="right">Accounting Indicator :</div>
              	</td>
              	<td nowrap > 
					<div align="left"> 
              			<input type="radio" name="E01PRCACG" value="Y"
               			<%if(msgPart.getE01PRCACG().equals("Y") && msgPart.getE01PRCACG().equals("Y")) out.print("checked");%> >Yes
            ...
            <tr id="trdark"> 
              	<td nowrap  > 
                	<div align="right">Credit Account (Settlement) :</div>
              	</td>
              	<td nowrap > 
                	<div align="left"> 
                  		<input type="text" name="E01PRCLBK" size="2" maxlength="2" value="<%= msgPart.getE01PRCLBK().trim()%>" >
                  		<input type="text" name="E01PRCLBR" size="4" maxlength="3"  value="<%= msgPart.getE01PRCLBR().trim()%>" onkeypress="enterInteger()"
                  		oncontextmenu="showPopUp(branchHelp,this.name,document.forms[0].E01PRCLBK.value,'','','','')">
                		<input type="text" name="E01PRCLCY" size="3" maxlength="3" value="<%= msgPart.getE01PRCLCY().trim()%>"  
                		oncontextmenu="showPopUp(currencyHelp,this.name,document.forms[0].E01PRCLBK.value,'','','','')"> 
                		<input type="text" name="E01PRCLGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCLGL().trim()%>" onkeypress="enterInteger()" 
                		oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E01PRCLBK.value,document.forms[0].E01PRCLCY.value,'','','')">
                	</div>
              	</td>
            </tr>   
            ...
            <tr id="trclear"> 
              	...
              	<td nowrap > 
					<div align="left"> 
						...
						<%if(msgPart.getE01PRCLCG().equals("Y") && msgPart.getE01PRCLCG().equals("Y")) out.print("checked");%> >Yes 
           	...
           	<td nowrap > 
                	<div align="left"> 
			      		...
			      		<input	type="text" name="D01PRCMPG" size="35" maxlength="30" value="<%= msgPart.getD01PRCMPG().trim()%>" readonly >
 	  	       		 <a href="javascript:GetCodeDescCNOFC('E01PRCMPG','D01PRCMPG','MP')">
            ...
            <tr id="trclear"> 
            	<td nowrap  > 
            		<div align="right">Payment Indicator :</div>
            	</td>
            	<TD nowrap>
					<div align="left"> 
              			<input type="radio" name="E01PRCDVP" value="Y"
						<%if(msgPart.getE01PRCDVP().equals("Y") && msgPart.getE01PRCDVP().equals("Y")) out.print("checked");%> >Yes 
            ...
            <tr id="trdark"> 
              	<td nowrap  > 
            		<div align="right">Settlement by Compensation :</div>
            	</td>
            	<TD nowrap>
					<div align="left"> 
              			<input type="radio" name="E01PRCLPC" value="Y"
						<%if(msgPart.getE01PRCLPC().equals("Y") && msgPart.getE01PRCLPC().equals("Y")) out.print("checked");%> >Yes 
            ...
            <tr id="trclear"> 
				<td nowrap  > 
            		<div align="right">Payment Queue Retention :</div>
            	</td>
            	<TD nowrap>
					<div align="left"> 
              			<input type="radio" name="E01PRCRCP" value="Y"
						<%if(msgPart.getE01PRCRCP().equals("Y") && msgPart.getE01PRCRCP().equals("Y")) out.print("checked");%> >Yes 
  			...
  			<H4><br>Incoming Messages Parameters<br></H4>
           ...
           <table id="mainTable" class="tableinfo">
	            <tr id="trdark"> 
	              	...
	              	<td nowrap colspan="2"> 
	                	<div align="left"> 
                  		...
                  		<input type="text" name="E01PRCCGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCCGL().trim()%>" onkeypress="enterInteger()" 
                  		oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E01PRCCBK.value,document.forms[0].E01PRCCCY.value,'','','')">
                	</div>
              	</td>
            </tr>
            <tr id="trclear"> 
              	...
              	<td nowrap colspan="2"> 
					<div align="left"> 
						...
						<%if(msgPart.getE01PRCCAG().equals("Y") && msgPart.getE01PRCCAG().equals("Y")) out.print("checked");%> >Yes 
	            ...
	            <tr id="trdark"> 
	              	<td nowrap > 
	                	<div align="right">Rejection Account :</div>
	              	</td>
	              	<td nowrap colspan="2"> 
	                	<div align="left"> 
                  		...
                  		<input type="text" name="E01PRCRGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCRGL().trim()%>" onkeypress="enterInteger()" 
                  		oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E01PRCRBK.value,document.forms[0].E01PRCRCY.value,'','','')">
                	</div>
              	</td>
            </tr>
            <tr id="trclear"> 
              	...
              	<td nowrap > 
					<div align="left"> 
						...
						<%if(msgPart.getE01PRCRAG().equals("Y") && msgPart.getE01PRCRAG().equals("Y")) out.print("checked");%> >Yes 
            ...
            <tr id="trdark"> 
              	<td nowrap > 
                	<div align="right">Veification Account :</div>
              	</td>
              	<td nowrap colspan="2"> 
	                	<div align="left"> 
                  		...
                  		<input type="text" name="E01PRCVGL" size="17" maxlength="16" value="<%= msgPart.getE01PRCVGL().trim()%>" onkeypress="enterInteger()"
                  		oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E01PRCVBK.value,document.forms[0].E01PRCVCY.value,'','','')" >
                	</div>
              	</td>
            </tr>
            <tr id="trclear"> 
              	...
              	<td nowrap > 
					<div align="left"> 
						...
						<%if(msgPart.getE01PRCVRY().equals("Y") && msgPart.getE01PRCVRY().equals("Y")) out.print("checked");%> >Yes 
