      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark">
            ...
            <td nowrap width="20%" >
              <div align="left">
                <input type="text" name="E01ACMCUN" size="9" maxlength="9" value="<%= rtBasic.getE01ACMCUN().trim()%>" <%=(currUser.getE01CCU().equals("Y"))?"" : "readonly" %>>
                <% if (currUser.getE01CCU().equals("Y")) { %>
          ...
          <tr id="trclear">
            ...
            <td nowrap width="26%">
              <select name="E01ACMPEC">
                ...
                <option value="2" <% if (rtBasic.getE01ACMPEC().equals("2")) out.print("selected"); %>>Joined</option>
                <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  >
              </select>
            </td>
          </tr>
