  ...
  <tr>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr id=trdark>
	      ...
	      <td>
	        <input size="3" type="text" name="E01LCMID1" maxlength="2" value="<%=bolgaran.getE01LCMID1()%>" readonly>
			<INPUT size="3" type="text" name="E01LCMID2" maxlength="2" value="<%=bolgaran.getE01LCMID2()%>" readonly>
			<INPUT size="3" type="text" name="E01LCMID3" maxlength="2" value="<%=bolgaran.getE01LCMID3()%>" readonly>
		  </td>
	      <td align=right nowrap>Fecha Vcto. :</td>
          <td>
            <input size="3" type="text" name="E01LCMEX1" maxlength="2" value="<%=bolgaran.getE01LCMEX1()%>" readonly>
            <INPUT size="3" type="text" name="E01LCMEX2" maxlength="2" value="<%=bolgaran.getE01LCMEX2()%>" readonly>
            <INPUT size="3" type="text" name="E01LCMEX3" maxlength="2" value="<%=bolgaran.getE01LCMEX3()%>" readonly>
          </td>
    </tr>
    <tr id=trclear>
    ...
    <tr id=trdark>
      ...
      <td colspan=3><INPUT type="text" name="E01REVAMN" readonly size="17" value="<%=bolgaran.getE01REVAMN()%>"></td>
    </tr>
   </table>
   </td>
  </tr>
  ...
  <tr>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr id=trclear>
      ...
      <td>
            <input size="3" type="text" name="E01PAGVD1" maxlength="2" value="<%=bolgaran.getE01PAGVD1()%>">
            <INPUT size="3" type="text" name="E01PAGVD2" maxlength="2" value="<%=bolgaran.getE01PAGVD2()%>">
            <INPUT size="3" type="text" name="E01PAGVD3" maxlength="2" value="<%=bolgaran.getE01PAGVD3()%>">
      </td>
    </tr>
  ...
  <tr>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr id=trdark>
      <td align=right nowrap>Monto Boleta :</td>
      <td colspan=3>
      	<INPUT type="text" name="E01PAGPRI" size="15" maxlength="15" readonly value="<%=bolgaran.getE01PAGPRI()%>">
      </td>
    </tr>
    <tr id=trclear>
      <td align=right nowrap>Monto Reajuste :</td>
      <td>
      	<INPUT type="text" name="E01PAGREV" size="15" maxlength="15" readonly value="<%=bolgaran.getE01PAGREV()%>">
      </td>
      <td align=right nowrap>Reversion Reajuste :</td>
      <td>
      	<INPUT type="text" name="E01REVREV" size="15" maxlength="15" value="<%=bolgaran.getE01REVREV()%>" readonly>
    ...
    <tr id=trclear>
      <td align=right nowrap>Total a Pagar :</td>
      <td>
      	<INPUT type="text" name="E01PAGTOT" readonly size="15" maxlength="15" value="<%=bolgaran.getE01PAGTOT()%>" readonly>
      </td>
      <td align=right nowrap>Fecha Valor :</td>
      <td>
            <input size="3" type="text" name="E01PAGVD1" maxlength="2" value="<%=bolgaran.getE01PAGVD1()%>" readonly>
            <INPUT size="3" type="text" name="E01PAGVD2" maxlength="2" value="<%=bolgaran.getE01PAGVD2()%>" readonly>
            <INPUT size="3" type="text" name="E01PAGVD3" maxlength="2" value="<%=bolgaran.getE01PAGVD3()%>" readonly>
      </td>
    </tr>
    ...
    <tr id="trclear">
      ...
      <table id="headTable" class="tableinfo" style="filter:";>
          ...
          <tr id="trclear">
            <td nowrap >
              <div align="center" nowrap>
                <input type="text" name="E01PAGOPC" value="<%= bolgaran.getE01PAGOPC().trim()%>" size="3" maxlength="3" readonly>
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01PAGOBK" size="2" maxlength="2" value="<%= bolgaran.getE01PAGOBK().trim()%>" readonly>
              </div>
            </td>
            <td nowrap >
              <div align="left">
                <input type="text" name="E01PAGOBR" size="3" maxlength="3" value="<%= bolgaran.getE01PAGOBR().trim()%>" readonly>
              </div>
            </td>
            <td nowrap >
              <div align="center">
                <input type="text" name="E01PAGOCY" size="3" maxlength="3" value="<%= bolgaran.getE01PAGOCY().trim()%>" readonly>
              </div>
            </td>
            <td nowrap >
              <div align="center">
                <input type="text" name="E01PAGOAC" size="12" maxlength="12"  value="<%= bolgaran.getE01PAGOAC().trim()%>" readonly>
              </div>
            </td>
          </tr>
   	  </table>
  ...
  <tr>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr id=trdark>
      <td align=right nowrap>Monto Comision :</td>
      <td>
      	<INPUT type="text" name="E01PAGCOM" readonly maxlength="15" size="15" value="<%=bolgaran.getE01PAGCOM()%>">
      </td>
      <td align=right nowrap>Reversa Comision :</td>
      <td>
      	<INPUT type="text" name="E01REVCOM" size="15" maxlength="15" value="<%=bolgaran.getE01REVCOM()%>" readonly>
    ...
    <tr id="trclear">
      ...
      <table id="headTable" class="tableinfo" style="filter:";>
          ...
          <tr id="trclear">
            <td nowrap >
              <div align="center" nowrap>
                <input type="text" name="E01PAGEPC" value="<%= bolgaran.getE01PAGEPC().trim()%>" size="3" maxlength="3" readonly>
                <input type="hidden" name="E01PAGEGL" value="<%= bolgaran.getE01PAGEGL().trim()%>">
                <input type="text" name="E01PAGECO" size="25" maxlength="25" readonly value="<%= bolgaran.getE01PAGECO().trim()%>">
              </div>
            </td>
            <td nowrap >
              <div align="left">
                <input type="text" name="E01PAGEBK" size="2" maxlength="2" value="<%= bolgaran.getE01PAGEBK().trim()%>" readonly>
              </div>
            </td>
            <td nowrap >
              <div align="left">
                <input type="text" name="E01PAGEBR" size="3" maxlength="3" value="<%= bolgaran.getE01PAGEBR().trim()%>" readonly>
              </div>
            </td>
            <td nowrap >
              <div align="center">
                <input type="text" name="E01PAGECY" size="3" maxlength="3" value="<%= bolgaran.getE01PAGECY().trim()%>" readonly>
              </div>
            </td>
            <td nowrap >
              <div align="center">
                <input type="text" name="E01PAGEAC" size="12" maxlength="12"  value="<%= bolgaran.getE01PAGEAC().trim()%>" readonly>
              </div>
            </td>
          </tr>
   	  </table>
