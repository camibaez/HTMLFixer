...
<h3 align="center">Placements - Back Office<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fe_tps.jsp,EDL0130B"></h3>
<hr size="4">
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear">
            ...
            <td nowrap width="21%" > <% if(deal.getE11DLSSBT().equals("SL")) out.print("Issue");
