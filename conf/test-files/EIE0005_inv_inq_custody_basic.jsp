...
%>
<div align="center"> 
  <h3>Agents of Custody Inquiry <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_brokers_basic.jsp,EIE0005"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              <input type="text" readonly  name="E01FEB" size="7" maxlength="6"  value="<%= invBrok.getE01FEBCCN().trim()%>"
