...
%> 
<h3 align="center"> <%= dftBasic.getE01DSCPRO().trim() %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="dft_inq_basic.jsp,EDL0800"> 
</h3>
<hr size="4">
...
%>
  ...
  <table class=tbenter>
   <tr > 
      ...
      <td nowrap> 
   		<b><font color="#ff6600"><%= dftBasic.getE01STATUS().trim()%></font></b>
      </td>
    </tr>
  </table>
  <table class="tableinfo">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="33%" >Overdraft Authorization : <input type="text" name="E01DEAODA" <% if (dftBasic.getF01DEAODA().equals("Y")) out.print("id=\"txtchanged\""); %> size="2" maxlength="1" value="<%= dftBasic.getE01DEAODA() %>" readonly> </td>
            <td nowrap width="15%" > 
   ...
   <tr > 
	...
	String chk = "";
     	while (lstAcceptors.getNextRow()) {
    		...
    		out.print("</TD>");
    		out.print("<TD nowrap>");
    		out.print("<div align=\"center\">Name</div>");
    		out.print("</TD>");
    		out.print("<TD nowrap>");
    		out.print("</TD>");
    		out.print("</TR>");
				...
				while (lstDocuments.getNextRow()) {
					if (lstDocuments.getFlag().equals("") && lstDocuments.getRecord(8).equals(lstAcceptors.getRecord(0))) {
					    if (firstTime) {
							 ...
							 out.print("</td>");
							 out.print("<TD>");
							 out.print("<div align=\"center\">Secuence</div>");
							 out.print("</TD>");
							 out.print("<TD>");
							 out.print("<div align=\"center\">Expiration Date</div>");
							 out.print("</TD>");
							 out.print("<TD>");
							 ...
							 out.print("</TD>");
							 out.print("<TD>");
							 out.print("Automatic Debit Account");
							 out.print("</TD>");
							 out.print("<TD>");
							 out.print("Ruta/Cobro");
							 out.print("</TD>");
							 out.print("<TD>");
							 out.print("Int.Normal");
							 out.print("</TD>");
							 out.print("<TD>");
							 out.print("Int.Mora");
							 out.print("</TD>");
