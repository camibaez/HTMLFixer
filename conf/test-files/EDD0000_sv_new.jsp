...
%>
<H3 align="center"> Saving Accounts Opening<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sv_new.jsp, EDD0000"></H3>
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="20%">
              <div align="left">
                <input type="text" name="E01ACMACC" size="15" maxlength="9" readonly value="<% if (svBasic.getE01ACMACC().trim().equals("999999999")) out.print("NEW ACCOUNT"); else out.print(svBasic.getE01ACMACC().trim()); %>">
              </div>
            </td>
            <td nowrap width="16%">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="26%">
              <select name="E01ACMRCD">
                ...
                <option value="D" <% if (svBasic.getE01ACMRCD().equals("D")) out.print("selected"); %>>Debits
                Only</option>
                <option value="C" <% if (svBasic.getE01ACMRCD().equals("C")) out.print("selected"); %>>Credits
                Only</option>
                <option value="A" <% if (svBasic.getE01ACMRCD().equals("A")) out.print("selected"); %>>Both</option>
              </select>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap width="26%">
              <div align="right">Authorized Signatures :</div>
            </td>
            <td nowrap width="26%">
              <select name="E01ACMPEC">
                ...
                <option value="2" <% if (svBasic.getE01ACMPEC().equals("2")) out.print("selected"); %>>Joined</option>
          ...
          <tr id="trdark">
            ...
            <td nowrap width="26%" height="23">
			  ...
			  <%if(svBasic.getE01ACMPTF().equals("N")) out.print("checked");%> checked>
              No </td>
          </tr>
          <tr id="trclear">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="19%" height="19">
              <input type="text" size="2" maxlength="1" value="<% if(svBasic.getE01ACMWLF().trim().equals("")) {out.print("N");}
				else {out.print(svBasic.getE01ACMWLF().trim());}%>" name="E01ACMWLF">
            ...
            <td nowrap width="26%" height="19">
              <input type="text" size="2" maxlength="1" value="<% if(svBasic.getE01ACMWNF().trim().equals("")) {out.print("N");}
				else {out.print(svBasic.getE01ACMWNF().trim());}%>" name="E01ACMWNF">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="24%">
              ...
              <a href="javascript:GetRetCod('E01ACMACL',document.forms[0].E01ACMATY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Direcciones de Correo del Cliente" align="absmiddle" border="0" ></a>
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  >
            </td>
          </tr>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="18%">
              ...
              <a href="javascript:GetCode('E01ACMSDY','STATIC_rt_ciclo.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Dia/Ciclo Cobro de Cargos" align="absbottom" border="0" ></a><img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  >
            </td>
            <td nowrap width="28%">
            ...
            <td nowrap width="24%"><font face="Arial" size="2"> </font><font face="Arial" size="2">
			  ...
			  <%if(svBasic.getE01ACMCSF().equals("N")) out.print("checked");%> checked>
              No</font> </td>
          </tr>
          <tr id="trdark">
            ...
            <td nowrap width="28%" height="23">
              <div align="right">Account Statement Via :</div>
            </td>
