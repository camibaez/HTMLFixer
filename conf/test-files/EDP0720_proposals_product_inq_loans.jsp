...
<h3 align="center">Detalle del Producto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="proposals_product_inq_loans.jsp,EDP0720"></h3>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td nowrap width="50%" align="left">
			              <input type="text" name="E01PLTORI" size="5" maxlength="4" value="<%= msgList.getE01PLTORI().trim()%>" readonly >
					 <% if(!msgRT.getH01FLGWK3().equals("3")){ %>
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
		   <tr id="trclear">
				  ...
				  <td nowrap width="50%" align="left">
			              <input type="text" name="E01PLTDST" size="5" maxlength="4" value="<%= msgList.getE01PLTDST().trim()%>"
					 <% if(!msgRT.getH01FLGWK3().equals("3")){ %>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear" >
				...
				<td width="50%" align="left">
					...
					<OPTION value="3"
						<%if (msgList.getE01PLTUPL().equals("3")) { out.print("selected"); }%>>A�o(s)</OPTION>
					</SELECT>
				</td>
			</tr>
		</table>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr id="trclear">
				...
				<td nowrap align="right" width="20%">
					<div>Frecuencia Cuotas Plan:</div>
				</td>
				<td align="left" width="15%">
...
<%--
				<SELECT name="E01PLTGAR"
					...
					<OPTION value="0"
						<%if (msgList.getE01PLTGAR().equals("0")) { out.print("selected"); }%>>Sin Garant�a</OPTION>
					<OPTION value="1"
						<%if (msgList.getE01PLTGAR().equals("1")) { out.print("selected"); }%>>Garant�a</OPTION>
					<OPTION value="2"
						<%if (msgList.getE01PLTGAR().equals("2")) { out.print("selected"); }%>>Aval</OPTION>
					<OPTION value="3"
						<%if (msgList.getE01PLTGAR().equals("3")) { out.print("selected"); }%>>Garant�a/Aval</OPTION>
					<OPTION value="5"
						<%if (msgList.getE01PLTGAR().equals("5")) { out.print("selected"); }%>>Fianza</OPTION>	
					<OPTION value="6"
						<%if (msgList.getE01PLTGAR().equals("6")) { out.print("selected"); }%>>Garant�a-Fianza</OPTION>	
					<OPTION value="4"
						<%if (msgList.getE01PLTGAR().equals("4")) { out.print("selected"); }%>>Garant�a/Co-Solicitante</OPTION>	
				</SELECT>
--%>
...
<table class="tableinfo">
      <tr > 
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			<tr id="trclear">
				<td nowrap width="10%">
				<div align="right">N�mero Registro:</div>
				</td>
				<td nowrap width="10%" align="left">
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			<tr id="trclear">
				...
				<td nowrap width="28%">
				<div align="right">Plazo del Cr�dito: 
      ...
      <tr > 
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			<tr id="trclear">
				...
				<td nowrap width="15%">
				<div align="right">Nombre Explotaci�n:</div>
				</td>
				<td nowrap width="5%">
