...
<H3 ALIGN="center">Letter of Credit Negotiation/Payment [<%= title %>]
	<IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left" NAME="EIBS_GIF" ALT="lc_nego_ref.jsp, ELC0560"></H3>
<HR SIZE="4">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <TR id="trclear">
    ...
    <TD nowrap valign="top" height="24" align="center" width="61"><INPUT type="text" name="E01CRPBRN" size="6" maxlength="3" value="<%=msg01.getE01CRPBRN()%>" ONCONTEXTMENU="showPopUp(branchHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')" onKeyPress="enterInteger()"></TD>
    <TD nowrap align="center" valign="top" height="24" width="47"><INPUT type="text" name="E01CRPCCY" size="6" maxlength="3" value="<%=msg01.getE01CRPCCY()%>" ONCONTEXTMENU="showPopUp(currencyHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')"></TD>
    <TD nowrap align="center" valign="top" height="24" width="128"><INPUT type="text" name="E01CRPGLN" size="20" maxlength="16" value="<%=msg01.getE01CRPGLN()%>" onKeyPress="enterInteger()"
    ...
    <TD nowrap align="center" valign="top" height="24" width="114"><INPUT type="text" name="E01CRPCCN" size="13" maxlength="8" value="<%=msg01.getE01CRPCCN()%>"oncontextmenu="showPopUp(costcenterHelp,this.name,document.forms[0].E01CRPBNK.value,'','','','')"></TD>
  </TR>
</TABLE>
<% } %>
<P></P>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
		...
		<A href="javascript: GetProduct('E01NEWPRO','<%=(msg01.getE01OPCODE().equals("5") ? "10" : "14")%>','<%= msg01.getE01CUSBNK()%>','E01DSCPRO', ' ')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0"></A>		</TD>
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  ...
	  <TD nowrap><INPUT type="radio" name="E01DISCNT" value="Y" <% if(msg01.getE01DISCNT().equals("Y")) out.print("checked");%>>
	    Yes
	    <INPUT type="radio" name="E01DISCNT" value="N" <% if(msg01.getE01DISCNT().equals("N")) out.print("checked");%>>
	    No </TD>
	</TR>
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  ...
	  <img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." border="0"></a></TD>
	  <TD height="24" align="right" valign="top" nowrap>Next Interest Payment Date</TD>
	  <TD height="24" align="left" valign="top" nowrap>
	  <INPUT name="E01NXIPDM" type="text" onKeyPress="enterInteger()" value="<%=msg01.getE01NXIPDM()%>" size="2" maxlength="2">
          <INPUT type="text" name="E01NXIPDD" size="2" maxlength="2" value="<%=msg01.getE01NXIPDD()%>" onKeyPress="enterInteger()">
          <INPUT type="text" name="E01NXIPDY" size="2" maxlength="2" value="<%=msg01.getE01NXIPDY()%>" onKeyPress="enterInteger()">
	...
	<TR id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  ...
	  <TD height="24" align="left" valign="top" nowrap>
	  <INPUT name="E01NXPPDM" type="text" value="<%=msg01.getE01NXPPDM()%>" size="2" maxlength="2" onKeyPress="enterInteger()">
          <INPUT type="text" name="E01NXPPDD" size="2" maxlength="2" value="<%=msg01.getE01NXPPDD()%>" onKeyPress="enterInteger()">
          <INPUT type="text" name="E01NXPPDY" size="2" maxlength="2" value="<%=msg01.getE01NXPPDY()%>" onKeyPress="enterInteger()">
...
if (msg01.getE01OPCODE().equals("3")) {%>
	...
	<TR id='<%= (i++ %2 == 0 ? "trclear" : "trdark") %>'>
		...
		<TD align="center"><INPUT type="text" name="E01DSCAMN" value="<%=msg01.getE01DSCAMN()%>"></TD>
		<TD align="center">
			<SELECT name="E01DSCPBY">
				<OPTION value="A" <%if(msg01.getE01DSCPBY().equals("A")) out.print("selected");%>>Applicant</OPTION>
				<OPTION value="B" <%if(msg01.getE01DSCPBY().equals("B")) out.print("selected");%>>Beneficiary</OPTION>
