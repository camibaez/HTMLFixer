...
<H3 align="center">Service Charges Table/Clearing<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="causal_basic.jsp, EDD0938"></H3>
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            <td nowrap width="16%" > 
              <div align="right"><b>Causal codel :</b></div>
            </td>
            <td nowrap width="20%" > 
              <div align="left"> 
            ...
            <td nowrap width="16%" > 
              <div align="right"><b>Descrption :</b> </div>
            </td>
            <td nowrap colspan="3" > 
              <div align="left"> 
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trclear"> 
            <td nowrap width="29%"> 
              <div align="right">Currency   Commission:</div>
            </td>
            ...
            <td nowrap width="26%"><div align="right">Debit / Credit to Account :</div></td>
            <td nowrap width="26%">
            	<SELECT name="E01CDVDEB">
					<OPTION value="N"
						<% if (caBasic.getE01CDVDEB().equals("N")) out.print("selected"); %>>No Debits neither Credits</OPTION>
					<OPTION value="1"
						<% if (caBasic.getE01CDVDEB().equals("1")) out.print("selected"); %>>Debited to Account</OPTION>
					<OPTION value="2"
						<% if (caBasic.getE01CDVDEB().equals("2")) out.print("selected"); %>>Debited and Credit to Accounts</OPTION>
				</SELECT></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="29%"> 
              <div align="right">Type of Return :</div>
            </td>
            <td nowrap width="19%">
            	            	<SELECT name="E01CDVFLG">
					<OPTION value="N"
						<% if (caBasic.getE01CDVFLG().equals("N")) out.print("selected"); %>>Do not Apply</OPTION>
					<OPTION value="1"
						<% if (caBasic.getE01CDVFLG().equals("1")) out.print("selected"); %>>Return by Form</OPTION>
					<OPTION value="2"
						<% if (caBasic.getE01CDVFLG().equals("2")) out.print("selected"); %>>Return by Funds</OPTION>
				</SELECT>
            </td>
            <td nowrap width="26%"><div align="right">Causal Alternate :</div></td>
          	...
          	<tr id="trclear">          	
            	...
            	<td>
            		<SELECT name="E01CDVCF1">
						...
						<OPTION value="%"<% if (caBasic.getE01CDVCF1().equals("%")) out.print("selected"); %>>Percentage</OPTION>
						<OPTION value="F"<% if (caBasic.getE01CDVCF1().equals("F")) out.print("selected"); %>>Fixed</OPTION>
					</SELECT>
            	</td>
            	...
            	<td>
            		<SELECT name="E01CDVAP1">
						...
						<OPTION value="1"<% if (caBasic.getE01CDVAP1().equals("1")) out.print("selected"); %>>Taxes Protested</OPTION>
						<OPTION value="2"<% if (caBasic.getE01CDVAP1().equals("2")) out.print("selected"); %>>Taxes Rejected</OPTION>
						<OPTION value="3"<% if (caBasic.getE01CDVAP1().equals("3")) out.print("selected"); %>>Taxes Accept</OPTION>
						<OPTION value="A"<% if (caBasic.getE01CDVAP1().equals("A")) out.print("selected"); %>>Protested Commissions</OPTION>
						<OPTION value="B"<% if (caBasic.getE01CDVAP1().equals("B")) out.print("selected"); %>>Rejected Commissions</OPTION>
						<OPTION value="C"<% if (caBasic.getE01CDVAP1().equals("C")) out.print("selected"); %>>Accept Commissions</OPTION>						
					</SELECT>
            	</td>            	
            	...
            	<td>
            		<SELECT name="E01CDVGF1">
						...
						<OPTION value="B"<% if (caBasic.getE01CDVGF1().equals("B")) out.print("selected"); %>>Base Currency</OPTION>
						<OPTION value="N"<% if (caBasic.getE01CDVGF1().equals("N")) out.print("selected"); %>>Currency Transaction</OPTION>
					</SELECT>
            	</td>            	
            	<td>
            	...
            	<td>
            		<SELECT name="E01CDVIV1">
						...
						<OPTION value="Y"<% if (caBasic.getE01CDVIV1().equals("Y")) out.print("selected"); %>>Yes</OPTION>
          	...
          	<tr id="trclear">          	
            	...
            	<td>
            		<SELECT name="E01CDVCF2">
						...
						<OPTION value="%"<% if (caBasic.getE01CDVCF2().equals("%")) out.print("selected"); %>>Percentage</OPTION>
						<OPTION value="F"<% if (caBasic.getE01CDVCF2().equals("F")) out.print("selected"); %>>Fixed</OPTION>
					</SELECT>
            	</td>
            	...
            	<td>
            		<SELECT name="E01CDVAP2">
						...
						<OPTION value="1"<% if (caBasic.getE01CDVAP2().equals("1")) out.print("selected"); %>>Taxes Protested</OPTION>
						<OPTION value="2"<% if (caBasic.getE01CDVAP2().equals("2")) out.print("selected"); %>>Taxes Rejected</OPTION>
						<OPTION value="3"<% if (caBasic.getE01CDVAP2().equals("3")) out.print("selected"); %>>Taxes Accept</OPTION>
						<OPTION value="A"<% if (caBasic.getE01CDVAP2().equals("A")) out.print("selected"); %>>Protested Commissions</OPTION>
						<OPTION value="B"<% if (caBasic.getE01CDVAP2().equals("B")) out.print("selected"); %>>Rejected Commissions</OPTION>
						<OPTION value="C"<% if (caBasic.getE01CDVAP2().equals("C")) out.print("selected"); %>>Accept Commissions</OPTION>						
					</SELECT>
            	</td>            	
            	...
            	<td>
            		<SELECT name="E01CDVGF2">
						...
						<OPTION value="B"<% if (caBasic.getE01CDVGF2().equals("B")) out.print("selected"); %>>Base Currency</OPTION>
						<OPTION value="N"<% if (caBasic.getE01CDVGF2().equals("N")) out.print("selected"); %>>Currency Transaction</OPTION>
					</SELECT>
            	</td>            	
            	...
            	<td>
            		<SELECT name="E01CDVIV2">
						...
						<OPTION value="Y"<% if (caBasic.getE01CDVIV2().equals("Y")) out.print("selected"); %>>Yes</OPTION>
          	...
          	<tr id="trclear">          	
            	...
            	<td>
            		<SELECT name="E01CDVCF3">
						...
						<OPTION value="%"<% if (caBasic.getE01CDVCF3().equals("%")) out.print("selected"); %>>Percentage</OPTION>
						<OPTION value="F"<% if (caBasic.getE01CDVCF3().equals("F")) out.print("selected"); %>>Fixed</OPTION>
					</SELECT>
            	</td>
            	...
            	<td>
            		<SELECT name="E01CDVAP3">
						...
						<OPTION value="1"<% if (caBasic.getE01CDVAP3().equals("1")) out.print("selected"); %>>Taxes Protested</OPTION>
						<OPTION value="2"<% if (caBasic.getE01CDVAP3().equals("2")) out.print("selected"); %>>Taxes Rejected</OPTION>
						<OPTION value="3"<% if (caBasic.getE01CDVAP3().equals("3")) out.print("selected"); %>>Taxes Accept</OPTION>
						<OPTION value="A"<% if (caBasic.getE01CDVAP3().equals("A")) out.print("selected"); %>>Protested Commissions</OPTION>
						<OPTION value="B"<% if (caBasic.getE01CDVAP3().equals("B")) out.print("selected"); %>>Rejected Commissions</OPTION>
						<OPTION value="C"<% if (caBasic.getE01CDVAP3().equals("C")) out.print("selected"); %>>Accept Commissions</OPTION>						
					</SELECT>
            	</td>            	
            	...
            	<td>
            		<SELECT name="E01CDVGF3">
						...
						<OPTION value="B"<% if (caBasic.getE01CDVGF3().equals("B")) out.print("selected"); %>>Base Currency</OPTION>
						<OPTION value="N"<% if (caBasic.getE01CDVGF3().equals("N")) out.print("selected"); %>>Currency Transaction</OPTION>
					</SELECT>
            	</td>            	
            	...
            	<td>
            		<SELECT name="E01CDVIV3">
						...
						<OPTION value="Y"<% if (caBasic.getE01CDVIV3().equals("Y")) out.print("selected"); %>>Yes</OPTION>
          	...
          	<tr id="trclear">          	
            	...
            	<td>
            		<SELECT name="E01CDVCF4">
						...
						<OPTION value="%"<% if (caBasic.getE01CDVCF4().equals("%")) out.print("selected"); %>>Percentage</OPTION>
						<OPTION value="F"<% if (caBasic.getE01CDVCF4().equals("F")) out.print("selected"); %>>Fixed</OPTION>
					</SELECT>
            	</td>
            	...
            	<td>
            		<SELECT name="E01CDVAP4">
						...
						<OPTION value="1"<% if (caBasic.getE01CDVAP4().equals("1")) out.print("selected"); %>>Taxes Protested</OPTION>
						<OPTION value="2"<% if (caBasic.getE01CDVAP4().equals("2")) out.print("selected"); %>>Taxes Rejected</OPTION>
						<OPTION value="3"<% if (caBasic.getE01CDVAP4().equals("3")) out.print("selected"); %>>Taxes Accept</OPTION>
						<OPTION value="A"<% if (caBasic.getE01CDVAP4().equals("A")) out.print("selected"); %>>Protested Commissions</OPTION>
						<OPTION value="B"<% if (caBasic.getE01CDVAP4().equals("B")) out.print("selected"); %>>Rejected Commissions</OPTION>
						<OPTION value="C"<% if (caBasic.getE01CDVAP4().equals("C")) out.print("selected"); %>>Accept Commissions</OPTION>						
					</SELECT>
            	</td>            	
            	...
            	<td>
            		<SELECT name="E01CDVGF4">
						...
						<OPTION value="B"<% if (caBasic.getE01CDVGF4().equals("B")) out.print("selected"); %>>Base Currency</OPTION>
						<OPTION value="N"<% if (caBasic.getE01CDVGF4().equals("N")) out.print("selected"); %>>Currency Transaction</OPTION>
					</SELECT>
            	</td>            	
            	...
            	<td>
            		<SELECT name="E01CDVIV4">
						...
						<OPTION value="Y"<% if (caBasic.getE01CDVIV4().equals("Y")) out.print("selected"); %>>Yes</OPTION>
...
<% if (!caBasic.getH01FLGWK2().equals("N")) { %> 
	<h4 style="text-align:center"><input type="checkbox" name="H01FLGWK1" value="D">Mark for Delete</h4>
<% } %>
