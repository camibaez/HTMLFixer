...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.accounting.JSECON00" >
  ...
  <table class="tableinfo">
    <tr id="trdark"> 
      ...
      <td nowrap colspan="2" > 
        <div align="left"> 
          <input type="text" name="E01CONSEQ" size="5" maxlength="4" value="<%= gl.getE01CONSEQ()%>">
        </div>
      </td>
    </tr>
  </table>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" > 
              <div align="left"> 
                <input type="text" name="E01CONBNK" size="2" maxlength="2" value="<%= gl.getE01CONBNK()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" > 
              <div align="left"> 
                ...
                oncontextmenu="showPopUp(currencyHelp,this.name,document.forms[0].E01CONBNK.value,'','','','')">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" > 
              <div align="left"> 
				...
				oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E01CONBNK.value,document.forms[0].E01CONCCY.value,'','','')" >
              </div>
            </td>
          </tr>
        </table>
