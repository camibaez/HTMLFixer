...
%>
<div align="center">
  <h3>Foreign Exchange Forward <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_forward.jsp,EFE0140B"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="21%" > <%= fex.getE01WKFBRK()%> - <%= fex.getD01FEBNM1()%> 
            </td>
            <td nowrap width="23%" > 
              <div align="right">Action Taken :</div>
            </td>
            <td nowrap width="23%" > <% if(fex.getE01WKFSBT().equals("PU")) out.print("Purchase");
          ...
          <tr id="trclear">
            ...
            <td nowrap colspan="3" >
            <% if (fex.getE01WKFHEF().equals("Y")) { %>
            Yes - <%= fex.getE01WKFHEM().trim()%> 
            <% } else { %>
            No
            <% } %>
            </td>          	
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
              <a href="javascript:GetClassFex('E01WKFCLS','FWR','<%= fex.getE01WKFCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
