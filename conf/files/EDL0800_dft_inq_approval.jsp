...
<html>
<head>
<title>Discount of Documents Approval</title>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  <%if(dftBasic.equals("1")) out.print("checked");%> readonly> Yes <input type="radio" name="CE01DEAHFQ" value="2" onClick="document.forms[0].E01DEAHFQ.value='2'"
   ...
   <tr > 
	...
	String chk = "";
     	while (lstAcceptors.getNextRow()) {
    		...
    		out.print("<TD nowrap>"); 
    		out.print("<div align=\"center\">Identificaci�n</div>"); 
    		out.print("</TD>");
    		out.print("<TD nowrap>");
				...
				while (lstDocuments.getNextRow()) {
					if (lstDocuments.getFlag().equals("") && lstDocuments.getRecord(8).equals(lstAcceptors.getRecord(0))) {
					    if (firstTime) {
							 ...
							 out.print("</TD>");
							 out.print("<TD>");
							 out.print("<div align=\"center\">Interest</div>");
							 out.print("</TD>");
							 out.print("<TD>");
							 out.print("Auto. Debit Account");
							 out.print("</TD>");
							 out.print("<TD>");
