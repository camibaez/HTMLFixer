...
%>
<div align="center"> 
  <h3>Trade Tickets - Multiple Orders - Approval <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_trade_tickets_mp.jsp,EIE0130A"> 
  </h3>
</div>
<hr size="4">
          ...
          <table cellpadding=2 cellspacing=0 width="100%" border="0">
			...
			<TR id="trclear">
				...
				<TD nowrap width="36%"><INPUT type="text" readonly name="E02ORDF15A"
					size="3" maxlength="2" value="<%= invMult.getE02ORDIN1()%>"> <INPUT
