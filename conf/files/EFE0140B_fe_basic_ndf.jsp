...
%> 
<h3 align="center"> Foreign Exchange Non Deliverable Forwards </h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
              <a href="javascript:GetClassFex('E01WKFCLS','SWP','<%= fex.getE01WKFCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" >
              <input type="text" name="E01WKFMA1" size="3" maxlength="2" value="<%= fex.getE01WKFMA1()%>" 
			  >
              <input type="text" name="E01WKFMA2" size="3" maxlength="2" value="<%= fex.getE01WKFMA2()%>" 
			  >
              <input type="text" name="E01WKFMA3" size="3" maxlength="2" value="<%= fex.getE01WKFMA3()%>" 
			  >
            </td>
            <td nowrap >&nbsp;</td>
            <td nowrap >&nbsp;</td>
