...
%> 
<h3 align="center">Account Holders of <%= userPO.getHeader4().trim()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_tit.jsp,EDL0150"></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0150" >
  ...
  <table class="tbenter">
   <tr>
    ...
    <td align=center class=TDBKG width><a href="javascript:DeleteHolderSel()">Delete Selection</a></td>
   </tr>
  </table>
  <table class="tableinfo">
    <tr > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="18%"> 
              <div align="center"> 
				...
				oncontextmenu="showPopUp(accholdersLoanHelp,this.name,'','','','','')"  value="<%= lnTit.getField("E06TY"+name).getString().trim()%>" >
              </div>
            </td>
          </tr>
          <%
