...
%>
<div align="center"> 
  <h3>Trade Ticket Back Office<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_trade_tickets.jsp,EIE0130"> 
  </h3>
</div>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="5" > 
              <input type="text" name="E01ORDWHF" size="3" maxlength="1" value="<%= invTrade.getE01ORDWHF().trim()%>">
              <a href="javascript:GetCode('E01ORDWHF','STATIC_cd_taxes.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></a> 
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="33%" >
            <INPUT type="text" name="E01ORDISI" size="16" maxlength="12"
					value="<%= invTrade.getE01ORDISI()%>" readonly></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap width="33%" >
            <INPUT type="text" name="E01ORDCSP" size="16" maxlength="12"
					value="<%= invTrade.getE01ORDCSP()%>" readonly></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="36%" colspan="2" > 
              <div align="left"> 
                ...
                <a href="javascript:DatePicker(document.forms[0].E01ORDIN1,document.forms[0].E01ORDIN2,document.forms[0].E01ORDIN3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"> 
                <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  > 
                </a> </div>
            </td>
            <td nowrap width="14%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="4" > 
              ...
              <a href="javascript:DatePicker(document.forms[0].E01ORDST1,document.forms[0].E01ORDST2,document.forms[0].E01ORDST3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  > 
              </a></td>
          </tr>
			<TR id="trdark">
				...
				<TD nowrap colspan="4"><INPUT type="text" name="E01ORDF15A" size="3"
					maxlength="2" value="<%= invTrade.getE01ORDF15A()%>"> <INPUT
					type="text" name="E01ORDF15B" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDF15B()%>"> <INPUT type="text"
					name="E01ORDF15C" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDF15C()%>"> <A
            ...
            <td nowrap colspan="4" > 
              <div align="left"> 
                <input type="text" name="E01ORDVNO" size="17" maxlength="16" value="<%= invTrade.getE01ORDVNO()%>" readonly>
                <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="4" > 
              <div align="left"> 
                <input type="text" name="E01ORDQTY" size="17" maxlength="16" value="<%= invTrade.getE01ORDQTY()%>" readonly>
                <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="4" > 
              <div align="left"> 
                <input type="text" name="E01ORDPRB" size="17" maxlength="15" value="<%= invTrade.getE01ORDPRB()%>" readonly onKeyPress="enterDecimal()">
                <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  > 
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap colspan="4" > 
              <div align="left"> 
                <input type="text" name="E01ORDPRC" size="17" maxlength="15" value="<%= invTrade.getE01ORDPRC()%>" readonly onKeyPress="enterDecimal()">
                <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  > 
              </div>
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="36%" colspan="2" > 
              <div align="left"> 
                <input type="text" name="E01ORDIAL" size="17" maxlength="15" value="<%= invTrade.getE01ORDIAL()%>" readonly onKeyPress="enterDecimal()">
                <input type="hidden" name="H01FLGWK3"  value="<%= invTrade.getH01FLGWK3()%>" >
                Recalculate : 
                <input type="radio" disabled name="CH01FLGWK3" value="Y" onClick="document.forms[0].H01FLGWK3.value='Y'"
			  <%if(invTrade.getH01FLGWK3().equals("Y")) out.print("checked");%>>
                Yes 
                <input type="radio" disabled name="CH01FLGWK3" value="" onClick="document.forms[0].H01FLGWK3.value=''"
            ...
            <td nowrap width="33%" > 
              <input type="text" name="E01ORDDYS" size="4" maxlength="3" value="<%= invTrade.getE01ORDDYS()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap colspan="5" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="33%"> 
              ...
              <a href="javascript:GetCommCustodyTable('E01ORDOCT',document.forms[0].E01ORDPTY.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0"></a></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
        ...
        <TR id="trclear">
						...
						<TD nowrap colspan="3">
						<INPUT type="text" disabled name="E01ORDCFR"
          	...
          	<TR id="trdark">
					...
					<TD nowrap colspan="3">
						<INPUT type="text" name="E01ORDF11"
							size="17" maxlength="15" value="<%= invTrade.getE01ORDF11()%>" disabled>
					</TD>
			</TR>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" >
              <input type="text" name="E01ORDTC1" size="35" maxlength="30" value="<%= invTrade.getE01ORDTC1()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="3" >
              <input type="text" name="E01ORDTC2" size="35" maxlength="30" value="<%= invTrade.getE01ORDTC2()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="3" >
              <input type="text" name="E01ORDTC3" size="35" maxlength="30" value="<%= invTrade.getE01ORDTC3()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
