...
%>
<div align="center"> 
  <h3>Trade Ticket Back Office<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_pb_treas_bo_inq.jsp,EIE0130"> 
  </h3>
</div>
<hr size="4">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="5" > 
              <div align="left"> 
                ...
                <input type="text" disabled name="E01ORDPNM" size="35" maxlength="30" value="<%= invTrade.getE01ORDPNM()%>">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <input type="text" disabled name="E01ORDIIC" disabled size="9" maxlength="9" value="<%= invTrade.getE01ORDIIC()%>" >
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <input type="text" disabled name="E01ORDBC1" size="35" maxlength="30" value="<%= invTrade.getE01ORDBC1()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="3" > 
              <input type="text" disabled name="E01ORDBC2" size="35" maxlength="30" value="<%= invTrade.getE01ORDBC2()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="17%" > 
            ...
            <td nowrap colspan="3" > 
              <input type="text" disabled name="E01ORDBC3" size="35" maxlength="30" value="<%= invTrade.getE01ORDBC3()%>">
            </td>
          </tr>
        </table>
      </td>
