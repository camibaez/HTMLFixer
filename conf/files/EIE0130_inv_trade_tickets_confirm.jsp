...
%>
<div align="center"> 
  <h3>Trade Ticket Back Office Confirmation<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_trade_tickets_confirm.jsp,EIE0130"></h3>
</div>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0309" >
  <table class="tableinfo">
    <tr> 
      <td> 
        <div align="center">The operation has been completed successfully</div>
      </td>
    </tr>
  </table>
  <h4> 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            Original Trade Number : <INPUT type="text" name="E01ORDFL50"
					size="16" maxlength="15" value="<%= invTrade.getE01ORDFL5()%>"
					readonly></td>
            <td nowrap > 
      ...
      <td nowrap>
		<table cellpadding=2 cellspacing=0 width="100%" border="0">
			<tr id="trdark">
				...
				<td nowrap colspan="3">
				<div align="left"><select disabled name="E01ORDTRN">
					<option value="1"
						<%if (invTrade.getE01ORDTRN().equals("1")) { out.print("selected"); }%>>Purchase</option>
					<option value="2"
						<%if (invTrade.getE01ORDTRN().equals("2")) {  out.print("selected"); }%>>Sale</option>
					<option value="3"
						<%if (invTrade.getE01ORDTRN().equals("3")) {  out.print("selected"); }%>>Transfer
					In</option>
					<option value="4"
						<%if (invTrade.getE01ORDTRN().equals("4")) {  out.print("selected"); }%>>Transfer
					Out</option>
					<option value="5"
						<%if (invTrade.getE01ORDTRN().equals("5")) {  out.print("selected"); }%>>Multiple
					Purchase</option>
					<option value="6"
						<%if (invTrade.getE01ORDTRN().equals("6")) {  out.print("selected"); }%>>Multiple
					Sale</option>
					<option value="7"
						<%if (invTrade.getE01ORDTRN().equals("7")) {  out.print("selected"); }%>>Adjustment(Decrement)</option>
				</select></div>
				</td>
			</tr>
			<tr id="trclear">
				...
				<td nowrap width="36%">
				<div align="left"><input type="text" readonly name="E01ORDIN1"
					size="3" maxlength="2" value="<%= invTrade.getE01ORDIN1()%>"> <input
					type="text" readonly name="E01ORDIN2" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDIN2()%>"> <input type="text" readonly
					name="E01ORDIN3" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDIN3()%>"> <a
					href="javascript:DatePicker(document.forms[0].E01ORDIN1,document.forms[0].E01ORDIN2,document.forms[0].E01ORDIN3)">
				</a></div>
				</td>
				<td nowrap width="14%">
				...
				<td nowrap width="33%">
				<div align="left"><select disabled name="E01ORDCNF">
					<option value="N"
						<%if (invTrade.getE01ORDCNF().equals("N")) { out.print("selected"); }%>>None</option>
					<option value="E"
						<%if (invTrade.getE01ORDCNF().equals("E")) { out.print("selected"); }%>>e-Mail</option>
					<option value="F"
						<%if (invTrade.getE01ORDCNF().equals("F")) { out.print("selected"); }%>>Fax</option>
					<option value="P"
						<%if (invTrade.getE01ORDCNF().equals("P")) { out.print("selected"); }%>>Printer</option>
				</select></div>
				</td>
			</tr>
			<tr id="trclear">
				...
				<td nowrap width="36%">
				<div align="left"><INPUT type="text" readonly name="E01ORDST1"
					size="3" maxlength="2" value="<%= invTrade.getE01ORDST1()%>"> <INPUT
					type="text" readonly name="E01ORDST2" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDST2()%>"> <INPUT type="text" readonly
					name="E01ORDST3" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDST3()%>"></div>
				</td>
				<td nowrap width="14%">&nbsp;Delivery Date :</td>
				<td nowrap width="33%">&nbsp;<INPUT type="text" readonly
					name="E01ORDF15A" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDF15A()%>"> <INPUT type="text" readonly
					name="E01ORDF15B" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDF15B()%>"> <INPUT type="text" readonly
					name="E01ORDF15C" size="3" maxlength="2"
					value="<%= invTrade.getE01ORDF15C()%>"></td>
			</tr>
			<tr id="trclear">
				<td nowrap width="17%">
				...
				<td nowrap colspan="3">
				<div align="left"><input type="text" readonly name="E01ORDVNO"
					size="17" maxlength="16" value="<%= invTrade.getE01ORDVNO()%>">
			...
			<tr id="trdark">
				...
				<td nowrap colspan="3">
				<div align="left"><input type="text" readonly name="E01ORDQTY"
					size="17" maxlength="16" value="<%= invTrade.getE01ORDQTY()%>"> of
				<%= invTrade.getD01MEASUR()%></div>
				</td>
			</tr>
			<tr id="trclear">
				<td nowrap width="17%">
				...
				<td nowrap colspan="3">
				<div align="left"><input type="text" readonly name="E01ORDPRB"
					size="17" maxlength="15" value="<%= invTrade.getE01ORDPRB()%>"
			...
			<tr id="trdark">
				...
				<td nowrap colspan="3">
				<div align="left"><input type="text" readonly name="E01ORDPRC"
					size="17" maxlength="15" value="<%= invTrade.getE01ORDPRC()%>"
					onKeyPress="enterDecimal()"></div>
				</td>
			</tr>
			<tr id="trclear">
				...
				<td nowrap width="36%">
				<div align="left"><input type="text" name="E01ORDIAM" size="17"
					maxlength="15" value="<%= invTrade.getE01ORDIAM()%>" readonly></div>
				</td>
			...
			<tr id="trdark">
				...
				<td nowrap width="36%"><input type="text" readonly name="E01ORDIAL"
					size="17" maxlength="15" value="<%= invTrade.getE01ORDIAL()%>"
					onKeyPress="enterDecimal()"></td>
				<td nowrap width="14%">
				<div align="right">Accrued Days :</div>
				</td>
				<td nowrap width="33%">
				<div align="left"><input type="text" readonly name="E01ORDDYS"
					size="4" maxlength="3" value="<%= invTrade.getE01ORDDYS()%>"></div>
				</td>
			</tr>
			<tr id="trclear">
				<td nowrap colspan="4" > 
			...
			<tr id="trdark">
				...
				<td nowrap width="36%">
				<div align="left"><input type="text" readonly name="E01ORDOCV"
					size="17" maxlength="15" value="<%= invTrade.getE01ORDOCV()%>"
					onKeyPress="enterDecimal()"></div>
				</td>
				<td nowrap width="14%">
				...
				<td nowrap width="33%">
				<div align="left"><input type="text" readonly name="E01ORDOCT"
					size="4" maxlength="2" value="<%= invTrade.getE01ORDOCT()%>"></div>
				</td>
			</tr>
			...
			<tr id="trclear">
				...
				<td nowrap width="36%">
				<div align="left"><input type="text" readonly name="E01ORDTGV"
					size="17" maxlength="15" value="<%= invTrade.getE01ORDTGV()%>"
					onKeyPress="enterDecimal()"></div>
				</td>
				<td nowrap width="14%">
				<div align="right"></div>
			...
			<tr id="trdark">
				...
				<td nowrap width="36%">
				<div align="left"><input type="text" readonly name="E01ORDFL9"
					size="17" maxlength="15" value="<%= invTrade.getE01ORDFL9()%>"
					onKeyPress="enterDecimal()"></div>
				</td>
				<td nowrap width="14%">
				<div align="right"></div>
          ...
          <tr id="trclear"> 
			...
			<tr id="trclear">
				...
				<td nowrap colspan="3">
				<div align="left"><a href="javascript:Calculate()"> </a> <input
					type="text" readonly name="E01ORDTBK" size="17" maxlength="15"
					value="<%= invTrade.getE01ORDTBK()%>" onKeyPress="enterDecimal()">
				</div>
				</td>
			</tr>
			<tr id="trdark">
				...
				<td nowrap colspan="3"><input type="text" readonly name="E01ORDTVL"
					size="17" maxlength="15" value="<%= invTrade.getE01ORDTVL()%>"
					onKeyPress="enterDecimal()"></td>
			</tr>
			<tr id="trclear">
				<td nowrap colspan="4">
			...
			<tr id="trdark">
				<td nowrap width="17%">
				<div align="right"><a
					href="javascript:showInvHolds(document.forms[0].E01ORDCUN.value,document.forms[0].E01ORDHAC.value,document.forms[0].E01ORDST1.value
												,document.forms[0].E01ORDST2.value,document.forms[0].E01ORDST3.value)">
				Balance in <%= invTrade.getE01ORDHCY()%> : </a></div>
				</td>
				<td nowrap colspan="3"><input type="text" readonly name="E01FUTBAL"
					size="17" maxlength="15" value="<%= invTrade.getE01FUTBAL()%>"
					onKeyPress="enterDecimal()"></td>
			</tr>
			<tr id="trclear">
				<td nowrap width="17%" height="37">
				<div align="right">Balance in <%= invTrade.getE01ORDSCY()%> :</div>
				</td>
				<td nowrap colspan="3" height="37"><input type="text" readonly
					name="E01CNVFUB" size="17" maxlength="15"
					value="<%= invTrade.getE01CNVFUB()%>" onKeyPress="enterDecimal()">
				</td>
			</tr>
		</table>
		</td>
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark">
          	<td>
          	<div align="right">Custody Operation Status :</div> </td>
          	<td>
          	<SELECT disabled name="E01ORDF130" size="0">
					<OPTION value="100"
						<%if (invTrade.getE01ORDF13().equals("100")) { out.print("selected"); }%>>Trade
					Live</OPTION>
					<OPTION value="200"
						<%if (invTrade.getE01ORDF13().equals("200")) {  out.print("selected"); }%>>Trade
					No Match</OPTION>
					<OPTION value="300"
						<%if (invTrade.getE01ORDF13().equals("300")) {  out.print("selected"); }%>>Trade
					Holdover</OPTION>
					<OPTION value="400"
						<%if (invTrade.getE01ORDF13().equals("400")) {  out.print("selected"); }%>>Trade
					Posted</OPTION>
				</SELECT></td>          	
          </tr>
          <tr id="trclear">
          	<td>
          	<div align="right">Reason Code :</div> </td>
          	<td>
          	<SELECT disabled name="E01ORDF140" size="0">
				<OPTION value=" "
					<%if (invTrade.getE01ORDF14().equals(" ")) { out.print("selected"); }%>>N/A</OPTION>
				<OPTION value="ADV"
					<%if (invTrade.getE01ORDF14().equals("ADV")) { out.print("selected"); }%>>Counterparty's
				Instructions Comments:</OPTION>
				<OPTION value="CSEC"
					<%if (invTrade.getE01ORDF14().equals("CSEC")) {  out.print("selected"); }%>>Counterparty
				Does not have Security to Deliver</OPTION>
				<OPTION value="OTH"
					<%if (invTrade.getE01ORDF14().equals("OTH")) {  out.print("selected"); }%>>Counterparty
				Did Not Match or Did Not Input Instruction</OPTION>
				<OPTION value="UNM"
					<%if (invTrade.getE01ORDF14().equals("UNM")) {  out.print("selected"); }%>>Counterparty
				Did Not Match or Did Not Input Instruction</OPTION>
				<OPTION value="USEC"
					<%if (invTrade.getE01ORDF14().equals("USEC")) {  out.print("selected"); }%>>We
				Did Not Have Security to Deliver</OPTION>
				<OPTION value="FUT"
					<%if (invTrade.getE01ORDF14().equals("FUT")) {  out.print("selected"); }%>>Trade
				With Match/Future Settlement Comments:</OPTION>
			</SELECT></td>          
          </tr>
        </table>
      </td>
