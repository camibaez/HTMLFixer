...
%> 
<h3 align="center"> Foreign Exchange Swap (Back Office)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basi_swap.jsp, EFE0140B"> 
</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEFE0140" >
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
              <a href="javascript:GetClassFex('E01WKFCLS','SPT','<%= fex.getE01WKFCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
            ...
            <td nowrap > 
			  ...
			  >
                <a href="javascript:GetClassFex('E01WKFFLS','FWR','<%= fex.getE01WKFCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a></div>
            </td>
            <td nowrap >&nbsp;</td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
                <a href="javascript:GetCode('E01WKFRVF','STATIC_fe_bo_rev.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a></div>
            </td>
            <td nowrap colspan="2" > 
            ...
            <td nowrap > 
			  ...
			  >
                <a href="javascript:GetCode('E01WKFNTF','STATIC_fe_bo_not.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a></div>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
			  ...
			  >
                <a href="javascript:GetCode('E01WKFBCT','STATIC_fe_bo_pay.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a></div>
            </td>
            <td nowrap width="17%" >&nbsp;</td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="center">
                ...
                oncontextmenu="showPopUp(branchHelp,this.name,document.forms[0].E01WKFFBK.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01WKFFCU" size="3" maxlength="3" value="<%= fex.getE01WKFFCU()%>"
                oncontextmenu="showPopUp(currencyHelp,this.name,document.forms[0].E01WKFFBK.value,'','','','')">
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01WKFFGL" size="15" maxlength="13" value="<%= fex.getE01WKFFGL()%>"
				oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E01WKFFBK.value,document.forms[0].E01WKFFCU.value,'','','')"  >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01WKFFAC" size="12" maxlength="9" value="<%= fex.getE01WKFFAC()%>"
                oncontextmenu="showPopUp(accountHelp,this.name,document.forms[0].E01WKFFBK.value,'','','','RT')" >
              </div>
            </td>
            <td nowrap > 
              <div align="center">
                <input type="text" name="E01WKFFCC" size="12" maxlength="9" value="<%= fex.getE01WKFFCC()%>"
                oncontextmenu="showPopUp(costcenterHelp,this.name,document.forms[0].E01WKFFBK.value,'','','','')" >
              </div>
            </td>
          </tr>
          <tr id="trclear" > 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" bordercolor="#FFFFFF">
    <tr bgcolor="#FFFFFF"> 
      <td width="33%"> 
        <div align="center"> 
          <input type=image class="imgfilter" name="Submit" src="<%=request.getContextPath()%>/images/e/bt_submit.gif" onMouseDown="this.className='imgfilterpress' "
