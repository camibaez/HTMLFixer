...
<h3 align="center"><%=currUser.getH01WK3().equals("4")?"Interbank ":"Time Deposits "%>- Back Office<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fe_tds.jsp, EDL0130B"></h3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2" > 
              ...
              <a href="javascript:GetProductT('E11DEAPRO','E11DLSPDS','<%= deal.getE11DLSSBT()%>','<%= deal.getE11DEATYP()%>')""><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="10%" > 
              ...
              <a href="javascript:GetAccount('E11EEEACC',document.forms[0].E11DEABNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a> 
              or </td>
            <td nowrap width="36%" >&nbsp;</td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="10%" > 
              ...
              <a href="javascript:GetLedger('E11DDDGLN',document.forms[0].E11DEABNK.value,document.forms[0].E11DEACCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a></td>
            <td nowrap width="36%" >&nbsp;</td>
          </tr>
        </table>
      </td>
