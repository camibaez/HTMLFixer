...
<hr size="4">
  ...
  <table class="tableinfo">
    ...
    <tr> 
      ...
      <td valign="middle" align="center" height=33 width="51%"> 
        <div align="left"> 
	          <input type="text" name="E01TDRTGL" size="20" maxlength="16" value="<%= userPO.getAccNum().trim()%>" onkeypress="enterInteger()"
    ...
    <tr> 
      <td valign="middle" align="center" height=33 width="49%"> 
        <div align="right">Importe D�bito : </div>
      </td>
      <td valign="middle" align="center" height=33 width="51%"> 
        <div align="left"> 
		   	<input type="text" name="E01INPLMI" value="<%= msgList.getE01INPLMI() %>" size="17" maxlength="15" onkeypress="enterDecimal()">              
        </div>
      </td>
    </tr>
    <tr> 
      <td valign="middle" align="center" height=33 width="49%"> 
        <div align="right">Importe Cr�dito : </div>
      </td>
      <td valign="middle" align="center" height=33 width="51%"> 
        <div align="left"> 
		   	<input type="text" name="E01INPLMX" value="<%= msgList.getE01INPLMX() %>" size="17" maxlength="15" onkeypress="enterDecimal()">              
        </div>
      </td>
    </tr>
