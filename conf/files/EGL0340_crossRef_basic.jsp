...
<h3 align="center">Cross References <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="crossRef_basic,EGL0340"></h3>
<hr size="4">      
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEGL0340">
  ...
  <table class="tableinfo">
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        ...
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" name="D02GLMXO32" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX32() %>">
      </td>
    </tr>    
  </table>
  <% } %>
  ...
  <table class="tableinfo"> 
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" name="E02GLMXDR" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXDR() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" name="D02GLMXDR" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXDR() %>">
      </td>
    </tr>
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" name="E02GLMX16" size="13" maxlength="12" value = "<%= crossRef.getE02GLMX16() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" name="D02GLMX16" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX16() %>">
      </td>
    </tr>
  ...
  <table class="tableinfo">
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" name="E02GLMX18" size="17" maxlength="17" value = "<%= crossRef.getE02GLMX18() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" name="D02GLMX18" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX18() %>">
      </td>
    </tr>
    <tr  id="trclear">
  ...
  <% } %>
  <% if (crossRef.getE02GLMACD().equals("13") || crossRef.getE02GLMACD().equals("36")) { %>
  <H4>Investments (Commercial Paper / IRS)</H4>
  <table class="tableinfo">
    <tr  id="trdark">
      <TH align="left" colspan=2>Interests</TH>
    </tr> 
  ...
  <% } %> <% if (crossRef.getE02GLMACD().equals("10") || crossRef.getE02GLMACD().equals("11") || crossRef.getE02GLMACD().equals("12") || crossRef.getE02GLMACD().equals("13") || crossRef.getE02GLMACD().equals("14") || crossRef.getE02GLMACD().equals("15") || crossRef.getE02GLMACD().equals("36")) { %> 
