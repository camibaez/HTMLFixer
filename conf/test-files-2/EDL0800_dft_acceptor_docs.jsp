...
%> 
<h3 align="center">Document Creation<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="dft_acceptor_docs.jsp, EDL0800"> 
</h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap>
        <TABLE id="tblAcceptant" cellpadding="2" cellspacing="0" width="100%" border="0">
          ...
          <tr id="trclear"> 
            <TD nowrap width="19%"> 
              <div align="right">Automatic Creation :</div>
            </TD>
            <TD nowrap colspan="4"> 
          ...
          <tr id="trdark"> 
            <TD nowrap width="19%"> 
              <div align="right">Initial Document :</div>
            </TD>
            <TD nowrap colspan="2"> 
              <INPUT size="6" type="text" name="DFTINIDOC" maxlength="6">
            </TD>
            <TD nowrap width="13%" align="right">Final Document :</TD>
            <TD nowrap width="56%"> 
          ...
          <tr id="trclear"> 
            ...
            <TD nowrap width="8%"> 
              <input type="radio" name="INDFREC" value="D" checked> Day(s) </TD>
            <TD width="13%"></TD>
          ...
          <tr id="trdark"> 
            ...
            <TD nowrap width="8%"> 
              <input type="radio" name="INDFREC" value="M"> Month(s)</TD>
          ...
          <tr id="trclear"> 
            ...
            <TD nowrap width="4%">&nbsp; </TD>
            <TD nowrap width="8%"> 
              <input type="radio" name="INDFREC" value="Y"> Year(s)</TD>
            <TD nowrap width="13%"></TD>
            <TD nowrap width="56%"></TD>
          </tr>
          <tr id="trdark"> 
            <TD nowrap width="19%"> 
              <div align="right">First Expiration Date :</div>
            </TD>
            <TD nowrap colspan="2"> 
          ...
          <tr id="trclear"> 
            ...
            <TD nowrap width="13%" align="right">Document Interest Rate :</TD>
            <TD nowrap width="56%"> 
          ...
          <tr id="trdark"> 
            <TD nowrap width="19%"> 
              <div align="right">Automatic Debit Account :</div>
            </TD>
            <TD nowrap colspan="2"> 
