...
<script language="JavaScript">
  function getValor(Reference,Dealer,Type,actiontaken) {
...
<h3 align="center">Back Office Selection<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel.jsp,EWD0325BO"></h3>
<hr size="4">
<%
 ...
 <TR > 
  ...
  <table id="headTable" width="100%" >
    <tr id="trdark"> 
        ...
        <th align=CENTER nowrap >Counterparty <br> Name</th>
        <th align=CENTER nowrap > 
