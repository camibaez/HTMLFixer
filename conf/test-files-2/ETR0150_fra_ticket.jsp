...
<meta http-equiv="Refresh" CONTENT="10;url='<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEWD0332M?SCREEN=1'">
...
%> 
<h3 align="center"> Forward Rates Agreements - Settlement - Ticket
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fra_ticket.jsp,ETR0150">
</h3>
<hr size="4">
    ...
    <tr> 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
            ...
            <td nowrap colspan="2"><%= fra.getE01FRANRT().trim()  %> 
            </td> 
        </table>
      </td> 
    </tr>
