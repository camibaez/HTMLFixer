...
<SCRIPT Language="Javascript">
  ...
  %>
	 builtNewMenu(tds_bo_opt);
 <%   
    }
     else if ( userPO.getHeader3().equals("TPS") ) {
  %>
	 builtNewMenu(tps_bo_opt);
     
  <%   
    }
     else if ( userPO.getHeader3().equals("FFS") ) {
  %>
	 builtNewMenu(ffs_bo_opt); 
   <%   
    }
     else if ( userPO.getHeader3().equals("ACC") ) {
  %>
	 builtNewMenu(acc_bo_opt);
  <%
    }	
   else if ( userPO.getHeader3().equals("SPT") ) {
  %>
	 builtNewMenu(spt_bo_opt);
  <%
    }	
   else if ( userPO.getHeader3().equals("FWD") ) {
  %>
	 builtNewMenu(fwd_bo_opt);
  <%
    }	
   else if ( userPO.getHeader3().equals("NDF") ) {
  %>
	 builtNewMenu(ndf_bo_opt);
  <%
    }	
   else if ( userPO.getHeader3().equals("OPT") ) {
  %>
	 builtNewMenu(opt_bo_opt);
   <%
    }	
   else if ( userPO.getHeader3().equals("SWP") ) {
  %>
	 builtNewMenu(swp_bo_opt);
  <%
   }
    else if ( userPO.getHeader3().equals("PLP") ) {
  %>
	 builtNewMenu(plp_bo_opt);
  <%
   }
  %>
...
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSESW100" >
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap > 
			  ...
			  >
              <a href="javascript:GetSwiftIdDesc('E01SWFRID','E01SWFRNM')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a> 
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="22%" > 
              <div align="left"><a href="javascript:DisabledRef('E01SWFIN1','E01SWFIN4',document.forms[0].E01SWFINO.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="22%" > 
              <div align="left"><a href="javascript:DisabledRef('E01SWFBB1','E01SWFBB4',document.forms[0].E01SWFBBO.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="22%" > 
              <div align="left"><a href="javascript:DisabledRef('E01SWFSC1','E01SWFSC4',document.forms[0].E01SWFSCO.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a></div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> 
            ...
            <td nowrap width="22%" > 
              <div align="left"><a href="javascript:DisabledRef('E01SWFBC1','E01SWFBC4',document.forms[0].E01SWFBCO.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="22%" > 
              <div align="left"><a href="javascript:DisabledRef('E01SWFRC1','E01SWFRC4',document.forms[0].E01SWFRBO.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"></a></div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> 
