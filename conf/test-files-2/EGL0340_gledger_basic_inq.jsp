...
%> 
<H3 align="center">General Ledger Account Master File Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="gledger_basic_inq.jsp, EGL0340"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3">                
                <input type="text" readonly  name="E01GLMBNK" size="2" maxlength="2" value="<%= gLedger.getE01GLMBNK().trim()%>" >                             
                <input type="text" readonly  name="E01GLMCCY" size="3" maxlength="3" value="<%= gLedger.getE01GLMCCY().trim()%>" >              
                <input type="text" readonly  name="E01GLMGLN" size="17" maxlength="16"  value="<%= gLedger.getE01GLMGLN().trim()%>" >              
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="29%"> 
            ...
            <td nowrap colspan="3"> 
              <input type="text" readonly  name="E01GLMDSC" size="36" maxlength="35" value="<%= gLedger.getE01GLMDSC().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="19%">
              <input type="text" readonly  name="E01GLMATY" size="5" maxlength="4" value="<%= gLedger.getE01GLMATY().trim()%>">
            ...
            <td nowrap width="26%">
             <input type="text" readonly  name="E01GLMCLS" size="3" maxlength="2" value="<%= gLedger.getE01GLMCLS()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="19%">
              <INPUT type="radio" name="E01GLMCCN" value="Y" <%if(gLedger.getE01GLMCCN().equals("Y")) out.print("checked");%> disabled>
              Yes 
            ...
            <td nowrap width="26%">
             <input type="text" readonly  name="E01GLMCIC" size="3" maxlength="2" value="<%= gLedger.getE01GLMCIC()%>">
		  ...
		  <tr id="trdark">
            ...
            <td nowrap width="19%">
              <INPUT type="radio" name="E01GLMRCL" value="Y" <%if(gLedger.getE01GLMRCL().equals("Y")) out.print("checked");%> disabled>
              Yes 
            ...
            <td nowrap width="26%">
              <INPUT type="radio" name="E01GLMDST" value="Y" <%if(gLedger.getE01GLMDST().equals("Y")) out.print("checked");%> disabled>
              Yes 
              <INPUT type="radio" name="E01GLMDST" value="N" <%if(!gLedger.getE01GLMDST().equals("Y")) out.print("checked");%> disabled> No
            </td>
         </tr>
          <tr id="trclear"> 
            <td nowrap width="29%"> 
            ...
            <td nowrap width="19%" height="19">
              <INPUT type="radio" name="E01GLMIBF" value="IB" <%if(gLedger.getE01GLMIBF().equals("IB")) out.print("checked");%> disabled>
              Yes 
              <INPUT type="radio" name="E01GLMIBF" value="" <%if(!gLedger.getE01GLMIBF().equals("IB")) out.print("checked");%> disabled> No
            </td>		  
            <td nowrap width="26%"> 
              <div align="right">Accounting Level :</div>
            </td>
            <td nowrap width="26%"> 
              <input type="text" readonly  name="E01GLMACL" size="2" maxlength="1" value="<%= gLedger.getE01GLMACL().trim()%>" onkeypress="enterInteger()">
            </td>
          <tr id="trdark"> 
            <td nowrap width="29%"> 
            ...
            <td nowrap width="19%">
              <INPUT type="radio" name="E01GLMPRV" value="Y" <%if(gLedger.getE01GLMPRV().equals("Y")) out.print("checked");%> disabled>
              Yes 
            ...
            <td nowrap width="26%">
              <input type="text" readonly  name="E01GLMBUN" size="13" maxlength="12" value="<%= gLedger.getE01GLMBUN()%>" onKeyPress="enterInteger()">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="19%">
              <INPUT type="radio" name="E01GLMMEF" value="Y" <%if(gLedger.getE01GLMMEF().equals("Y")) out.print("checked");%> disabled>
              Yes 
            ...
            <td nowrap width="26%">
              <INPUT type="radio" name="E01GLMF51" value="Y" <%if(gLedger.getE01GLMF51().equals("Y")) out.print("checked");%> disabled>
              Yes 
              <INPUT type="radio" name="E01GLMF51" value="N" <%if(!gLedger.getE01GLMF51().equals("Y")) out.print("checked");%> disabled> No
            </td>                    
          </tr> 
          <tr id="trdark"> 
            <td nowrap> 
            ...
            <td nowrap>
              <input type="text" readonly  name="E01GLMHOA" size="21" maxlength="20" value="<%= gLedger.getE01GLMHOA()%>">
            </td>          
            <td nowrap width="26%" height="19"> 
              <div align="right">Rate Sensitivity Analysis :</div>
            </td>
            <td nowrap width="26%" height="19">
              <input type="text" readonly  name="E01GLMFR6" size="5" maxlength="5" value="<%= gLedger.getE01GLMFR6().trim()%>">
            </td>
          </tr>      
          <tr id="trclear"> 
            <td nowrap> 
            ...
            <td nowrap width="26%">
              <INPUT type="radio" name="E01GLMF52" value="D" <%if(gLedger.getE01GLMF52().equals("D")) out.print("checked");%> disabled>
              Detail 
              <INPUT type="radio" name="E01GLMF52" value="T" <%if(!gLedger.getE01GLMF52().equals("D")) out.print("checked");%> disabled> Total
            </td>                       
          </tr>      
          <tr id="trclear"> 
            <td nowrap> 
            ...
            <td nowrap>
              <input type="text" readonly  name="E01GLMBRC" size="4" maxlength="3" value="<%= gLedger.getE01GLMBRC() %>">
            ...
            <td nowrap width="26%">
              <input type="text" readonly  name="E01GLMF43" size="2" maxlength="1" value="<%= gLedger.getE01GLMF43().trim()%>">
              <input type="text" readonly  name="E01GLMF44" size="2" maxlength="1" value="<%= gLedger.getE01GLMF44().trim()%>">
              <input type="text" readonly  name="E01GLMF45" size="2" maxlength="1" value="<%= gLedger.getE01GLMF45().trim()%>">
            </td>                       
          </tr>      
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="71%">                
              <SELECT name="E01GLMF11" disabled>
                ...
                <input type="text" readonly  name="E01GLMF12" size="2" maxlength="1" value="<%= gLedger.getE01GLMF12().trim()%>">                                             
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="29%"> 
            ...
            <td nowrap width="71%">                
                <input type="text" readonly  name="E01GLMF21" size="2" maxlength="1" value="<%= gLedger.getE01GLMF21().trim()%>">                             
                <input type="text" readonly  name="E01GLMF22" size="2" maxlength="1" value="<%= gLedger.getE01GLMF22().trim()%>">                                             
                <input type="text" readonly  name="E01GLMF23" size="2" maxlength="1" value="<%= gLedger.getE01GLMF23().trim()%>">                             
                <input type="text" readonly  name="E01GLMF24" size="2" maxlength="1" value="<%= gLedger.getE01GLMF24().trim()%>">                                             
                <input type="text" readonly  name="E01GLMF25" size="2" maxlength="1" value="<%= gLedger.getE01GLMF25().trim()%>">                             
                &nbsp;
                (Lines 12345 = + or -)
            </td>
          </tr>     
          <tr id="trdark"> 
            ...
            <td nowrap width="71%">  
               <SELECT name="E01GLMF32" disabled>
               ...
               Form BC :
               &nbsp;           
               <SELECT name="E01GLMF35" disabled>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="71%">                
               <SELECT name="E01GLMF33" disabled>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="71%">  
               <SELECT name="E01GLMF41" disabled>
				...
				Form BQ2 :
                &nbsp;
               <SELECT name="E01GLMF42" disabled>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="71%">  
               <SELECT name="E01GLMF43" disabled>
				...
				Row :
                &nbsp;
               <SELECT name="E01GLMF44" disabled>
