...
<SCRIPT Language="Javascript">
  ...
  function paymentterms() {
  	var lip = document.getElementById("E01OFFLIP");
  	var lpp = document.getElementById("E01OFFLPP");
  	if (lip.selectedIndex == 3) {
  		document.forms[0].E01OFFLIP1.value = "";
  		document.forms[0].E01OFFLIP1.disabled = false;
  	}
  	else {
  		document.forms[0].E01OFFLIP1.value = "";
  		document.forms[0].E01OFFLIP1.disabled = true;
  	}
  	
  	if (lpp.selectedIndex == 3) {
  		document.forms[0].E01OFFLPP1.value = "";
  		document.forms[0].E01OFFLPP1.disabled = false;
  	}
  	else {
  		document.forms[0].E01OFFLIP1.value = "";
  		document.forms[0].E01OFFLPP1.disabled = true;
  	}
 }
 
function goAction(op) {
   var pg = "<%=request.getContextPath()%>/servlet/datapro.eibs.credit.JSELN0185?SCREEN=6&OFF=" + document.forms[0].E01OFFNUM.value;
   CenterWindow(pg,600,500,2);
}

function highlight() {
	if (document.forms[0].E01EXCPT.value != "") {
		btnExc.style.color = "#FF0000";
	}
	else {
		btnExc.style.color = "#009900";
	}
}
...
<h3 align="center">Offering Memorandum<br>Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="offering_memo_maint.jsp, ELN0185"></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.credit.JSELN0185" >
  ...
  <!-- Fields in Exception Page  -->
  <input type=hidden name="E01EXCP1" value="<%= msgOff.getE01EXCP1() %>">
  <input type=hidden name="E01EXCP2" value="<%= msgOff.getE01EXCP2() %>">
  <input type=hidden name="E01EXCP3" value="<%= msgOff.getE01EXCP3() %>">
  <input type=hidden name="E01EXCP4" value="<%= msgOff.getE01EXCP4() %>">
  <input type=hidden name="E01EXCP5" value="<%= msgOff.getE01EXCP5() %>">
  <input type=hidden name="E01OUTSB" value="<%= msgOff.getE01OUTSB() %>">
  <input type=hidden name="E01OFFRKE" value="<%= msgOff.getE01OFFRKE() %>">
  <input type=hidden name="E01TRAEQV" value="<%= msgOff.getE01TRAEQV() %>">
  <input type=hidden name="E01OFFLLM" value="<%= msgOff.getE01OFFLLM() %>">
  <input type=hidden name="E01EXCBAL" value="<%= msgOff.getE01EXCBAL() %>">
  <!-- End -->
      ...
      <td nowrap>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="28%" colspan="2">
				<input type="text" name="E01OFFCR1" size="66" maxlength="65" value="<%= msgOff.getE01OFFCR1() %>"><br>
				<input type="text" name="E01OFFCR2" size="66" maxlength="65" value="<%= msgOff.getE01OFFCR2() %>"><br>
				<input type="text" name="E01OFFCR3" size="66" maxlength="65" value="<%= msgOff.getE01OFFCR3() %>"><br>
				<input type="text" name="E01OFFCR4" size="66" maxlength="65" value="<%= msgOff.getE01OFFCR4() %>"><br>
				<input type="text" name="E01OFFCR5" size="66" maxlength="65" value="<%= msgOff.getE01OFFCR5() %>">
            </td>
            <td class=TDBKG nowrap width="24%" >
              	<INPUT TYPE="hidden" NAME="E01EXCPT" VALUE="<%= msgOff.getE01EXCPT() %>">
        		<div align="center"><a href="javascript:goAction(4)" id="btnExc"><b>Exceptions</b></a></div>
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="28%" >
            	<input type="text" name="E01OFFCMD1" size="3" maxlength="2" value=""  onkeypress="enterInteger()">
            	<input type="text" name="E01OFFCMD2" size="3" maxlength="2" value=""  onkeypress="enterInteger()">
            	<input type="text" name="E01OFFCMD3" size="3" maxlength="2" value=""  onkeypress="enterInteger()">
            	<a href="javascript:DatePicker(document.forms[0].E01OFFCMD1,document.forms[0].E01OFFCMD2,document.forms[0].E01OFFCMD3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absbottom" border="0"></a>
            </td>
            <td nowrap width="22%" >
            	<div align="right">Terms :</div>
            </td>
            <td nowrap width="18%" >
            	<input type="text" name="E01OFFLTR" size="4" maxlength="3" value="<%= msgOff.getE01OFFLTR().trim()%>" onkeypress="enterInteger()">
            	<select name="E01OFFTRC">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="28%" >
            	<input type="text" name="E01OFFLFT" size="3" maxlength="2" value="<%= msgOff.getE01OFFLFT().trim()%>">
            	<a href="javascript:GetFloating('E01OFFLFT')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0"  ></a>
            </td>
            <td nowrap width="22%" >
            	<div align="right">Floating Rate Type Code :</div>
            </td>
            <td nowrap width="18%" >
            	<select name="E01OFFLTY">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="28%" >
            	<input type="text" name="E01OFFLSP" size="13" maxlength="12" value="<%= msgOff.getE01OFFLSP().trim()%>" onKeypress="enterSignDecimal()">
            </td>
            <td nowrap width="22%" >
            	<div align="right">Loan Table :</div>
            </td>
            <td nowrap width="18%" >
            	<input type="text" name="E01OFFLTF" size="3" maxlength="2" value="<%= msgOff.getE01OFFLTF().trim()%>">
            	<a href="javascript:GetLoanTable('E01OFFLTF','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a>
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="32%" >
            ...
            <td nowrap width="28%" >
            	<input type="text" name="E01OFFLRT" size="4" maxlength="3" value="<%= msgOff.getE01OFFLRT().trim()%>">
				<a href="javascript:GetCode('E01OFFLRT','STATIC_ln_rate_rev.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absbottom" border="0" ></a>
            	<select name="E01OFFLTF">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="28%" >
            	<input type="radio" name="E01OFFIBF" value="Y" <%if (msgOff.getE01OFFIBF().equals("Y")) out.print("checked"); %>>Yes
            	<input type="radio" name="E01OFFIBF" value="N" <%if (msgOff.getE01OFFIBF().equals("N")) out.print("checked"); %>>No
			</td>
            <td nowrap width="22%" >
            </td>
            <td nowrap width="18%" >
          ...
          <tr id="trclear">
            ...
            <td nowrap width="28%" >
            	<select name="E01OFFLIP" id="E01OFFLIP" onChange="javascript:paymentterms()">
            	...
            	<input type="text" name="E01OFFLIP1" size="4" maxlength="3" value="<% if (!(msgOff.getE01OFFLIP().equals("SCH") || msgOff.getE01OFFLIP().equals("MAT") || msgOff.getE01OFFLIP().equals(""))) out.print(msgOff.getE01OFFLIP().trim()); %>" <% if (!msgOff.getE01OFFLIP().equals("NNN")) out.print("disabled"); %>>
            </td>
            <td nowrap width="22%" >
            	<div align="right">Principal Payment Term Period :</div>
            </td>
            <td nowrap width="18%" >
            	<select name="E01OFFLPP" id="E01OFFLPP" onChange="javascript:paymentterms()">
            	...
            	<input type="text" name="E01OFFLPP1" size="4" maxlength="3" value="<% if (!(msgOff.getE01OFFLPP().equals("SCH") || msgOff.getE01OFFLPP().equals("MAT") || msgOff.getE01OFFLPP().equals(""))) out.print(msgOff.getE01OFFLPP().trim()); %>" <% if (!msgOff.getE01OFFLPP().equals("NNN")) out.print("disabled"); %>>
            </td>
          </tr>
        </table>
      </td>
      ...
      <TD>
        <table class="tableinfo" style="filter:''">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLBK" size="2" maxlength="2" value="<%= msgOff.getE01OFFLBK().trim()%>">
			  </div>
            </td>
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLBR" size="4" maxlength="3" value="<%= msgOff.getE01OFFLBR().trim()%>"
           		oncontextmenu="showPopUp(branchHelp,this.name,document.forms[0].E01OFFLBK.value,'','','','')" onkeypress="enterInteger()">
              </div>
            </td>
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLCY" size="3" maxlength="3" value="<%= msgOff.getE01OFFLCY().trim()%>"
				oncontextmenu="showPopUp(currencyHelp,this.name,document.forms[0].E01OFFLBK.value,'','','','')">
			  </div>
            </td>
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLGL" size="13" maxlength="12" value="<%= msgOff.getE01OFFLGL().trim()%>" onkeypress="enterInteger()"
				oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E01OFFLBK.value,document.forms[0].E01OFFLCY.value,'','','')">
			  </div>
            </td>
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLAC" size="13" maxlength="12" value="<%= msgOff.getE01OFFLAC().trim()%>"
				oncontextmenu="showPopUp(accountCustomerHelp,this.name,document.forms[0].E01OFFLBK.value,'','','','RT')" onKeyPress="enterInteger()">
			  </div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLDB" size="2" maxlength="2" value="<%= msgOff.getE01OFFLDB().trim()%>">
			  </div>
            </td>
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLDR" size="4" maxlength="3" value="<%= msgOff.getE01OFFLDR().trim()%>"
           		oncontextmenu="showPopUp(branchHelp,this.name,document.forms[0].E01OFFLDB.value,'','','','')" onkeypress="enterInteger()">
              </div>
            </td>
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLDC" size="3" maxlength="3" value="<%= msgOff.getE01OFFLDC().trim()%>"
				oncontextmenu="showPopUp(currencyHelp,this.name,document.forms[0].E01OFFLDB.value,'','','','')">
			  </div>
            </td>
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLDG" size="13" maxlength="12" value="<%= msgOff.getE01OFFLDG().trim()%>" onkeypress="enterInteger()"
				oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E01OFFLDB.value,document.forms[0].E01OFFLDC.value,'','','')">
			  </div>
            </td>
            <td nowrap width="16%" >
              <div align="center">
            	<input type="text" name="E01OFFLDA" size="13" maxlength="12" value="<%= msgOff.getE01OFFLDA().trim()%>"
				oncontextmenu="showPopUp(accountCustomerHelp,this.name,document.forms[0].E01OFFLDB.value,'','','','RT')" onKeyPress="enterInteger()">
			  </div>
            </td>
          </tr>
        </table>
      ...
      <td nowrap>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="17%" >
            	<input type="text" name="E01OFFCTC" size="3" maxlength="2" value="<%= msgOff.getE01OFFCTC().trim()%>">
            	<a href="javascript:GetTariffLC('E01OFFCTC','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a>
            </td>
            <td nowrap width="22%" >
            	<div align="right">Letter of Credit Type :</div>
            </td>
            <td nowrap width="40%" >
          		<input type="text" name="E01OFFCTY" size="3" maxlength="2" value="<%= msgOff.getE01OFFCTY().trim()%>">
          		<a href="javascript:GetCode('E01OFFCTY','STATIC_typ_lc.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absbottom" border="0" ></a>
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="21%" >
            ...
            <td nowrap width="17%" >
            	<input type="radio" name="E01OFFCCF" value="Y" <%if (msgOff.getE01OFFCCF().equals("Y")) out.print("checked"); %>>Yes
            	<input type="radio" name="E01OFFCCF" value="N" <%if (msgOff.getE01OFFCCF().equals("N")) out.print("checked"); %>>No
            </td>
            <td nowrap width="22%" >
            	<div align="right">General Ledger Number :</div>
            </td>
            <td nowrap width="40%" >
            	<input type="text" name="E01OFFCGL" size="13" maxlength="12" value="<%= msgOff.getE01OFFCGL().trim()%>"  onkeypress="enterInteger()">
            	<a href="javascript:GetLedger('E01OFFCGL','',document.forms[0].E01OFFCCY.value,'LC')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absbottom" border="0" ></a>
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="21%" >
      ...
      <td nowrap>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="28%" >
            	<input type="text" name="E01OFFLRT" size="4" maxlength="3" value="<%= msgOff.getE01OFFLRT().trim()%>">
				<a href="javascript:GetCode('E01OFFLRT','STATIC_ln_rate_rev.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0" ></a>
            	<select name="E01OFFLTF">
            		<option value=" " <% if (!(msgOff.getE01OFFLTF().equals("D") || msgOff.getE01OFFLTF().equals("M") || msgOff.getE01OFFLTF().equals("Y"))) out.print("selected"); %>></option>
            		<option value="D" <% if(msgOff.getE01OFFLTF().equals("D")) out.print("selected");%>>Day(s)</option>
            		<option value="M" <% if(msgOff.getE01OFFLTF().equals("M")) out.print("selected");%>>Month(s)</option>
