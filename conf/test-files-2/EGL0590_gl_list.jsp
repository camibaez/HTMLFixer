...
<BODY>
<h3 align="center">Treasury G/L Account<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="gl_list.jsp, EGL0590"></h3>
<hr size="4">
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="20%">G/L Number</th>
            ...
            <th align=CENTER nowrap width="20%"> 
              <div align="center">Begining Balance</div>
            </th>
          </tr>
          <%
          glList.initRow();
