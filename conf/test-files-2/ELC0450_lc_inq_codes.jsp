...
<h3 align="center">Letter Of Credit Inquiry [Classification Codes]<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_inq_codes.jsp, ELC0450"></h3>
<hr size="4">
 <FORM >
    ...
    <tr > 
      <td nowrap > 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark">
            <td nowrap width="30%">
              <div align="right">Sale Chanel :</div>
            </td>
            <td nowrap width="70%">
          ...
          <tr id="trclear"> 
            <td nowrap width="30%"> 
              <div align="right">Sales Information Source :</div>
            </td>
            <td nowrap width="70%"> 
