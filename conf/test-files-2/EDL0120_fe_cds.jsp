...
%> 
<h3 align="center"> Certificate of Deposit<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_cds.jsp, EDL0120"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
			  ...
			  >
              <a href="javascript:DatePicker(document.forms[0].E01DLSVD1,document.forms[0].E01DLSVD2,document.forms[0].E01DLSVD3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="middle" border="0"></a> 
            </td>
            ...
            <td nowrap> 
			  ...
			  >
              <a href="javascript:DatePicker(document.forms[0].E01DLSMA1,document.forms[0].E01DLSMA2,document.forms[0].E01DLSMA3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="middle" border="0"></a> 
            </td>
          </tr>
          ...
          <TR id="trdark">
			...
			<TD nowrap width="23%"><INPUT type="text" name="E01DLSLCU" size="9" maxlength="9" value="0" onKeyPress="enterInteger()">
	...
	<TBODY>
		<TR>
			...
			<TABLE cellpadding="2" cellspacing="0" border="0" width="100%">
				<TBODY>
					<TR id="trdark0">
						<TD nowrap width="21%" align="right">Trade Date :</TD><TD nowrap width="35%"> 
              ...
              <A href="javascript:DatePicker(document.forms[0].E01DLSDD1,document.forms[0].E01DLSDD2,document.forms[0].E01DLSDD3)"><IMG src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="middle" border="0"></A> 
            </TD>
					...
					<TR id="trclear">
						...
						<TD nowrap width="35%"><INPUT type="text" name="E01DLSTRM" size="6" maxlength="5" value="<%= deal.getE01DLSTRM().trim()%>" readonly>
						...
						<TD nowrap width="35%" align="right">Amount at Maturity :</TD>
