...
<BODY>
<H3 align="center">Export Comercial Letter Of Credit Approval Inquiry [Basic Information]
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_opening_export.jsp, ELC0525"></H3>
<HR size="4">
<FORM>
<BR>
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo" id="trclear">
	...
	<TR>
	  <TD align="right" nowrap="nowrap"><B>Our Reference :</B></TD>
		...
		<TD nowrap="nowrap"><B>
		  <INPUT type="text" name="E01LCMPRO" size="4" maxlength="4" value="<%=msg050001.getE01LCMPRO().trim()%>" readonly>
		</B></TD>
	</TR>
	<TR id="trdark">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF2" disabled>
      <OPTION value=" "
								...
								selected></OPTION>
      <OPTION value="C" <%if (msg050001.getE01LCMAF2().equals("C")) out.print("selected");%>>CIF</OPTION>
      <OPTION value="A" <%if (msg050001.getE01LCMAF2().equals("A")) out.print("selected");%>>DDA</OPTION>
    </SELECT>
        <INPUT name="E01LCMAPA" type="text" value="<%=msg050001.getE01LCMAPA()%>" size="12"
  ...
  <TR id="">
    ...
    <TD align="left"><INPUT name="E01LCMAP5" type="text"
      ...
      <INPUT
							...
							value="<%=msg050001.getE01LCMAP6()%>" size="11" maxlength="10" readonly="readonly">
      Country :
      <INPUT
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF3" disabled>
        ...
        <OPTION value="C" <%if (msg050001.getE01LCMAF3().equals("C")) out.print("selected");%>>CIF</OPTION>
        <OPTION value="A" <%if (msg050001.getE01LCMAF3().equals("A")) out.print("selected");%>>DDA</OPTION>
      </SELECT>
  ...
  <TR id="">
    ...
    <TD align="left"><INPUT name="E01LCMBN5" type="text"
							value="<%=msg050001.getE01LCMBN5()%>" size="2" maxlength="2" readonly="readonly">
      Zip Code :
      <INPUT
							name="E01LCMBN6" type="text"
							value="<%=msg050001.getE01LCMBN6()%>" size="11" maxlength="10" readonly="readonly">
      Country :
      <INPUT
      ...
      <TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
          ...
          <TR id="">
            ...
            <TD nowrap><SELECT name="E01LCMAF1" disabled>
                <OPTION value=" "></OPTION>
<OPTION value="C" <%if (msg050001.getE01LCMAF1().equals("C")) out.print("selected");%>>CIF</OPTION>
                <OPTION value="A" <%if (msg050001.getE01LCMAF1().equals("A")) out.print("selected");%>>DDA</OPTION>
              </SELECT>
                <INPUT name="E01LCMIBA" type="text" value="<%=msg050001.getE01LCMIBA()%>" size="12" maxlength="12" readonly="readonly">
                </TD>
          </TR>
          <TR id="">
            <TD align="right">Swift Code :</TD>
            <TD align="left" nowrap><INPUT name="E01LCMIBI" type="text" value="<%=msg050001.getE01LCMIBI()%>" size="14" maxlength="12" readonly="readonly">
             </TD>
          </TR>
          <TR id="">
            <TD align="right">Name :</TD>
            <TD align="left" nowrap><INPUT name="E01LCMIB1" type="text" value="<%=msg050001.getE01LCMIB1()%>" size="45" maxlength="35" readonly="readonly">
              </TD>
          </TR>
          <TR id="">
            <TD align="right">Address :</TD>
            <TD align="left"><INPUT name="E01LCMIB2" type="text" value="<%=msg050001.getE01LCMIB2()%>" size="45" maxlength="35" readonly="readonly">
            </TD>
          </TR>
          <TR id="">
            <TD></TD>
            <TD align="left"><INPUT name="E01LCMIB3" type="text" value="<%=msg050001.getE01LCMIB3()%>" size="45" maxlength="35" readonly="readonly"></TD>
          </TR>
          <TR id="">
            <TD></TD>
            <TD align="left"><INPUT name="E01LCMIB4" type="text" value="<%=msg050001.getE01LCMIB4()%>" size="45" maxlength="35" readonly="readonly">
            </TD>
          </TR>
          <TR id="">
            <TD align="right" valign="bottom">State :</TD>
            <TD align="left" valign="bottom" nowrap><INPUT name="E01LCMIB5" type="text" value="<%=msg050001.getE01LCMIB5()%>" size="2" maxlength="2" readonly="readonly">
              Zip Code :
              <INPUT name="E01LCMIB6" type="text" value="<%=msg050001.getE01LCMIB6()%>" size="11" maxlength="10" readonly="readonly">
              Country :
              <INPUT name="E01LCMIB7" type="text" value="<%=msg050001.getE01LCMIB7()%>" size="4" maxlength="4" readonly="readonly">
               </TD>
          </TR>
      </TABLE>
	 <BR>
      <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
        ...
        <TR id="">
          <TD align="right" valign="bottom">State : </TD>
          <TD align="left" nowrap><INPUT name="E01LCMCA5" type="text" value="<%=msg050001.getE01LCMCA5()%>" size="2" maxlength="2" readonly="readonly">
            Zip Code :
            <INPUT name="E01LCMCA6" type="text" value="<%=msg050001.getE01LCMCA6()%>" size="11" maxlength="10" readonly="readonly">
            Country :
            <INPUT name="E01LCMCA7" type="text" value="<%=msg050001.getE01LCMCA7()%>" size="3" maxlength="7" readonly="readonly">
            </TD>
        </TR>
      </TABLE>
      <BR>
      <TABLE width="100%" border="0" align="center" cellpadding="2"  cellspacing="0" class="tableinfo">
        ...
        <TR id="">
          ...
          <TD align="left" nowrap><INPUT name="E01LCMCB5" type="text" id="E01LCMCB5" value="<%=msg050001.getE01LCMCB5()%>" size="2" maxlength="2" readonly="readonly">
            Zip Code :
            <INPUT name="E01LCMCB6" type="text" id="E01LCMCB6" value="<%=msg050001.getE01LCMCB6()%>" size="11" maxlength="10" readonly="readonly">
            Country :
      ...
      <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
        ...
        <TR id="">
          <TD align="right" valign="bottom">State :</TD>
          <TD align="left" valign="bottom" nowrap><INPUT name="E01LCMRB5" type="text" value="<%=msg050001.getE01LCMRB5()%>" size="2" maxlength="2" readonly="readonly">
            Zip Code :
            <INPUT name="E01LCMRB6" type="text" value="<%=msg050001.getE01LCMRB6()%>" size="11" maxlength="10" readonly="readonly">
            Country :
