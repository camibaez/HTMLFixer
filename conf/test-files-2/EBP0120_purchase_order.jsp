...
<html> 
<head>
<title>BAP Purchase Order Header</title>
...
<H3 align="center">Purchase Order<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bap_operators.jsp, EBP0120"></H3>
<hr size="4">
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap width="15%" align="right">Vendor : </td>
            ...
            <td nowrap width="15%" align="right">Vendor Name : </td>
            <td nowrap width="35%" align="left">
            	<INPUT type="text" name="E01BPVNM1" size="40" value="<%= EBP0120Record.getE01BPVNM1().trim()%>" readonly></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="15%" align="right">Total Amount : </td>
			<td nowrap width="35%" align="left">
          ...
          <tr id="trdark"> 
			...
			<td nowrap width="35%" align="left">
			  ...
			  <IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatory Field" align="bottom"></B>
            </td>
            <td nowrap width="15%" align="right"> Maximum Amount : </td>
			<td nowrap width="35%" align="left">
          ...
          <tr id="trclear"> 
			...
			<td nowrap width="35%" align="left"> 
              <SELECT name="E01BPOPST" <%= disabled %>>
					<OPTION <%= EBP0120Record.getE01BPOPST().trim().equals("A")?"Selected":"" %> value="A">Active</OPTION>
					<OPTION <%= EBP0120Record.getE01BPOPST().trim().equals("I")?"Selected":"" %> value="I">Inactive</OPTION>
				</SELECT>
	 		</td>
            <td nowrap width="15%" align="right"></td>
