      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" disabled name="E01ORDPRB" size="17" maxlength="15" value="<%= invTrade.getE01ORDPRB()%>" onKeyPress="enterDecimal()">
          ...
          <tr id="trclear">
            <td nowrap width="17%" ><tr id="trdark"> 
            <td nowrap width="17%" > 
           ...
           <tr id="trdark">
            ...
            <td nowrap width="33%"" > 
              <input type="text" disabled name="E01ORDF6C" size="6" maxlength="6" value="<%= invTrade.getE01ORDF6C()%>">
