...
<h3 align="center">Beneficiaries <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_bene.jsp, EDL0130B"></h3>
<hr size="4">
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark">
            <td nowrap width="16%">
              <div align="right"><font face="Arial"><font face="Arial"><font size="2"><b>Account
          ...
          <tr id="trclear">
            ...
            <td width="58%" nowrap >
              <select name="E<%= name %>4BMS">
                <option value="M" <% if (bene.getField("E" + name + "4BMS").getString().equals("M")) out.print("selected"); %>>Married</option>
                <option value="S" <% if (bene.getField("E" + name + "4BMS").getString().equals("S")) out.print("selected"); %>>Single</option>
                <option value="D" <% if (bene.getField("E" + name + "4BMS").getString().equals("D")) out.print("selected"); %>>Divorced</option>
                <option value="W" <% if (bene.getField("E" + name + "4BMS").getString().equals("W")) out.print("selected"); %>>Widower</option>
                <option value="L" <% if (bene.getField("E" + name + "4BMS").getString().equals("L")) out.print("selected"); %>>Legally Separated</option>
                <option value="O" <% if (bene.getField("E" + name + "4BMS").getString().equals("O")) out.print("selected"); %>>Other</option>
                <option value="U" <% if (bene.getField("E" + name + "4BMS").getString().equals("U")) out.print("selected"); %>>Unassigned</option>
                <option value="" <% if ( !(bene.getField("E" + name + "4BMS").getString().equals("S") ||
                						   bene.getField("E" + name + "4BMS").getString().equals("M") || 
                						   bene.getField("E" + name + "4BMS").getString().equals("D") || 
                						   bene.getField("E" + name + "4BMS").getString().equals("W") || 
                						   bene.getField("E" + name + "4BMS").getString().equals("L") || 
                						   bene.getField("E" + name + "4BMS").getString().equals("O") || 
                						   bene.getField("E" + name + "4BMS").getString().equals("U"))) out.print("selected"); %>></option>
              </select>
              </td>
          </tr>
          <tr id="trdark">
