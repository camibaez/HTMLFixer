...
<H3 align="center">Letter Of Credit Maintenance<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="lc_enter_maint, ELC0510"></H3>
<HR size="4">
  ...
  <TABLE class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
    <TR>
      ...
      <TD nowrap width="50%">
        ...
        <A href="javascript:GetAccount('E01LCMACC','','CC','')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></A>
      </TD>
    </TR>
    <TR>
			<TD nowrap align="right">Amendment :</TD><TD align="left">
