...
<%
	if ( cifList.getNoResult() ) {
   		out.print("<center><h4>There is no match for your search criteria</h4></center>");
	}
	else {
%>
<h3 align="center">Letter of Credit Inquiry [Documents]
  	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_list_doc.jsp, ELC0455"></h3>
<hr size="4">
...
<table class="tableinfo">
  ...
  <h4 align="left">Documents List</h4>
  <TABLE class="tableinfo">
    <TR id="trdark"> 
      <TH ALIGN=CENTER nowrap width="9%"  >Number</TH>
      <TH ALIGN=CENTER  nowrap width="9%" >Code</TH>
      <TH ALIGN=LEFT  nowrap width="68%" >Description</TH>
