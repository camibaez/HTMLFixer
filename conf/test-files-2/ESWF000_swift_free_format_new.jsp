...
%>
<h3 align="center"> SWIFT Free Formats<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="swift_free_format_new.jsp,ESWF000">
</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSESWF000" >
  <p>
    <input type=HIDDEN name="SCREEN" value="2">
    <input type=HIDDEN name="ESWFACC" value="<%= swff.getESWFACC()%>">
  </p>
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="27%" >
              <input type="text" name="ESWFREF" size="17" maxlength="16" value="<%= swff.getESWFREF()%>">
            </td>
            <td nowrap width="26%" >
              <div align="right">Related Reference : </div>
            </td>
            <td nowrap >
              <input type="text" name="ESWFRLR" size="17" maxlength="16" value="<%= swff.getESWFRLR()%>">
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="27%" >
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" bordercolor="#FFFFFF">
    <tr bgcolor="#FFFFFF">
      <td width="33%">
        <div align="center">
          <input type="checkbox" name="H01WK2" value="1" >
