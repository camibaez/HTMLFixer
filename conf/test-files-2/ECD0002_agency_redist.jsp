...
<body>
<h3 align="center">Card Reallocation<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="agency_redist.jsp, ECD0002"> 
</h3>
<hr size="4">
<% 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
				...
				<a href="javascript:GetPlastic3('E02CDRINI', document.forms[0].E02CDRTPL.value,document.forms[0].E02CDRBRN.value, '','2')">
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absbottom" border="0" ></a>
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
				...
				<a href="javascript:GetPlastic3('E02CDREND', document.forms[0].E02CDRTPL.value,document.forms[0].E02CDRBRN.value, '','2')">
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absbottom" border="0" ></a>
			  </div>
            </td>
          </tr>
