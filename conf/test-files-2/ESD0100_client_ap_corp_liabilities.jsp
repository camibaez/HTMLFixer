<html>
<head>
<title>Customer Liabilities</title>
...
%> 
<h3 align="center">Customer Liabilities <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_ap_corp_liabilities, ESD0100"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" name="TB_BENEFICIARY_CORP" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
          <tr id="trdark"> 
            ...
            <td width="23%" nowrap>  
              <input type="text" name="E<%= name %>4MA1" maxlength="45" size="46" value="<%= liabilities.getField("E" + name + "4MA1").getString().trim()%>" readonly>
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="13%" nowrap> 
            ...
            <td nowrap>  
              <input type="text" name="E<%= name %>4MA2" maxlength="35" size="36" value="<%= liabilities.getField("E" + name + "4MA2").getString().trim()%>" readonly>
              </td>
          </tr>
          <tr id="trdark"> 
            <td width="13%" nowrap> 
            ...
            <td width="23%" nowrap>  
              <input type="text" name="E<%= name %>4MA3" maxlength="35" size="36" value="<%= liabilities.getField("E" + name + "4MA3").getString().trim()%>" readonly>
              </td>
          </tr>
          <tr id="trclear"> 
            <td width="13%" nowrap> 
            ...
            <td width="23%" nowrap>  
              <input type="text" name="E<%= name %>4AM1" maxlength="15" size="16" value="<%= liabilities.getField("E" + name + "4AM1").getString().trim()%>" readonly>
              </td>
          </tr>
          <tr id="trdark"> 
            <td width="13%" nowrap> 
            ...
            <td width="23%" nowrap>  
              <input type="text" name="E<%= name %>4DT1" size="2" maxlength="2" value="<%= liabilities.getField("E" + name + "4DT1").getString().trim()%>" readonly>
             
              <input type="text" name="E<%= name %>4DT2" size="2" maxlength="2" value="<%= liabilities.getField("E" + name + "4DT2").getString().trim()%>" readonly>
             
              <input type="text" name="E<%= name %>4DT3" size="2" maxlength="2" value="<%= liabilities.getField("E" + name + "4DT3").getString().trim()%>" readonly>
              </td>
          </tr>
        </table>
      </td>
