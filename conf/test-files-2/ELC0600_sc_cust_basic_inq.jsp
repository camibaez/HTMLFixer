...
<H3 align="center">Letters of Credit Commissions Table by Customer
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 	name="EIBS_GIF" ALT="ELC0600_sc_cust_basic_inq"></H3>
<HR size="4">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	<TR id="trdark"> 
            <TD width="25%" align="right" nowrap  ><B>Bank :</B></TD>
            <TD width="25%" nowrap  ><INPUT type="text" name="E01RLCBNK" size="3" maxlength="2" value="<%= msg01.getE01RLCBNK().trim()%>" readonly></TD>
            <TD width="25%" align="right" nowrap  ><B>Table Number :</B></TD>
            <TD width="25%" nowrap  ><INPUT type="text" name="E01RLCTAR" size="3" maxlength="2" value="<%= msg01.getE01RLCTAR().trim()%>" readonly></TD>
    </TR>
    <TR id="trclear"> 
            <TD align="right" nowrap  ><B>Tariff Currency :</B></TD>
            <TD nowrap  ><input type="text" name="E01RLCTCY" size="4" maxlength="3" value="<%= msg01.getE01RLCTCY().trim()%>" ></TD>
            <TD align="right" nowrap  ><b>Accounting Currency :</b></TD>
            <TD nowrap ><input type="text" name="E01RLCACY" size="4" maxlength="3" value="<%= msg01.getE01RLCACY().trim()%>" ></TD>
    </TR>
    <TR id="trdark"> 
            <TD align="right" nowrap  ><b>Customer Number :</b></TD>
            <TD nowrap ><input type="text" name="E01RLCCUN2" size="15" maxlength="10" value="<%= msg01.getE01RLCCUN().trim()%>" readonly ></TD>
            <TD align="right" nowrap  ><b>Customer Name :</b></TD>
...
<TBODY>
	...
	<TR id="trclear">
		<TD nowrap><DIV align="right">Issuance 1 :</DIV></TD>
		<TD nowrap></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCIBR" size="12" maxlength="11" value="<%= msg01.getE01RLCIBR().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCIBP" size="5" maxlength="4" value="<%= msg01.getE01RLCIBP().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCIMF" size="12" maxlength="11" value="<%= msg01.getE01RLCIMF().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCIMX" size="12" maxlength="11" value="<%= msg01.getE01RLCIMX().trim()%>" readonly></DIV></TD>
		<TD nowrap>
			<DIV align="center">
				<SELECT name="E01RLCI01" disabled>
		...
		<TD nowrap>
			...
			<SELECT name="<%=field%>" disabled> 
				...
				<OPTION value="P" <% if (msg01.getField(field).getString().equals("P")) out.print("selected"); %>>Assigment Of Proceeds</OPTION>
				...
				<OPTION value="X" <% if (msg01.getField(field).getString().equals("X")) out.print("selected"); %>>Always</OPTION>
			</SELECT>
		</TD>
	</TR>
	<TR id="trdark">
		<TD nowrap><DIV align="right">Issuance 2 :</DIV></TD>
		<TD nowrap></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCIR2" size="12" maxlength="11" value="<%= msg01.getE01RLCIR2().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCIP2" size="5" maxlength="4" value="<%= msg01.getE01RLCIP2().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCIM2" size="12" maxlength="11" value="<%= msg01.getE01RLCIM2().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCIX2" size="12" maxlength="11" value="<%= msg01.getE01RLCIX2().trim()%>" readonly></DIV></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	</TR>
	<TR id="trclear">
		<TD nowrap><DIV align="right">Advising :</DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCADF" size="12" maxlength="11" value="<%= msg01.getE01RLCADF().trim()%>" readonly></DIV></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	...
	<TR id="trdark">
		<TD nowrap><DIV align="right">Confirmation 1 :</DIV></TD>
		<TD nowrap></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCCBR" size="12" maxlength="11" value="<%= msg01.getE01RLCCBR().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCCBP" size="5" maxlength="4" value="<%= msg01.getE01RLCCBP().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCCMF" size="12" maxlength="11" value="<%= msg01.getE01RLCCMF().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCCMX" size="12" maxlength="11" value="<%= msg01.getE01RLCCMX().trim()%>" readonly></DIV></TD>
		<TD nowrap>
			<DIV align="center">
				<SELECT name="E01RLCI03" disabled>
	...
	<TR id="trclear">
		<TD nowrap><DIV align="right">Confirmation 2 :</DIV></TD>
		<TD nowrap></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCCR2" size="12" maxlength="11" value="<%= msg01.getE01RLCCR2().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCCP2" size="5" maxlength="4" value="<%= msg01.getE01RLCCP2().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text"   name="E01RLCCM2" size="12" maxlength="11" value="<%= msg01.getE01RLCCM2().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text"   name="E01RLCCX2" size="12" maxlength="11" value="<%= msg01.getE01RLCCX2().trim()%>" readonly></DIV></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	</TR>
	<TR id="trdark">
		<TD nowrap><DIV align="right">Extension of Validity :</DIV></TD>
		<TD nowrap></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCEBR" size="12" maxlength="11" value="<%= msg01.getE01RLCEBR().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCEBP" size="5" maxlength="4" value="<%= msg01.getE01RLCEBP().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCEMF" size="12" maxlength="11" value="<%= msg01.getE01RLCEMF().trim()%>" readonly></DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCEMX" size="12" maxlength="11" value="<%= msg01.getE01RLCEMX().trim()%>" readonly></DIV></TD>
		<TD nowrap>
			<DIV align="center">
				<SELECT name="E01RLCI04" disabled>
	...
	<TR id="trclear">
		<TD nowrap>
		<DIV align="right">Amendment :</DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCAMF" size="12" maxlength="11" value="<%= msg01.getE01RLCAMF().trim()%>" readonly></DIV></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center">
				<SELECT name="E01RLCI05" disabled>
	...
	<TR id="trdark">
		<TD nowrap><DIV align="right">Advising Amendment :</DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCAAF" size="12" maxlength="11" value="<%= msg01.getE01RLCAAF().trim()%>" readonly></DIV></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center">
				<SELECT name="E01RLCI06" disabled>
	...
	<TR id="trclear">
		<TD nowrap><DIV align="right">Discrepancy :</DIV></TD>
		<TD nowrap><DIV align="center"><INPUT type="text" name="E01RLCDIF" size="12" maxlength="11" value="<%= msg01.getE01RLCDIF().trim()%>" readonly></DIV></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	...
	<TR id="trdark">
		...
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCSBR" size="12" maxlength="11" value="<%= msg01.getE01RLCSBR().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCSPM" size="12" maxlength="11" value="<%= msg01.getE01RLCSPM().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap>
	...
	<TR id="trclear">
		...
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCACB" size="12" maxlength="11" value="<%= msg01.getE01RLCACB().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCABP" size="5" maxlength="4" value="<%= msg01.getE01RLCABP().trim()%>" readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCACM" size="12" maxlength="11" value="<%= msg01.getE01RLCACM().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCAMX" size="12" maxlength="11" value="<%= msg01.getE01RLCAMX().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
	...
	<TR id="trdark">
		...
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCDPB" size="12" maxlength="11" value="<%= msg01.getE01RLCDPB().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCDBP" size="5" maxlength="4" value="<%= msg01.getE01RLCDBP().trim()%>" readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCDPM" size="12" maxlength="11" value="<%= msg01.getE01RLCDPM().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCDMX" size="12" maxlength="11" value="<%= msg01.getE01RLCDMX().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
	...
	<TR id="trclear">
		...
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCNBR" size="12" maxlength="11" value="<%= msg01.getE01RLCNBR().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCNMF" size="12" maxlength="11" value="<%= msg01.getE01RLCNMF().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCNMX" size="12" maxlength="11" value="<%= msg01.getE01RLCNMX().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
	...
	<TR id="trdark">
		...
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCAPB" size="12" maxlength="11" value="<%= msg01.getE01RLCAPB().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCAPM" size="12" maxlength="11" value="<%= msg01.getE01RLCAPM().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
	...
	<TR id="trclear">
		...
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCTBR" size="12" maxlength="11" value="<%= msg01.getE01RLCTBR().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCTMF" size="12" maxlength="11" value="<%= msg01.getE01RLCTMF().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCTMX" size="12" maxlength="11" value="<%= msg01.getE01RLCTMX().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap>
	...
	<TR id="trdark">
		...
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCPST" size="12" maxlength="11" value="<%= msg01.getE01RLCPST().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	...
	<TR id="trclear">
		...
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCCOU" size="12" maxlength="11" value="<%= msg01.getE01RLCCOU().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	...
	<TR id="trdark">
		...
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCCAN" size="12" maxlength="11" value="<%= msg01.getE01RLCCAN().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	...
	<TR id="trclear">
		...
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCWTF" size="12" maxlength="11" value="<%= msg01.getE01RLCWTF().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	...
	<TR id="trdark">
		...
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCCTF" size="12" maxlength="11" value="<%= msg01.getE01RLCCTF().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	...
	<TR id="trclear">
		...
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCCTM" size="12" maxlength="11" value="<%= msg01.getE01RLCCTM().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
	...
	<TR id="trdark">
		...
		<TD nowrap>
			<DIV align="center"><INPUT type="text"   name="E01RLCCA2" size="12" maxlength="11" value="<%= msg01.getE01RLCCA2().trim()%>"   readonly></DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
		<TD nowrap></TD>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
			<TR id="trdark">
				...
				<TD nowrap align="center" width="199"><B>Account</B></TD>
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGIS" size="19" maxlength="16" value="<%= msg01.getE01RLCGIS().trim()%>"  readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGAD" size="19" maxlength="16" value="<%= msg01.getE01RLCGAD().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGCO" size="19" maxlength="16" value="<%= msg01.getE01RLCGCO().trim()%>"  readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<DIV align="center"><INPUT type="text"   name="E01RLCGEV" size="19" maxlength="16" value="<%= msg01.getE01RLCGEV().trim()%>"  readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGAM" size="19" maxlength="16" value="<%= msg01.getE01RLCGAM().trim()%>"  readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGAA" size="19" maxlength="16" value="<%= msg01.getE01RLCGAA().trim()%>"  readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGDI" size="19" maxlength="16" value="<%= msg01.getE01RLCGDI().trim()%>"  readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGPM" size="19" maxlength="16" value="<%= msg01.getE01RLCGPM().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGAC" size="19" maxlength="16" value="<%= msg01.getE01RLCGAC().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGDP" size="19" maxlength="16" value="<%= msg01.getE01RLCGDP().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGNE" size="19" maxlength="16" value="<%= msg01.getE01RLCGNE().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGAS" size="19" maxlength="16" value="<%= msg01.getE01RLCGAS().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGTR" size="19" maxlength="16" value="<%= msg01.getE01RLCGTR().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGPO" size="19" maxlength="16" value="<%= msg01.getE01RLCGPO().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGCR" size="19" maxlength="16" value="<%= msg01.getE01RLCGCR().trim()%>"  readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGCA" size="19" maxlength="16" value="<%= msg01.getE01RLCGCA().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGWT" size="19" maxlength="16" value="<%= msg01.getE01RLCGWT().trim()%>"	 readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGTF" size="19" maxlength="16" value="<%= msg01.getE01RLCGTF().trim()%>"  readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trclear">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCGTM" size="19" maxlength="16" value="<%= msg01.getE01RLCGTM().trim()%>"  readonly> 
				</DIV> 
				</TD>
				<TD nowrap width="234">
			...
			<TR id="trdark">
				...
				<TD nowrap width="212">
				<DIV align="center"><INPUT type="text"   name="E01RLCCG2" size="19" maxlength="16" value="<%= msg01.getE01RLCCG2().trim()%>"  readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
...
<DIV align="center"><INPUT id="EIBSBTN" type=Submit name="Close" value="Close"></DIV>
