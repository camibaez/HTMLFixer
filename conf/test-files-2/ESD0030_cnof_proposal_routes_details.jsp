...
<H3 align="center">System Reference Codes- Proposal Routes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_proposal_routes_details.jsp, ESD0030"></H3>
<hr size="4">
    ...
    <tr>
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear">
            <td nowrap width="30%">
              <div align="right">Initial Status :</div>
            </td>
            <td nowrap>
              <div align="left">
                <input type="text" name="E02CNOCPC" size="5" maxlength="4" value="<%= refCodes.getE02CNOCPC().trim()%>">
                <a href="javascript:GetCodeCNOFC('E02CNOCPC','37')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"></a></div>
            </td>
          </tr>
        </table>
      </td>
