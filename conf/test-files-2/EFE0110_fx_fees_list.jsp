...
function protect(row) {
	if(getElement("E01FEFFT1_" + row)[0].value == "F") {
    	getElement("E01FEFBR1_" + row)[0].value="0";
        getElement("E01FEFBR1_" + row)[0].disabled=true;
      	getElement("E01FEFFA1_" + row)[0].disabled=false;
    }
	if(getElement("E01FEFFT1_" + row)[0].value == "P") {
    	getElement("E01FEFFA1_" + row)[0].value="0";
        getElement("E01FEFFA1_" + row)[0].disabled=true;
      	getElement("E01FEFBR1_" + row)[0].disabled=false;
    }
	if(getElement("E01FEFFT1_" + row)[0].value == "N") {
    	getElement("E01FEFBR1_" + row)[0].value="0";
    	getElement("E01FEFFA1_" + row)[0].value="0";
        getElement("E01FEFBR1_" + row)[0].disabled=true;
      	getElement("E01FEFFA1_" + row)[0].disabled=true;
    }
	if(getElement("E01FEFFT2_" + row)[0].value == "F") {
    	getElement("E01FEFBR2_" + row)[0].value="0";
        getElement("E01FEFBR2_" + row)[0].disabled=true;
      	getElement("E01FEFFA2_" + row)[0].disabled=false;
    }
	if(getElement("E01FEFFT2_" + row)[0].value == "P") {
    	getElement("E01FEFFA2_" + row)[0].value="0";
        getElement("E01FEFFA2_" + row)[0].disabled=true;
      	getElement("E01FEFBR2_" + row)[0].disabled=false;
    }
	if(getElement("E01FEFFT2_" + row)[0].value == "N") {
    	getElement("E01FEFBR2_" + row)[0].value="0";
    	getElement("E01FEFFA2_" + row)[0].value="0";
        getElement("E01FEFBR2_" + row)[0].disabled=true;
      	getElement("E01FEFFA2_" + row)[0].disabled=true;
...
<h3 align="center">Foreign Exchange Fee Tables<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
...
<TABLE class="tbenter"> 
	<TR>
		<TD align="CENTER" class="TDBKG" width="33%">
			<a href="javascript:goNew()"><b>New<br>Table</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="33%">
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center"> There are not Fee Tables.</h4> 
      </div>
      </TD></TR>
   	</TABLE>
<%
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    ...
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="5%"><b>Bank<BR> </b></td>
		<td NOWRAP align="center" width="5%"><b>Fee<BR>Number</b></td>
		<td NOWRAP align="center" width="10%"><b>Table Description</b></td>
		<td NOWRAP align="center" width="5%"><b>Fee<BR>Currency</b></td>
		<td NOWRAP align="center" width="35%" colspan="3"><B> Fees</B></td>
		<td NOWRAP align="center" width="35%" colspan="4"><b>General Ledger<B></B></b></td>
	</TR>
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="10%"><B>Type</B><BR><B>
			<IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatory" align="bottom"></B>
		</td>
		<TD nowrap align="center" width="15%"><B>Value<BR>
			<IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatory" align="bottom"></B>
		</TD>
		<TD nowrap align="center" width="10%"><B>Minimum /<BR>
		Maximum</B></TD>
		<TD nowrap align="center" width="10%"><B>Currency</B></TD><TD nowrap align="center" width="15%"><B>Number<BR>
			<IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatory" align="bottom"></B>
		</TD>
	</TR>
		...
		<TD nowrap align="center" width="10%" valign="top">
			<INPUT type="text" name="E01FEFGL1_<%= EFE0110List.getCurrentRow() %>" 
				value="<%= msgList.getE01FEFGL1() %>" size="13" maxlength="12" onkeypress="enterInteger()" <%= read %>>
				<A href="javascript:GetLedger('E01FEFGL1_<%= EFE0110List.getCurrentRow() %>',document.forms[0].E01FEFBNK_<%=EFE0110List.getCurrentRow()%>.value,'','')">
    ...
    <TR id=trclear>
		...
		<TD nowrap align="center" width="10%" valign="top">
			<INPUT type="text" name="E01FEFGL2_<%= EFE0110List.getCurrentRow() %>" 
				value="<%= msgList.getE01FEFGL2() %>" size="13" maxlength="12" onkeypress="enterInteger()" <%= read %>>
				<A href="javascript:GetLedger('E01FEFGL2_<%= EFE0110List.getCurrentRow() %>',document.forms[0].E01FEFBNK_<%=EFE0110List.getCurrentRow()%>.value,'','')">
				<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" align="top"></A>
		</TD>
	</TR>
