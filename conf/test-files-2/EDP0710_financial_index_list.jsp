...
<html>
<head>
<title>Formulas Financial Indices</title>
...
function goAction(op) {
	...
	if (op == "3") {
      ok = confirm("Confirm to delete this record");
	  if (ok) 
	       {
...
<BODY>
<h3 align="center">Formulas Financial Indices <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="financial_index_list.jsp, EDP0710"></h3>
<hr size="4">
