...
<h3 align="center">Correspondant Bank Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bank_instructions.jsp,ESD0005"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="29%" height="23"> 
              <div align="right">Correspondant Swift Id :</div>
            </td>
            ...
            <td nowrap width="26%" height="23"> 
              <div align="right">Correspondant A.B.A :</div>
            </td>
            <td nowrap width="26%" height="23">
