...
<h3 align="center"> Basic Information<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cp_inq_maint.jsp,EDL0105"></h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="75%" colspan="3"> 
              ...
              <input type="text" name="D01DEAUC7" readonly  size="40" maxlength="35" value="<%= cdMant.getD01DEAUC7().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%" > 
           ...
           <tr id="trclear"> 
            ...
            <td nowrap width="23%" > 
              <input type="text" name="E01DEAGCD" readonly  size="5" maxlength="4" value="<%= cdMant.getE01DEAGCD().trim()%>" >
            </td>
            <td nowrap width="25%" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="E01DEABA1" readonly  size="2" maxlength="2" value="<%= cdMant.getE01DEABA1().trim()%>" >
              <input type="text" name="E01DEABA2" readonly  size="2" maxlength="2" value="<%= cdMant.getE01DEABA2().trim()%>" >
              <input type="text" name="E01DEABA3" readonly  size="2" maxlength="2" value="<%= cdMant.getE01DEABA3().trim()%>" >
            </td>
            ...
            <td nowrap width="27%" >
              <input type="radio" disabled name="E01DEAFL3" value="V" <%if(cdMant.getE01DEAFL3().equals("V")) out.print("checked");%>>Private
              <input type="radio" disabled name="E01DEAFL3" value="B" <%if(cdMant.getE01DEAFL3().equals("B")) out.print("checked");%>>Public
            </td>
          </tr>  
        </table>
      </td>
