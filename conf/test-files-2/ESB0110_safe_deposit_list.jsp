...
function ShowNew(x,y) {	 
    ...
    enterNew.filters[0].Play();
	document.forms[0].E01SBMCOD.focus();
}
...
function SetErrorVisible(){	 
	 var myValue = document.forms[0].E01SBMCOD.value;

	 if (true) { // verify myValue Here
	 	document.forms[0].E01SBMCOD.onkeypress = "";
     	errorMsg.style.visibility="hidden";
	 } else {
	 	document.forms[0].E01SBMCOD.onkeypress="";
	 	document.forms[0].E01SBMCOD.value="";
...
<h3 align="center">Safe Deposits Box<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_list, ESB0110"></H3>
<hr size="4">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<tr id="trdark"> 
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          <input type="text" name="E01SBMCOD" size="12" maxlength="10" onchange="SetErrorVisible()">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01SBMCOD())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getD01SBTDSC())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getD01LOCNME())%></TD>
