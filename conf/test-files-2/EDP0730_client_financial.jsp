...
//    				document.forms[0].E01IFMAMT.focus();
    ...
    case 3 :{
			if ("<%= mL0730.getE01CUSLGT().trim() %>" == "1") {
            page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0730?SCREEN=600";
			CenterWindow(page,800,600,2);
			} else {;
            page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0730?SCREEN=300&E01DPBFED="
...
//			document.forms[0].submit(); 
            page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0730?SCREEN=800&E01IFMFEM="
    ...
    case 7 :{
			if ("<%= mL0730.getE01CUSLGT().trim() %>" == "1") {
            page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0739?SCREEN=400&E01DPBFEM="
							+ document.forms[0].E01DPBFEM.value +
            ...
            page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0739?SCREEN=400&E01DPBFEY="
    ...
    case 8 :{
			if ("<%= mL0730.getE01CUSLGT().trim() %>" == "1") {
            page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0755?SCREEN=400&E01DPBFEM="
							+ document.forms[0].E01DPBFEM.value +
							"&E01DPBFEY="+ document.forms[0].E01DPBFEY.value +
							"&E01DPBFED="+ document.forms[0].E01DPBFED.value +
							"&E01IFMCFO="+ document.forms[0].E01IFMCFO.value ;
            ...
            page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0755?SCREEN=400&E01DPBFEY="
							+ document.forms[0].E01DPBFEY.value +
							"&E01DPBFEM="+ document.forms[0].E01DPBFEM.value +
							"&E01DPBFED="+ document.forms[0].E01DPBFED.value +
							"&E01IFMCFO="+ document.forms[0].E01IFMCFO.value ;
...
<h3 align="center">Financial Information Proposal Credit<img
...
<FORM Method="post" ACTION="<%= request.getContextPath() %>/pages/e/body_wait.jsp?ServletName=<%= request.getContextPath() %>/servlet/datapro.eibs.creditproposal.JSEDP0730">
...
<table class="tableinfo">
	<TR>
		...
		<TABLE id="headTable" width="100%" cellpading=0 cellspacing=0>
			...
			<tr id="trdark">
				<td align="right">Day/Month/Year<b></b></td>
				<td nowrap>
				...
				<div align="right"> 
					<INPUT id="EIBSBTN" type="submit" name="Submit0" value="Submit" onclick="goAction(5)"
...
<TABLE class="tbenter" width=100% height=30%>
	<TR>
		...
		<%} else {%>
		<div align="center"><font size="3">
		<b> Create New Financial Statement </b>
		</font>
		</div>
		<%} %>
		</TD>
...
<TABLE class="tbenter">
	<TR>
		...
		<TD ALIGN=CENTER width="15%" class=tdbkg><a
			href="javascript:goAction(2)"><b>Financial Statement</b></a></TD>
		<TD ALIGN=CENTER width="15%" class=tdbkg><a
			href="javascript:goAction(7)"><b>Variation Analysis</b></a></TD>
		<TD ALIGN=CENTER width="15%" class=tdbkg><a
			href="javascript:goAction(3)"><b>Financial Indices</b></a></TD>
		<TD ALIGN=CENTER width="15%" class=tdbkg><a
			href="javascript:goAction(6)"><b>Quantitative Analysis Aspects</b></a></TD>
		<TD ALIGN=CENTER width="15%" class=tdbkg><a
			href="javascript:goAction(8)"><b>Projection</b></a></TD>
		<TD ALIGN=CENTER width="15%" class=tdbkg><a 
			href="<%=request.getContextPath()%>/pages/background.jsp"><b>Exit</b></a></TD>
	</TR>
</TABLE>
		...
		<TABLE id="headTable" width="100%" cellpading=0 cellspacing=0>
			<tr id="trdark">
				...
				>
					...
					<OPTION value="1"
						<%if (mL0730.getE01DPBREV().equals("1")) { out.print("selected"); }%>>YES</OPTION>
					<OPTION value="0"
				...
				<td align="right" width="344"><b>Period: From:</b>
				...
				<td align="right" width="282"><b>To:</b>
			...
			<tr id="trclear">
				...
				<td nowrap>
					...
					<OPTION value="1"
						<%if (mL0730.getE01DPBCRE().equals("1")) { out.print("selected"); }%>>Audited</OPTION>
					<OPTION value="2"
						<%if (mL0730.getE01DPBCRE().equals("2")) { out.print("selected"); }%>>No Audited</OPTION>
					<OPTION value="3"
						<%if (mL0730.getE01DPBCRE().equals("3")) { out.print("selected"); }%>>Pre-Closing</OPTION>	
				</SELECT>	 
				</td>
				...
				<b>Date Expir.: </b><%=mL0730.getE01DPBFVD()%>/<%=mL0730.getE01DPBFVM()%>/<%=mL0730.getE01DPBFVA()%>
<%--
...
--%>
				...
				<div align="right">
				<INPUT id="EIBSBTN" type="submit" name="Submit0" value="Submit" onclick="goVal()"
					<% if(userPO.getOption().equals("4")){out.print("disabled");}%> 
					>
				</div>
				</td>
...
<div align="center"> 
		<INPUT id="EIBSBTN" type="submit" name="Submit0" value="Submit" onclick="goUpdVal()"
	<% if(userPO.getOption().equals("4")){out.print("disabled");}%> 
	>
</div>
