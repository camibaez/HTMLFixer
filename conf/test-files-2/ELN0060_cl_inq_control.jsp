...
<h3 align="center">Line of Control<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cl_inq_control.jsp, ELN0060"></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trdark"> 
            ...
            <td width=20%> 
              <div align="left"> 
                <input type="text" name="E03LNEAMN" readonly  size="17" maxlength="13" value="<%= clControl.getE03LNEAMN().trim()%>">
              </div>
            </td>
            <td width=26%> 
          ...
          <tr id="trclear"> 
            ...
            <td width=20%> 
              <div align="left"> 
                <input type="text" name="E03LNEAMU" readonly  size="17" maxlength="13" value="<%= clControl.getE03LNEAMU().trim()%>">
              </div>
            </td>
            <td width=26%> 
          ...
          <tr id="trdark"> 
            ...
            <td width=20%> 
              <div align="left"> 
                <input type="text" name="E03LNEBAL" readonly  size="17" maxlength="13" value="<%= clControl.getE03LNEBAL().trim()%>">
              </div>
            </td>
            <td width=26%> 
