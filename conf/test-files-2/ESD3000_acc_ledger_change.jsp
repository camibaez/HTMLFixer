...
<h3 align="center">General Ledger Change<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ESD3000_acc_ledger_change.jsp"></h3>
<hr size="4">
...
<form method="post" name="ledger_change" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD3000">
  ...
  <table  class="tbenter" width="100%" border="0" cellspacing=0 cellpadding=2>
	<tr>
    	...
    	<td align="left">
            <input type="text" name="E01OLDACC" size="12" maxlength="9" onkeypress="enterInteger()" value="<%= account.getE01OLDACC()%>">
            <a href="javascript:GetAccount('E01OLDACC','','<%= userPO.getType()%>','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
    	</td>
    </tr>
	<tr>
    	<td align="right">
	...
	<tr>
    	...
    	<td align="left">
              <input type="text" name="E01NEWGLN" size="14" maxlength="12" value="<%= account.getE01NEWGLN()%>">
              <a href="javascript:GetLedger('E01NEWGLN',document.forms[0].E01NEWBNK.value,'',document.forms[0].APC.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
        </td>
    </tr>
	<tr>
