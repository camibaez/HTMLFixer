...
<h3 align="center">Wachovia Incoming File
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="enter_wachovia_file, EPR0020"></h3>
<hr size="4">

<FORM METHOD="POST" action="<%=request.getContextPath()%>/servlet/datapro.eibs.misc.JSEPR0020A" ENCTYPE="multipart/form-data">	
