...
<table width="161" border="0" align="right" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan=2 width="161" align="right" height="50" valign="bottom"><img src="<%=request.getContextPath()%>/images/e/options_up.gif" width="161" height="69" vspace="0" hspace="0" border="0"></td>
  </tr>
  <tr>
