...
<H3 align="center">Safe Deposits Box Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_maint, ESB0110"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trclear> 
		  ...
		  <td nowrap width="60%" colspan="7"><input type="text"
					name="E01SBMCOD" size="6" maxlength="6"
					value="<%= msgPart.getE01SBMCOD() %>" readonly>
