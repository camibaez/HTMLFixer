...
%> 
<h3 align="center"> Foreign Exchange Spot - Inquiry</h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="85%" > <font face="Arial"><font face="Arial"><font face="Arial"><font face="Arial"><font size="2"> 
              <input type="hidden" name="D01FEMCP32"  value="<%= fex.getD01FEMCP3()%>" readonly>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > <%= fex.getE01FEMBRK()%> - <%= fex.getD01FEBNM1()%> </td>
            <td nowrap > 
              <div align="right">Action Taken :</div>
            </td>
            <td nowrap > <% if(fex.getE01FEMSBT().equals("PU")) out.print("Purchase");
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > <%= fex.getE01FEMCCY().trim()%> </td>
            <td nowrap > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap ><%= Util.fcolorCCY(fex.getE01FEMSOA())%> </td>
            <td nowrap align="right"> 
              <div align="right">Counter Original Amount :</div>
            </td>
            <td nowrap><%= Util.fcolorCCY(fex.getE01FEMDOA())%> </td>
          </tr>
          <tr id="trdark">
            <td nowrap >
              <div align="right">Primary Balance Amount :</div>
            </td>
            <td nowrap ><%= Util.fcolorCCY(fex.getE01FEMSAM())%></td>
            <td nowrap >
              <div align="right">Counter Balance Amount :</div>
            </td>
            <td nowrap ><%= Util.fcolorCCY(fex.getE01FEMDAM())%></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap >
            ...
            <td nowrap >
              <div align="left"><%= fex.getE01FEMEXR()%></div>
            </td>
            <td nowrap >
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="center"><b>CCY</b></div>
            </td>
            <td nowrap > 
              <div align="center"><b>G/L</b></div>
            </td>
            <td nowrap > 
