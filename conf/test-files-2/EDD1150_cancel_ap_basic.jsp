...
<html>
<head>
<title>Retail Account Cancellation</title>
...
--%>
            <INPUT type="text" readonly name="E01NARRAT" size="35"
					maxlength="30" value="<%= rtCancel.getE01NARRAT().trim()%>"></td> 
            <td nowrap > 
              <div align="right"></div>
            </td>
            <td nowrap >
