...
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0102">
...
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  <h3 align="center">Customer Portfolio Approval<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
    ...
    <TD NOWRAP valign="top" width="100%" >
        <TABLE id="headTable" >
          <TR id="trdark"> 
            ...
            <TH ALIGN=CENTER NOWRAP>Main Customer</TH>
			
            <TH ALIGN=CENTER NOWRAP>Officer <br> Code</TH>
			<TH ALIGN=CENTER NOWRAP>Currency</TH>
			<TH ALIGN=CENTER NOWRAP>Openning <br> Date</TH>
