...
%> 
<h3 align="center">Letter of Credit [Special Instructions]<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="lc_special_inst.jsp, ELC0500"></h3>
<hr size="4">
