...
%>
  <TABLE class="tableinfo" align="center" style="width:'95%'" cellspacing=0 cellpadding=2>
    <TR id="trdark"> 
  ...
  <TABLE class="tableinfo" align="center" style="width:'95%'">
    <TR id="trdark"> 
      <TH ALIGN=CENTER  nowrap width="20%">Portfolio Number</TH>
      <TH ALIGN=CENTER  nowrap width="80%">Description</TH>
    </TR>
    <%               
                ewd0302Help.initRow();
