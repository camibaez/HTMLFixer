...
<table class="tableinfo" style="width:95%" ALIGN=CENTER>
  ...
  <tr> 
    ...
    <td width="420"><a href="javascript:a('1')">Retención sobre Intereses ISR</a></td>
  </tr>
  <tr> 
    <td width=30 height="18" > 
  ...
  <tr> 
    ...
    <td width="420"><a href="javascript:a('4')"> IVA solo en Comisiones</a></td>
  </tr>
  <tr> 
    <td width=30 height="18" > 
    ...
    <td width="420"><A HREF="javascript:a('6')">Débito Bancario IDB</a></td>
  </tr>
  <tr> 
    <td width=30 height="18" > 
