...
<script language="javascript">
  ...
  function goAction(op) {
 	...
 	alert("Select Assets before this operation");	   
      }
 ...
 // INQUIRY Call EIBS.JSP "showinqapprovalfixedasset"
...
// INQUIRY Call EIBS.JSP "showinqappfixedasset"     
...
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.amort.JSEFIX010">
...
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  <h3 align="center">Fixed assets Approval<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fix_approval_list.jsp,EFIX010"> 
  </h3>
<hr size="4">
 ...
 <TABLE class="tbenter">
  <TR> 
    ...
    <TD ALIGN=CENTER width="25%"> <a href="javascript:goAction('D')" id="linkReject" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','<%=request.getContextPath()%>/images/e/delete_over.gif',1)"><img name="Image3" alt="Delete" border="0" src="<%=request.getContextPath()%>/images/e/delete.gif" ></a> 
      </TD>            
 ...
 <TR> 
   ...
   <TABLE id="headTable" NOWRAP>
      ...
      <TH ALIGN=CENTER NOWRAP> Fixed Assets<br> amortization ID </TH>
      <TH ALIGN=CENTER NOWRAP> Asset<br> Class </TH>
      <TH ALIGN=CENTER NOWRAP> GL Number </TH>
   ...
   <div id="dataDiv1" class="scbarcolor" NOWRAP>
    <table id="dataTable" ALIGN=CENTER NOWRAP>
    <%
                appList.initRow();
                int k=1;
