...
<body>
 ...
 <h3 align="center">New Customer <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="client_both_enter_new, ESD0080"></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080">
  <p>
    <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="400">
  </p>
  <h4 align="center">Enter either Customer Number or Identification and Customer 
    Type </h4>
  <p>&nbsp; </p>
    ...
    <tr> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap align="right" valign="middle" width="49%">Identification 
              : </td>
            <td nowrap align="left" valign="middle" colspan="2"> 
...
<%-- 
   **** This lines have been deleted, because the customer encryption will be done after the approval
   **** Removed by HG 10/13/2006
   
          <tr id="trclear"> 
            <td nowrap align="right" valign="middle" width="49%">Do you want encrypted information ?
              : </td>
            <td nowrap align="left" valign="middle" colspan="2"> 
              <input type="radio" name="ENC" value="1">Yes
              <input type="radio" name="ENC" value=" ">No
            </td>
          </tr>
--%>          
        </table>
