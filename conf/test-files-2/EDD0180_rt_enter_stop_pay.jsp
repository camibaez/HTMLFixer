...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="rt_enter_stop_pay.jsp , EDD0180">
<hr size="4">
    ...
    <tr>
          <td nowrap align="center">
             Account Number :
              ...
              <a href="javascript:GetAccount('E01STPACC','','RA','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0"  ></a>
				<br>
 <div align="center">
