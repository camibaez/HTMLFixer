...
%> 
<h3 align="center">Bankers Acceptance - Confirmation Ticket </h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="18%" align="right">Effective Rate : </td>
            <td nowrap width="20%"> 
		...
		<TR>
			...
			<TABLE cellpadding="2" cellspacing="0" border="0" width="100%">
				<TBODY>
					<TR id="trdark0">
						<TD nowrap width="25%">
						<DIV align="right">Terms :</DIV>						</TD><TD nowrap width="35%"><%= deal.getE01DLSTRM().trim()%><% if(deal.getE01DLSTRC().equals("D")) out.print("Day(s)");
					...
					<TR id="trclear0">
						<TD nowrap width="25%">
						<DIV align="right">Accrual Type Basis :</DIV>						</TD><TD nowrap width="35%"><% if(deal.getE01DLSICT().equals("1")) out.print("Actual/actual");
					...
					<TR id="trdark0">
					  <TD nowrap><DIV align="right">Book :</DIV></TD>
					  <TD nowrap><%= deal.getE01DLSLNC().trim()%></TD>
