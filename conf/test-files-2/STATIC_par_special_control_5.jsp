...
<BODY>
<h4>Confirmed Letter of Credit Advising Commission</h4>
<table class="tableinfo" style="width:95%" ALIGN=CENTER>
  ...
  <tr> 
    ...
    <td width="420"><a href="javascript:a('Y')">
    	An Advising Commission Fee will be Charged Besides the Commission for any Incoming <br>
  ...
  <tr> 
    ...
    <td width="420"><a href="javascript:a('N')">
		Only the Confirmation Commission will be Charged</a>
	</td>
  </tr> 
</table>
<P>
