...
<h3 align="center">Customer Accounts Management Module - Setup Accounts Relationship
  - Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cam_enter_params, ECA0010"></h3>
<hr size="4">
