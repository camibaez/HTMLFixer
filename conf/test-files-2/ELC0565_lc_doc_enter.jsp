...
<H3 ALIGN="center">Letter of Credit Remittance Letter<IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left"
	NAME="EIBS_GIF" ALT="lc_doc_enter.jsp, ELC0565"></H3>
<HR SIZE="4">
...
<TABLE CLASS="tbenter" WIDTH="100%" BORDER="0">
	...
	<tr>
		<td width="50%" align="right">Payment/Neg. Number : </td>
		<td width="50%"><input type="text" name="E01LCMACC0" size="3"
			maxlength="2" onkeypress="enterInteger()"> <a
			href="javascript:GetAccount('E01LCMACC','','40','')"></a></td>
	</tr>
	<tr>
		<td width="50%" align="right">Type of Transport Documents : </td>
		<td width="50%">
		<a
