...
<H3 align="center">Safe Deposit Box Enter New<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_enter_new, ESB0110"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap width="60%"> 
	        <input type="text" name="E01SBMCOD" size="7" maxlength="6">
	      </td>
     	</tr>
     </table>
    </td>
