...
<BODY>
<h3 align="center">Retail Account Rates and Charges Maintenance</h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSESD0205" >
  <input type=HIDDEN name="SCREEN" value="2">
  <input type=HIDDEN name="opt" value="1">
  <input type=HIDDEN name="totalRow" value="0">
  <input type=HIDDEN name="BANK" value="<%=userPO.getHeader1()%>">
  <input type=HIDDEN name="ACD" value="<%=userPO.getHeader2()%>">
  <input type=HIDDEN name="ACCTYPE" value="<%=userPO.getHeader2()%>">
  <input type=HIDDEN name="TABLEN" value="<%=userPO.getHeader3()%>">
