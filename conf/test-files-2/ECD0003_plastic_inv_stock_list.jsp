...
{
	page = "<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0003?SCREEN=113&ROW=" + rowNum;
...
%>
<BODY>
<h3 align="center">Branch Stock<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_inv_gen_list.jsp , ECD0003">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="30%">Branch</th>
            <th align=CENTER nowrap width="30%">Stock</th>
            <th align=CENTER nowrap width="30%">Min.</th>
            <th align=CENTER nowrap width="30%">Max.</th>
          </tr>
     	<%
        stockList.initRow(); 
