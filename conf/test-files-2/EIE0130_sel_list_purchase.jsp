...
<BODY>
<h3 align="center">Trade Ticket - Multiple Orders<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel_list_purchase.jsp, EIE0130"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0130" >
          ...
          <tr id="trclear"> 
			...
			<TR id="trdark">
				...
				<TD nowrap width="36%"><INPUT type="text" name="E02ORDF15A" size="3"
					maxlength="2" value="<%= userPO.getHeader16()%>">
              <INPUT type="text" name="E02ORDF15B" size="3"
					maxlength="2" value="<%= userPO.getHeader17()%>">
              <INPUT type="text" name="E02ORDF15C" size="3"
					maxlength="2" value="<%= userPO.getHeader18()%>"></TD>
				<TD nowrap width="14%">
				<DIV align="right"></DIV>
				</TD>
