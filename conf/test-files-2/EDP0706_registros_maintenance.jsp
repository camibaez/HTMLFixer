...
<body onload=javascript:init()>
	...
	<H3 align="center">Maintenance 
	  <% if(userPO.getOption().equals("1")) {out.print("Guarantee Detail");} %>
	  <% if(userPO.getOption().equals("2")) {out.print("Alternative Paths");} %>
...
<h4>  
      Detalle 
      <% if(userPO.getOption().equals("1")) {out.print("Guarantee Detail to");} %>
	  <% if(userPO.getOption().equals("2")) {out.print("Alternative Paths to");} %>
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trdark">
								<td nowrap width="30%">
								    <% if(userPO.getOption().equals("1")) {out.print("Guarantee Record");} %>
	   							    <% if(userPO.getOption().equals("2")) {out.print("Aditional Operation");} %>
								</td>
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trclear">
								<td nowrap width="30%">
								<DIV align="right">Record Status :</DIV>
								</td>
								<td nowrap align="left" width="70%">
								...
								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>
									...
									<option value="A" 
									   <%if (s0706.getE01DPQEST().equals("A")) { out.print("selected"); }%>>Active</option>
									<option value="I"
										<%if (s0706.getE01DPQEST().equals("I")) { out.print("selected"); }%>>Inactive</option>
								</SELECT>								
								</td>
							</tr>
						</TBODY>
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trdark">
								<td nowrap width="33%">
								<DIV align="right">Activity Code # 1</DIV>
								</td>
								<td nowrap align="left" width="100%">
									...
									<INPUT type="text" name="E01DPQAD0" size="30" maxlength="30" readonly value="<%= s0706.getE01DPQAD0().trim()%>">
										<A href="javascript:GetCodeDescCNOFC('E01DPQAC0','E01DPQAD0','P2')"><IMG src=" <%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></A>
								</td>
							</tr>
						</TBODY>
					</TABLE>
