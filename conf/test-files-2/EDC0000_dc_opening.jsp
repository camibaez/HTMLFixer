...
<body>
<h3 align="center">Documentary Collections <%= dcNew.getE01DCMOPT().equals("N")?"Opening":"Maintenance" %> <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="dc_opening.jsp, EDC0000"></h3>
<hr size="4">
				...
				<table border="0" cellspacing="0">
					<tr id="trdark">
						...
						<td>
							...
							<img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onclick="javascript: document.forms[0].E01DCMAF2.selectedIndex = 2" border="0"></a> Account
						</td>
					</tr>
				</table>
				</td>
			...
			<TBODY><TR id="trdark">
			  ...
			  <TR id="trclear">
			    ...
			    <TD align="left" nowrap><INPUT type="text" name="E01DCMRBI" size="14" maxlength="12" value="<%=dcNew.getE01DCMRBI()%>">
			      <A href="javascript:GetSwiftIdDesc('E01DCMRBI','','','')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help"  border="0"></A> </TD>
			  </TR>
			<TR id="trdark">
				<TD>
					<DIV align="right">Name :</DIV>
...
<% } %>
<h4><%= dcNew.getE01DCMTYP().trim().equals("I")?"Reembursement Bank":"Presenting Bank" %> </h4>
<table class="tableinfo">
	<tr>
		<td>
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
			...
			<td nowrap width="30%">
             	<div align="right">Issuance Date :</div>
			</td>
            <td nowrap width="20%">
          ...
          <tr id="trclear">
            <td nowrap width="30%">
             	<div align="right">Remittance Date :</div>
            </td>
            <td nowrap width="20%">
        ...
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trdark">
			...
			<TD nowrap width="30%">
            	...
            	<A href="javascript:GetCostCenter('E01DCMCCN',document.forms[0].E01DCMBNK.value)"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"></A>
			</TD>
          </TR>
          <TR id="trclear">
            <TD nowrap width="30%">
             	<DIV align="right">Collection Amount :</DIV>
			</TD><TD nowrap width="20%">
			...
			<TD nowrap width="30%">
            	...
            	<INPUT type="radio" name="E01DCMPTF" value="Y" <%if(dcNew.getE01DCMPTF().equals("Y")) out.print("checked");%>>Yes
            	<INPUT type="radio" name="E01DCMPTF" value="N" <%if(dcNew.getE01DCMPTF().equals("N")) out.print("checked");%>>No
			</TD>
          </TR>
          <TR id="trdark">
            <TD nowrap width="30%">
             	<DIV align="right">Release Documents Against :</DIV>
            </TD>
            <TD nowrap width="20%">
				<SELECT name="E01DCMRDF">
					<OPTION value=" " <% if ((!dcNew.getE01DCMRDF().equals("P")) && (!dcNew.getE01DCMRDF().equals("A"))) out.println("selected"); %>></OPTION>
					<OPTION value="P" <% if (dcNew.getE01DCMRDF().equals("P")) out.println("selected"); %>>Payment</OPTION>
					<OPTION value="A" <% if (dcNew.getE01DCMRDF().equals("A")) out.println("selected"); %>>Acceptance</OPTION>
				</SELECT>
			</TD>
			<TD nowrap width="30%">
             	<DIV align="right">Waive Charges :</DIV>
            </TD><TD nowrap width="20%">
            	<INPUT type="radio" name="E01DCMWCF" value="Y" <%if(dcNew.getE01DCMWCF().equals("Y")) out.print("checked");%>>Yes
            	<INPUT type="radio" name="E01DCMWCF" value="N" <%if(dcNew.getE01DCMWCF().equals("N")) out.print("checked");%>>No
			</TD>
          </TR>
          <TR id="trclear">
            <TD nowrap width="30%">
             	<DIV align="right">Advise Acceptance Via :</DIV>
            </TD>
            <TD nowrap width="20%">
				<SELECT name="E01DCMAAF">
					...
					<OPTION value="T" <% if (dcNew.getE01DCMAAF().equals("T")) out.println("selected"); %>>Telex</OPTION>
					<OPTION value="S" <% if (dcNew.getE01DCMAAF().equals("S")) out.println("selected"); %>>Swift</OPTION>
					<OPTION value="A" <% if (dcNew.getE01DCMAAF().equals("A")) out.println("selected"); %>>Mail</OPTION>
            ...
            <TD nowrap width="20%">
            	<INPUT type="radio" name="E01DCMPPF" value="Y" <%if(dcNew.getE01DCMPPF().equals("Y")) out.print("checked");%>>Yes
          ...
          <TR id="trdark">
            ...
            <TD nowrap width="20%">
            	<INPUT type="radio" name="E01DCMWIF" value="Y" <%if(dcNew.getE01DCMWIF().equals("Y")) out.print("checked");%>>Yes
          ...
          <TR id="trdark">
            ...
            <TD nowrap width="20%">
				<SELECT name="E01DCMOCF">
					...
					<OPTION value="D" <% if (dcNew.getE01DCMOCF().equals("D")) out.println("selected"); %>>Drawee/Importer</OPTION>
		  ...
		  <TR id="trclear">
			...
			<TD nowrap width="20%">
				<SELECT name="E01DCMOBF">
					...
					<OPTION value="D" <% if (dcNew.getE01DCMOBF().equals("D")) out.println("selected"); %>>Drawee/Importer</OPTION>
					<OPTION value="P" <% if (dcNew.getE01DCMOBF().equals("P")) out.println("selected"); %>>Drawer/Principal</OPTION>
				</SELECT>
				<IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatory Field"  border="0">
            </TD>
			<TD nowrap width="30%"><DIV align="right">Commisions Table :</DIV></TD>
			<TD nowrap width="20%">
          ...
          <TR id="trdark">
			...
			<TD nowrap width="20%">
				<SELECT name="E01DCMTRC">
					...
					<OPTION value="AS" <% if (dcNew.getE01DCMTRC().equals("AS")) out.println("selected"); %>>At Sight</OPTION>
					<OPTION value="BE" <% if (dcNew.getE01DCMTRC().equals("BE")) out.println("selected"); %>>After Bill of Exchange Date</OPTION>
					<OPTION value="BL" <% if (dcNew.getE01DCMTRC().equals("BL")) out.println("selected"); %>>After Bill of Lading Date</OPTION>
					<OPTION value="CC" <% if (dcNew.getE01DCMTRC().equals("CC")) out.println("selected"); %>>After Customs Clearance Goods</OPTION>
					<OPTION value="FD" <% if (dcNew.getE01DCMTRC().equals("FD")) out.println("selected"); %>>After Goods Pass F.D.A.</OPTION>
					<OPTION value="FP" <% if (dcNew.getE01DCMTRC().equals("FP")) out.println("selected"); %>>At First Presentation</OPTION>
					<OPTION value="GA" <% if (dcNew.getE01DCMTRC().equals("GA")) out.println("selected"); %>>After Arrival of Goods</OPTION>
					<OPTION value="ID" <% if (dcNew.getE01DCMTRC().equals("ID")) out.println("selected"); %>>After Invoice Date</OPTION>
					<OPTION value="ST" <% if (dcNew.getE01DCMTRC().equals("ST")) out.println("selected"); %>>After Sight</OPTION>
					<OPTION value="TD" <% if (dcNew.getE01DCMTRC().equals("TD")) out.println("selected"); %>>After Date of Transport Docs</OPTION>
				</SELECT>
            </TD>
			<TD nowrap width="30%">
             	<DIV align="right">Term (in Days) :</DIV>
            </TD>
            <TD nowrap width="20%">
		  ...
		  <TR id="trclear">
			<TD nowrap width="30%">
             	<DIV align="right">Increase / Decrease  :</DIV>
			</TD>
			<TD nowrap width="20%">
		  ...
		  <% } %>
          <% if(dcNew.getE01DCMOPT().equals("N") && dcNew.getE01DCMTYP().equals("I")) { %>
				<TR id="trdark">
				  <TD width="25%" align="right" nowrap>Swift Message? :</TD>
				  <TD nowrap width="25%"><INPUT type="radio" name="E01DCMSWF" value="Y" <% if(!dcNew.getE01DCMSWF().equals("N")) out.print("checked");%>>
				    ...
				    No </TD>
				  <TD align="right" nowrap>Swift Format: </TD>
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
		  ...
		  <tr id="trclear">
            ...
            <td nowrap width="30%"> 
             	<div align="right">Merchandise in Consignment? :</div>
            </td>
            <td nowrap width="20%">  
            	<input type="radio" name="E01DCMMCO" value="Y" <%if(dcNew.getE01DCMMCO().equals("Y")) out.print("checked");%>>Yes 
            	<input type="radio" name="E01DCMMCO" value="N" <%if(dcNew.getE01DCMMCO().equals("N")) out.print("checked");%>>No 
			</td>
		  </tr>
		  <tr id="trdark">
			<td nowrap>
             	<div align="right">Name of Vessel :</div>
			</td>
            <td nowrap colspan=3>
          ...
          <tr id="trclear">
             <td><DIV align="right">Agent :</div></td>
             <td colspan=3>
