...
<h3 align="center">Investments - Deletion Customer Portfolio <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_enter_port, EIE00010"></h3>
<hr>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010" >
  <CENTER>
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter" border=0   width=70% align="center" height="80%">
      ...
      <tr valign="middle"> 
        <td nowrap width=40% align="right" height="28" > Portfolio Number : </td>
