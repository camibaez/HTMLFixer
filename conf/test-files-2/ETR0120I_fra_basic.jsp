...
%> 
<h3 align="center"> Inquiry of Forward Rates Agreements <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fra_basic.jsp,ETR0120I"> 
</h3>
<hr size="4">
