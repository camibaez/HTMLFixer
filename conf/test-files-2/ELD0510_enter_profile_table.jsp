...
%>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSELD0510" >
  ...
  <h3 align="center">Profile Table<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="enter_profile_table.jsp,ELD0510"> 
  </h3>
  <hr size="4">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
      ...
      <td> 
        <table id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr> 
            ...
            <td width="22%" nowrap> 
              <div align="right">Profile Table Code :</div>
            </td>
            <td nowrap width="60%"> 
