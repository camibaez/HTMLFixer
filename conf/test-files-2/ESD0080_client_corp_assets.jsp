...
%>
<h3 align="center">Customer Assets<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_corp_assets, ESD0080"></h3>
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" name="TB_BENEFICIARY_CORP" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
          <tr id="trdark">
            ...
            <td nowrap width="66%" >
              <input type="text" name="E<%= name %>4MA1" maxlength="45" size="46" value="<%= assets.getField("E" + name + "4MA1").getString().trim()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="34%">
            ...
            <td nowrap width="66%">
              <input type="text" name="E<%= name %>4MA2" maxlength="35" size="36" value="<%= assets.getField("E" + name + "4MA2").getString().trim()%>">
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="34%">
            ...
            <td nowrap width="66%" >
              <input type="text" name="E<%= name %>4MA3" maxlength="35" size="36" value="<%= assets.getField("E" + name + "4MA3").getString().trim()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="34%">
            ...
            <td nowrap width="66%">
              <input type="text" name="E<%= name %>4CTY" maxlength="30" size="31" value="<%= assets.getField("E" + name + "4CTY").getString().trim()%>">
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="34%">
            ...
            <td nowrap width="66%" >
              <input type="text" name="E<%= name %>4STE" maxlength="4" size="5" value="<%= assets.getField("E" + name + "4STE").getString().trim()%>">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="66%" >
              <input type="text" name="E<%= name %>4CTR" maxlength="30" size="31" value="<%= assets.getField("E" + name + "4CTR").getString().trim()%>">
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="34%" >
            ...
            <td nowrap width="66%">
              <input type="text" name="E<%= name %>4ZPC" maxlength="15" size="16" value="<%= assets.getField("E" + name + "4ZPC").getString().trim()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="34%">
            ...
            <td nowrap width="66%">
              <input type="text" name="E<%= name %>4HPN" maxlength="11" size="12" value="<%= assets.getField("E" + name + "4HPN").getString().trim()%>" onKeypress="enterInteger()">
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="34%">
            ...
            <td nowrap width="66%">
              <input type="text" name="E<%= name %>4AM1" maxlength="15" size="16" value="<%= assets.getField("E" + name + "4AM1").getString().trim()%>" onKeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="34%">
            ...
            <td nowrap width="66%" >
              <input type="text" name="E<%= name %>4AM2" maxlength="15" size="16" value="<%= assets.getField("E" + name + "4AM2").getString().trim()%>" onKeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="34%">
            ...
            <td nowrap width="66%" >
              <div align="left">
                <input type="text" name="E<%= name %>4DT1" size="2" maxlength="2" value="<%= assets.getField("E" + name + "4DT1").getString().trim()%>" onKeypress="enterInteger()">
                <input type="text" name="E<%= name %>4DT2" size="2" maxlength="2" value="<%= assets.getField("E" + name + "4DT2").getString().trim()%>" onKeypress="enterInteger()">
                <input type="text" name="E<%= name %>4DT3" size="2" maxlength="2" value="<%= assets.getField("E" + name + "4DT3").getString().trim()%>" onKeypress="enterInteger()">
              </div>
            </td>
          </tr>
        </table>
