...
<jsp:useBean id="EDEN025Record" class="datapro.eibs.beans.EDEN02501Message"  scope="session" /> 
...
<H3 align="center"><%=title %> - Negation Codes <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="our_denial.jsp, EDEN025"></H3>
<hr size="4">
      ...
      <td nowrap> 
        ...
        <tr id="<%= (row % 2 == 1) ? "trdark" : "trclear" %><%row++;%>">
            ...
            <td nowrap width="35%" align="left">
				<INPUT type="text" name="E01DTCCDE" size="11" maxlength="11" value="<%= EDEN025Record.getE01DTCCDE().trim()%>" <%=read%> >            	
			</td>
            <td nowrap width="15%" align="right">Description :</td>
			<td nowrap width="35%" align="left"> 
				<INPUT type="text" name="E01DTCDSC" id="E01DTCDSC" size="60" value="<%= EDEN025Record.getE01DTCDSC().trim()%>"> 
			</td>
		</tr>		
        </table>
      </td>
