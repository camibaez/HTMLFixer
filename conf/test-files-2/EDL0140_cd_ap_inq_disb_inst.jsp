      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left">
                <input type="text" readonly name="E08ACC" size="12" maxlength="12" value="<%= userPO.getIdentifier().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0"  align="center">
          ...
          <tr id="trclear"> 
            ...
            <td width="58%" nowrap> 
              <input type="text" readonly name="E<%= name %>1BAC" maxlength="9" size="11" value="<%= cdDisb.getField("E" + name + "1BAC").getString().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="42%" nowrap> 
