...
<h3 align="center">Classification Codes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_both_codes, ESD0080"></h3>
<hr size="4">
        ...
        <td nowrap>
          <table cellspacing="0" cellpadding="2" width="100%" border="0">
            ...
            <tr id=trclear>
              ...
              <td nowrap width="70%">
                <input type="text" name="E03UC4" size="7" maxlength="6" value="<%= codes.getE03UC4().trim()%>">
              </td>
            </tr>
          </table>
        </td>
