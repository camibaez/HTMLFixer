...
%> 
<h3 align="center">Loan Reversal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_reversal.jsp,EDL1300"> 
</h3>
<hr size="4">
 ...
 <table class=tableinfo>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr id=trdark>
         ...
         <td><input size="13" type="text" name="E01DEAACC"  value="<%= msgLoan.getE01DEAACC()%>"></td>
    ...
    <tr id=trdark>
	     ...
	     <td>
			<input type="radio" name="H01FLGWK1" value="Y" onClick="document.forms[0].H01FLGWK1.value='Y'" <%if(msgLoan.getH01FLGWK1().equals("Y")) out.print("checked");%>>Yes 
			<input type="radio" name="H01FLGWK1" value="N" onClick="document.forms[0].H01FLGWK1.value=''" <%if(msgLoan.getH01FLGWK1().equals("")) out.print("checked");%>>No 
		 </td>
        ...
        <%}%>
         ...
         <td>
         <%if (msgLoan.getH01FLGWK3().equals("A")){%>
			<input type="radio" name="H01FLGWK2" value="Y" onClick="document.forms[0].H01FLGWK2.value='Y'" <%if(msgLoan.getH01FLGWK2().equals("Y")) out.print("checked");%>>Yes 
			<input type="radio" name="H01FLGWK2" value="N" onClick="document.forms[0].H01FLGWK2.value='N'" <%if(!msgLoan.getH01FLGWK2().equals("Y")) out.print("checked");%>>No          
         <%}%>
         </td>
    </tr>    
  </table>
