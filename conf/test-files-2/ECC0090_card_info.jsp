...
function goAction(op) {
	...
	if (op == 1) {
    	...
    	document.getElementById("E01CCRNUM").value = temp[0];
    	document.getElementById("E01CCRTPI").value = temp[1];
		document.getElementById("SCREEN").value = 1600;
		document.forms[0].submit();
	}
}
...
<body>
<h3 align="center">Debit Card Assignment</h3>
<hr size="4">
<% 
 ...
 <TR > 
	...
	<TBODY>
		<TR id="trdark">
			...
			<TH align="CENTER" nowrap width="20%"><B>Card Number</B></TH>
			<TH align="CENTER" nowrap width="20%"><B>Delivery Branch</B></TH>
			<TH align="CENTER" nowrap width="15%"><B>Status</B></TH>
			<TH align="CENTER" nowrap width="20%"><B>Delivery Date</B></TH>
			<TH align="CENTER" nowrap width="20%"><B>Assignment Type</B></TH>
		</TR>
		<%
		cardList.initRow(); 
...
<% if (atg == 1) {%>
	...
	<TR>
      <TD> 
	      <div align="center"> <font size="3"><b> <FONT size="3"><B>There
		are transactions to approve</B></FONT></b></font></div>
      </TD>
     </TR>
   	</TABLE>
<%}%>
...
<% } else { %>
	...
	<TR>
      <TD> 
	      <div align="center"> <font size="3"><b> <FONT size="3"><B>There
		are not assigned accounts</B></FONT></b></font></div>
      </TD>
     </TR>
   	</TABLE>
	<% } else {%>
	...
	<TR>
      <TD> 
	      <div align="center"> <font size="3"><b> <FONT size="3"><B><FONT
			size="3"><B>There are transactions to approve</B></FONT></B></FONT></b></font></div>
      </TD>
     </TR>
   	</TABLE>
   	<%}%>
