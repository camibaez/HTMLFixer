...
<h3 align="center">Services Charges Structure List<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sc_cust_list.jsp, EDC0600"></h3>
<hr size="4">
	...
	filter:progid:DXImageTransform.Microsoft.dropshadow(OffX=3, OffY=3, Color='gray', Positive='true');">
      ...
      <tr id="trdark"> 
        ...
        <td align=left width="34%"> 
          		<INPUT type="text" name="NEWCUN" size="15" maxlength="10" onkeypress="enterInteger()">
            	<a href="javascript:GetCustomerDescId('NEWCUN','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a> 
       ...
       %>             
        <TR>
          <td align="center" nowrap > 
        	<input type="radio" name="ROW1" <%= chk %> value="<%= ccList.getCurrentRow() %>" onClick="setInfo('<%= msgList.getE01RCOBNK()%>', '<%= msgList.getE01RCOTAR() %>', '<%= msgList.getE01RCOCUN() %>')" >
      	  </td>
