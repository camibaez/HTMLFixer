...
<FORM Method="post" Action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0145">
...
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  ...
  <h3 align="center">Second Trade Ticket Approval<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="approval_list2.jsp,EIE0145"> 
  </h3>
<hr size="4">

  <TABLE class="tbenter">
    <TR>
		<TD ALIGN=CENTER class=TDBKG width="47%"><a
			href="javascript:goAction('A')" id="linkApproval">Approval</a></TD>
		<TD ALIGN=CENTER class=TDBKG width="175"> <a href="javascript:goAction('D')">Delete</a> 
      </TD>
		<TD ALIGN=CENTER class=TDBKG><a href="javascript:goExit()"
