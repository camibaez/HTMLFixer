      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" height="100%">
          <tr id="tbenter">
            <td nowrap colspan=2> 
              <div align="center">
              	<APPLET name="history" code="VerticalBar3D.class" width="90%" height="90%" align="absmiddle" archive="3DGraphs.zip" codebase="<%=request.getContextPath()%>/pages/e/">
                ...
                <PARAM name="x_axis_description" value="Months">
                  ...
                  <% lstTransactions.getFirstRec();
                     datapro.eibs.beans.DC_LOG xlog = new datapro.eibs.beans.DC_LOG();
                     int xi=0;
                     while(lstTransactions.getNextRow()){
                        xlog = (datapro.eibs.beans.DC_LOG) lstTransactions.getRecord();
                        xi++;                        
                        if(xi>12) break;                           
                   %>
