...
<h3 align="center">New/Maintenance of Credit Line<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="cl_enter_maint, ELN0000"></h3>
<hr>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.credit.JSELN0000" >
  <CENTER>
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter" border=0   width=70% align="center" height="80%">
      ...
      <tr valign="middle"> 
        <td nowrap width=40% align="right" height="28" > Credit Line Number : 
        </td>
        <td nowrap width=40% align="left" height="28" > 
          <INPUT type="text" name="LNENUM" size="5" maxlength="4" onkeypress="enterInteger()">
