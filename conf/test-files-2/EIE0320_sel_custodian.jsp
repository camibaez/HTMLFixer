...
<BODY>
<h3 align="center">Instrument Open Position by Custodian<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel_custodian.jsp, EIE0320"></h3>
<hr size="4">
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trclear">
            <td nowrap width="25%" >
              <div align="right"><a href="javascript:showInstrumentInq(document.forms[0].INSTRUMENT.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" alt="Help" border="0" >
                Instrument </a> :</div>
            </td>
            <td nowrap colspan="5" >
              <div align="left">
  ...
  <table class="tbenter" width=100% align=center>
    <tr>
      <td class=TDBKG width="33%">
        <div align="center">
			<a href="javascript:showOpenTransCustRecDte(document.forms[0].CUSTODIAN.value,document.forms[0].INSTRUMENT.value,document.forms[0].RCDT1.value,document.forms[0].RCDT2.value,document.forms[0].RCDT3.value)">
			<b>Details</b></a></div>
      </td>
      <td class=TDBKG width="33%">
