...
%> 
<h3 align="center"> Foreign Exchange Currency Options - Inquiry</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap >&nbsp;</td>
            <td nowrap >Date :<%= Util.formatDate(fex.getE01FEMDD1(),fex.getE01FEMDD2(),fex.getE01FEMDD3())%></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="23%" > 
              <div align="right">Broker :</div>
            </td>
            <td nowrap colspan="3" ><%= fex.getE01FEMBRK()%> - <%= fex.getD01FEBNM1()%></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="23%" > 
              <div align="right">Action Taken :</div>
            </td>
            <td nowrap colspan="3" > <% if(fex.getE01FEMSBT().equals("BC")) out.print("Buy Call Option");
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="16%" > 
              <div align="right">Counter Curreny :</div>
            </td>
            <td nowrap width="23%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="38%" > 
              <div align="left"><% if(fex.getE01FEMOPT().equals("1")) out.print("American");
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="38%" ><%= fex.getE01FEMTRM().trim()%> - <% if(fex.getE01FEMTRC().equals("M")) out.print("Month(s)");
																		  else if(fex.getE01FEMTRC().equals("D")) out.print("Day(s)");
