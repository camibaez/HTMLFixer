...
<H3 align="center">Mantenimiento de Boletas de Garantia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bg_enter_maint,ELC5000"></H3>
