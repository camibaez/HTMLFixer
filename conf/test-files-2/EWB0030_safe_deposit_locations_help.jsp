...
<BODY>
<h3 align="center">Safe Deposit Box Locations<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_locations, EWB0030"></H3>
<hr size="4">
     	...
     	%>
					<TR>
						<TD nowrap align="CENTER"><a 
							...
							<%=Util.formatCell(msgPart.getE01LOCLOC())%>
						</TD>						
						<TD nowrap align="CENTER"><a 
							href="javascript:enter('<%=Util.formatCell(msgPart.getE01LOCLOC())%>','<%=Util.formatCell(msgPart.getE01LOCNME())%>')">
							<%=Util.formatCell(msgPart.getE01LOCNME())%>
						</TD>						
					</TR>
					<%}%>
				</TBODY>
