...
<h3 align="center">Communications <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_both_com, ESD0080"></h3>
<hr size="4">
      ...
      <td nowrap > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
          ...
          <tr id=trclear> 
            ...
            <td nowrap width="44%"> 
              <div align="left"> 
                <input type="text"   name="E07ABK" size="18" maxlength="17" value="<%= com.getE07ABK().trim()%>">
              </div>
            </td>
          </tr>
        </table>
