...
%>
  <h3 align="center"> Collection Documents<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="coll_list_doc_det.jsp,ELC0455"> 
  </h3>
  <hr size="4">
  ...
  <TABLE width="100%">
    <TR> 
      ...
      <TH ALIGN=CENTER  nowrap width="95%" >Text</TH>
    </TR>
    <%
                cifList.initRow();
