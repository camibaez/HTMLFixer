...
<html>
<head>
<title>Database Access List</title>
...
<BODY>
<h3 align="center">Database Access<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="db_access_list.jsp, ESS0240"></h3>
<hr size="4">
    ...
    <tr > 
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="15%">Ref Number</th>
