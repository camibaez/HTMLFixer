      	...
      	case 4 : 
                ...
                for(n=0;n<formLength;n++) {
		   		...
		   		if (ok) {
                  	...
                  	alert('You dont have any item selected !');
                  	break;
                }
...
function openFile(nameOfFile) {
	...
	if(<%=JSEIBSProp.getEODDirectUrl()%>){
		pg = "<%=JSEIBSProp.getEODPDFURL()%>" + nameOfFile;
	} else {
...
<table class="tbenter" width=100% align=center>
	<tr>
    	<td width="2%"></td>
		<% if (vOnlyAdm) { %>
		 		<td width="16%"><div align="center"><a href="javascript:goAction(8)"><img src="<%=request.getContextPath()%>/images/e/new.gif" align="middle" border="0"></a></div></td>
 				<td width="16%"><div align="center"><a href="javascript:goAction(4)"><img src="<%=request.getContextPath()%>/images/e/delete.gif" align="middle" border="0"></a></div></td>
 				<td width="16%"><div align="center"><a href="javascript:goAction(6)"><img src="<%=request.getContextPath()%>/images/e/update.gif" align="middle" border="0"></a></div></td>
              	<td width="16%"><div align="center"><a href="javascript:goAction(<%=jScriptAction %>)"><img src="<%=request.getContextPath()%>/images/e/exit.gif" align="middle" border="0"></a></div></td>
		<%  } %>
		<td width="2%"></td>
	</tr>
</table>
	...
	<tr>
    	<td nowrap> 
        	<table cellspacing="0" cellpadding="2" class="tbhead" width="100%" align="center">
				<tr>
					<td align=left colspan=5 ><%= type %>: <%= usercode %> </td>
				</tr>
            </table>
        </td>
	</tr>
  		...
  		<TD NOWRAP>
  			<TABLE id="headTable" >
 				<TR id="trdark">  
					...
					<td align=center NOWRAP>Report</td>
					<td align=center NOWRAP>Description</td>
					<td align=center NOWRAP>Excel</td>
			 	</tr>
		   	</TABLE>
					            ...
					            while (beanList.getNextRow()){
							        ...
							        if (vOnlyAdm) {
							        	if (firstItem) {
					        	        	...
					        	        	if ( reportName.trim().equals(rowData.substring(11,21))) {
					        	        		chk = "checked";
					            	        } else {
					            	        	chk = "";
					            	        }
					                ...
					                if (vOnlyAdm) {
								    	out.println("<td nowrap><input type=\"radio\" " + chk + " name=\"REPNAME\" value=\"" + rowData.substring(11,21) + "\" " + dsb + "  ></td>"); // radio button
					                } else {
