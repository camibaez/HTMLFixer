...
<h3 align="center">Letters Of Credit [Documents]<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_documents.jsp,0500"></h3>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="8%" align="center">
              <a href="javascript:GetCodeDescCNOFC('E02OFC','D02OFC','15')"></a>Code</td>
				<td nowrap width="21%" align="center">Description
            </td>
				<td nowrap width="5%" align="center">Originals</td>
				<td nowrap width="36%">Copies</td>
			</tr>
          <tr id="trclear"> 
            <td nowrap width="30%" > 
              <div align="right"></div>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD2','E06LCMDS2','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD3','E06LCMDS3','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD4','E06LCMDS4','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD5','E06LCMDS5','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD6','E06LCMDS6','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD7','E06LCMDS7','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="8%"> 
              ...
              <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD8','E06LCMDS8','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></a><%}%> 
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="8%">             
                ...
                <% if( !flgrd.trim().equals("readonly") ) {%> <a href="javascript:GetCodeDescCNOFC('E06LCMDD9','E06LCMDS9','08')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help"	align="bottom" border="0"></a><%}%>
            </td>
