...
<BODY>
<h3 align="center">Chart of Accounts Maintenance <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="financial_list_enter.jsp, EDP0703"></h3>
<hr size="4">
 ...
 %>
  ...
  <TABLE class="tbenter" width="100%" >
    <TR>
      <TD > 
        <div align="center"> 
          <p><b>Formats have not been established to work with chart of accounts</b></p>
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      <td class=TDBKG width="30%"> 
        <div align="center"><a href="javascript:goAction(1)"><b>Maintenance</b></a></div>
     </td>
      <td class=TDBKG width="30%"> 
        <div align="center"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Exit</b></a></div>
      </td>
