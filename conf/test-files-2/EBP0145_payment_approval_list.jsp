...
function goApproval() {
	...
	if (!confirm("Do you want to Approval this Payment?")) {
		return;
	}
	document.forms[0].E01BPBBIL.value = "";
	document.getElementById("SCREEN").value="2";
	//
	if (document.getElementById("VIA").value == "C") {
  		<% 
     	...
     	var elementName= document.forms[0].elements[n].name;
      	if(elementName == "CODE") {
			if (document.forms[0].elements[n].checked == true) {
				...
				document.getElementById("VIA").value = document.forms[0].elements[n].value.substr(0,1);
				document.getElementById("E01BPPNUM").value = document.forms[0].elements[n].value.substr(1,I);
...
function goNewOCK(){
    ...
    if (ok){
  	  document.forms[0].E01BPBBIL.value = document.forms[0].chknum.value;
  	  document.forms[0].submit();
  	} else {
...
%>
	<TABLE class="tbenter" width="100%"> 
 	...
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      		<TD>         
      			<div align="center"> <h4 style="text-align:center">There are no Payments for Approval.</h4> 
      			</div>
      		</TD></TR>
   	</TABLE>
<%
...
%>    
	...
	<TABLE class="tbenter" width="100%"> 
		<TR>
			<TD align="CENTER" class="TDBKG" width="25%"><a href="javascript:goInquiry()"><b>Bill<br>Inquiry</b></a></TD>
			<TD align="CENTER" class="TDBKG" width="25%"><a href="javascript:goApproval()"><b>Approval</b></a></TD>
			<TD align="CENTER" class="TDBKG" width="25%"><a href="javascript:goReject()"><b>Reject</b></a></TD>
	  		<TD align="CENTER" class="TDBKG" width="25%"><a href="<%=request.getContextPath()%>/pages/background.jsp"><b>Exit</b></a></TD>
		</TR>
	</TABLE> 
  ...
  <TABLE class="tableinfo" id="dataTable" width="100%">
    <TR id=trdark> 
		...
		<td nowrap align="center" width="5%"><B>Sequence</B></td>
		...
		<td nowrap align="center" width="8%"><B>Fee<BR>Amount</B></td>
    ...
    <TR id=trclear>
		...
		<td NOWRAP align="center" width="2%"> 
            <INPUT type="radio" name="CODE" value="<%= msgList.getE01BPPPVI()%><%= msgList.getE01BPPNUM()%>|<%= msgList.getE01BPPSEQ()%>" >
		</td>
