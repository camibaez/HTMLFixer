...
<body>
 ...
 <h3 align="center">Bloomberg Interface Management<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="bloomberg_transfer_file.jsp, EFE0224"></h3>
<hr size="4">
 <FORM METHOD="POST" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEFE0224" ENCTYPE="multipart/form-data">	
    <p>
    ...
    <tr> 
      <td> 
        <table id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
          	<tr id="trdark">
              <td nowrap >
              	<div align="center">File Type : 
              <input type="radio" name="OPT" value="R">
              Rates 
              <input type="radio" name="OPT" value="I" >
              Investment Instruments              	</div>
              </td>
            </tr>        
			<tr>
     			<td align="center"> 
