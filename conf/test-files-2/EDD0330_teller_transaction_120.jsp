...
<h3 align="center">TELLER TRANSACTIONS<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="teller_transaction_120.jsp, EDD0330"></h3>
<hr size="4">
...
<p><input type=HIDDEN name="PAGE_NAME" value="EDD0330_teller_transaction_120.jsp"></p>
...
<table  class="tableinfo" cellspacing="0" cellpadding="2" border="0">
	...
	<tr id="trclear"> 
	    ...
	    <td nowrap align="left" colspan="2"><input type="text" id="SERIAL" name="T120_N#9$07" size="18" maxlength="9" value="<%= serial %>" <%= readonly %>>
    </tr>
	<tr id="trdark"> 
	    <td nowrap align="right" width="40%" > Cash Deposit :</td>
	    <td nowrap align="left" colspan="2"><input type="text" id="CASH" <%= cash_disabled %> name="T120_N#15:2$01" size="18" maxlength="15" value="<%= cash %>" <%= readonly %> onkeypress = "enterDecimal()">
    </tr>
	<tr id="trclear"> 
	    <td nowrap align="right" width="40%"> Check Deposit :</td>
	    <td nowrap align="left" colspan="2"><input type="text" id="CHECK_AMOUNT" <%= check_disabled %> name="T120_N#15:2$03" size="18" maxlength="15" value="<%= check %>" <%= readonly %> onkeypress = "enterDecimal()"></td>	
    </tr>
	<tr id="trdark"> 
	    <td nowrap align="right" width="40%"> Other Banks on US Check Deposit :</td>
	    <td nowrap align="left" colspan="2"><input type="text" id="OTHER_BANK_CHECK" <%= check_disabled %> name="T120_N#15:2$04" size="18" maxlength="15" value="<%= other_bank_check %>" <%= readonly %> onkeypress = "enterDecimal()">
    </tr>
	<tr id="trclear"> 
	    <td nowrap align="right" width="40%"> Other Banks not on US Check Deposit :</td>
	    <td nowrap align="left" colspan="2"><input type="text" id="OTHER_COUNTRY_CHECK" <%= check_disabled %> name="T120_N#15:2$05" size="18" maxlength="15" value="<%= other_country_check %>" <%= readonly %> onkeypress = "enterDecimal()">
    </tr>
	<tr id="trdark"> 
	    <td nowrap align="right" width="40%"> Cash Back :</td>
	    <td nowrap align="left" colspan="2"><input type="text" id="CASH_BACK" <%= cash_back_disabled %> name="T120_N#15:2$02" size="18" maxlength="15" value="<%= cash_back %>" <%= readonly %>></td>
    </tr>
	<tr id="trclear"> 
	    <td nowrap align="right" width="40%" > Total Amount :</td>
	    <td nowrap align="left" colspan="2"><input type="text" id="TOTAL" name="T120_N#15:2$06" size="18" maxlength="15" value="<%= total %>" <%= readonly %> onkeypress = "enterDecimal()">
    </tr>
</table>
