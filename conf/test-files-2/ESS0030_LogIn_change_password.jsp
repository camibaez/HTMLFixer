...
function validate() {
  ...
  if (document.forms[0].NewPassword_1.value == document.forms[0].NewPassword_2.value) {
    ...
    alert("New and Confirm Password \nMust be the same.");
  }
 ...
 <br>
  <CENTER>
    ...
    <TABLE WIDTH="100%"  class="tbenter" BORDER=0>
	 <TR>      
        <TD ALIGN=right width="50%" > <b>New Password</b></TD>
        ...
        <TD ALIGN=right width="50%" > <b>Confirm Password</b></TD>
   ...
   <CENTER>  
    ...
    <TABLE class="tbenter" WIDTH="100%" BORDER=0>
      ...
      <TR> 
        <TD ALIGN=middle> 
          <div align="center"> 
            <input type=image name="imgLogin" src="<%=request.getContextPath()%>/images/e/login.gif" onClick="validate()"> 
          </div>
        </TD>
      </TR>
    </TABLE>
