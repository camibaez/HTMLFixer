...
<body>
<h3 align="center">Floating Rates Schedule<BR>New<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="floatRate_schedule_new.jsp, EDL0157">
</h3>
<hr size="4">
<%
