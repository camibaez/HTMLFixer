...
<h3 align="center">Display Statement Header<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_inq_display_title.jsp,EDL0130"></h3>
<hr size="4">
