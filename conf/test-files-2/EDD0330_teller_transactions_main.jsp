...
<h3 align="center">TELLER TRANSACTIONS<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="teller_transactions_main.jsp, EDD0330"></h3>
<hr size="4">
			 ...
			 %>
			          <tr> 
			            <td NOWRAP align=CENTER width="10%"> 
			              <input type="radio" name="CURRCODE" value="<%= ETLR00001Help.getCurrentRow() %>" <%=chk%> onclick="goAction(<%= ETLR00001Help.getCurrentRow() %>)">
			            </td>
