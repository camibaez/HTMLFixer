...
%> 
<h3 align="center"> Foreign Exchange Swap <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_swap.jsp,EFE0120P"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap ><INPUT type="text" disabled name="E01FESAM1"
					size="15" maxlength="13" value="<%= fex.getE01FESAM1()%>"
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="right">
            Forward Counter Amount :</div></td>
            <td nowrap ><INPUT type="text" name="E01FESAM2"
					size="15" maxlength="13" value="<%= fex.getE01FESAM2()%>"
					onkeypress="enterDecimal()"></td>
            <td nowrap > 
