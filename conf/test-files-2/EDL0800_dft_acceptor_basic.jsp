...
%> 
<h3 align="center">Acceptant Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="dft_acceptor_basic.jsp,EDL0800"> 
</h3>
<hr size="4">
...
<INPUT TYPE=HIDDEN NAME="ACTION" VALUE="<%= strGrp %>">
