...
<h3 align="center">Transaction Inquiries<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="st_selection.jsp,EPR2030"> 
</h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">              
            <td nowrap width="32%"> 
              <div align="right"><b>Select Amounts from :</b></div>
            </td>
            <td nowrap width="3%">&nbsp;</td>
            <td nowrap width="23%"> 
              <div align="left"> 
