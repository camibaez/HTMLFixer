...
<H3 align="center">Correspondent Bank Charges<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sc_corresp_enter.jsp, ELC0600"></H3>
...
<BR>
   <TABLE class="tableinfo" id="clear"  cellspacing="0" cellpadding="2" width="100%"border="0" >        
          ...
          <TR> 
            <TD width="49%" nowrap> 
        <DIV align="right">Correspondent Bank Number:</DIV>
      </TD>
      <TD width="51%" nowrap> 
