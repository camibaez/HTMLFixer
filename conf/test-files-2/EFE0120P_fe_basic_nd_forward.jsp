...
%> 
<h3 align="center"> Foreign Exchange Non Deliverable Forwards <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_nd_forward.jsp, EFE0120P"> 
</h3>
<hr size="4">
