...
<h3 align="center">Change Status
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_status_enter.jsp, ECC0090"> 
</h3><hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECC0090" >
  ...
  <table class="tbenter" height="75%" width="100%" border="0">
    <tr>
      ...
      <td nowrap align="center"><B>Customer Number :</B> 
