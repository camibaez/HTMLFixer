...
<H3 align="center">Tax Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="taxes_500_iva.jsp, ESD0009"></H3>
<hr size="4">
    ...
    <tr bordercolor="#FFFFFF">
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark">
            <td nowrap width="16%" height="19">
              <div align="right">G/L Contingency Debit :</div>
            </td>
            <td nowrap height="19">
              <div align="left">
          ...
          <tr id="trclear">
            <td nowrap width="16%" height="19">
              <div align="right">G/L Contingency Credit
                :</div>
            </td>
            <td nowrap height="19">
              <div align="left">
          ...
          <% if (taxes.getE01TAXTTP().equals("500")) {%>
          <tr id="trclear">
            <td nowrap width="16%" height="19">
              <div align="right">VAT (Value Added Tax) Type :</div>
            </td>
            <td nowrap height="19">
              <div align="left"><select name="E01TAXIVA">
                  <option value="" <%if (taxes.getE01TAXIVA().equals("")) { out.print("selected"); }%>></option>
                  <option value="A" <%if (taxes.getE01TAXIVA().equals("A")) { out.print("selected"); }%>>Add-On</option>
				  <option value="D" <%if (taxes.getE01TAXIVA().equals("D")) { out.print("selected"); }%>>Discounted</option>
                </select></div>
            </td>
          </tr>
          <%}%>
