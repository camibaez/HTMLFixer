...
<h3 align="center">Bank Instructions<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bank_instructions.jsp,ESD0005"></h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSESD0005">
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            <td nowrap width="29%">
              <div align="right">Bank :<%= pymInst.getE06BNK()%></div>
            </td>
            <td nowrap width="19%">
              <div align="right">Currency : <%= pymInst.getE06CCY()%></div>
            </td>
            <td nowrap width="26%">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="26%">
              <div align="right">Correspondant Customer :</div>
            </td>
            <td nowrap width="26%">
              <input type="text" name="E06CC1" size="12" maxlength="9" value="<%= pymInst.getE06CC1()%>">
              <a href="javascript:GetCustomerDescId('E06CC1','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0" ></a>
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="29%" height="23">
              <div align="right">Default DDA Account 1 :</div>
            </td>
            <td nowrap width="19%" height="23">
              <input type="text" name="E06DDA" size="15" maxlength="12" value="<%= pymInst.getE06DDA()%>">
              <a href="javascript:GetAccount('E06DDA',document.forms[0].E06BNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
            <td nowrap width="26%" height="23">
              <div align="right">Default G/L Account 1 :</div>
            </td>
            <td nowrap width="26%" height="23">
              <input type="text" name="E06GLN" size="12" maxlength="9" value="<%= pymInst.getE06GLN()%>">
              <a href="javascript:GetLedger('E06GLN',document.forms[0].E06BNK.value,document.forms[0].E06CCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="29%" height="19">
              <div align="right">Default DDA Account 2 :</div>
            </td>
            <td nowrap width="19%" height="19">
              <input type="text" name="E06DD1" size="15" maxlength="12" value="<%= pymInst.getE06DD1()%>">
              <a href="javascript:GetAccount('E06DD1',document.forms[0].E06BNK.value,'RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
            <td nowrap width="26%" height="19">
              <div align="right">Default G/L Account 2 :</div>
            </td>
            <td nowrap width="26%" height="19">
              <input type="text" name="E06GL1" size="12" maxlength="9" value="<%= pymInst.getE06GL1()%>">
              <a href="javascript:GetLedger('E06GL1',document.forms[0].E06BNK.value,document.forms[0].E06CCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
          </tr>
        </table>
      </td>
  ...
  <p>&nbsp;</p><div id="OtherOpt">
                          ...
                          <table width="94%" border="0">
                            <tr>
                              <td width="53%">
                                ...
                                <a href="javascript:GetCustomerDescId('E06PYC','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0" ></a>
                                </div>
                              </td>
                            </tr>
                            <tr>
                          ...
                          <table width="94%" border="0">
                            <tr>
                              <td width="53%">
                                ...
                                <a href="javascript:GetCustomerDescId('E06RCC','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absmiddle" border="0" ></a>
                                </div>
                              </td>
                            </tr>
                            <tr>
    ...
    <table width="100%">
      <tr>
        <td width="50%">
          <p align="center"> <input id="EIBSBTN" type=button name="Submit" value="Submit" onClick="submit()">
          </p>
        </td>
      </tr>
    </table>
