...
<body bgcolor="#FFFFFF">
<H3 align="center"> Treasury - Profitability<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fe_enter_new,EFE0120P"></H3>
...
<center>
    <table class="tableintro" width="58%">
      ...
      <tr id="trintro">
        ...
        <td width="23%">
          <div align="left">Trading Profit</div>
        </td>
        <td width="4%">
          <div align="center">
        ...
        <td width="18%">
          <div align="left"> Points </div>
        </td>
        <td width="4%">
          <input type="radio" name="INPTOPT" value="32">
        </td>
        <td colspan="3">Revaluation Profit </td>
      </tr>
      <tr id="trdark">
        <td colspan="8">&nbsp;</td>
      </tr>
      <tr id="trintro">
        <td colspan="5">
          <div align="left">Counterparty :
            ...
            <a href="javascript:GetCustomerDescId('CUNCOD','CUNDSC','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a></div>
        </td>
