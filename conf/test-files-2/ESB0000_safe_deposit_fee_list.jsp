...
<HTML>
<HEAD>
<TITLE>Safe Deposit Fee Table</TITLE>
...
function ShowNew(x,y) {	 
    ...
    enterNew.filters[0].Play();
	document.forms[0].E01SBFCOD.focus();
}
...
<h3 align="center">Safe Deposit Box Fees Table<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_fee_list, ESB0000"></H3>
<hr size="4">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<tr id="trdark"> 
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          <input type="text" name="E01SBFCOD" size="3" maxlength="2" onchange="SetErrorVisible()">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01SBFCOD())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01SBFAM1())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01SBFBK1() + "-" + msgPart.getE01SBFCY1() + "-" + msgPart.getE01SBFGL1())%></TD>
		</TR>    		
    	<%}%>    
     </TABLE>
    </TD>
