		...
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0"
			...
			<TR id="trdark">
				...
				<DIV align="left"><INPUT type="text" name="E04LCMBNK" readonly
					size="4" maxlength="2" value="<%=msg050004.getE04LCMBNK().trim()%>"></DIV></TD>
				<TD nowrap width="16%">
				<DIV align="right"><B>Product : </B></DIV>
				</TD>
				<TD nowrap width="16%">
				<DIV align="left"><B> <INPUT type="text" name="E01LCMPRO" size="4"
					maxlength="4" value="<%=msg050004.getE04LCMPRO().trim()%>" readonly> </B>
				</DIV>
				</TD>
				<TD nowrap width="16%">
				...
				<DIV align="left"><B><INPUT type="text" name="E04LCMACC" size="12"
					maxlength="12" value="<%=msg050004.getE04LCMACC().trim()%>" readonly> </B>
				</DIV>
				</TD>
			</TR>
			<TR id="trclear">
				...
				<DIV align="left"><INPUT type="text" name="E04LCMBNK0" readonly
					...
					"/"+(msg050004.getE04LCMID3().length() == 1 ? "0"+msg050004.getE04LCMID3() : msg050004.getE04LCMID3())%>"></DIV></TD>
				<TD nowrap width="16%">
				...
				<TD nowrap width="16%" align="left">
					...
					maxlength="3" value= "<%=msg050004.getE04LCMTCY()%>" readonly>
				</TD>
			</TR>
			<TR id="trclear">
				<TD nowrap width="16%">
				...
				<DIV align="left"><INPUT type="text" name="E04LCMBNK0" readonly
					...
					+(msg050004.getE04LCMEX3().length() == 1 ? "0"+msg050004.getE04LCMEX3() : msg050004.getE04LCMEX3())%>"></DIV></TD>
				<TD nowrap width="16%">
				<DIV align="right"><B>Amount (L/C Currency) :</B></DIV>
				</TD>
				<TD nowrap width="16%">
				<DIV align="left"><B><INPUT type="text" name="E04LCMOAM" size="12"
					maxlength="12" value="<%=msg050004.getE04LCMOAM()%>" readonly> </B></DIV>
				</TD>
			</TR>
		</TABLE>
		</TD>
						...
						<TR id="<%=( i%2==0 ? "trclear" : "trdark" )%>">
							...
							<TD nowrap width="10%" align="center">
								<INPUT name="<%=field1.get(i)%>" type="text"
									value="<%=msg050004.getField((String) field1.get(i)).getString().trim()%>" size="15" maxlength="15" readonly="readonly">
						  </TD>
							<TD nowrap width="10%">
