...
<body>
 ...
 <h3 align="center"> FINCEN File Upload Process</h3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0"> 
        ...
        <tr id=trdark> 
		 ...
		 <tr id=trdark> 
	      <td nowrap width="40%"> 
	        <div align="right">Type of File :</div>
	      </td>
		  <td nowrap width="60%" >
              <input type="radio" name="E01TYPE" value="B"  checked>Master Business 
              <input type="radio" name="E01TYPE" value="P"  >Master People
