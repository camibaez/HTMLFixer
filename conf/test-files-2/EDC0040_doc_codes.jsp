<html>
<head>
<title>Documentary Collection Approval [Special Codes]</title>
...
<h3 align="center">Documentary Collection Approval Inquiry [Special Codes]
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0" height="118">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatoty Field" border="0" align="middle"> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%"> 
