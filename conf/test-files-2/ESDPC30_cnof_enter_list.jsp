...
<jsp:useBean id= "ESDPC3001Help" class= "datapro.eibs.beans.JBObjList"  scope="session" />
...
<BODY>
<h3 align="center">Reference Codes Table<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_enter_list.jsp, ESD0030"></h3>
<hr size="4">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<tr id="trdark"> 
      <td align=CENTER width="18%"> 
        <div align="right">Reference Code :</div>
      </td>
 ...
 %>
  ...
  <TABLE class="tbenter" width="100%" >
    <TR>
      <TD > 
        <div align="center"> 
          <p><b><B>There is no match for your search criteria</B></b></p>
          <p>&nbsp;</p>
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
      ...
      <td class=TDBKG width="30%"> 
		<div id="eibsSearch" align="center" style="cursor:pointer"><a><b>Direct<BR>Search</b></a></div>
      </td>
      <td class=TDBKG width="30%"> 
 			   ...
 			   <TR> 
  				...
  				<TABLE id="headTable" >
   			    ...
   			    <div id="dataDiv1" class="scbarcolor">
    				<table id="dataTable" > 
          <%
                ESDPC3001Help.initRow();
				boolean firstTime = true;
				String chk = "";
        		while (ESDPC3001Help.getNextRow()) {
					if (firstTime) {
						firstTime = false;
						chk = "checked";
					} else {
                  ...
                  datapro.eibs.beans.ESDPC3001Message msgList = (datapro.eibs.beans.ESDPC3001Message) ESDPC3001Help.getRecord();
		 %>
		 	<tr> 
