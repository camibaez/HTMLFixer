...
%> 
<h3 align="center">Corporate Officers<img src="<%=request.getContextPath()%>/images/e_ibs.gif"  align="left" name="EIBS_GIF" ALT="cleint_inq_corp_stock_holder, ESD0080"></h3>
<hr size="4">
