...
%> 
<h3 align="center"> Foreign Exchange Fast Spot - Confirmation Ticket </h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="17%" ><%= Util.formatDate(fex.getE01FESDD1(),fex.getE01FESDD2(),fex.getE01FESDD3())%></td>
            <td nowrap width="20%" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="17%" ><%= fex.getE01FESREF()%></td>
            <td nowrap width="20%" > 
              <div align="right">Action Taken :</div>
            </td>
            <td nowrap width="24%" ><% if(fex.getE01FESSBT().equals("PU")) out.print("Purchase");
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="17%" > <%= fex.getE01FESBRK()%> - <%= fex.getD01FEBNM1()%> 
            </td>
            <td nowrap width="20%" > 
              <div align="right"></div>
            </td>
