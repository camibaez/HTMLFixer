...
<h3 align="center">Collection Product<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="products_collections.jsp, ESD0700"></h3>
<hr size="4">
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0700" >
          ...
          <tr id="trdark">
            ...
            <td>
          	...
          	<td>
            	...
            	<a href="javascript:GetTariffColl('E01APCTLN',document.forms[0].E01APCTYP.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
          </tr>
          <tr>
          	<td>
            ...
            <td >
              	<select name="E01APCAMO">
                	<OPTION value="I" <%if (prd.getE01APCAMO().equals("I")) { out.print("selected"); }%>>Incoming</OPTION>
                    <OPTION value="O" <%if (prd.getE01APCAMO().equals("O")) { out.print("selected"); }%>>Outgoing</OPTION>
            	</select>
            </td>
          </tr>
          <tr id="trdark">
          	...
          	<td >
            	<select name="E01APCITP">
              		<OPTION value="D" <%if (prd.getE01APCITP().equals("D")) { out.print("selected"); }%>>Documentary</OPTION>
                	<OPTION value="C" <%if (prd.getE01APCITP().equals("C")) { out.print("selected"); }%>>Clean</OPTION>
            	</select>
            </td>
		  </tr>
          <tr id="trclear">
            ...
            <td >
              <div align="right">Send Document :</div>
            </td>
            <td >
              	<select name="E01APCCDT">
                  	<OPTION value="P" <%if (prd.getE01APCCDT().equals("P")) { out.print("selected"); }%>>Payment</OPTION>
                  	<OPTION value="A" <%if (prd.getE01APCCDT().equals("A")) { out.print("selected"); }%>>Acceptance</OPTION>
              	</select>
            </td>
          </tr>
          <tr id="trdark">
 ...
 <p>
  <div align="center">
    <input id="EIBSBTN" type=button name="Submit" OnClick="submit()" value="submit">
  </div>
</form>
</body>
</html>
