...
<TITLE>Service Charges Table List</TITLE>
...
%>
<H3 align="center">Letters of Credit Commissions Table List<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sc_prod_list.jsp, ELC0600"></H3>
	...
	filter:progid:DXImageTransform.Microsoft.dropshadow(OffX=3, OffY=3, Color='gray', Positive='true');">
      <TR id="trdark"> 
        ...
        <TD align=CENTER width="34%"> 
          <DIV align="left"> 
            <INPUT type="text" name="NEWBNK" size="3" maxlength="2" value="<%=request.getParameter("E01RLCBNK")%>" readonly>
          </DIV>
        </TD>
      </TR>
      <TR id="trclear"> 
      ...
      <TR id="trdark"> 
        <TD nowrap  > 
	            ...
	            <TD nowrap  > 
		             	<INPUT type="text" name="NEWATY"  size=5 maxlength="8" value="<%=request.getParameter("E01RLCATY")%>" readonly>
	            </TD>
      </TR>
      
      <TR id="trclear"> 
        <TD align=center nowrap colspan="2"> 
          <INPUT id="EIBSBTN" type=button name="Submit" value="Submit" onClick="javascript:goNew()">
        </TD>
      </TR>
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <DIV align="center"> <H4 style="text-align:center"><B>There are no results to your Search</B>.Click &lt;<B>New</B>&gt; to create one</H4> 
      </DIV>
      </TD></TR>
   	</TABLE>
   	<TABLE class="tbenter">
...
<TABLE class="tbenter" width="585">
	<TBODY>
		<TR>
			<TD align="CENTER" class="TDBKG" width="20%"><DIV align="center" style="cursor: hand" onClick="ShowEnterCod()"><A>New</A></DIV></TD>
			<TD align="CENTER" class="TDBKG" width="20%"><A href="javascript:goMaint()">Maintenance</A></TD>
			<TD align="CENTER" class="TDBKG" width="20%"><A	href="javascript:goInquiry()">Inquiry</A></TD>
			<TD align="CENTER" class="TDBKG" width="20%"><A	href="javascript:goDelete()">Delete</A></TD>
			<TD align="CENTER" class="TDBKG" width="20%"><A	href="<%=request.getContextPath()%>/pages/background.jsp">Exit</A></TD>
		</TR>
	</TBODY>
</TABLE>
</CENTER>
    ...
    <%
       ...
       %>             
        <TR>
          ...
          <TD NOWRAP align=center><%=Util.formatCell(msgList.getE01RLCBNK())%></TD>		  
		  <TD NOWRAP align="center"><%=Util.formatCell(msgList.getE01RLCTAR())%></TD>		  
		  <TD NOWRAP align="center"><%=Util.formatCell(msgList.getE01RLCTCY())%></TD>
		  <TD NOWRAP align="center"><%=Util.formatCell(msgList.getE01RLCACY())%></TD>
		  <TD NOWRAP align="left"><%=Util.formatCell(msgList.getE01RLCDSC())%></TD>
		</TR>
