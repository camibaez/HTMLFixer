...
<H3 align="center">DCIBS External Transfers ( USA )<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="DCIBS_transfer_external_us_list.jsp, DCIBS"></H3>
<hr size="4">
