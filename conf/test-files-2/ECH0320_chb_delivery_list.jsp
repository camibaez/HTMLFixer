     ...
     for(var n=0;n<formLength;n++)
      ...
      if ( ok )
      {
 	  ...
 	  else
 	   {
 		...
 		alert("Select a Checkbook before this operation");
      }
...
<h3 align="center">Release of Checkbooks to Customers
          ...
          <tr id="trdark">
            ...
            <td nowrap colspan=2>
              <select name="E02CHMCBC">
                ...
                <option value="Y" <% if (msgChkB.getE02CHMCBC().equals("Y")) out.print("selected"); %>>YES</option>
              </select>
            </td>
            <td nowrap>
  ...
  <TABLE class="tbenter" width="60%" align=center>
    <TR>
      <TD class=TDBKG width="50%">
        <div align="center"><a href="javascript:goAction('A')" id="linkApproval">Release</a>
        </div>
      </TD>
      <TD class=TDBKG width="50%">
        <div align="center"><a href="javascript:goExit()">Exit</a> </div>
      </TD>
    </TR>
  </TABLE>
 ...
 <TR>
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
  		<TR id="trdark">
    		<TH ALIGN=CENTER ></TH>
    		<TH ALIGN=CENTER >Request<br>Date</TH>
    		<TH ALIGN=CENTER >Checks<br>Number</TH>
    ...
    %>
     ...
     <TD valign=top>
        <TABLE  border = "0" width="100%" >
          <TR id="trdark">
            <TH ALIGN=CENTER colspan=2>Release <br>
              to Thirds</TH>
          </TR>
          <TR>
		...
		<%}%>
          ...
          <TR>
            ...
            <td>
              ...
              <!--    		    <a href="javascript:GetCodeCNOFC('E02CHMETID','34')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>           -->
            </td>
          </TR>
          <TR>
            <td  ALIGN=right ></td>
            <td>
              ...
              <!--    		    <a href="javascript:GetCodeCNOFC('E02CHMEPID','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>             -->
            </td>
          </TR>
        </TABLE>
            </TD>
