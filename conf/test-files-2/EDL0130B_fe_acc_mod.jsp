...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130B" >
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap >
              <div align="left"><%= Util.formatDate(deal.getE11DEASD1(),deal.getE11DEASD2(),deal.getE11DEASD3())%></div>
            </td>
            <td nowrap > 
  ...
  <table class="tableinfo">
    ...
    <tr id="trclear"> 
      <td nowrap width="14%" ><%= deal.getE11OFFOP1()%> - <%= deal.getE11OFFCO1()%></td>
      <td nowrap width="14%" > 
        <div align="center"> <%= deal.getE11OFFBK1()%> </div>
      </td>
      <td nowrap width="17%" > 
        <div align="center"> <%= deal.getE11OFFBR1().trim()%> </div>
      </td>
      <td nowrap width="22%" > 
        <div align="center"> <%= deal.getE11OFFCY1()%> </div>
      </td>
      <td nowrap width="15%" > 
        <div align="center"> <%= deal.getE11OFFAC1()%> </div>
      </td>
    </tr>
  </table>
  <h4>Limits</h4>
