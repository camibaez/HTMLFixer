...
<H3 align="center">System Reference Codes - Collaterals Type<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_collat_types_codes_details.jsp, ESD0030"></H3>
<hr size="4">
    ...
    <tr>
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear">
            <td nowrap width="30%">
              <div align="right">Adjustment Month:</div>
            </td>
            <td nowrap>
              <div align="left">
