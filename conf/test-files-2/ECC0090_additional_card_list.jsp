	...
	if (!document.forms[0].CC_Main[0].checked && !document.forms[0].CC_Main[1].checked && !document.forms[0].CC_Main[2].checked) {
		...
		//}
			...
			if (document.forms[0].AccSList[0].value == "X") {
	   		...
	   		document.getElementById("SCREEN").value = 1400;
...
<body>
<h3 align="center">Debit Card Assignment<BR>Additional Card Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="additional_card_list.jsp, ECC0090"></h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="16%"> 
              <div align="right">
				<DIV align="right"><B>Customer Name :</B></DIV></div>
            </td>
            <td nowrap width="20%"> 
              <div align="left"> 
