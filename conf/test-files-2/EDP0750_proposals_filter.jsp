...
<h3 align="center">Tracing Credit Proposal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="proposals_filter,EDP0750"></h3>
<hr size="4">
