...
%> 
<h3 align="center"> SWIFT Free Formats Confirmation<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="swift_free_format_new_confirm.jsp, ESWF000"> 
</h3>
<hr size="4">
