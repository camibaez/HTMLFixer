...
<body>
<h3 align="center">Card Fee<BR>New<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_commissions_maint.jsp, ECD0005"> 
</h3>
<hr size="4">
<% 
...
%> 
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0005" >
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E05CDRTPL" size="3" maxlength="2" value="<%= msgCD.getE05CDRTPL() %>">
                <input type="hidden" name="E05CDRNPL" size="35" maxlength="30" readonly value="<%= msgCD.getE05CDRNPL() %>">
				<a href="javascript:GetDescATMCard('E05CDRTPL','','D')">
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" name="E05CDRFEE" size="5" maxlength="3" value="<%= msgCD.getE05CDRFEE() %>">
                <input type="hidden" name="E05CDRFED" size="17" maxlength="15" value="<%= msgCD.getE05CDRFED() %>">
<%--
				<a href="javascript:GetCommissionType('E05CDRFEE','')">
--%>
				<a href="javascript:GetCodeCNOFC('E05CDRFEE', '67')">
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absbottom" border="0" ></a>
              </div>
            </td>
          </tr>
...
<%--          
            <td nowrap width="16%" > 
              <div align="right">Charge Cycle : </div>
            </td>
            <td nowrap width="20%" > 
              <div align="left"> 
...
--%>            
            <td nowrap width="16%" > 
              <div align="right">Charge Type : </div>
            </td>
            <td nowrap width="20%" > 
              <div align="left"> 
	              <select name="E05CDRFFC">
	                ...
	                <option value="F" <% if(msgCD.getE05CDRFFC().equals("F")) out.print("selected");%>>Fixed</option>
	                <option value="P" <% if(msgCD.getE05CDRFFC().equals("P")) out.print("selected");%>>Porcentual</option>
	              </select>
			  </div>
            </td>
            <td nowrap width="16%"> 
              <div align="right">Fee Charge : </div>
            </td>
            <td nowrap width="20%"> 
              <div align="left"> 
