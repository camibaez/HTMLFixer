...
function ShowNew(x,y) {	 
    ...
    enterNew.filters[0].Play();
	document.forms[0].E01CRMMSA.focus();
}
...
function SetErrorVisible() {	 
	 var myValue = document.forms[0].E01CRMMSA.value;

	 if (true) { // verify myValue Here
	 	document.forms[0].E01CRMMSA.onkeypress = "";
     	errorMsg.style.visibility="hidden";
	 } else {
	 	document.forms[0].E01CRMMSA.onkeypress="";
	 	document.forms[0].E01CRMMSA.value="";
...
<h3 align="center">MSA Codes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="MSA_codes_list,JSECRA030"></H3></H3>
<hr size="4">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<tr id="trclear"> 
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          <input type="text" name="E01CRMMSA" size="12" maxlength="10" onchange="SetErrorVisible()">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        while (msgList.getNextRow()) {
           ...
           datapro.eibs.beans.ECRA03001Message msgMSA = (datapro.eibs.beans.ECRA03001Message) msgList.getRecord();
     	%>               
        <TR>
			...
			<TD NOWRAP ALIGN="LEFT"><%=Util.formatCell(msgMSA.getE01CRMMSA())%></TD>
			<TD NOWRAP ALIGN="LEFT"><%=Util.formatCell(msgMSA.getE01CRMDSC())%></TD>
			<TD NOWRAP ALIGN="LEFT"><%=Util.formatCell(msgMSA.getE01CRMSTC() + " - " + msgMSA.getD01STCDSC())%></TD>
		</TR>    		
    	<%}%>    
     </TABLE>
    </TD>
