...
%>
  ...
  <TABLE class="tableinfo" style="width:95%" ALIGN=CENTER>
    <TR id="trdark">
      ...
      <TH ALIGN=CENTER  nowrap width="15%">Type</TH>
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25"> <%
        if ( EWD0151Help.getShowPrev() ) {
      			int pos = EWD0151Help.getFirstRec() - 21;
      			   out.print("<A HREF=\""+ request.getContextPath()+"/servlet/datapro.eibs.helps.JSEWD0151?AppCode=" + AppCode + "&FromRecord=" + pos + " \"> <img src=\"" + request.getContextPath() + "/images/s/previous_records.gif\" border=0></A>");
        }
%> </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> <%
        if ( EWD0151Help.getShowNext() ) {
      			int pos = EWD0151Help.getLastRec();
      			out.print("<A HREF=\"" +request.getContextPath() +"/servlet/datapro.eibs.helps.JSEWD0151?AppCode=" + AppCode + "&FromRecord=" + pos + " \" ><img src=\""+ request.getContextPath() + "/images/s/next_records.gif\" border=0></A>");
