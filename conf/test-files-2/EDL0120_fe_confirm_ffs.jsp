      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="21%" >
            	<% if(userPO.getHeader23().equals("1")) {
            		if(deal.getE01DLSSBT().equals("SL")) out.print("Placement"); else out.print("Taking");
            	   } else {
            	   	if(deal.getE01DLSSBT().equals("SL")) out.print("Sale"); else out.print("Purchase");
            	   } 	
            	%> 
			</td>
          </tr>
		...
		<TR>
			...
			<TABLE cellpadding="2" cellspacing="0" border="0" width="100%">
				<TBODY>
					<TR id="trdark0">
						<TD nowrap width="25%">
						<DIV align="right">Trade Date :</DIV>						</TD>
					...
					<TR id="trclear0">
						...
						<TD nowrap width="35%">
						<DIV align="right">Amount at Maturity :</DIV>						</TD>
