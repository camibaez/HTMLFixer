...
<h3 align="center">Letters Of Credit Inquiry [Product]
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_inq_products.jsp, ELC0450"></h3>
<hr size="4">
    ...
    <tr > 
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td width="30%"> 
              <div align="right">Product Description : </div>
            </td>
            <td width="70%"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E04APCAMO" size="10" maxlength="1"  
			   value="<% if (lcProdInq.getE04APCAMO().equals("I")) out.print("Incoming (Export)");
			    		else if (lcProdInq.getE04APCAMO().equals("O")) out.print("Ourgoing (Import)");
						else if (lcProdInq.getE04APCAMO().equals("S")) out.print("Outgoing Standby");
						else if (lcProdInq.getE04APCAMO().equals("R")) out.print("Incoming Standby");
						%>">
            </td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E04APCITP" size="15" maxlength="1"  
			   value="<% if (lcProdInq.getE04APCITP().equals("B")) out.print("Beneficiary");
			    		else if (lcProdInq.getE04APCITP().equals("A")) out.print("Applicant");
						%>">
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td width="55%"> 
              ...
              <input type="text" readonly name="E04APCCDT" size="15" maxlength="1"  
			   value="<% if (lcProdInq.getE04APCCDT().equals("S")) out.print("Sight Payment");
			    		else if (lcProdInq.getE04APCCDT().equals("A")) out.print("Aceptance");
						else if (lcProdInq.getE04APCCDT().equals("M")) out.print("Mixed Payment");
						else if (lcProdInq.getE04APCCDT().equals("D")) out.print("Diferred Paymeny");
						else if (lcProdInq.getE04APCCDT().equals("N")) out.print("Negotiation");
						%>">
            </td>
          </tr>
          <tr id="trclear"> 
