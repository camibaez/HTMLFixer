...
<h3 align="center">Annul Checkbook or Check<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="check_books_list.jsp, ECH0580"></h3>
<hr size="4">
...
<%
 ...
 %>
   		...
   		<TR>
      <TD> 
        <div align="center"> <font size="3"><b>Not found in this criteria</b></font></div>
      </TD></TR>
   		</TABLE>
  <%   		
	}
...
<h4></h4> 
  ...
  <TABLE class="tableinfo">
    <TR id=trdark> 
      ...
      <TH ALIGN=CENTER rowspan="2" width="12%">Quantity of Checks</TH>
      <TH ALIGN=CENTER rowspan="2" width="8%">Initial Check</TH>
      <TH ALIGN=CENTER rowspan="2" width="7%">Last Check</TH>
      <TH ALIGN=CENTER rowspan="2" width="4%">Send to Vendor</TH>
      <TH ALIGN=CENTER rowspan="2" width="4%">Receive from Vendor</TH>
      <TH ALIGN=CENTER rowspan="2" width="4%">Send to Agency</TH>
      <TH ALIGN=CENTER rowspan="2" width="4%">Receive from Agency</TH>
      <TH ALIGN=CENTER rowspan="2" width="4%">Send to Customer</TH>
      <TH ALIGN=CENTER rowspan="2" width="4%">Select</TH>
    </TR>
    <TR id=trdark> 
      <TH ALIGN=CENTER width="5%">Received</TH>
      <TH ALIGN=CENTER width="5%">Sent</TH>
    </TR>
    <%
                checkBooks.initRow();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" bordercolor="#FFFFFF">
 <tr bgcolor="#FFFFFF"> 
   <td align="center"><input id="EIBSBTN" type=submit name="AnullB" value="Annul Chechbook" onclick="document.forms[0].ACTION.value='01'"> </td>
   <td align="center"><input id="EIBSBTN" type=submit name="AnullC" value="Annul Check" onclick="document.forms[0].ACTION.value='02'"> </td>
 </tr>
</table>  
</FORM>
