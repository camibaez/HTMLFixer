<html>
<head>
<title>Rate Table Inquiry</title>
...
<h3 align="center"> Time Deposit Table of Rate <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_inq_ren_rate, EDL0130"></h3>
<hr size="4">
    ...
    <tr> 
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            <td width="24%"> 
              <div align="right">Efective Date :</div>
            </td>
            <td width="35%"> 
          ...
          <tr id="trclear"> 
            ...
            <td width="23%"> 
              <div align="right">Days of Penalty :</div>
            </td>
            <td width="18%"> 
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
              ...
              <div align="center"><i><b>Days /</b></i></div>
                  </td>
                  <td width="13%" height="22"> 
                    
              <div align="center"><i><b>To:</b></i></div>
                  </td>
                  <td width="13%" height="22"> 
          ...
          <tr id="trclear"> 
              ...
              <div align="center"><i><b>Term:</b></i></div>
                  </td>
                  <td width="13%"> 
                    <div align="center"> 
