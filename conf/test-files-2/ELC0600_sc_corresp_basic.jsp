  	...
  	function showPopUp(opth,field,bank,ccy,field1,field2,opcod) {
   	...
   	function onSubmit() {
   		if (document.getElementById("OPTION").value == "INQUIRY") {
   			document.getElementById("ACTION").value = "301";
   		}
   		return true;
   	}
...
<H3 align="center">Table of Commissions and Expenses of Letters of Credit<IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" ALT="ELC0600_sc_corresp_basic"></H3>
<HR size="4">
<FORM method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0600" onsubmit="onSubmit()">
  <INPUT TYPE=HIDDEN ID="ACTION" NAME="SCREEN" VALUE="305">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <TR id="trclear">
            ...
            <TD nowrap  ><input type="text" <%= readonly %> name="E01RLCTCY" size="4" maxlength="3" value="<%= msg01.getE01RLCTCY().trim()%>" >
				<% if (readonly.equals("")) { %>
              	<a href="javascript:GetCurrency('E01RLCTCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" border="0" ></a> </TD>
				<% } %>
            <TD align="right" nowrap  ><b>Account Currency :</b></TD>
            <TD nowrap ><input type="text" <%= readonly %> name="E01RLCACY" size="4" maxlength="3" value="<%= msg01.getE01RLCACY().trim()%>" >
				<% if (readonly.equals("")) { %>
              	<a href="javascript:GetCurrency('E01RLCACY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" border="0" ></a> </TD>
				<% } %>
    </TR>
          <TR id="trdark">
            <TD align="right" nowrap  ><b>Bank Number :</b></TD>
            <TD nowrap  ><input type="text" name="E01RLCCUN2" size="15" maxlength="10" value="<%= msg01.getE01RLCCUN().trim()%>" readonly ></TD>
            <TD align="right" nowrap  ><b>Bank Name:</b></TD>
            <TD nowrap ><input type="text" name="E01CUSNME" size="30" maxlength="25" value="<%= msg01.getE01CUSNME().trim()%>" readonly></TD>
    </TR>
          <TR id="trclear">
            <TD align="right" nowrap  ><B>Product Type:</B></TD>
            <TD nowrap  ><INPUT type="text" <%= readonly %> name="E01RLCATY"  size=5 maxlength="8" value="<%= msg01.getE01RLCATY().trim()%>">
				<% if (readonly.equals("")) { %>
            ...
            <TD nowrap ><input type="text" <%= readonly %> name="E01RLCDSC" size="23" maxlength="21" value="<%= msg01.getE01RLCDSC().trim()%>" ></TD>
          </TR>
</TABLE>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%"	border="0">
	...
	<TR id="trdark">
		<TD nowrap><DIV align="right">Issuance 2:</DIV>
		</TD>
		<TD nowrap></TD>
		<TD nowrap>
		...
		<TD nowrap>
			<DIV align="center"><INPUT type="text" <%= readonly %> name="E01RLCIX2" size="12" maxlength="11" value="<%= msg01.getE01RLCIX2().trim()%>" onKeyPress="enterDecimal()"></DIV>
				...
				<TR id="trclear">
		<TD nowrap><DIV align="right">Advising :</DIV>
		</TD>
		<TD nowrap>
