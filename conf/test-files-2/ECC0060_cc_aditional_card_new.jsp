...
<body>
<h3 align="center">Aditional Card <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_aditional_card_new.jsp,ECC0060">
</h3>
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="16%">
              <div align="left"><b>
                <input type="text" name="E01CCRNUM" size="21" maxlength="20" value="<%= msgAdtCard.getE01CCRNUM().trim()%>" onKeypress="enterInteger()">
                </b> </div>
            </td>
          </tr>
          <tr id="trdark">
