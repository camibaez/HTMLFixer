...
<h3 align="center">Corporate Officers<img src="<%=request.getContextPath()%>/images/e_ibs.gif"  align="left" name="EIBS_GIF" ALT="cleint_corp_stock_holder, ESD0080"></h3>
<hr size="4">
          ...
          <tr id="trclear">
            ...
            <td width="58%" nowrap >
              <select name="E<%= name %>4BMS" >
                <option value=1 <% if (stockHolder.getField("E" + name + "4BMS").getString().equals("1")) out.print("selected"); %>>Married</option>
                <option value=2 <% if (stockHolder.getField("E" + name + "4BMS").getString().equals("2")) out.print("selected"); %>>Single</option>
                <option value=3 <% if (stockHolder.getField("E" + name + "4BMS").getString().equals("3")) out.print("selected"); %>>Divorced</option>
                <option value=4 <% if (stockHolder.getField("E" + name + "4BMS").getString().equals("4")) out.print("selected"); %>>Widower</option>
                <option value=5 <% if (stockHolder.getField("E" + name + "4BMS").getString().equals("5")) out.print("selected"); %>>Cohabitant</option>
          ...
          <tr id="trdark">
            ...
            <td width="58%" nowrap>
			 <select name="E<%= name %>4BSX" >
                ...
                <option value="F" <% if (stockHolder.getField("E" + name + "4BSX").getString().equals("F")) out.print("selected"); %>>Female</option>
                <option value="M" <% if (stockHolder.getField("E" + name + "4BSX").getString().equals("M")) out.print("selected"); %>>Male</option>
              </select>
          </tr>
          <tr id="trclear">
            <td width="42%" nowrap>
