...
<body>
 ...
 <h3 align="center">Incoming ACH File<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="incoming_file, EACH400"></h3>
<hr size="4">
 <FORM METHOD="POST" action="<%=request.getContextPath()%>/servlet/datapro.eibs.ach.JSEACH400" ENCTYPE="multipart/form-data">	
	...
	<table  class="tbenter" width="100%" height="50%" border="0" cellspacing=0 cellpadding=2>
		...
		<tr>
			<td align="center">
				<br>
				This option  will import and validate the file,    if it meets all NACHA specifications it will be processed.<br><br>
				The  reports ACH400 and GL0021 will be available in the user spool. <br>
				If you don't have automatic approval for ACH transactions (see parameters) you must go to batch approval  <br>in order to continue with the process.<br> 
 			</td>      
	   	</tr>
  	</table>
	<table width="100%">		
