...
%> 
<h3 align="center">General Ledger Transactions Inquiry by Bank<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="st_list_fp.jsp,EGL0425"></h3>
<hr size="4">
<FORM>
