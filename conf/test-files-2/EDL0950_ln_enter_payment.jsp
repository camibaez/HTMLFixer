...
<h3 align="center">Prepayment of Loans<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_enter_payment.jsp , EDL0950"></h3>
<hr size="4">
