...
function goSearch() {
	if (getElement("SEARCHCDE").value == "") {
		alert("Please enter a transaction number for a position in the list!!!");
		return;	 
	}
...
function setKey(num) {
	getElement("E01ACUNUM").value = num;
}
...
<h3 align="center">ACH Transactions with batch number <%= userPO.getIdentifier().trim() %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
...
%>
	<TR>
		...
		<TD align="CENTER" class="TDBKG" width="25%">
			<a href="javascript:goProcess()"><b>Update<br>Transaction</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="25%">
			<a href="javascript:goDelete()"><b>Delete<br>Transaction</b></a>
		</TD>
	  	<TD align="CENTER" class="TDBKG" width="25%">
			<a href="<%=request.getContextPath()%>/servlet/datapro.eibs.ach.JSEACH310?SCREEN=1"><b>Exit</b></a>
	  	</TD>
	</TR>
<%	} else { %>
	<TR>
		<TD align="CENTER" class="TDBKG" width="50%">
			<a href="javascript:goProcess()"><b>See <br>Transaction</b></a>
      	</TD>
	  	<TD align="CENTER" class="TDBKG" width="50%">
			<a href="<%=request.getContextPath()%>/servlet/datapro.eibs.ach.JSEACH310?SCREEN=10"><b>Exit</b></a>
      	</TD>
	</TR>
<% 	} %>
</TABLE> 
...
<%	if ( EACH315List.getNoResult() ) { %>
 	...
 	<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center"> There are no transactions.</h4></div>
      </TD>
	</TR>
   	</TABLE>
<%
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    <TR id=trdark> 
		...
		<td NOWRAP align="center" width="10%"><B>Number</B></td>
		<TD nowrap align="center" width="5%"><B>TR</B></TD>
		<td NOWRAP align="center" width="10%"><B>Account</B></td>
		<td NOWRAP align="center" width="25%"><B>Customer</B></td>
		<TD nowrap align="center" width="10%"><B>Routing</B></TD>
		<TD nowrap align="center" width="20%"><B>Recipient Account</B></TD>
		<TD nowrap align="center" width="15%"><B>Amount</B></TD>
	</TR>
    <TR id=trdark>
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25">
       <%
    	if ( EACH315List.getShowPrev() ) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH315?SCREEN=1&BATCH=" + userPO.getProdCode() + "&FromRecord=" + pos + "&SEARCHCDE=" + userPO.getProdCode() + "\" > <img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
    	} %>
      </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> 
    	...
    	if (EACH315List.getShowNext()) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH315?SCREEN=1&BATCH=" + userPO.getProdCode() + "&FromRecord=" + pos + "&SEARCHCDE=" + userPO.getProdCode() + "\" ><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
	    } %>
  </TD>
 </TR>
 </TABLE>
