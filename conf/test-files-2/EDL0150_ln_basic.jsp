...
<%
 ...
 out.println("<SCRIPT> initMenu();  </SCRIPT>");}
  ...
  if(DEAIPD.equals(""))
    DEAIPD="000";
  DEAPPD = lnBasic.getE01DEAIPD().trim();
  if(DEAPPD.equals(""))
    DEAPPD="000";
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark">
            ...
            <td nowrap width="20%" >
              <div align="left">
                <input type="text" name="E01DEACUN" size="9" maxlength="9" value="<%= CUSCUN%>" <%=(!msgUser.getE01CCU().equals("Y")&&!userPO.getPurpose().equals("NEW"))?"readonly" : "" %>>

                <% if (msgUser.getE01CCU().equals("Y")||userPO.getPurpose().equals("NEW")) { %>
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark">
            <td nowrap width="16%" >
              <div align="right"><a href="javascript:showCustomerInq(document.forms[0].E01PARCUN.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" alt="help" align="bottom" border="0" >
                Participant : </a></div>
            </td>
            <td nowrap width="20%" >
              <div align="left"> <b>
                <input type="text" name="E01PARCUN" size="9" maxlength="9" value="<%= lnBasic.getE01PARCUN()%>" readonly>
                </b></div>
            </td>
            <td nowrap width="16%" >
              <div align="right"><b>Name : </b></div>
            ...
            <td nowrap >
              <div align="left"><b><font face="Arial"><font face="Arial"><font size="2">
                <input type="text" name="E01PARNA1" size="45" maxlength="45" value="<%= lnBasic.getE01PARNA1().trim()%>" readonly>
                </font></font></font></b></div>
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="16%">
              <div align="right"><a href="javascript:showLoanInq('<%= lnBasic.getE01DEAPAC()%>')"><img src="<%=request.getContextPath()%>/images/aquire.gif" alt="help" align="bottom" border="0" >
                Loan Number : </a> </div>
            </td>
            <td nowrap width="20%">
              <div align="left"> <b><b>
                <input type="text" name="E01DEAPAC size="13" maxlength="12" value="<%= lnBasic.getE01DEAPAC()%>" readonly>
                </b> </b></div>
            </td>
            <td nowrap width="16%">
            ...
            <td nowrap width="16%">
              <div align="left"><b>
                <input type="text" name="E01PAROAM" size="17" maxlength="15" value="<%= lnBasic.getE01PAROAM().trim()%>" readonly>
                </b></div>
            </td>
          </tr>
          <tr id="trdark">
            ...
            <td nowrap width="20%"><b>
              <input type="text" name="E01PARASD" size="17" maxlength="15" value="<%= lnBasic.getE01PARASD().trim()%>" readonly>
              </b></td>
            <td nowrap width="16%">
              <div align="right"><b>Available :</b></div>
            </td>
            <td nowrap width="16%"><b>
              <input type="text" name="E01PARAVL" size="17" maxlength="15" value="<%= lnBasic.getE01PARAVL().trim()%>" readonly>
              </b></td>
          </tr>
          <tr id="trclear">
            <td nowrap width="16%">
            ...
            <td nowrap width="20%"><b>
              <input type="text" name="E01PARMD1" size="3" maxlength="2" value="<%= lnBasic.getE01PARMD1().trim()%>" readonly>
              <input type="text" name="E01PARMD2" size="3" maxlength="2" value="<%= lnBasic.getE01PARMD2().trim()%>" readonly>
              <input type="text" name="E01PARMD3" size="3" maxlength="2" value="<%= lnBasic.getE01PARMD3().trim()%>" readonly>
              </b></td>
            <td nowrap width="16%">
              <div align="right"><b>Rate :</b></div>
            </td>
            <td nowrap width="16%"><b>
              <input type="text" name="E01PARRTE" size="12" maxlength="11" value="<%= lnBasic.getE01PARRTE().trim()%>" readonly>
              </b></td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear">
            ...
            <td nowrap width="23%">
              <input type="text" name="E01DEAOD1" size="2" maxlength="2" value="<%= lnBasic.getE01DEAOD1().trim()%>" onkeypress="enterInteger()">
              <input type="text" name="E01DEAOD2" size="2" maxlength="2" value="<%= lnBasic.getE01DEAOD2().trim()%>" onkeypress="enterInteger()">
              <input type="text" name="E01DEAOD3" size="2" maxlength="2" value="<%= lnBasic.getE01DEAOD3().trim()%>" onkeypress="enterInteger()">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="27%">
            	<input type="text" name="E01DEADED" size="15" maxlength="13" value="<%= lnBasic.getE01DEADED().trim()%>"  onkeypress="enterDecimal()">
             </td>
          </tr>
    ...
    <tr>
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            <td nowrap width="25%" >
	              <div align="right">VIR Index Table / Flt.Rate :</div>
            </td>
            <td nowrap width="23%" >
              <A href="javascript:GetFloating('E01DEAFTB')"><IMG
					src="<%=request.getContextPath()%>/images/1b.gif" alt="help"
					align="middle" border="0"></A><input type="text" name="E01DEAFTB" size="2" maxlength="2" value="<%= lnBasic.getE01DEAFTB().trim()%>">
              ...
              <input type="text" name="E01FLTRTE" size="10" maxlength="9" value="<%= lnBasic.getE01FLTRTE().trim()%>" onKeypress="enterSignDecimal()" 
              <%if (!lnBasic.getH01SCRCOD().equals("N")) out.print("readonly");%> >
            </td>
            <td nowrap width="25%" >
    ...
    <tr>
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <%if (userPO.getPurpose().equals("MAINTENANCE") || (!lnBasic.getE01DEAPAR().equals("P"))){%>
          <tr id="trdark">
            <td nowrap width="25%" >
            <%if (!lnBasic.getE01DEAPAR().equals("P")){%>
            ...
            <%if (userPO.getPurpose().equals("MAINTENANCE")){%>
              ...
              <a href="javascript:GetClassCred('E01DEACLF','STATIC_ln_cred_class.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="bottom" border="0" ></a>
             <%}%>
			</td>
          </tr>
          <%}%>
          ...
          <tr id="trdark">
            ...
            <td nowrap width="23%" >
              ...
              <a href="javascript:GetBroker('E01DEABRK')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0"></a>
              <input type="text" name="E01DEABCP" size="10" maxlength="9" value="<%= lnBasic.getE01DEABCP().trim()%>"  onkeypress="enterDecimal()"> <B>%</B>
            </td>
            <td nowrap width="25%" >
              <div align="right">Deferred Loan Costs : </div>
            </td>
            <td nowrap width="23%" >
              <input type="text" name="E01DEATDA" size="17" maxlength="15" value="<%= lnBasic.getE01DEATDA().trim()%>" onkeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="25%" >
            ...
            <td nowrap width="23%" >
              <input type="text"  name="E01DEAOPT" size="2" maxlength="1" value="<%= lnBasic.getE01DEAOPT().trim()%>" >
            </td>
            <td nowrap width="25%" >
          ...
          <tr id="trclear">
            ...
            <td nowrap width="23%" >
              ...
              <a href="javascript:GetRel1('E01DEAPAR','STATIC_ln_rel1.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0" ></a>
            </td>
            <td nowrap width="25%" >
              <div align="right">Relation Account 1 :</div>
            </td>
            <td nowrap width="27%" >
              <input type="text" name="E01DEAPAC" size="12" maxlength="9" value="<%= lnBasic.getE01DEAPAC().trim()%>">
              <a href="javascript:GetAccount('E01DEAPAC',document.forms[0].SCRDEABNK.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="middle" border="0" ></a>
            </td>
          </tr>
        <%}%>
 		...
 		<td nowrap width="25%" >
              <input type="text"  name="E01DEAREF" size="9" maxlength="9" value="<%= lnBasic.getE01DEAREF().trim()%>" border="0" >
            </td>
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="23%">
              <select name="E01CRLACT">
                <option value=" " <% if (!(lnBasic.getE01CRLACT().equals("1") ||lnBasic.getE01CRLACT().equals("2"))) out.print("selected"); %> selected></option>
                <option value="1" <% if(lnBasic.getE01CRLACT().equals("1")) out.print("selected");%>>Loan Originated</option>
                <option value="2" <% if(lnBasic.getE01CRLACT().equals("2")) out.print("selected");%>>Purchased by Institution</option>
              </select>
            </td>
            <td nowrap width="25%">
              <div align="right"></div>
          ...
          <tr id="trclear">
            ...
            <td nowrap width="23%">
            	<input type="text" name="E01CRLSTC" size="3" maxlength="2" value="<%= lnBasic.getE01CRLSTC().trim()%>" onkeypress="enterInteger()">
            	<a href="javascript:GetCodeCNOFC_St_FIPS('E01CRLSTC','','27')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help"  border="0"  ></a>
            </td>
            <td nowrap width="25%">
              <div align="right">FIPS County Code :</div>
            </td>
            <td nowrap width="27%">
              <input type="text" name="E01CRLCTC" size="4" maxlength="3" value="<%= lnBasic.getE01CRLCTC().trim()%>" onkeypress="enterInteger()">
              <a href="javascript:GetCodeCounty('E01CRLCTC','',document.forms[0].E01CRLSTC.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help"  border="0"  ></a>
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="25%">
            ...
            <td nowrap width="23%">
            	<input type="text" name="E01CRLMSA" size="6" maxlength="5" value="<%= lnBasic.getE01CRLMSA().trim()%>" onkeypress="enterInteger()">
            	<a href="javascript:GetCodeMSA('E01CRLMSA','',document.forms[0].E01CRLSTC.value,document.forms[0].E01CRLCTC.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help"  border="0"  ></a>
            </td>
            <td nowrap width="25%">
              <div align="right">Census Tract :</div>
            </td>
            <td nowrap width="27%">
              <input type="text" name="E01CRLCET" size="7" maxlength="6" value="<%= lnBasic.getE01CRLCET().trim()%>" >
              <a href="javascript:GetCodeCensus('E01CRLCET',document.forms[0].E01CRLSTC.value,document.forms[0].E01CRLCTC.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help"  border="0"  ></a>
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="25%">
            ...
            <td nowrap width="23%">
              <select name="E01CRLRVC">
                <option value=" " <% if (!(lnBasic.getE01CRLRVC().equals("1") ||lnBasic.getE01CRLRVC().equals("2")||lnBasic.getE01CRLRVC().equals("3")||lnBasic.getE01CRLRVC().equals("4"))) out.print("selected"); %> selected></option>
                <option value="1" <% if(lnBasic.getE01CRLRVC().equals("1")) out.print("selected");%>>Less Or Equal To 1 Million</option>
                <option value="2" <% if(lnBasic.getE01CRLRVC().equals("2")) out.print("selected");%>>Greater Than 1 Million</option>
                <option value="3" <% if(lnBasic.getE01CRLRVC().equals("3")) out.print("selected");%>>Not Known</option>
                <option value="4" <% if(lnBasic.getE01CRLRVC().equals("4")) out.print("selected");%>>N/A</option>
              </select>
            </td>
            <td nowrap width="25%">
            ...
            <td nowrap width="27%">
              <select name="E01CRLAFC">
                <option value=" " <% if (!(lnBasic.getE01CRLAFC().equals("1") ||lnBasic.getE01CRLAFC().equals("2"))) out.print("selected"); %> selected></option>
                <option value="1" <% if(lnBasic.getE01CRLAFC().equals("1")) out.print("selected");%>>Action Taken at this Institution</option>
                <option value="2" <% if(lnBasic.getE01CRLAFC().equals("2")) out.print("selected");%>>Action Taken at an Affiliate</option>
              </select>
            </td>
          </tr>
   		</table>
      ...
      <td nowrap>
        <table  id="TBDEDUCT" cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="30%" >
              <div align="center">Deduction Name</div>
            </td>
            <td nowrap width="20%" >
              <div align="center">Payment Amount</div>
            </td>
            <td nowrap width="10%" >
            ...
            <td nowrap width="24%">
              <div align="left">
                <select name="E01PMTVIA" onChange="ShowHideACH()">
				  ...
				  <option value="3" <% if(lnBasic.getE01PMTVIA().equals("3")) out.print("selected");%>>Swift MT-202</option>
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="27%">
              <input type="text" name="E01FIXGLN" size="16" maxlength="12" value="<%= lnBasic.getE01FIXGLN().trim()%>" onkeypress="enterInteger()">
              <a href="javascript:GetLedger('E01FIXGLN',document.forms[0].SCRDEABNK.value,document.forms[0].E01DEACCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="bottom" border="0" ></a>
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0"  >
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap width="27%">
              <input type="text" name="E01FIXCCN" size="8" maxlength="8" value="<%= lnBasic.getE01FIXCCN().trim()%>" onkeypress="enterDecimal()">
              <a href="javascript:GetCostCenter('E01FIXCCN',document.forms[0].SCRDEABNK.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a>
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap width="25%" >
              <div align="right">Asset Model :</div>
            </td>
            <td nowrap width="23%" >
            ...
            <td nowrap width="27%" >
              <input type="text" name="E01FIXTIC" size="11" maxlength="11" value="<%= lnBasic.getE01FIXTIC().trim()%>" onkeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="25%" >
            ...
            <td nowrap width="23%" >
              <input type="text" name="E01FIXPPR" size="15" maxlength="15" value="<%= lnBasic.getE01FIXPPR().trim()%>"  onkeypress="enterDecimal()" >
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0"  >
            </td>
            <td nowrap width="25%" >
            ...
            <td nowrap width="27%" >
              ...
              <a href="javascript:GetDepTyp('E01FIXDTY','STATIC_ln_dep_typ.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a>
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0"  >
            </td>
          </tr>
          <tr id="trdark">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="23%" >
              ...
              <a href="javascript:GetLoc('E01FIXLOC')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a>
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0"  >
            </td>
            <td nowrap width="25%" >
          ...
          <tr id="trdark">
            ...
            <td nowrap width="23%" >
              ...
              <a href="javascript:GetAct('E01FIXCLS')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a>
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0"  >
            </td>
            <td nowrap width="25%" >
            ...
            <td nowrap width="27%" >
              ...
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0" width="32" height="32"  >
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="25%" >
            ...
            <td nowrap width="23%" >
              <input type="text" name="E01FIXRVA" size="15" maxlength="13" value="<%= lnBasic.getE01FIXRVA().trim()%>"  onkeypress="enterDecimal()">
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0"  >
            </td>
            <td nowrap width="25%" >
            ...
            <td nowrap width="27%" >
              <input type="text" name="E01FIXPIN" size="10" maxlength="9" value="<%= lnBasic.getE01FIXPIN().trim()%>" onkeypress="enterInteger()">
              <a href="javascript:GetVendor('E01FIXPIN')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0"></a>
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0"  >
            </td>
          </tr>
        </table>
    ...
    <tr >
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark">
            <td nowrap width="40%" >
              <div align="right"> Date Refinance Up To :</div>
            </td>
            <td nowrap width="60%" >
              <input type="text" name="E01DEAPC1" size="2" maxlength="1" value="<%= lnBasic.getE01DEAPC1().trim()%>" onkeypress="enterInteger()">
              <input type="text" name="E01DEAPC2" size="2" maxlength="1" value="<%= lnBasic.getE01DEAPC2().trim()%>" onkeypress="enterInteger()">
              <input type="text" name="E01DEAPC3" size="2" maxlength="1" value="<%= lnBasic.getE01DEAPC3().trim()%>" onkeypress="enterInteger()">
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear">
            ...
            <td nowrap width="60%">
              <input type="text" name="REFPAG01" size="15" maxlength="13" value="<%= lnBasic.getE01REFPAG().trim()%>" onkeypress="enterDecimal()">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="60%">
              <input type="text" name="REFPAG11" size="15" maxlength="13" value="<%= lnBasic.getE01REFPAG().trim()%>" onkeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="40%">
            ...
            <td nowrap width="60%">
              <input type="text" name="E01REFACC" size="12" maxlength="12" value="<%= lnBasic.getE01REFACC().trim()%>" onkeypress="enterInteger()">
            </td>
          </tr>
        </table>
      </td>
