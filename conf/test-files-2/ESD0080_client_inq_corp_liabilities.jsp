...
%> 
<h3 align="center">Customer Liabilities<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_inq_corp_liabilities, ESD0080"></h3>
<hr size="4">
