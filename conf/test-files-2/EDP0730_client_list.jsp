...
<html>
<head>
<title>Financial Statements by Customer</title>
...
//		document.forms[0].E01IFMCUN.value = 0;
	...
	if (op == "3") {
      ok = confirm("Confirm Delete the selected record");
	  if (ok) 
	       {
...
<BODY>
<h3 align="center">Financial Statements by Customer<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_list.jsp, EDP0730"></h3>
<hr size="4">
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
	...
	<% if(userPO.getOption().equals(" ")) { %> 
      <td class=TDBKG width="20%"> 
        <div align="center"><a href="javascript:goAction(2)"><b>Modify</b></a></div>
     </td>
      <td class=TDBKG width="20%"> 
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%"><div align="center">Custumer ID</div></th>
            <th align=CENTER nowrap width="25%"><div align="center">Name</div></th>
            <th align=CENTER nowrap width="25%"><div align="center">Format</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Begin Date</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Final Date</div></th>
            <th align=CENTER nowrap width="5%"><div align="center">Revised</div></th>
            <th align=CENTER nowrap width="5%"><div align="center">Expired</div></th>
           </tr>
          <%
  ...
  <%
		...
		int pos = EDP073001Help.getFirstRec() - 20;
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0730?SCREEN=200&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
        }
  %>
  </TD>
  ...
  <%
		...
		int pos = EDP073001Help.getLastRec();
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0730?SCREEN=200&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
        }
  %> 
 </TD>
 </TR>
