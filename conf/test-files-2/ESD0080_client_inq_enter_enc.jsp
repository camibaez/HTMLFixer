...
<body>
 ...
 <h3 align="center">Customer Confidential Information Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="client_enter_enc, ESD0080"></h3>
<hr size="4">
