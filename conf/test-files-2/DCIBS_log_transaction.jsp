            	...
            	<div align="left">
          			<SELECT NAME="TRANSCODE" class=inputs >
						...
						while(lstTransactions.getNextRow()){
  							datapro.eibs.beans.DC_MENU logtransdatabean = new datapro.eibs.beans.DC_MENU();
  							logtransdatabean = (datapro.eibs.beans.DC_MENU) lstTransactions.getRecord();
						%>
