...
function goAction(op) {
	...
	case  2: 
	        ...
	        document.forms[0].submit();
			break;   
	case  3: ok = confirm("Confirm Delete the selected record");
	  		if (ok) 
	       {
	       		document.forms[0].opt.value = op;
	...
	case  4: document.forms[0].opt.value = op;
			...
			break;   
	case  5: 
			if (!document.forms[0].IDAVAL.value == '') {
			ok = confirm("Confirm Add the selected record");
	         if (ok)
	         {
			...
			alert('This customer does not have guarantees created in the eIBS.');
	       	}  
		     break;			
	...
	case  7: document.forms[0].opt.value = op;
	       	...
	       	document.forms[0].submit();
			break;   
	case  8: ok = confirm("Confirm Delete the selected record");
	  		if (ok) 
	       {
	       	document.forms[0].opt.value = op;
...
<h3 align="center">Guarantees by Credit Proposal<img
...
<TABLE id="mainTable" class="tableinfo">
	<TR>
		<TD NOWRAP valign="top" width="100%">
		<h3>Avals, Bails/Co-Applicant Proposal</h3>
		<table class="tbenter" width=100% align=center>
			<tr>
				<td class=TDBKG width="20%">
				<div align="center"><a href="javascript:goAction(6)"><b>New</b></a></div>
				</td>
				<td class=TDBKG width="20%">
				<div align="center"><a href="javascript:goAction(9)"><b>Inquiry</b></a></div>
				</td>
				<td class=TDBKG width="20%">
				<div align="center"><a href="javascript:goAction(7)"><b>Modify</b></a></div>
				</td>
				<td class=TDBKG width="20%">
...
<TR>
	<TABLE id="mainTable" class="tableinfo">
		<TBODY>
			<TR>
				<TD nowrap valign="top" width="100%">
				<H3>Existing Customer Guarantees in eIBS</H3>
				<table class="tbenter" width=100% align=center>
				 	  <tr>
						...
						--%>
							<div align="center">
								<a href="javascript:goAction(5)"><b>Copy</b></a>
							</div>
						<%--
						<% } %>
						--%>
						...
						<td class=TDBKG width="50%">
							<div align="center"><a href="javascript:goAction(10)"><b>Inquiry</b></a></div>
						</td>
				  	  </tr>
					</table>
				...
				<TABLE id="headTable3">
					<TBODY>
						<TR id="trdark">
							...
							<TH align="CENTER" nowrap>Ttpe</TH>
							<TH align="CENTER" nowrap>Amount</TH>
							<TH align="CENTER" nowrap>Owner ID</TH>
