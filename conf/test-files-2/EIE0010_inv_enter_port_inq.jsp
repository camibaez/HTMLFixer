...
<h3 align="center">Investments - Inquiry Customer Portfolio <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_enter_port, EIE00010"></h3>
<hr>
