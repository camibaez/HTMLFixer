...
%>
<h3 align="center"> Process Payment File<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="payments_basic.jsp,EPR0015">
</h3>
<hr size="4">
    ...
    <tr >
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark">
            <td nowrap >
              <div align="right">Offset GL Account :</div>
            </td>
            <td nowrap >
              <input type="text" name="E01PRCOSA" size="13" maxlength="12" value="">
              <a href="javascript:GetLedger('E01PRCOSA','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
          </tr>
        </table>
      </td>
