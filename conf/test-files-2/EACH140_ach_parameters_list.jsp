...
<h3 align="center">ACH Parameters<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
...
<TABLE class="tbenter"> 
	<TR>
		<TD align="CENTER" class="TDBKG" width="33%">
			<a href="javascript:goNew()"><b>New<br>Bank</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="33%">
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center">There are no defined parameters.</h4> 
      </div>
      </TD></TR>
   	</TABLE>
<%
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    ...
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="10%"><b>Operator /<BR>Originator</b></td>
		<td NOWRAP align="center" width="35%" colspan="3"><B> Incoming</B></td>
		<td NOWRAP align="center" width="45%" colspan="4"><b>Outgoing<br>
		<B></B></b></td>
	</TR>
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="5%"><B>GL Batch</B><BR>
			<B><IMG src="<%=request.getContextPath()%>/images/Check.gif"
				alt="Mandatory Field" align="bottom"></B>
		</td>
		<TD nowrap align="center" width="15%"><B>ACH Account/<BR>
		Payment Account<BR>Loans Account
		<BR>
		<IMG src="<%=request.getContextPath()%>/images/Check.gif"
				alt="Mandatory Field" align="bottom">
		</B></TD>
		<TD nowrap align="center" width="15%"><B>Apply</B></TD>
		<td NOWRAP align="center" width="5%"><B> GL Batch </B><BR>
			<b><IMG src="<%=request.getContextPath()%>/images/Check.gif"
				alt="Mandatory Field" align="bottom"><B></B></b></td>
		<TD nowrap align="center" width="15%"><B>ACH Account</B><BR>
		<B><IMG src="<%=request.getContextPath()%>/images/Check.gif"
			alt="Mandatory Field" align="bottom"></B></TD>
		<TD nowrap align="center" width="15%"><B>Bridge Account <BR>
		<IMG src="<%=request.getContextPath()%>/images/Check.gif"
			alt="Mandatory Field" align="bottom">
		</B></TD>
		...
		<TD nowrap align="center" width="15%" valign="top">
			<INPUT type="text" name="E01ACHIGL_<%= EACH140List.getCurrentRow() %>" 
				value="<%= msgList.getE01ACHIGL() %>" size="13" maxlength="12"  <%= read %>>
			...
			<INPUT type="text" name="E01ACHGLP_<%= EACH140List.getCurrentRow() %>"
				value="<%= msgList.getE01ACHGLP() %>" size="13" maxlength="12" <%= read %>>
		...
		<INPUT type="text" name="E01ACHGLL_<%= EACH140List.getCurrentRow() %>"
			value="<%= msgList.getE01ACHGLL() %>" size="13" maxlength="12" <%= read %>>
		...
		<TD nowrap align="left" width="15%" valign="top">
			<INPUT type="CHECKBOX" name="E01ACHNSF_<%= EACH140List.getCurrentRow() %>" <%= disabled %> 
			 	value="Y" <% if (msgList.getE01ACHNSF().equals("Y")) out.print(" checked"); %>>NSF Charges<BR>
		<INPUT type="CHECKBOX" name="E01ACHREP_<%= EACH140List.getCurrentRow() %>"
				value="A" <% if (msgList.getE01ACHREP().equals("A")) out.print(" checked"); %>>Returns<BR>
		<INPUT type="CHECKBOX" name="E01ACHBAA_<%= EACH140List.getCurrentRow() %>"
				value="Y" <% if (msgList.getE01ACHBAA().equals("Y")) out.print(" checked"); %>>Approval
		</TD> 
		...
		<TD nowrap align="center" width="15%" valign="top">
			<INPUT type="text" name="E01ACHOGL_<%= EACH140List.getCurrentRow() %>" value="<%= msgList.getE01ACHOGL() %>" size="13" maxlength="12" <%= read %>>
			<A
		...
		<TD nowrap align="center" width="15%" valign="top">
			<INPUT type="text" name="E01ACHGLN_<%= EACH140List.getCurrentRow() %>" value="<%= msgList.getE01ACHGLN() %>" size="13" maxlength="12" <%= read %>>
			<A
