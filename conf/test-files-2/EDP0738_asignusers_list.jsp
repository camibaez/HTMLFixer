...
<html>
<head>
<title>List Proposals to Assign User</title>
...
function goAction(op) {	
 ...
 case  2: 
	document.forms[0].USR.value=document.forms[0].E01PLPUID.value; 
...
%> 
<h3 align="center">List Proposals to Assign User<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="asignusers_list.jsp, EDP0738"></h3>
<hr size="4">
...
--%>
        <INPUT type="text" name="E01PLPUID" size="16" maxlength="15" >
        <INPUT type="text" name="E01DSC" >
           <a href="javascript:GetUser('E01PLPUID','E01DSC',document.forms[0].E01PLPUID.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0"></a> 
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="20%"> 
              <div align="center">Product/Operation</div>
            </th>
                                 
           <th align=CENTER nowrap width="10%"> 
              <div align="center">Amount Requ.<BR>Amount Approv.</div>
           </th>  
           ...
           <th align=CENTER nowrap width="10%"> 
              <div align="center">Days Last.Act.</div>
            </th>
           ...
           <th align=CENTER nowrap width="10%"> 
            ...
            <th align=CENTER nowrap width="20%"> 
              <div align="center">Seq-Activity</div>
            </th>     
  ...
  <%
		...
		int pos = EDP072001Help.getFirstRec() - 21;
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0738?SCREEN=200&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
        }
  %>
  </TD>
  ...
  <%
		...
		int pos = EDP072001Help.getLastRec();
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0738?SCREEN=200&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
        }
  %> 
 </TD>
 </TR>
