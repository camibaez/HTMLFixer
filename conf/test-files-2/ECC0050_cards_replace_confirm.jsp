...
<SCRIPT LANGUAGE="javascript">
 	...
 	function redirect() {
 		self.window.location.href = "<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECC0050?SCREEN=30";
 	}
...
<h3 align="center">
	Card Activation Confirmation<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="card_replace_confirm.jsp, ECC0050"></h3> 
<hr size="4">
    	...
    	<tr > 
      		<td><p align="center">&nbsp; </p>
	        	<table width="100%">
	          		...
	          		<tr>
	            		<td width="9%">&nbsp;</td>
	            		<td width="91%"><div align="center">The Debit Card has been processed successfully, please approve this replacement.</div></td>
	          		</tr>
	        	</table>
      		</td>
		</tr>
