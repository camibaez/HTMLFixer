...
<INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  ...
  <h3 align="center">Trade Ticket Approval<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="approval_list.pb_treasury.jsp,EIE0140"> 
  </h3>
<hr size="4">
  ...
  <TABLE class="tbenter">
    <TR> 
      ...
      <TD ALIGN=CENTER width="34%" class=TDBKG> <a href="javascript:goAction('R')">Reject</a>
      </TD>
 ...
 <TR > 
  ...
  <TR id="trdark"> 
      ...
      <TH ALIGN=CENTER NOWRAP>Transaction<br>Type</TH>
      <TH ALIGN=CENTER NOWRAP>Portfolio<br>Number</TH>
      <TH ALIGN=CENTER NOWRAP>Instrument<br>Descrip.</TH>
