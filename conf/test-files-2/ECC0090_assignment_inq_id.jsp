...
<body>
<h3 align="center">Assignments Inquiry<BR>Detail<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="assignment_inq_id.jsp, ECC0090"></h3>
<hr size="4">
<% 
  ...
  <TABLE class="tableinfo">
    ...
    %>             
        ...
        <TR>
			...
			<td NOWRAP align="center">
				<A HREF="javascript:cardInquiry('<%= msgCard.getE02CCRNUM()%>')">
				<% if (msgCard.getE02CCRTPI().equals("T")) { out.println("Main"); } else { out.println("Additional"); }%>
				</A>
			</td>
			<td NOWRAP align="center">
				<A HREF="javascript:cardInquiry('<%= msgCard.getE02CCRNUM()%>')">
