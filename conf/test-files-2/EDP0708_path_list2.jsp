...
<BODY>
<h3 align="center">Route Maintenance</h3>
<P align="center">
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="path_list2.jsp, EDP0708">
      ...
      <td NOWRAP valign="top" width="100%"> 
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%"> <div align="center">Sequencia</div> </th>
            <th align=CENTER nowrap width="25%"> <div align="center">Activity</div> </th>
            <th align=CENTER nowrap width="10%"> <div align="center">Area/Dept.</div> </th>
            <th align=CENTER nowrap width="25%"> <div align="center">Actividad Type</div> </th>
           </tr>
          <%
		 ...
		 %>
          <tr> 
            ...
            <td NOWRAP  align=CENTER width=\"25%\"><%= msgList.getE01DPPTDE() %></td>	
          </tr>
          <%
              				chk = "";     
                }
