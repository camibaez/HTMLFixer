...
<H3 align="center">Stand By Letter Of Credit Maintenance<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="sb_enter_maint, ELC0400"" ></H3>
...
<FORM method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0400">
  ...
  <TABLE class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
    ...
    <TR>
		<TD nowrap align="right">Amendment :</TD>
		<TD align="left">
