...
<script language="Javascript1.1" src="<%=request.getContextPath()%>/pages/e/javascripts/eIBS.jsp">
...
<h3 align="center">Credit Proposal - Client Financial Information<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="client_financial_enter,EDP0730"></h3>
<hr size="4">
