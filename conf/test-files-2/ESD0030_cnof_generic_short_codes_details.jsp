...
<H3 align="center">System Reference Codes - <%= userPO.getHeader21() %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_generic_short_codes_details.jsp, ESD0030"></H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSESD0030" >
  <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="600">
   ...
   <INPUT TYPE=HIDDEN NAME="H02USERID" value="<%= currUser.getH01USR()%>"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="left"> 
                <%  String tCode = refCodes.getE02CNOCFL().trim();
                	if ( tCode.equals("") ){
                		tCode = userPO.getHeader6();
                	}
                 %>
                <input type="text" name="E02CNOCFL" size="2" maxlength="1" value="<%=tCode%>">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
