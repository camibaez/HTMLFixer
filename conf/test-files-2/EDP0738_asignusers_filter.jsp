...
<TITLE>Asign User to Proposals</TITLE>
...
<h3 align="center">Asign User to Proposals<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="asignusers_filter,EDP0738"></h3>
<hr size="4">
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0738" >
  <CENTER>
...
--%>       
      <tr valign="middle"> 
        ...
        <td nowrap width=60% align="left"> 
            <input type=TEXT name="E01FILEST" size=16 maxlength=2 onKeypress="enterInteger()">
            <A href="javascript:GetCodeDescCNOFC('E01FILEST','E01FILEST','37')">
            <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0">
        </td>                  
      </tr>
      ...
      <tr> 
        <td nowrap colspan="2" valign="middle" height="200"> 
			<div align="center"> 
			<INPUT id="EIBSBTN" type="button" name="Submit" value="Submit" onclick="goConfirm()"></div>
        </td>
      </tr>
      <tr> 
