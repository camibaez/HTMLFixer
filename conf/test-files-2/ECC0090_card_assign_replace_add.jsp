...
<body>
<h3 align="center">Debit Card Assignment<BR>Additional Card Replacement<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_assign_replace_add.jsp, ECC0090"></h3>
<hr size="4">
<% 
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECC0090" onSubmit="return validate();">
  ...
  <h4>Replaced Card Information</h4>
  <TABLE class="tableinfo">
	<TBODY>
		<TR>
			<TD nowrap>
			<TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
				<TBODY>
					<TR id="trdark">
						<TD nowrap width="16%">
							<DIV align="right"><B>Replace Card Number:</B></DIV>
						</TD>
						<TD nowrap width="20%">
							<DIV align="left">
								<INPUT type="text" name="E01CCRNUMA" size="21" maxlength="20" value="<%= userPO.getHeader13().trim()%>" readonly>
							</DIV>
						</TD>
					</TR>
					<TR id="trclear">
						...
						<TD nowrap width="20%">
							<DIV align="left">
								<INPUT type="text" name="E01CCRNUM" size="21" maxlength="20" value="<% if (userPO.getType().equals("T")) { out.println(userPO.getHeader1()); } else { out.println(userPO.getHeader14()); } %>" readonly>
							</DIV>
						</TD>
						<TD nowrap width="16%">
							<DIV align="right"><B>Replace Reason:</B></DIV>
						</TD>
						<TD nowrap width="20%">
							<DIV align="left">
								...
								<a href="javascript:GetCodeDescCNOFC('E01CCRSTS','E01CCRDSC','17')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="absbottom" border="0"></a>
							</DIV>
						</TD>
					</TR>
				</TBODY>
