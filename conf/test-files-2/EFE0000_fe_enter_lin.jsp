...
<body bgcolor="#FFFFFF">
<H3 align="center"> Treasury - Line of Credit<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fe_enter_lin,EFE0000"></H3>
...
<input type=HIDDEN name="E01FESTYP">
  ...
  <center>
    <table class="tableinfo" width="58%">
      ...
      <tr id="trintro"> 
        <td colspan="3"> 
          <div align="center">Line of Credit : 
