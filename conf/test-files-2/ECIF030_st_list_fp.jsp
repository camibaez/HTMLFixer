...
function showGraph()
{
	var pg = "<%=request.getContextPath()%>/pages/e/ECIF030_st_balance_graph.jsp";
...
<FORM>
  <h3 align="center">Account Statement<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="st_list_fp,ECIF030"></h3>
  <hr size="4">
  <BR>
      ...
      <td > 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td  width="30%" nowrap> 
              <div align="right"><%= stBalances.getE02LGNA10().trim()%></div>
            </td>
            <td  width="1%">&nbsp;</td>
            <td  width="32%" nowrap> 
...
%>
  ...
  <table class="tableinfo">
    <tr id="trclear"> 
      ...
      <th align=CENTER width="44" nowrap>Value Date </th>
