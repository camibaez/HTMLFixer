...
<h3 align="center">Detalle del Producto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="proposals_product_inq_others.jsp,EDP0720"></h3>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">		
			<tr id="trclear">
				...
				<td nowrap width="80%" align="left">
		              <input type="text" name="E01PLTOTH" size="5" maxlength="4" value="<%= msgList.getE01PLTOTH().trim()%>" readonly>
				</td>
			</tr>
			...
			<tr id="trclear">
				...
				<td nowrap width="80%" align="left">
				 <TEXTAREA name="E02DPAC10" rows="4" cols="75" disabled >
			...
			<tr id="trclear">
				...
				<td nowrap width="80%" align="left">
					<input type="text" name="E01PLTAMX" size="16" maxlength="15" readonly value="<%= msgList.getE01PLTAMX().trim()%>"
		            >
				</td>
			</tr>
