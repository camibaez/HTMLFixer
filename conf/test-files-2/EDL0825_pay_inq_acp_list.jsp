...
<h3 align="center">Discount of Documents Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_inq_basic.jsp,EDL0160"></h3>
<hr size="4">
...
<table class="tableinfo" id="trdark">
    ...
    <tr id="trclear">
      <td align="center" nowrap width="50%">
       <b>Identification : </b><%= docHeader.getE03NUMIDE() %>
      </td>
      
      <td align="center" nowrap width="50%">
       <b>Name : </b><%= docHeader.getE03CUMMA1() %>
      </td>
    </tr>   
  </table>
    ...
    <TR>
        ...
        <TABLE id="headTable">
            <TR id="trdark">
                ...
                <TH ALIGN=CENTER NOWRAP>Value Doc.</TH>
                <TH ALIGN=CENTER NOWRAP>Maturity</TH>
                <TH ALIGN=CENTER NOWRAP>Penalty</TH>
