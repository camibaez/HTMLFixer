...
<h3 align="center">Mailing Address<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_both_mail_address, ESD0080" ></h3>
<hr size="4">
      ...
      <table cellspacing="0" cellpadding="2" width="100%" class="tbhead" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
        <tr>
          ...
          <% } else { %>
            ...
            <td nowrap width="10%" align="right"> Portfolio: </td>
          <td nowrap width="12%" align="left">
      			<%= userPO.getIdentifier()%>
          </td>
            <td nowrap width="6%" align="right"></td>
          <td nowrap width="14%" align="left">
          </td>
            <td nowrap width="8%" align="right"> Description: </td>
          <td nowrap width="50%"align="left">
      			<%= userPO.getHeader3()%>
          </td>
          <% } %>
