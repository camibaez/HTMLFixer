      ...
      <td nowrap >
        <table cellspacing=2 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap >
			<div align="left">
              <input type="text" name="CURGL" size="12" maxlength="12" value="<%= chkList.getRecord(26) %>" readonly>
			</div>
            </td>
            <td nowrap >
			<div align="left">
              <input type="text" name="NEWGL" size="12" maxlength="12" value="<%= request.getParameter("GL") %>" onKeypress="enterInteger()" >
              <a href="javascript:GetLedger('NEWGL','<%= chkList.getRecord(18) %>','<%= chkList.getRecord(25) %>','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"  ></a>
			</div>
            </td>
          </tr>
		<tr id="trclear">
			<td nowrap id="trdark">
              <div align="center"><b>Reference/Account</b></div>
            </td>
            <td nowrap>
			<div align="left">
              <input type="text" name="CURACC" size="12" maxlength="9" value="<%= chkList.getRecord(0) %>" readonly>
			</div>
            </td>
            <td nowrap >
			<div align="left">
              <input type="text" name="NEWACC" size="12" maxlength="9" value="<%= request.getParameter("Acc") %>" onKeypress="enterInteger()" >
              <a href="javascript:GetAccount('NEWACC','<%= chkList.getRecord(18) %>','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"  ></a>
			</div>
            </td>
          </tr>
		<tr id="trclear">
            <td nowrap id="trdark">
			  <div align="center"><b>Check Number</b></div>
			</td>
			<td nowrap  >
			<div align="left">
		...
		<tr id="trclear">
 			<td nowrap id="trdark" rowspan=4>
              <div align="center"><b>Cause</b></div>
            </td>
            <td nowrap  >
			<div align="left">
            ...
            <td nowrap >
			<div align="left">
              <input type="text" name="NEWRS1" size="5" maxlength="3" value="<%= request.getParameter("Rs1") %>">
              <a href="javascript:GetCasualTable('NEWRS1')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"  ></a>
			</div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap >
			<div align="left">
              <input type="text" name="NEWRS2" size="5" maxlength="3" value="<%= request.getParameter("Rs2") %>">
              <a href="javascript:GetCasualTable('NEWRS2')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"  ></a>
			</div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap >
			<div align="left">
              <input type="text" name="NEWRS3" size="5" maxlength="3" value="<%= request.getParameter("Rs3") %>">
              <a href="javascript:GetCasualTable('NEWRS3')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"  ></a>
			</div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap >
			<div align="left">
              <input type="text" name="NEWRS4" size="5" maxlength="3" value="<%= request.getParameter("Rs4") %>">
              <a href="javascript:GetCasualTable('NEWRS4')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"  ></a>
			</div>
            </td>
          </tr>
	 </table>
