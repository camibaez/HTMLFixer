...
<H3 align="center">Safe Deposit Box Type Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="safe_deposit_types_maint, ESB0010"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	<tr id=trdark> 
	      ...
	      <td nowrap width="60%"> 
	        <input type="text" name="E01SBTTYP" size="6" maxlength="6" value="<%= msgPart.getE01SBTTYP() %>" readonly>
	      </td>
     	</tr>
     	<tr id=trclear> 
	      <td nowrap> 
