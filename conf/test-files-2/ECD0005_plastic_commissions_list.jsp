...
function goAction(op) {
	...
	if (op == 4){
		if(confirm("This record will be erased")){
...
%>
<BODY>
<h3 align="center">Card Fee<br><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_commissions_list.jsp, ECD0005">
</h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0005" >
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="30%">Fee Type</th>
            <th align=CENTER nowrap width="30%">Charge Type</th>
            <th align=CENTER nowrap width="10%"><div align="center">Charge %</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Fee Amt</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Credit Acc.</div></th>
          </tr>
     	<%
        appList.initRow(); 
        ...
        while (appList.getNextRow()) {
           ...
           datapro.eibs.beans.ECD0005DSMessage msgPart = (datapro.eibs.beans.ECD0005DSMessage) appList.getRecord();
     	%>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE05CDRNPL())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE05CDRFED())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE05CDRFFC())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE05CDRCHG())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE05CDRAMT())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE05CDRACC())%></TD>
		</TR>    		
    	<%}%>    
        </table>
    </table>
