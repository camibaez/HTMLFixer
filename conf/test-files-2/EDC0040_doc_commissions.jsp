...
<html>
<head>
<title>Documentary Collection Approval [Commissions]</title>
...
<body>
<h3 align="center">Documentary Collections Approval [Commissions]
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="doc_commissions.jsp, EDC0040"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
			...
			<td nowrap width="30%"><div align="right">Stamp Duty :</div>
			</td>
            <td nowrap width="20%">
          ...
          <tr id="trdark"> 
            <td nowrap width="30%"> 
             	<div align="right">
				<DIV align="right">Issuance Swift :</DIV></div>
            </td>
            <td nowrap width="20%">  
			...
			<td nowrap width="30%"><div align="right">Fax/Phone  :</div>
			</td>
            <td nowrap width="20%">
          ...
          <tr id="trclear"> 
            <td nowrap width="30%"><div align="right">Funds Transfer :</div>
            </td>
            <td nowrap width="20%">  
          ...
          <tr id="trclear"> 
			...
			<td nowrap width="30%"><div align="right">Interest :</div>
			</td>
            <td nowrap width="20%">
          ...
          <tr id="trdark"> 
            <td nowrap width="30%"> 
             	<div align="right">
				<DIV align="right">Advice of Payment :</DIV></div>
            </td>
            <td nowrap width="20%">  
