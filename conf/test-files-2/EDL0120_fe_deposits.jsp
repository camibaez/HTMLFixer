...
%> 
<h3 align="center"> <%= sTitle %> <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_deposits, EDL0120"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan="2">
              ...
              <%=currUser.getH01WK3().equals("4")?"Taking ":"Sale "%> 
              ...
              <%=currUser.getH01WK3().equals("4")?"Placement ":"Purchase "%></td>
          </tr>
          <tr id="trclear"> 
