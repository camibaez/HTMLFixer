...
function get_IRA_Summary (){
	window.location.href = "<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEIRA020?SCREEN=11";
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0130" >
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap  > 
              <div align="left"> 
 				<b><font color="#ff6600">
		   		<% if (cdInquiry.getH01FLGWK1().equals("1")) out.print("Special Instructions");
		   		   else if (cdInquiry.getH01FLGWK1().equals("2")) out.print("Teller Messages"); 
		   		   else if (cdInquiry.getH01FLGWK1().equals("3")) out.print("Special Instructions/Teller Messages");
		   		%>
		   		</font></b>               
		      </div>            
             </td>
 ...
 if (cdInquiry.getE01DEAROC().equals("A")) out.print("Principal plus Interests will be roll over by the same period of time.  ");
 				  ...
 				  + cdInquiry.getE01TEXTO2().trim() + " will have as a number");
 					...
 					out.print("When Certificate matures roll over  the Deposit plus Interest, by the same period of time, decreasing the Interests in " +  cdInquiry.getE01DEAROA().trim()  +  "   and crediting them to the Account (Retail, Savings, etc.) number  "  
...
%>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="29%" > 
              <div align="right">Renewal Times:</div>
            </td>
            <td nowrap width="22%" > 
