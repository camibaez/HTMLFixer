...
<h3 align="center">Beneficiaries <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_bene.jsp, EDL0130"></h3>
<hr size="4">
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark">
            <td nowrap width="16%">
              <div align="right"><font face="Arial"><font face="Arial"><font size="2"><b>Reference
