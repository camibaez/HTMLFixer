...
function ShowNew(x,y) {	 
    ...
    enterNew.filters[0].Play();
	document.forms[0].E01EWDCTC.focus();
}
...
function SetErrorVisible() {	 
	 var myValue = document.forms[0].E01EWDF02.value;

	 if (true) { // verify myValue Here
	 	document.forms[0].E01EWDF02.onkeypress = "";
	 	document.forms[0].E01EWDCTC.onkeypress = "";
	 } else {
	 	document.forms[0].E01EWDF02.onkeypress="";
	 	document.forms[0].E01EWDF02.value="";
	 	document.forms[0].E01EWDCTC.onkeypress="";
	 	document.forms[0].E01EWDCTC.value="";	 	
	 }
}
...
<h3 align="center">FIPS County Codes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="county_codes_list, EWD0018DS"></H3>
<hr size="4">
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
	...
	<tr id="trdark"> 
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          <input type="text" name="E01EWDF02" size="12" maxlength="10" onchange="SetErrorVisible()">
          <a href="javascript:GetCodeCNOFC_St_FIPS('E01EWDF02','','27')"> 
   ...
   <tr id="trclear">      
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          <input type="text" name="E01EWDCTC" size="12" maxlength="10" onchange="SetErrorVisible()">
          <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom"> 
        </div>
      </td>      
    </tr>
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
  		<TR id="trdark"> 
    		...
    		<TH ALIGN=CENTER >FIPS State Code</TH>
        ...
        while (msgList.getNextRow()) {
           ...
           datapro.eibs.beans.EWD0018DSMessage msgPart = (datapro.eibs.beans.EWD0018DSMessage) msgList.getRecord();
     	%>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getEWDCTC())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getEWDDSC())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getEWDSTC())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getEWDSAC())%></TD>
		</TR>    		
    	<%}%>    
     </TABLE>
    </TD>
