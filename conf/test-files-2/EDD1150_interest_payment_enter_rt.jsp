...
<H3 align="center">Retail Accounts - Interest Payment<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cancel_enter_rt, EDD1150"></H3>
