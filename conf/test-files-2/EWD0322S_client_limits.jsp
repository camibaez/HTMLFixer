...
<script language="JavaScript">
  function goAction(op) {
		  ...
		  if(document.forms[0].date1.value == '' && op==2){
             alert("A valid customer must be selected"); 
             return; 
          }
...
<h3 align="center">Customer Limits Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cif_position.jsp,ECIF010"></h3>
<hr size="4">
  <form>
<% 
  ...
  <center>
    <table class="tableinfo">
      <tr id="trclear"> 
        ...
        <th align=CENTER nowrap > 
          <div align="center">Approved <br>
            Amount</div>
        </th>
        <th align=CENTER nowrap > 
          <div align="center">Used <br>
            Amount</div>
        </th>
        <th align=CENTER nowrap > 
          <div align="center">Available <br>
            Amount</div>
        </th>
      </tr>
      <tr> <%
