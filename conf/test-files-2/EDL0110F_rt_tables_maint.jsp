...
<h3 align="center">Floating Rates Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_tables_maint,EDL0110F" ></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="left"> 
                <input type="text" name="E01PRRTBL" size="3" maxlength="2" value="<%= rates.getE01PRRTBL()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trclear">            
            ...
            <td nowrap  >             
              ...
              <div align="left"> 
              	<%
              		...
              		String d = "";
              		String y = "";
              		// (rates.getE01PRRAPP().equals("N")) {
              		// = currUser.getE01RDM();
              		// = currUser.getE01RDD();
              		// = currUser.getE01RDY();              		
              		//else {
              			//m = rates.getE01PRREFM();
              			//d = rates.getE01PRREFD();
              			//y = rates.getE01PRREFY();              		
              			
              		//
              		m = rates.getE01PRRETM();
           			d = rates.getE01PRRETD();
           			y = rates.getE01PRRETY();
              	%>
                 <BR>
				<input type="text" name="E01PRREFM" size="3" maxlength="2" value="<%= m%>">
                <input type="text" name="E01PRREFD" size="3" maxlength="2" value="<%= d%>">
                <input type="text" name="E01PRREFY" size="3" maxlength="2" value="<%= y%>">
                <a href="javascript:DatePicker(document.forms[0].E01PRREFM,document.forms[0].E01PRREFD,document.forms[0].E01PRREFY)">
