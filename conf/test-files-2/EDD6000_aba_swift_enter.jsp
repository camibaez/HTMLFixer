...
if ( (document.forms[0].E01INSAB9.value.length < 1 || document.forms[0].E01INSAB9.value == "0") & (document.forms[0].E01INSSWF.value.length < 1 || document.forms[0].E01INSSWF.value == "0") ) {
  alert("A ABA Number or Swift ID must be entered");
...
<h3 align="center">ABA Numbers and Swift Id Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="aba_swift_enter.jsp, EDD6000"></h3>
<hr size="4">
  <br><br><br>
  <table class="tableinfo"  cellspacing="0" cellpadding="2" width="100%" border="0">
    <tr id="trdark"> 
      <td valign="middle" align="center" width="49%"> 
        <div align="right">Enter ABA Number : </div>
      </td>
    ...
    <tr id="trdark"> 
      <td valign="middle" align="center" width="49%"> 
        <div align="right">Enter Swift ID : </div>
      </td>
      <td valign="middle" align="center" width="51%"> 
        <div align="left"> 
