...
<h3 align="center">Contract Transactions Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_enter_transac,EDL0130"></h3>
<hr size="4">
  ...
  <table class="tbenter" height="75%" width="100%" border="0">
    <tr>
          ...
          Reference Number :
              ...
              <a href="javascript:GetAccount('E03DEAACC','','CD','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
             <br>
  <div align="center">
