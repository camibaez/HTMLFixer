...
<BODY >
<h3 align="center">Módulo de Solicitudes - Aprobación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="aprobacion_list.jsp,EWD0414"> 
  </h3>
<hr size="4">
   ...
   <TABLE class="tbenter">
    <TR>
      <TD ALIGN=CENTER width="25%" class=TDBKG>
  			<a href="javascript:goAction('6')" >Aprobar</a>
      </TD>
      <TD ALIGN=CENTER width="25%" class=TDBKG>
  			<a href="javascript:goAction('4')" >Rechazar</a>
      </TD>
      <TD ALIGN=CENTER width="25%" class=TDBKG>
