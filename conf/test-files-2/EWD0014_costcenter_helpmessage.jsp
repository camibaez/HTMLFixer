...
<jsp:useBean id= "ewd0014Help" class= "datapro.eibs.beans.JBList"   scope="session"/>
...
<TABLE  id="mainTable" class="tableinfo" ALIGN=CENTER style="width:'95%'">
 <TR> 
  ...
  <TABLE id="headTable" >
  <TR id="trdark">
			  <th nowrap><div nowrap>Cost Center</div></th>
...
<%		
	 ewd0014Help.initRow();
		  int i=0;
                while (ewd0014Help.getNextRow()) {
                    if (ewd0014Help.getFlag().equals("")) {
                    		out.println(ewd0014Help.getRecord());
                    		i++;
			}
                }
    %> 
