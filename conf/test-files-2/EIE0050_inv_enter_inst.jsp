...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0308P" >
 ...
 <TABLE id=tbhelp style="border-top-width : 1px;border-right-width : 1px;border-bottom-width : 1px;border-left-width : 1px;
  ...
  <h3 align="center">Instruments Management</h3>
      ...
      <td nowrap align="center"> 
        <table class="tableinfo" align="center" >
          ...
          <div id="divShow" >
			  <table width="100%">
                <tr id="trdark"> 
                  <td valign="middle" align="center" colspan="3" height=33> 
                    <div align="left"><a href="javascript:Options('S')">Expand Search Options</a></div>
                  </td>
                </tr>
              </table>            
          </div>
          ...
          <tr> 
            <td> 
              ...
              <table width="100%">
                <tr tr id="trdark"> 
                  <td valign="middle" align="center" colspan="3" height=33> 
                    <div align="left"><b>Additional Search Options :&nbsp;&nbsp;&nbsp; </b><a href="javascript:Options('H')">Hide</a></div> 
                  </td>
                </tr>
                <tr id="trclear"> 
                  <td>&nbsp;</td>
                ...
                <tr id="trclear"> 
                  ...
                  <td width="70%" nowrap > 
                    <div align="left"> 
                      ...
                      Pending 
                      <input type="radio" name="CSTATUS" value="R" onClick="document.forms[0].STATUS.value=''" >
                      All </div>
                  </td>
                </tr>
                <tr id="trclear"> 
                ...
                <tr id="trclear"> 
                  <td width="10%" align="center">&nbsp;</td>
                  <td width="20%" nowrap > 
                    <div align="right">List Only Complex Instruments : </div>
                  </td>
                  <td width="70%" nowrap > 
                    <div align="left"> 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" bordercolor="#FFFFFF">
          ...
          <tr bgcolor="#FFFFFF"> 
            <td width="33%"> 
              <div align="center">
                <input id="EIBSBTN" type=button name="Submit2" value="New " onClick="ShowEnterCod()">
              </div>
            </td>
            <td width="33%"> 
              <div align="center">
                <input id="EIBSBTN" type=submit name="Submit" value="Search">
              </div>
            </td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
