...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.accounting.JSECON00" >
  ...
  <table class="tableinfo">
    <tr id="trdark"> 
      ...
      <td nowrap colspan="2" > 
        <div align="left"> 
          <input type="text" name="E01CONSEQ2" size="5" maxlength="4" value="<%= gl.getE01CONSEQ()%>" readonly>
        </div>
      </td>
    </tr>
  </table>
  ...
  <table class="tableinfo">
    <tr id="trdark"> 
      ...
      <td nowrap colspan="2" > 
        <input type="text" name="E01CONEBK" size="2" maxlength="2" value="<%= gl.getE01CONEBK()%>" readonly>
      </td>
    </tr>
    <tr id="trclear"> 
      <td nowrap > 
