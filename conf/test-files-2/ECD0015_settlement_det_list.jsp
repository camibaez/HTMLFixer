...
{
	page = "<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0015?SCREEN=3&ROW=" + rowNum;
	CenterWindow(page,800,600,2);
}

function PrintPreview() {

	var pg = "<%=request.getContextPath()%>/pages/e/ECD0015_settlement_det_print.jsp";
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%"><div align="center">Card<BR>Number
				</div></th>
...
<%
        if ( detList.getShowPrev() ) {
      			...
      			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.cards.JSECD0015?SCREEN=102&Pos=" + pos + "\"><IMG border=\"0\" src=\""+request.getContextPath()+"/images/s/previous_records.gif\" ></A>");
        }
  %>  
  </TD>
 ...
 <%      
        if ( detList.getShowNext() ) {
      			...
      			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.cards.JSECD0015?SCREEN=102&Pos=" + pos + "\"><IMG border=\"0\" src=\""+request.getContextPath()+"/images/s/next_records.gif\" ></A>");
        }
   %> 
   </TD>
 	</TR>
