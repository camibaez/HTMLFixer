...
<body>
<h3 align="center">Swift  Document<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="EDD0610_tr_inq_swift.jsp"></h3>
<hr size="4" width="100%">
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trdark"> 
            <td nowrap width="23%" >Receiver ID:</td>
            <td nowrap width="35%" >Receiver ID Address:</td>
            <td nowrap width="42%" >Sender ID:</td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="23%" > 
              <div align="left"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="23%">Receiver:</td>
            <td nowrap width="35%">City and Country:</td>
            <td nowrap width="42%">Amount:</td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="23%"> 
              <div align="left"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="23%">Swift Reference M20:</td>
            <td nowrap width="35%">&nbsp;</td>
            <td nowrap width="42%">Value Date:</td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="23%"> 
              <div align="left"> 
    ...
    <tr> 
        ...
        <table cellspacing=0 cellpadding=2 border="0" width="100%" height="363">
          <tr id="trdark"> 
            <td nowrap colspan="2" bordercolor="#000000" > 
              <div align="center"><b>Ordering</b></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap colspan="2" bordercolor="#000000" >Ordering Customer M50:</td>
          </tr>
          <tr id="trdark"> 
          ...
          <tr id="trdark"> 
            <td nowrap bordercolor="#000000" colspan="2" >Ordering Bank....52</td>
          </tr>
          <tr id="trclear"> 
      ...
      <td nowrap width="48%" height="363"> 
        <table cellspacing=0 cellpadding=2 border="0" width="100%" height="363">
          ...
          <tr id="trclear"> 
            <td nowrap colspan="2" bordercolor="#000000" >Sender's Corr. Bk 53: 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="33%" bordercolor="#000000" > 
          ...
          <tr id="trdark"> 
            <td nowrap bordercolor="#000000" colspan="2" >Receiver's Corr. Bank 
              54: </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap bordercolor="#000000" > 
    ...
    <tr > 
      <td nowrap width="48%" height="315"> 
        <table cellspacing=0 cellpadding=2 border="0" width="100%" height="363">
          <tr id="trdark"> 
            <td nowrap colspan="2" > 
              <div align="center"><b>Intermediary</b></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap colspan="2" >Intermediary Bank 56 
              A :</td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="33%" > 
          ...
          <tr id="trdark"> 
            <td nowrap  colspan="2" >Account With Bank 57</td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
              <p align="right">A</p>
      ...
      <td nowrap width="48%" height="100%"> 
        <table cellspacing=0 cellpadding=2 border="0" width="100%" height="363">
          ...
          <tr id="trclear"> 
            <td nowrap colspan="2" >Beneficiary Cust M59: 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="33%" > 
          ...
          <tr id="trdark"> 
            <td nowrap colspan="2" >Beneficiary Bank: </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
              <p align="right">A</p>
    ...
    <tr > 
      <td nowrap width="30%" height="150"> 
        <table cellspacing=0 cellpadding=2 border="0" width="100%">
          <tr id="trdark"> 
            <td nowrap colspan="2"  > 
              <div align="left">Detail of Payments:</div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="36%"> 
