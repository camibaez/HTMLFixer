...
<% 
 if ( !error.getERRNUM().equals("0")  ) {
	...
	String title = "Letters Of Credit Maintenance ["; 
	int lines = 0;
	int chars = 0;
	int charssize = 0;
...
%> 
<H3 align="center"><%= title %><IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_field_info.jsp, ELC0500"></H3>
<HR size="4">
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0500" >
  ...
  <table class="tableinfo" cellspacing="0" cellpadding="4" width="100%" border="0">
  	<TR id="trdark">
  		...
  		<TD nowrap align="left" width="20%">
  			<INPUT type="text" readonly name="E03LCDPRO" size="5" maxlength="4" value="<%=msgLC.getE03LCDPRO().trim()%>"></TD>
