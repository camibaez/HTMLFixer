...
<SCRIPT LANGUAGE="JavaScript" SRC="javascripts/eIBS.jsp"> </SCRIPT>
...
<APPLET archive="eibs_applets.zip" code="datapro.eibs.applets.speak.AMySpeaker.class" name="Speaker" width="0" height="0" codebase="./">
</APPLET>
<%
}
else {
...
<tr>
    <td>
	<img src="../../images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="error_viewer">
    </td>
    <td align=center colspan=2 >
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2" class="tbenter">
        <tr>
          <td width="75"> 
            <div align="right"><font color="red"><img src="../../images/warning.gif"></font></div>
          </td>
          <td>
            <div align="center" nowrap><font color="#FF3333" face="Arial, Helvetica, sans-serif" size="3"><b>Errors - Warnings</b></font></div>
          </td>
          <td width="75"><font color="red"><img src="../../images/warning.gif"></font></td>
        </tr>
      </table>
...
<tr>
  <td>
	...
	%>
	<IMG src="../../images/warning01.gif" alt="Warning!!!">
	<% 
		} 
		else { 
	%>
	<IMG src="../../images/error01.gif" alt="Error!!!">
	<% 
		} 
	}
	%>
