...
%> 
<h3 align="center"><% if (userPO.getHeader2().equals("D")) out.print("Debit Card"); else out.print("Credit Card");%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="cc_ap_additional_cards_list.jsp , ECC0140"></h3>
<hr size="4">
...
%> 
      ...
      <TD> 
        <div align="center"> 
          ...
          <p>&nbsp;</p>
          <p><font size="3"><b>This account has no Additional Credits Cards</b></font></p>
          <p>&nbsp; </p>
        </div>
      </TD></TR>
   		</TABLE>
