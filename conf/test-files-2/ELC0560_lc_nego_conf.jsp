...
<H3 ALIGN="center">Letter of Credit Negotiation/Payment [Accounting]
	<IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left" NAME="EIBS_GIF" ALT="lc_nego_conf.jsp, ELC0560"></H3>
<HR SIZE="4">
    ...
    <TD align="center"><B>Equivalent</B></TD>
	  ...
	  <TR >
	    ...
	    <TD align="center"><INPUT name="E01EQVDRW" type="text" value="<%=msg01.getE01EQVDRW()%>" size="15" maxlength="13" readonly></TD>
	  	  ...
	  	  <TR>
	    <TD align="left">Applicant Commissions</TD>
	  ...
	  <TR>
	    <TD align="left">Beneficiary Commissions</TD>
	  ...
	  <TR>
	    <TD align="left">Applicant Taxes</TD>
	    <TD align="center"><INPUT type="text" name="E01DEBCY2" value="<%=msg01.getE01DEBCY2()%>" size="15" maxlength="13" readonly></TD>	    
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  <TR id="trdark">
    ...
    <TD align="center"><B>DDA Account</B></TD>
...
<P align="center">
  <INPUT id="EIBSBTN" type="submit" name="back" value="Back" onClick="document.forms[0].H01FLGWK1.value='N'">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
  <INPUT id="EIBSBTN" type="submit" name="Submit" value="Finish" onClick="document.forms[0].H01FLGWK1.value='Y'">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  
</P>
</FORM>
