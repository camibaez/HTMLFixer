...
%> 
<h3 align="center"> Customer Settlement Limits<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_lim_basic_new.jsp,EFE0325"> 
</h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" >
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" width="85%" > 
              <div align="left"> 
                <input type="hidden" name="E01FEOCUN"  value="<%= fex.getE01FEOCUN()%>" readonly>
                <%= fex.getE01FEOCUN()%>- 
                <input type="hidden" name="D01FEOCP1"  value="<%= fex.getD01FEOCP1()%>" readonly>
          ...
          <tr id="trclear">
            ...
            <td nowrap colspan="3" width="85%" >
              <input type="hidden" name="D01FEOCP2"  value="<%= fex.getD01FEOCP2()%>" readonly>
              <%= fex.getD01FEOCP2()%></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="15%" > 
            ...
            <td nowrap colspan="3" width="85%" ><%= fex.getD01FEOCP3()%> 
             </td>
          </tr>
        </table>
      </td>
...
<input type="hidden" name="D01FEOCP3"  value="<%= fex.getD01FEOCP3()%>" readonly>
