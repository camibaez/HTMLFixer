...
<h3 align="center"><%= !currUser.getH01WK3().equals("1") ?"Overnight Funds ":"Federal Funds "%>- Back Office<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fe_ffs.jsp,EDL0130B"></h3>
<hr size="4">
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trclear">
            ...
            <td nowrap width="21%" > <% if(deal.getE11DLSSBT().equals("SL")) out.print("Sale");
						else out.print("Purchase");%>
      ...
      <td nowrap width="32%" >
        <div align="center">
          ...
          <input type="text" name="E11OFFCO1" size="25" maxlength="25"  value="<%= deal.getE11OFFCO1().trim()%>"
                  oncontextmenu="showPopUp(conceptHelp,this.name,document.forms[0].E11DEABNK.value,'','E11OFFGL1','E11OFFOP1','FF')">
        </div>
      </td>
      <td nowrap width="14%" >
        <div align="center">
