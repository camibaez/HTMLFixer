...
<H3 align="center">Export Comercial Letter Of Credit Approval Inquiry  [Basic Information]
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_opening_import.jsp, ELC0525"></H3>
<HR size="4">
<FORM>
...
<TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF4" disabled>
      <OPTION value=""></OPTION>
      <OPTION value="C" <%if (msg050001.getE01LCMAF4().equals("C")) out.print("selected");%>>CIF</OPTION>
      <OPTION value="A" <%if (msg050001.getE01LCMAF4().equals("A")) out.print("selected");%>>DDA</OPTION>
    </SELECT>
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT name="E01LCMAB5" type="text" value="<%=msg050001.getE01LCMAB5()%>" size="2" maxlength="2" readonly="readonly">
      Zip Code :
      <INPUT name="E01LCMAB6" type="text" value="<%=msg050001.getE01LCMAB6()%>" size="11" maxlength="10" readonly="readonly">
      Country : 
