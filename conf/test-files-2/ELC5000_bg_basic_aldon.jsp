...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.bolgaran.JSELC5000">
    ...
    <tr id=trdark>
		...
		<%if(userPO.getPurpose().equals("MAINTENANCE")){	%>
          ...
          %>
              ...
              <a href="javascript:GetBranch('E01LCMBRN','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"  ></a>
          <%
            }
          %>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr id=trdark>
        ...
        <td nowrap> 
    		...
    		<a href="javascript:GetCustomerDescId('E01LCMCUN','E01APLNME','E01APLRUT')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a>
    	</td>
    ...
    <tr id=trdark>
       ...
       <td>           
           ...
           <a href="javascript:GetAccByClient('E01LCMAPA',document.forms[0].E01LCMBNK.value,'RT','',document.forms[0].E01LCMCUN.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a> 
       </td>
       <td> 
       ...
       <td nowrap> 
           ...
           <a href="javascript:GetCreditLine2('E01LCMCMN',document.forms[0].E01LCMLNR.value,document.forms[0].E01LCMPRO.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absmiddle" border="0" ></a> 
       </td>                       
    </tr>
  </table>
 </td>
    ...
    <tr id=trdark>
            ...
            <td> 
        		<input size="15" type="text" name="E01LCMBCU" maxlength="10" value="<%=bolgaran.getE01LCMBCU()%>">
      		    <a href="javascript:GetCustomerDescId('E01LCMBCU','E01BNFNME','E01BNFRUT')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a>
      		</td>
            <td align=right nowrap>Identificaci&oacute;n :</td>
            <td> 
    ...
    <tr id=trdark>
     ...
     <tr id=trclear>
       ...
       <td>
            ...
            <a href="javascript:GetAccByClient('E01LCMBAC',document.forms[0].E01LCMBNK.value,'RT','',document.forms[0].E01LCMBCU.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a> 
       </td> 
 ...
 <h4>Datos Emisión</h4>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td><INPUT type="text" name="E01LCMOAM" maxlength="15" size="16" onkeypress="enterDecimal()" value="<%=bolgaran.getE01LCMOAM()%>"> </td>
      <td align=right nowrap>Gastos Notaría :</td>
      <td><INPUT type="text" name="E01LCMC12" onkeypress="enterDecimal()" maxlength="15" size="16" value="<%=bolgaran.getE01LCMC12()%>"></td>
    </tr>
    <tr id=trclear>
      <td align=right nowrap>Monto Boleta :</td>
      <td><INPUT type="text" name="E01LCMC10" maxlength="15" size="16" onkeypress="enterDecimal()" value="<%=bolgaran.getE01LCMC10()%>"> </td>
      <td align=right nowrap>Tasa Interes :</td>
      <td><INPUT type="text" name="E01LCMIRT" onkeypress="enterDecimal()" maxlength="9" size="10" value="<%=bolgaran.getE01LCMIRT()%>"></td>
    </tr>
    <tr id=trdark>
...
--%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr id=trdark>
      ...
      <td width="25%"></td>
      <td>Fecha Valor &nbsp;&nbsp;&nbsp; <input type="text" name="E01FECVAD" size="2" maxlength="2" value="<%= bolgaran.getE01FECVAD() %>"><input type="text" name="E01FECVAM" size="2" maxlength="2" value="<%= bolgaran.getE01FECVAM() %>"><input type="text" name="E01FECVAY" size="2" maxlength="2" value="<%= bolgaran.getE01FECVAY() %>"></td>
    </tr>
    <tr id=trdark>
    ...
    <tr id=trclear>
      ...
      <td align=left>
      		<INPUT type="radio" name="F01LCMEVF" value="Y" onClick="renAuto(0)" <% if (bolgaran.getF01LCMEVF().equals("Y")) out.print("checked"); %>> Si
			<INPUT type="radio" name="F01LCMEVF" value="N" onClick="renAuto(1)" <% if (bolgaran.getF01LCMEVF().equals("N")) out.print("checked"); %>> No
      </td>
    ...
    <tr id=trdark>
      ...
      <td align=left>
          <INPUT type="radio" name="F01LCMFDI" value="Y" onClick="planDisminDis(1)" <% if (bolgaran.getF01LCMFDI().equals("Y")) out.print("checked"); %>> Si
          <INPUT type="radio" name="F01LCMFDI" value="N" onClick="planDisminDis(0)" <% if (bolgaran.getF01LCMFDI().equals("N")) out.print("checked"); %>> No
      </td>
      <td nowrap colspan="2"><INPUT type="button" name="actualizar" value="Actualizar" onClick="enviar(310);" id="EIBSBTN"<% if (bolgaran.getF01LCMFDI().equals("N")) out.print(" disabled"); %>></td>
    </tr>
  </table>
</td>
  </tr>
