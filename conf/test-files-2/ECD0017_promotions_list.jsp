...
%>
<BODY>
<h3 align="center">Promotions Control<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="promotions_list.jsp, ECD0017"> </h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSECD0017" >
	...
	filter:progid:DXImageTransform.Microsoft.dropshadow(OffX=3, OffY=3, Color='gray', Positive='true');">
      <tr id="trdark"> 
        ...
        <td align=CENTER width="34%"> 
          <div align="left"> 
            <input type="text" name="E01CDRTPL"  size="3" maxlength="2" value="" >
            <a href="javascript:GetDescATMCard('E01CDRTPL','','D')">
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%"><div align="center">Card Type</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Initial Date</div></th>
            <th align=CENTER nowrap width="10%"><div align="center"> Final Date</div></th>
            <th align=CENTER nowrap width="10%"><div align="center">Points</div></th>
            <th align=CENTER nowrap width="20%"><div align="center">Amount</div></th>
          </tr>
     	<%
        appList.initRow(); 
        ...
        while (appList.getNextRow()) {
           ...
           datapro.eibs.beans.ECD0017DSMessage msgPart = (datapro.eibs.beans.ECD0017DSMessage) appList.getRecord();
     	%>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01CDPCOD())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01CDPDSC())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01CDPTPL())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01CDPINI().substring(3,5) + "/" + msgPart.getE01CDPINI().substring(1,3) + "/" + msgPart.getE01CDPINI().substring(0,1))%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01CDPFIN().substring(3,5) + "/" + msgPart.getE01CDPFIN().substring(1,3) + "/" + msgPart.getE01CDPFIN().substring(0,1))%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01CDPPTO())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgPart.getE01CDPMTO())%></TD>
		</TR>    		
    	<%}%>    
        </table>
    </table>
