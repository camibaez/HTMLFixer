...
<h3 align="center"> Account Holders Information<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_inq_tit.jsp,EDL0160"></h3>
<hr size="4">
              ...
              <div align="center"> 
                <input type="text" name="E06TY<%= name %>" size="20"  maxlength="15" 
				  value="<% if (cdTit.getField("E06TY"+name).getString().trim().equals("B")) out.print("Beneficiary");
							...
							else if (cdTit.getField("E06TY"+name).getString().trim().equals("O")) out.print("Guarantor");
