...
%> 
<h3 align="center">Special Codes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_codes.jsp,ECC0010" ></h3> 
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02BUC','D02BUC','12')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%"> 
          ...
          <tr id="trclear"> 
            <td nowrap width="30%"> 
              <div align="right">Portfolio Grade :</div>
            </td>
            <td nowrap width="70%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCallReport('E02UC4','D02UC4')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a>
           </td>
          </tr>
		</table>
      </td>
