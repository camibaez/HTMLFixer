          ...
          <td nowrap>
            <table cellpadding=2 cellspacing=0 width="100%" border="0">
              ...
              <tr id="trclear">
                ...
                <td nowrap >
                  <div align="center">
                    <input type="text" name="E01CAMPSF" size="10" maxlength="9" value="<%= cam.getE01CAMPSF()%>">
                  </div>
                </td>
                <td nowrap >
                ...
                <td nowrap >
                  <div align="left">
                    <input type="text" name="E01CAMERM" size="2" maxlength="2" value="<%= cam.getE01CAMERM().trim()%>" onKeyPress="enterInteger()">
                    <input type="text" name="E01CAMERD" size="2" maxlength="2" value="<%= cam.getE01CAMERD().trim()%>" onKeyPress="enterInteger()">
                    <input type="text" name="E01CAMERY" size="2" maxlength="2" value="<%= cam.getE01CAMERY().trim()%>" onKeyPress="enterInteger()">
                    <a href="javascript:DatePicker(document.forms[0].E01CAMERM,document.forms[0].E01CAMERD,document.forms[0].E01CAMERY)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"></a></div>
                </td>
              </tr>
              <tr id="trdark">
                <td nowrap >
                ...
                <td nowrap >
                  <div align="center">
                    <input type="text" name="E01CAMSTM" size="2" maxlength="1" value="<%= cam.getE01CAMSTM()%>">
                    (F%) </div>
                </td>
                <td nowrap >
                  <div align="center">
                    <input type="text" name="E01CAMMSF" size="10" maxlength="9" value="<%= cam.getE01CAMMSF()%>">
                  </div>
                </td>
                <td nowrap >
              ...
              <tr id="trclear">
                ...
                <td nowrap >
                  <div align="center">
                    <input type="text" name="E01CAMYSF" size="10" maxlength="9" value="<%= cam.getE01CAMYSF()%>">
                  </div>
                </td>
                <td nowrap >
              ...
              <tr id="trclear">
                ...
                <td nowrap >
                  <input type="text" name="E01CAMXSC" size="10" maxlength="9" value="<%= cam.getE01CAMXSC()%>">
                </td>
                <td nowrap >&nbsp;</td>
                <td nowrap >
                ...
                <td nowrap >
                  <div align="left">
                    <input type="text" name="E01CAMISC" size="10" maxlength="9" value="<%= cam.getE01CAMISC()%>">
                  </div>
                </td>
              </tr>
              <tr id="trdark">
                ...
                <td nowrap >
                  <input type="text" name="E01CAMLWT" size="10" maxlength="9" value="<%= cam.getE01CAMLWT()%>"
          ...
          <td nowrap>
            <table cellpadding=2 cellspacing=0 width="100%" border="0">
              <tr id="trdark">
                ...
                <td nowrap >
                  <div align="left">
                    <input type="text" name="E01CAMCCN" size="21" maxlength="20" value="<%= cam.getE01CAMCCN()%>">
                  </div>
                </td>
                <td nowrap >
              ...
              <tr id="trclear">
                ...
                <td nowrap >
                  <div align="left">
                    <input type="text" name="E01CAMCCL" size="15" maxlength="13" value="<%= cam.getE01CAMCCL()%>">
                  </div>
                </td>
                <td nowrap >
                ...
                <td nowrap >
                  <div align="left">
                    <input type="text" name="E01CAMCCB" size="15" maxlength="13" value="<%= cam.getE01CAMCCB()%>">
                  </div>
                </td>
              </tr>
              <tr id="trdark">
                ...
                <td nowrap >
                  <div align="left">
                    <input type="text" name="E01CAMCCR" size="12" maxlength="11" value="<%= cam.getE01CAMCCR()%>">
                  </div>
                </td>
                <td nowrap >
                ...
                <td nowrap >
                  <div align="left">
                    <input type="text" name="E01CAMCCI" size="15" maxlength="13" value="<%= cam.getE01CAMCCI()%>">
                  </div>
                </td>
              </tr>
            </table>
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">
            <td nowrap >
              <div align="center">
                <input type="text" name="E01CAMPRI" size="17" maxlength="15"  value="<%= userPO.getHeader1()%>" readonly>
              </div>
            </td>
            <td nowrap >
            ...
            <td nowrap >
              <div align="center">
                <input type="text" name="E01CAMLNS" size="17" maxlength="15" value="<%= cam.getE01CAMSACL()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trclear">
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMITAL" size="10" maxlength="9" value="<%= cam.getE01CAMITAL()%>">
              </div>
            </td>
            <td nowrap >
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMTMOL" size="8" maxlength="7" value="<%= cam.getE01CAMTMOL()%>">
              </div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMER1L" size="2" maxlength="2" value="<%= cam.getE01CAMER1L().trim()%>" onKeyPress="enterInteger()">
                <input type="text" name="E01CAMER2L" size="2" maxlength="2" value="<%= cam.getE01CAMER2L().trim()%>" onKeyPress="enterInteger()">
                <input type="text" name="E01CAMER3L" size="2" maxlength="2" value="<%= cam.getE01CAMER3L().trim()%>" onKeyPress="enterInteger()">
                <a href="javascript:DatePicker(document.forms[0].E01CAMER1L,document.forms[0].E01CAMER2L,document.forms[0].E01CAMER3L)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"></a>
              </div>
            </td>
            <td nowrap >
          ...
          <tr id="trdark">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMMLAL" size="10" maxlength="9" value="<%= cam.getE01CAMMLAL()%>">
              </div>
            </td>
            <td nowrap >
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01MINBAL" size="10" maxlength="9"  readonly>
              </div>
            </td>
          </tr>
          <tr id="trclear">
          ...
          <tr id="trdark">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMMPAL" size="15" maxlength="13" value="<%= cam.getE01CAMMPAL()%>">
              </div>
            </td>
            <td nowrap >
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMNIPL" size="5" maxlength="3" value="<%= cam.getE01CAMNIPL()%>" >
                (*)</div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap colspan="3" >
              <div align="left">
                <input type="text" name="E01CAMRK1L" size="71" maxlength="70" value="<%= cam.getE01CAMRK1L()%>" >
              </div>
            </td>
          </tr>
          <tr id="trdark">
            ...
            <td nowrap colspan="3" >
              <div align="left">
                <input type="text" name="E01CAMRK2L" size="71" maxlength="70" value="<%= cam.getE01CAMRK2L()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear">
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">
            <td nowrap >
              <div align="center">
                <input type="text" name="E01CAMPRIL" size="17" maxlength="15"  value="<%= userPO.getHeader1()%>" readonly>
              </div>
            </td>
            <td nowrap >
              <div align="center"><img src="<%=request.getContextPath()%>/images/left2.gif"  align="absbottom" border="0"></div>
            ...
            <td nowrap >
              <div align="center">
                <input type="text" name="E01CAMLNS2" size="17" maxlength="15" value="<%= cam.getE01CAMSACS()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trclear">
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMUPTS" size="10" maxlength="9" value="<%= cam.getE01CAMUPTS()%>">
              </div>
            </td>
            <td nowrap >
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMLWTS" size="10" maxlength="9" value="<%= cam.getE01CAMLWTS()%>">
              </div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMER1S" size="2" maxlength="2" value="<%= cam.getE01CAMER1S().trim()%>" onKeyPress="enterInteger()">
                <input type="text" name="E01CAMER1S" size="2" maxlength="2" value="<%= cam.getE01CAMER2S().trim()%>" onKeyPress="enterInteger()">
                <input type="text" name="E01CAMER3S" size="2" maxlength="2" value="<%= cam.getE01CAMER3S().trim()%>" onKeyPress="enterInteger()">
                <a href="javascript:DatePicker(document.forms[0].E01CAMER1S,document.forms[0].E01CAMER2S,document.forms[0].E01CAMER3S)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"></a>
              </div>
            </td>
            <td nowrap >
              <div align="right">Relation Status :</div>
          ...
          <tr id="trdark">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMITAS" size="10" maxlength="9" value="<%= cam.getE01CAMITAS()%>">
              </div>
            </td>
            <td nowrap >
              <div align="right">In Multiples of :</div>
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMTMOS" size="8" maxlength="7" value="<%= cam.getE01CAMTMOS()%>">
              </div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01MINBA1" size="15" maxlength="13" >
              </div>
            </td>
            <td nowrap >
              <div align="right"></div>
          ...
          <tr id="trdark">
            ...
            <td nowrap colspan="3" >
              <div align="left">
                <input type="text" name="E01CAMRK1S" size="71" maxlength="70" value="<%= cam.getE01CAMRK1S()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap colspan="3" >
              <div align="left">
                <input type="text" name="E01CAMRK2S" size="71" maxlength="70" value="<%= cam.getE01CAMRK2S()%>" >
              </div>
            </td>
          </tr>
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear">
            <td nowrap >
              <div align="center">
                <input type="text" name="E01CAMPRID" size="17" maxlength="15" value="<%= userPO.getHeader1()%>" readonly>
              </div>
            </td>
            <td nowrap >
              <div align="center"><img src="<%=request.getContextPath()%>/images/left2.gif"  align="absbottom" border="0"></div>
...
<br>
      ...
      <td nowrap>
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMUPTT" size="10" maxlength="9" value="<%= cam.getE01CAMUPTT()%>">
              </div>
            </td>
            <td nowrap >
              <div align="right">Primary Account Min/Bal :</div>
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01MINBA2" size="10" maxlength="9">
              </div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMER1T" size="2" maxlength="2" value="<%= cam.getE01CAMER1T().trim()%>" onKeyPress="enterInteger()">
                <input type="text" name="E01CAMER2T" size="2" maxlength="2" value="<%= cam.getE01CAMER2T().trim()%>" onKeyPress="enterInteger()">
                <input type="text" name="E01CAMER3T" size="2" maxlength="2" value="<%= cam.getE01CAMER3T().trim()%>" onKeyPress="enterInteger()">
          ...
          <tr id="trdark">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMITAT" size="10" maxlength="9" value="<%= cam.getE01CAMITAT()%>">
              </div>
            </td>
            <td nowrap >
              <div align="right">In Multiples of :</div>
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMTMOT" size="8" maxlength="7" value="<%= cam.getE01CAMTMOT()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMCDRT" size="12" maxlength="11" value="<%= cam.getE01CAMCDRT()%>">
              </div>
            </td>
            <td nowrap >
            ...
            <td nowrap >
              <div align="left">
                <input type="text" name="E01CAMPOMT" size="2" maxlength="1" value="<%= cam.getE01CAMPOMT()%>">
                (+/-)</div>
            </td>
          </tr>
          <tr id="trdark">
            ...
            <td nowrap >
              <input type="text" name="E01CAMCDDT" size="4" maxlength="3" value="<%= cam.getE01CAMCDDT()%>">
            </td>
            <td nowrap >
              <div align="right">CD Investment Rate Table :</div>
            </td>
            <td nowrap >
              <input type="text" name="E01CAMCDTT" size="3" maxlength="1" value="<%= cam.getE01CAMCDTT()%>">
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap >
          ...
          <tr id="trdark">
            ...
            <td nowrap colspan="3" >
              <div align="left">
                <input type="text" name="E01CAMRK1T" size="71" maxlength="70" value="<%= cam.getE01CAMRK1T()%>" >
              </div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap colspan="3" >
              <div align="left">
                <input type="text" name="E01CAMRK2T" size="71" maxlength="70" value="<%= cam.getE01CAMRK2T()%>" >
              </div>
            </td>
          </tr>
  ...
  <h3 align="center">Set - Up Account Relationship</h3>
    ...
    <tr>
      ...
      <td  width="33%">
        <div align="center"><a href="javascript:showRetAccountInq(document.forms[0].E01CAMPAC.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" alt="Help" border="0" >
          Account Number : </a>
          <input type="text" name="E01CAMPAC" size="12" maxlength="9" value="<%= cam.getE01CAMPAC()%>"
		  onChange="javascript:GetPrimNumber();">
          <a href="javascript:GetAccount('E01CAMPAC','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"></a></div>
      </td>
      <td  width="33%" >
    ...
    <tr>
      <td width="33%">
        <div align="center"><a href="javascript:showLoanInq(document.forms[0].E01CAMSACL.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" alt="Help" border="0" >
          Loan Number : </a>
          <input type="text" name="E01CAMSACL" size="12" maxlength="9" value="<%= cam.getE01CAMSACL()%>">
          <a href="javascript:GetAccount('E01CAMSACL','','10','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"></a></div>
      </td>
      <td  width="33%">
      ...
      <td  width="33%">
        <div align="center"> <a href="javascript:showRetAccountInq(document.forms[0].E01CAMSACS.value)"><img src="<%=request.getContextPath()%>/images/aquire.gif" alt="Help" border="0" >
          Account Number : </a>
          <input type="text" name="E01CAMSACS" size="12" maxlength="9" value="<%= cam.getE01CAMSACS()%>">
          <a href="javascript:GetAccount('E01CAMSACS','','04','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"></a></div>
      </td>
    </tr>
  </table>
  <br>
