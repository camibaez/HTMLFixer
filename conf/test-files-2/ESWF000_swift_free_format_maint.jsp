...
%> 
<h3 align="center"> SWIFT Free Formats<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="swift_free_format_maint.jsp,ESWF000"> 
</h3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSESWF010" >
  <p> 
    <input type=HIDDEN name="SCREEN" value="8">
    <input type=HIDDEN name="ESW2ACC" value="<%= swff.getESW2ACC()%>">
  </p>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="ESW2REF" size="17" maxlength="16" value="<%= swff.getESW2REF()%>" readonly>
            </td>
            <td nowrap width="26%" > 
              <div align="right">Swift Format:</div>
            </td>
            <td nowrap > 
              <INPUT type="text" name="ESW2FMT" size="15" maxlength="15" value="<%= swff.getESW2FMT()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="27%" > 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="ESW2RLR" size="17" maxlength="16" value="<%= swff.getESW2RLR()%>" readonly>
            </td>
            <td nowrap width="26%" > 
              <div align="right"></div>
            </td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" bordercolor="#FFFFFF">
    <tr bgcolor="#FFFFFF"> 
      <td width="33%"> 
        <div align="center"> 
          <input type="checkbox" name="H02WK2" value="1" >
