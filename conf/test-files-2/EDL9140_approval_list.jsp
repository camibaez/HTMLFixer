...
<INPUT TYPE=HIDDEN NAME="reason" VALUE="">
 <INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  ...
  <h3 align="center"> Approval of Deals <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="approval_list.jsp,EDL0140"> 
  </h3>
<hr size="4">
   ...
   <TD nowrap ALIGN="RIGHT" valign="top">
     ...
     <Table id="tbAddInfo"  >
      <tr id="trclear" >
         ...
         <b>Narrative : <br>Principal : <br>Currency : <br>Bank : <br>Branch : <br>
         Gral. Ledger : <br>Cost Center : <br>Batch : <br>User : <br>Commercial Code : <br>IBF : 
         <%
