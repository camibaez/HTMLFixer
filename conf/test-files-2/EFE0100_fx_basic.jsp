...
<%
 ...
 String typ = "";
 if (msgBasic.getE01FEGTYP().equals("FWR")) {
 	typ = "53";
 } else if (msgBasic.getE01FEGTYP().equals("SPT")) {
 	typ = "51";
 }  else if (msgBasic.getE01FEGTYP().equals("OPT")) {
 	typ = "57";
 }  else if (msgBasic.getE01FEGTYP().equals("SWP")) {
 	typ = "55";
 }
%>
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="14%">
              <div align="right">Non Deliverrable Forward :</div>
            </td>
            <td nowrap width="20%">
             <input type="radio" name="E01FEGNDF" value="Y" <%if(!msgBasic.getE01FEGNDF().equals("N")) out.print("checked");%>>Yes
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="25%">
              ...
              <a href="javascript:GetLedger('E01FEGPGL',document.forms[0].E01FEGBNK.value,document.forms[0].E01FEGCCY.value,'<%= typ%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
            <td nowrap width="50%">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="25%">
              ...
              <a href="javascript:GetLedger('E01FEGSGL',document.forms[0].E01FEGBNK.value,document.forms[0].E01FEGCCY.value,'<%= typ%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
            <td nowrap width="50%">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="25%">
              <input type="text" name="E01FEGST1" size="13" maxlength="12" value="<%= msgBasic.getE01FEGST1().trim()%>" onkeypress="enterInteger()">
              <a href="javascript:GetLedger('E01FEGST1',document.forms[0].E01FEGBNK.value,document.forms[0].E01FEGCCY.value,'51')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
            <td nowrap width="50%">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="25%">
              <input type="text" name="E01FEGSC1" size="13" maxlength="12" value="<%= msgBasic.getE01FEGSC1().trim()%>" onkeypress="enterInteger()">
              <a href="javascript:GetLedger('E01FEGSC1',document.forms[0].E01FEGBNK.value,document.forms[0].E01FEGCCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
            <td nowrap width="50%">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="25%">
              <input type="text" name="E01FEGST2" size="13" maxlength="12" value="<%= msgBasic.getE01FEGST2().trim()%>" onkeypress="enterInteger()">
              <a href="javascript:GetLedger('E01FEGST2',document.forms[0].E01FEGBNK.value,document.forms[0].E01FEGCCY.value,'51')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
            <td nowrap width="50%">
          ...
          <tr id="trclear">
            ...
            <td nowrap width="25%">
              <input type="text" name="E01FEGSC2" size="13" maxlength="12" value="<%= msgBasic.getE01FEGSC2().trim()%>" onkeypress="enterInteger()">
              <a href="javascript:GetLedger('E01FEGSC2',document.forms[0].E01FEGBNK.value,document.forms[0].E01FEGCCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            </td>
            <td nowrap width="50%">
    ...
    <tr >
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            <td nowrap width="25%">
              <div align="right"><%=msgBasic.getE01FEGTYP().equals("FWR")?"Accrual Receivable :":"Profit for Contracts :"%></div>
            </td>
            <td nowrap width="25%">
          ...
          <tr id="trclear">
            <td nowrap width="25%">
              <div align="right"><%=msgBasic.getE01FEGTYP().equals("FWR")?"Profit for Contracts :":"Losses for Contracts :"%></div>
            </td>
            <td nowrap width="25%">
           ...
           <% if (msgBasic.getE01FEGTYP().trim().equals("FWR")) { %>
           <tr id="trdark">
           	<td nowrap>
           		<div align="right">Accrual Payable :</div>
           	</td>
           	<td nowrap>
           	<INPUT type="text" name="E01FEGX03" size="13"
					maxlength="12" value="<%= msgBasic.getE01FEGX03().trim()%>"
           ...
           <tr id="trclear">
           	...
           	<td nowrap>
           	<INPUT type="text" name="E01FEGX04" size="13"
					maxlength="12" value="<%= msgBasic.getE01FEGX04().trim()%>"
					onkeypress="enterInteger()"><A
