...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.security.JSESS0240" >
  ...
  <h3 align="center">Database Access<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="db_access_enter.jsp, ESS0240"> 
  </h3>
  <hr size="4">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
      ...
      <td> 
        <table id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
          ...
          <tr align="center"> 
            ...
            <td nowrap> 
				<div align="left">&nbsp;Certificates of Deposit</div>
            </td>
          </tr>
          <tr align="center"> 
            <td nowrap align="right"> 
          ...
          <tr align="center"> 
            ...
            <td nowrap> 
				<div align="left">&nbsp;Investments</div>
            </td>
          </tr>
          <tr align="center"> 
            <td nowrap align="right"> 
            ...
            <td nowrap> 
				<div align="left">&nbsp;Stop Payments</div>
            </td>
          </tr>
          ...
          <tr align="center"> 
            ...
            <td nowrap> 
				<div align="left">&nbsp;Letters of Credit</div>
            </td>
          </tr>
          <tr align="center"> 
            <td nowrap align="right"> 
            ...
            <td nowrap> 
				<div align="left">&nbsp;Others (Beneficiaries, Signers, Mailing Address, etc.)</div>
            </td>
          </tr>  
        </table>
      </td>
      ...
      <td> 
        <table id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
          ...
          <tr align="center"> 
            ...
            <td nowrap> 
				<div align="left">&nbsp;Maintenance</div>
            </td>
          </tr>
        </table>
      </td>
