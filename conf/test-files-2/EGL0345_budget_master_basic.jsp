...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEGL0345">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap  > 
              <div align="right"><b>Budget Account :</b></div>
            </td>
            <td nowrap > 
              <div align="left"> 
    ...
    <tr > 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            <td nowrap  > 
              <div align="right"><b>Budget Description :</b></div>
            </td>
            <td nowrap > 
              <div align="left"> 
  ...
  <h4>Budget Amount for Months</h4>
  <table class="tableinfo">
    <tr > 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            <td nowrap  > 
              <div align="right"><b>January :</b></div>
            </td>
            <td nowrap > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap  > 
              <div align="right"><b>February :</b></div>
            </td>
            <td nowrap > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap  > 
              <div align="right"><b>August :</b></div>
            </td>
            <td nowrap > 
              <div align="left"> 
          ...
          <tr id="trdark"> 
            <td nowrap  > 
              <div align="right"><b>September :</b></div>
            </td>
            <td nowrap > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap  > 
              <div align="right"><b>October :</b></div>
            </td>
            <td nowrap > 
              <div align="left"> 
          ...
          <tr id="trdark"> 
            <td nowrap  > 
              <div align="right"><b>November :</b></div>
            </td>
            <td nowrap > 
              <div align="left"> 
          ...
          <tr id="trclear"> 
            <td nowrap  > 
              <div align="right"><b>December :</b></div>
            </td>
            <td nowrap > 
              <div align="left"> 
