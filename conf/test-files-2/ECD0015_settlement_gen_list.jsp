...
{
	page = "<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0015?SCREEN=103&ROW=" + rowNum;
	CenterWindow(page,800,600,2);
}

function PrintPreview() {

	var pg = "<%=request.getContextPath()%>/pages/e/ECD0015_settlement_gen_print.jsp";
...
%>
<BODY>
<h3 align="center">Clearing Inquiry<BR>General
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="settlement_gen_list.jsp, ECD0015">
</h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0015" >
 ...
 <TR > 
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            <th align=CENTER nowrap width="14%"><div align="center">Date</div></th>
            <th align=CENTER nowrap width="14%"><div align="center">Currency</div></th>
            <th align=CENTER nowrap width="14%"><div align="center">Original<BR>Amount
				</div></th>
            <th align=CENTER nowrap width="14%"><div align="center">Reverse<br>Amount</div></th>
            <th align=CENTER nowrap width="15%"><div align="center">Original<BR>
				Match Amount</div></th>
            <th align=CENTER nowrap width="15%"><div align="center">Reverse<br>Match Amount</div></th>
            <th align=CENTER nowrap width="14%"><div align="center">Clearin<BR>
				Amount</div></th>
          </tr>
     	<%
        genList.initRow(); 
...
<%
        if ( genList.getShowPrev() ) {
      			...
      			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.cards.JSECD0015?SCREEN=101&Pos=" + pos + "\"><IMG border=\"0\" src=\""+request.getContextPath()+"/images/s/previous_records.gif\" ></A>");
        }
  %>  
  </TD>
 ...
 <%      
        if ( genList.getShowNext() ) {
      			...
      			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.cards.JSECD0015?SCREEN=101&Pos=" + pos + "\"><IMG border=\"0\" src=\""+request.getContextPath()+"/images/s/next_records.gif\" ></A>");
        }
   %> 
   </TD>
 	</TR>
