...
function goAccept() {
	var ok = confirm("Selected Returns will be accepted ignoring warnings");
	if (!ok) return;
...
function goDelete() {
	var ok = confirm("Selected Returns will be swithed to delete or not delete");
	if (!ok) return;
...
function goProcess() {
	var ok = confirm("Do you want to process selected returns to accept and delete?");
	if (!ok) return;
...
<h3 align="center">ACH Outstanding Returns<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" 
...
<TABLE class="tbenter"> 
	<TR>
		<TD align="CENTER" class="TDBKG" width="20%">
			<a href="javascript:goInquiry(2,'0')"><b>Inquiry<br>Accounts</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="20%">
			<a href="javascript:goAccept()"><b>Accept/Send<br>Selection</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="20%">
			<a href="javascript:goDelete()"><b>Delete/Send<br>Selection</b></a>
      	</TD>
		<TD align="CENTER" class="TDBKG" width="20%">
			<a href="javascript:goProcess()"><b>Process<br>Updates</b></a>
		</TD>
	  	<TD align="CENTER" class="TDBKG" width="20%">
...
%>
 	<TABLE class="tbenter" width=100% height=30%">
 		<TR>
      <TD>         
      <div align="center"> <h4 style="text-align:center">There are no returns.</h4> 
      </div>
      </TD></TR>
   	</TABLE>
<%
...
%>    
  ...
  <TABLE class="tableinfo" id="dataTable">
    ...
    <TR id=trdark>
		...
		<td NOWRAP align="center" width="5%"><b>Return<br>Nr.</b></td>
		<td NOWRAP align="center" width="5%"><b>Status</b></td>
		<td NOWRAP align="center" width="8%"><b>Value<br>Valor</b></td>
		<td NOWRAP align="center" width="10%"><b>Customer<br>Nr.</b></td>
		<td NOWRAP align="center" width="15%"><b>Name</b></td>
		<td NOWRAP align="center" width="10%"><b>Account</b></td>
		<td NOWRAP align="center" width="10%"><b>Amount</b></td>
		<td NOWRAP align="center" width="15%"><b>Transaction</b></td>
		<td NOWRAP align="center" width="20%"><b>Reason</b></td>
	</TR>
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25">
       <%
    	if ( EACH360List.getShowPrev() ) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH360?SCREEN=1&FromRecord=" + pos + "\" > <img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
    	} %>
      </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> 
    	...
    	if (EACH360List.getShowNext()) {
  			...
  			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.ach.JSEACH360?SCREEN=1&FromRecord=" + pos +  "\" ><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
	    } %>
  </TD>
 </TR>
 </TABLE>
