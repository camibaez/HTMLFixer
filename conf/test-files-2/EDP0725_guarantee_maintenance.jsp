...
<H3 align="center">Maintenance Guarantee<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="guarantee_maintenance.jsp, EDP0725"></H3>
...
<% } %>
  ...
  <h4><% if(userPO.getHeader16().equals("2")){out.print("Modify Guarantee");} else {out.print("Create Guarantee"); } %> </h4> 
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap align="center"> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td nowrap width="16%" height="19"> 
              <div align="right">Guarante Type:</div>
            </td>
 		 ...
 		 <tr id="trclear"> 
            <td nowrap width="5%" height="19" align="right">Identification Guarantee :
         	</td>
          
            <td nowrap height="19" width="55%">	
      	      <input type="text" name="E01DPCIDN" size="5" maxlength="4" value="<%= l0725.getE01DPCIDN().trim()%>"
			  <% if((userPO.getHeader16().equals("3"))||(userPO.getHeader16().equals("4"))){out.print("readonly");}%>>	  
      	      <a href="javascript:GetCodeAuxCNOFCPC('E01DPCIDN','56',document.forms[0].E01DPCTYP.value)">
      	      <img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" ></a>
      	      <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="absbottom" border="0" width="16" height="20">
		  ...
		  <tr id="trclear"> 
            <td nowrap width="16%" height="23"> 
              <div align="right">Aditional Description:</div>
            </td>
            <td nowrap height="23" colspan="1" width="372"> 					
 		 ...
 		 <tr id="trclear"> 
            <td nowrap width="5%" height="19" align="right">Guarantee Number:</td>
 		 ...
 		 <tr id="trdark"> 
            <td nowrap width="5%" height="19" align="right">Guarantee Reference:</td>
		...
		<% if(!l0725.getE01DPCP00().equals("")){%>
          <tr id="trclear"> 
            <td nowrap width="5%" height="19" align="right">Product to Guarantee:</td>
            <td nowrap >
			...
			<% if((userPO.getHeader16().equals("3"))||(userPO.getHeader16().equals("4"))){out.print("readonly");} %> >
			Valor:
			<INPUT type="text" name="E01DPCA00" size="16" maxlength="16" onkeypress="enterDecimal()" value="<%= l0725.getE01DPCA00().trim()%>"
					<% if((userPO.getHeader16().equals("3"))||(userPO.getHeader16().equals("4"))){out.print("readonly");} %>>
			</td>
            <td nowrap > 
...
<TABLE id="mainTable1" class="tableinfo">
  ...
  <% if((userPO.getHeader16().equals("1"))||(userPO.getHeader16().equals("2"))){;%>
			...
			<div align="center"><a href="javascript:goActionTit(1)"><b>New</b></a></div>
			</td>
			<td class=TDBKG width="33%">
			<div align="center"><a href="javascript:goActionTit(2)"><b>Modify</b></a></div>
			</td>
			<td class=TDBKG width="33%">
			<div align="center"><a href="javascript:goActionTit(3)"><b>Delete</b></a></div>
			</td>
	<%} %> 
		</tr>
</table>
	...
	<TD NOWRAP width="100%">
		<TABLE id="headTable1">
			<tr id="trdark">
				...
				<div align="right">Date Record</div>
				</th>
				<th align=CENTER nowrap width="25%">
				<div align="right">% Participation</div>
				</th>
			</tr>
		</TABLE>
      ...
      <td nowrap height="306">
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan=2>
                <INPUT type="text" name="E01DPICIN" size="13" maxlength="12" value="<%= l0725.getE01DPICIN().trim()%>"
			<% if((userPO.getHeader16().equals("3"))||(userPO.getHeader16().equals("4"))){out.print("readonly");} %> >
                   <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="absbottom" border="0" width="16" height="20"  >
            </td>
            <td nowrap> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap colspan=2>
              ...
              <input type="text" name="E01DPIICY" size="5" maxlength="4" value="<%= l0725.getE01DPIICY().trim()%>" 
				<% if((userPO.getHeader16().equals("3"))||(userPO.getHeader16().equals("4"))){out.print("readonly");} %> >
					 <% if((!userPO.getHeader16().equals("3"))||(!userPO.getHeader16().equals("4"))){ %>
						<a href="javascript:GetCurrency('E01DPIICY','<%= userPO.getBank()%>')">
          ...
          <tr id="trdark"> 
            <td nowrap> 
                <div align="right">Expiration Notice :</div>
            </td>
              <td nowrap colspan=2>
            ...
            <td nowrap> 
                <div align="right">Bank/Endorses:</div>
            </td>
            <td nowrap colspan=2>
          ...
          <tr id="trclear">
            ...
            <TD colspan=2>
               <INPUT type="text" name="E01DPICRR" size="5" maxlength="4" value="<%= l0725.getE01DPICRR().trim()%>"
					<% if((userPO.getHeader16().equals("3"))||(userPO.getHeader16().equals("4"))){out.print("readonly");} %> >
					<% if((userPO.getHeader16().equals("1"))||(userPO.getHeader16().equals("2"))){ %> 
                <a href="javascript:GetCodeDescCNOFCPC('E01DPICRR','E01DPINCO','2M')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"  ></a>
                   <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="absbottom" border="0" width="16" height="20"  >
                  <% } %>
            </TD>
