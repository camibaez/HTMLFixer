...
<body>
<h3 align="center">Stock
Control<BR>Maintenance
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_stock_maint.jsp, ECD0006"> 
</h3>
<hr size="4">
<% 
...
%> 
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0006" >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
				...
				<a href="javascript:GetDescATMCard('E06CDRTPL','','D')">
