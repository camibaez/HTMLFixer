...
<body>
<h3 align="center">Documentary Collections Approval<BR>Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="doc_approval_inq.jsp, EDC0040"></h3>
<hr size="4">
	...
	<tr>
		...
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
			<TBODY><TR id="trdark">
				...
				{%>
					<input readonly  type="text" size="12" maxlength="12" value="New" readonly>
...
<h4>Drawer (Principal)</h4><table class="tableinfo">
	<tr>
		<td>
...
<H4><%= dcNew.getE01DCMTYP().trim().equals("I")?"Reimbursing":"Presenting" %> Bank </H4>
<TABLE class="tableinfo">
	<TBODY>
		<TR>
			<TD>
								...
								<TR id="trdark">
									...
									<TD nowrap width="25%"><SELECT disabled="disabled"
										...
										<OPTION value=" "
											...
											selected></OPTION>
										<OPTION value="C"
											<%if (dcNew.getE01DCMAF4().equals("C")) out.print("selected");%>>Customer</OPTION>
										<OPTION value="A"
											<%if (dcNew.getE01DCMAF4().equals("A")) out.print("selected");%>>Account</OPTION>
									</SELECT></TD>
								</TR>
							</TBODY>
						</TABLE>
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="30%"> 
             	<div align="right">Remitting Date :</div>
            </td>
            <td nowrap width="20%">  
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <TABLE cellspacing="0" cellpadding="2" width="100%" border="0">
          <TBODY>
          <TR id="trdark"> 
            <TD nowrap width="30%"><DIV align="right">Original Amount :</DIV>
			...
			<TD nowrap width="30%"> 
             	<DIV align="right">
					<DIV align="right">Foreign Exchange Rate
					:</DIV></DIV>
            </TD><TD nowrap width="20%">
		...
		<TR id="trdark"> 
			...
			<TD nowrap width="30%"> 
            	...
            	<input readonly  type="radio" name="E01DCMPTF" value="Y" <%if(dcNew.getE01DCMPTF().equals("Y")) out.print("checked");%>>Yes 
          ...
          <TR id="trclear"> 
			...
			<TD nowrap width="30%"> 
            	...
            	<input readonly  type="radio" name="E01DCMWCF" value="Y" <%if(dcNew.getE01DCMWCF().equals("Y")) out.print("checked");%>>Yes 
            	<input readonly  type="radio" name="E01DCMWCF" value="N" <%if(dcNew.getE01DCMWCF().equals("N")) out.print("checked");%>>No 
			</TD>
          </TR>
		  <TR id="trdark"> 
            <TD nowrap width="30%">
             	<DIV align="right">Avise Non Acceptance Via :</DIV>
			</TD><TD nowrap width="20%">
            ...
            <TD nowrap width="20%">
            	<input readonly  type="radio" name="E01DCMPPF" value="Y" <%if(dcNew.getE01DCMPPF().equals("Y")) out.print("checked");%>>Yes 
          ...
          <TR id="trclear"> 
            ...
            <TD nowrap width="20%">
            	<input readonly  type="radio" name="E01DCMWIF" value="Y" <%if(dcNew.getE01DCMWIF().equals("Y")) out.print("checked");%>>Yes 
			...
			<select disabled="disabled" name="E01DCMOBF">
						...
						<OPTION value="D"
							<% if (dcNew.getE01DCMOBF().equals("D")) out.println("selected"); %>>Drawee/Importer</OPTION>
						<OPTION value="P"
							<% if (dcNew.getE01DCMOBF().equals("P")) out.println("selected"); %>>Drawer/Principal</OPTION>
		   ...
		   <TR id="trclear"> 
            ...
            <TD nowrap width="20%">  
				<SELECT name="E01DCMTRC" disabled="disabled">
						...
						<OPTION value="AS"
							<% if (dcNew.getE01DCMTRC().equals("AS")) out.println("selected"); %>>At 
						Sight</OPTION>
						<OPTION value="BE"
							<% if (dcNew.getE01DCMTRC().equals("BE")) out.println("selected"); %>>After
						Bill of Exchange Date</OPTION>
						<OPTION value="BL"
							<% if (dcNew.getE01DCMTRC().equals("BL")) out.println("selected"); %>>After
						Bill of Lading Date</OPTION>
						<OPTION value="CC"
							<% if (dcNew.getE01DCMTRC().equals("CC")) out.println("selected"); %>>After
						Customs Clearance Goods</OPTION>
						<OPTION value="FD"
							<% if (dcNew.getE01DCMTRC().equals("FD")) out.println("selected"); %>>After
						Goods Pass F.D.A.</OPTION>
						<OPTION value="FP"
							<% if (dcNew.getE01DCMTRC().equals("FP")) out.println("selected"); %>>At First
						Presentation</OPTION>
						<OPTION value="GA"
							<% if (dcNew.getE01DCMTRC().equals("GA")) out.println("selected"); %>>After
						Arrival of Goods</OPTION>
						<OPTION value="ID"
							<% if (dcNew.getE01DCMTRC().equals("ID")) out.println("selected"); %>>After
						Invoice Date</OPTION>
						<OPTION value="ST"
							<% if (dcNew.getE01DCMTRC().equals("ST")) out.println("selected"); %>>After
						Sight</OPTION>
						<OPTION value="TD"
							<% if (dcNew.getE01DCMTRC().equals("TD")) out.println("selected"); %>>After
						Date of Transport Docs</OPTION>
					</SELECT>
				
			</TD>
			<TD nowrap width="30%" height="15">
             	<DIV align="right">Term (Days):</DIV>
			</TD>
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
		  ...
		  <tr id="trclear">
            ...
            <td nowrap width="20%">  
            	<input type="radio" name="E01DCMMCO" value="Y" <%if(dcNew.getE01DCMMCO().equals("Y")) out.print("checked");%> disabled="disabled">Yes 
            	<input type="radio" name="E01DCMMCO" value="N" <%if(dcNew.getE01DCMMCO().equals("N")) out.print("checked");%> disabled="disabled">No 
			</td>
		  </tr>
		  <tr id="trdark">
			<td nowrap>
             	<div align="right">Vessel Name :</div>
			</td>
            <td nowrap colspan=3>
