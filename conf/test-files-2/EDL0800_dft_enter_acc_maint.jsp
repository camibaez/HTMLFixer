...
alert("You must enter a valid Identification number.");
...
<h3 align="center">Acceptant/New Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_enter_maint,EDL0150"></h3>
<hr size="4">
<p>&nbsp;</p>
        ...
        <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
		  ...
		  <tr> 
            ...
            <td nowrap width="50%"> 
              ...
              <a href="javascript:GetAcceptantId('E01DEAACC')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a> 
            </td>
          </tr>
        </table>
      </td>
