...
%>
<h3 align="center">Board of Directors<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_corp_board, ESD0080" ></h3>
<hr size="4">
      ...
      <td>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" name="TB_BENEFICIARY_CORP" bgcolor="#FFFFFF" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF"  align="center">
          ...
          <tr id="trdark">
            ...
            <td width="58%" nowrap>
              <input type="text" name="E<%= name %>4INC" maxlength="35" size="35" value="<%= board.getField("E" + name + "4INC").getString().trim()%>">
              </td>
          </tr>
          <tr id="trclear">
            <td width="42%" nowrap >
            ...
            <td width="58%" nowrap >
              <select name="E<%= name %>4BMS" >
                <option value=1 <% if (board.getField("E" + name + "4BMS").getString().equals("1")) out.print("selected"); %>>Married</option>
                <option value=2 <% if (board.getField("E" + name + "4BMS").getString().equals("2")) out.print("selected"); %>>Single</option>
                <option value=3 <% if (board.getField("E" + name + "4BMS").getString().equals("3")) out.print("selected"); %>>Divorced</option>
                <option value=4 <% if (board.getField("E" + name + "4BMS").getString().equals("4")) out.print("selected"); %>>Widower</option>
                <option value=5 <% if (board.getField("E" + name + "4BMS").getString().equals("5")) out.print("selected"); %>>Cohabitant</option>
          ...
          <tr id="trdark">
            ...
            <td width="58%" nowrap>
              <select name="E<%= name %>4BSX" >
			    <option value="" <% if (board.getField("E" + name + "4BSX").getString().equals("")) out.print("selected"); %>></option>
                <option value="F" <% if (board.getField("E" + name + "4BSX").getString().equals("F")) out.print("selected"); %>>Female</option>
                <option value="M" <% if (board.getField("E" + name + "4BSX").getString().equals("M")) out.print("selected"); %>>Male</option>
              </select>
          </tr>
          <tr id="trclear">
            <td width="42%" nowrap>
