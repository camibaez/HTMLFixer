...
<H3 align="center">Transactions List <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="DCIBS_log_download_list.jsp, DCIBS"></H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/com.datapro.eibs.internet.JSLogTransSearch" >
	...
	<table border=0 style="border-collapse: collapse" CELLSPACING=0 CELLPADDING=0 width="100%" bgcolor="transparent" >
    	<tr>
			<td>
				<display:table  width="100%" name="lstTransactions" property="list" scope="session" export="true" decorator="datapro.eibs.beans.DC_LOGWrapper">
