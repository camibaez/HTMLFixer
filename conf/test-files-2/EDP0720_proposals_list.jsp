...
%> 
<h3 align="center">List of Proposals <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="proposals_list.jsp, EDP0720"></h3>
<hr size="4">
...
%> 
  ...
  <table class="tbenter" width=100% align=center>
    <tr> 
		...
		<td class=TDBKG width="16%">
        	<div align="center">
        		<a href="javascript:goAction(5)"><b>Inquiry</b></a>
        	</div> 
     	</td>
		...
		<td class=TDBKG width="16%">
        	<div align="center">
        		<a href="javascript:goAction(9)"><b>Next Activity</b></a>
        	</div> 
     	</td>
     	<%};%>
...
--%>      
        ...
        <table id="headTable" width="100%">
          <tr id="trdark"> 
           ...
           <th align=CENTER nowrap width="10%"> 
              <div align="center">Amount Requested/<BR>Approved</div>
           </th>  
  ...
  <%
		...
		int pos = EDP072001Help.getFirstRec() - 21;
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0720?SCREEN=200&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/previous_records.gif\" border=0></A>");
        }
  %>
  </TD>
  ...
  <%
		...
		int pos = EDP072001Help.getLastRec();
   			out.println("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.creditproposal.JSEDP0720?SCREEN=200&Pos=" + pos +"\"><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
        }
  %> 
 </TD>
 </TR>
