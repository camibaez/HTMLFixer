...
<H3 align="center">Customization of Checkbooks<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_basic.jsp, ECH0000"></H3>
    ...
    <tr bordercolor="#FFFFFF">
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark">
            <td><div align="right">Related Signature</div></td>
            <td>
            	<SELECT name="E01CHPRE1">
                            <OPTION value="Y" <% if (rtBasic.getE01CHPRE1().equals("S")) out.print("selected"); %>="" selected>YES</OPTION>
                            <OPTION value="N" <% if (rtBasic.getE01CHPRE1().equals("N")) out.print("selected"); %>="">NO</OPTION>
                        </SELECT></td>
          </tr>
          <tr id="trclear">
            <td><div align="right">Branch of Release</div></td>
            <td>
			...
			<a href="javascript:GetBranchCodeName('E01CHPDBR','DESNJMOET','01')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"  ></a>
			</td>
          </tr>
