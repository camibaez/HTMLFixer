...
<link Href="<%=request.getContextPath()%>/pages/etyle.css"
	rel="stylesheet">
...
function callDocum() {
var TABLE_NUM = document.forms[0].TABLE_NUM.value   
//alert(TABLE_NUM);
...
function goControlDoc(opt) {
    ...
    ok = confirm("Confirm advance to the next activity");
	if (ok) {
...
//	document.forms[0].submit(); 
	page = "<%=request.getContextPath()%>/servlet/datapro.eibs.creditproposal.JSEDP0720?SCREEN=800&opt="
...
//     
%>
<H3 align="center">Credito Proposal<img
...
<h4><A NAME="Miscelaneos"> Proposal</h4>
<table class="tableinfo">
	...
	out.print("checked");%>>
			   ...
			   --%></td>
				...
				<td width="50%" align="left">Status Proposal: <INPUT type="text"
			...
			<tr id="trdark">
				<td width="15%">
				<div align="right">Executive Code:</div>
				</td>
				...
				<td width="50%" align="left">Subject Credit <input type="text"
	...
	out.print("readonly");
				...
				<%if (!userPO.getHeader16().equals("5")) {%> <A
					href="javascript:GetCodeDescCNOFCPC('E01PLPCN2','E01PLPRE2','PD')"><IMG
					src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda"
			...
			<tr id="trdark">
				<td width="15%"></td>
				<td width="30%"></td>
				<td width="50%" align="left">Credit Destination <input type="text"
	...
	out.print("readonly");
				...
				<%if (!userPO.getHeader16().equals("5")) {%> <A
					href="javascript:GetCodeDescCNOFCPC('E01PLPCN3','E01PLPRE3','38')"><IMG
					src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda"
					align="bottom" border="0"> </A> <%}%> <INPUT type="text"
	...
	<tr>
		...
		<table cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<tr id="trdark">
				...
				<td width="20%">
				<div align="right">Economic Activity :</div>
				</td>
			...
			<tr id="trdark">
				<td width="20%">
				<div align="right">Date of Birth/Constitution:</div>
				</td>
...
<A NAME="producto">
<CENTER><A HREF="#Miscelaneos">Miscellaneous</A> &nbsp; |&nbsp; <A
	HREF="#producto">Product</A> &nbsp; |&nbsp; <A HREF="#recaudos">Documents</A>
&nbsp; |&nbsp; <A HREF="#comentarios">Analyst Comments</A> &nbsp;
|&nbsp;</CENTER>
...
<TABLE class="tbenter" height="20%">
	...
	<TR>
		...
		<H4 style="text-align: center">No product has been created for this proposal. <br>
		</h4>
		</TD>
	</TR>
	<tr>
		<td class=TDBKG width="20%">
		<div align="center"><a href="javascript:goActionProd(1)"><b>New</b></a></div>
		</td>
	</tr>
</TABLE>
<%} else {%>
...
<TABLE id="mainTable1" class="tableinfo">
	...
	&& (!userPO.getHeader16().equals("5"))) {%>
				<td class=TDBKG width="20%">
				<div align="center"><a href="javascript:goActionProd(1)"><b>Newo</b></a></div>
				</td>
				<%}%>
	...
	&& (!msgRT.getE01CRTEST().equals("AA"))) {%>
				<td class=TDBKG width="20%">
				<div align="center"><a href="javascript:goActionProd(2)"><b>Modify</b></a></div>
				<%}%> <%}%>
				<td class=TDBKG width="20%">
				<div align="center"><a href="javascript:goActionProd(3)"><b>Inquiry</b></a></div>
			</tr>
		</table>
	</TR>
	...
	<TR>
		...
		<TABLE id="headTable1">
			<tr id="trdark">
				...
				<div align="right">Recommended Amount</div>
				<%} else {%>
...
<CENTER><A HREF="#Miscelaneos">Miscellaneous</A> &nbsp; |&nbsp; <A
	HREF="#producto">Producto</A> &nbsp; |&nbsp; <A HREF="#recaudos">Documents</A>
&nbsp; |&nbsp; <A HREF="#comentarios">Analyst Comments</A> &nbsp;
|&nbsp;</CENTER>


<div id="SecRecaudoDocumento" style="display: none">Required Documents Section</DIV>

<A NAME="RecaudoDocumento">
<h4 align="left">Required Documents</h4>
<%--
...
<TABLE class="tableinfo" id="dataTableRD" width="100%">
	<TR id=trdark>
		...
		<TD ALIGN="center" NOWRAP width="70%"><b>Document</b></TD>
		<TD ALIGN="center" NOWRAP width="15%"><b>Check</b></TD>
		<TD ALIGN=center NOWRAP width="10%"><b>Condition</b></TD>
	</TR>
...
while (EDP073701Help.getNextRow()) {
	...
	out.print("readonly");
			...
			value="OPTIONAL" <%};%> readonly width="10%"></TD>
...
<div id="SecRegistroGarantia" style="display: none">Guarantees Section</DIV>
<h4>Guarantee Record</h4>
<%if (ga0726.getNoResult()) {%>

<TABLE class="tbenter" height="20%">
	<TR>
		<TD ALIGN=CENTER VALIGN=MIDDLE>
		<H4 style="text-align: center">No Guarantees Registration
Required for this Proposal. <br>
		</h4>
		</TD>
	</TR>
</TABLE>
...
<div id="SecDocGarantia" style="display: none">Documents Required by Guarantee</DIV>

<A NAME="Documentos Garantías">

<h4>Documents by Guarantee</h4>
...
<table class="tableinfo">
	...
	<tr id="clear">
		<TD ALIGN=CENTER width="50%" class=tdbkg><a
			href="javascript:goDOFA(1)"><b>SWOT Analysis</b></a></TD>
		<TD ALIGN=CENTER width="50%" class=tdbkg><a
			href="javascript:goDOFA(2)"><b>Financial Analysis</b></a></TD>
	</tr>
</table>
<%};%>

<h4>Application Comments</h4>
<table class="tableinfo">
	<tr id="trdark">
		<td width="100%" align="center">
		<TEXTAREA name="E02DPAC99" rows="10" cols="80" value="<%=msgRTC.getE02DPAC99().trim()%>"
...
<td class=TDBKG width="20%">
<div align="center"><a href="javascript:goRetrComm()"><b>Bring
Previous Review</b></a></div>
</td>
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
	...
	;%>
			...
			<tr id="trclear">
				...
				<td width="20%">Approved Amount: <INPUT type="text" name="E01PLPAM2"
	...
	;%>
				...
				<td width="20%">Recommended Amount : <INPUT type="text"
	...
	out.print("readonly");
				...
				<%};%>
				<%if (msgRT.getE01DPUBXX().equals("1")) {%>
				<td width="20%">Decision Date: <INPUT type="text" name="E01PLPNFD"
	...
	&& (!msgRT.getE01CRTEST().equals("AA"))) {%> <A
				...
				<%};%>
				<%if (msgRT.getE01DPUBXX().equals("1")) {%>
				<td nowrap width="20%" align="left">Number of Act: <INPUT
...
<CENTER><A HREF="#Miscelaneos">Miscellaneous</A> &nbsp; |&nbsp; <A
	HREF="#producto">Producto</A> &nbsp; |&nbsp; <A HREF="#recaudos">Documents</A>
&nbsp; |&nbsp; <A HREF="#comentarios">Analyst Comment</A> &nbsp;
|&nbsp;</CENTER>


<%if (!(userPO.getHeader16().equals("1"))) {%>

<h4>Select Next Activity:</h4>
...
while (optLP4.getNextRow()) {
	if (optLP4.getFlag().equals("")) {
		...
		<td width="10%"><INPUT type="button" value="Select"
			onclick="moveOver();"
...
<%if (!userPO.getPurpose().equals("NEW")
	...
	type="button" name="Submit0" value="Save"
	onclick="goConfirm('<%=userPO.getHeader16()%>','<%=userPO.getHeader23()%>','<%=userPO.getHeader21()%>')"
	<%if (userPO.getHeader16().equals("5")) {
	out.print("DISABLED");
}%>>
<%};%> <INPUT id="EIBSBTN" type="button" name="Cancel" value="Cancel"
