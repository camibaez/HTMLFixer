...
%>
<BODY>
<h3 align="center">Audit Inquiry<BR><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_audit_list.jsp, ECD0011"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input readonly type="text" name="E01TDDNAM" size="17" maxlength="15" value="<%= userPO.getHeader7() %>">
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input readonly type="text" name="E01TDDCED" size="17" maxlength="15" value="<%= userPO.getHeader8() %>">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input readonly type="text" name="E01TDDCUN" size="17" maxlength="15" value="<%= userPO.getHeader9() %>">
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input readonly type="text" name="E01TDDACC" size="17" maxlength="15" value="<%= userPO.getHeader10() %>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input readonly type="text" name="E01TDDTDD" size="17" maxlength="15" value="<%= userPO.getHeader11() %>">
              </div>
            </td>
            <td nowrap width="16%" > 
            </td>
    ...
    <TD NOWRAP valign="top" width="100%">
        <table id="headTable" width="100%">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="10%"><div align="center">User</div></th>
            ...
            <th align=CENTER nowrap width="20%"><div align="center">Currently<BR>
				Value 1</div></th>
            <th align=CENTER nowrap width="20%"><div align="center">Last<BR>Value 1
				</div></th>
            <th align=CENTER nowrap width="20%"><div align="center">Field 2</div></th>
            <th align=CENTER nowrap width="20%"><div align="center">Currently<BR>
				Value 2</div></th>
            <th align=CENTER nowrap width="20%"><div align="center">
				Last<BR>
				Value 2</div></th>
