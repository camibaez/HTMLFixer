...
var CusType = top.top.opener.fieldAux9;
    ...
    parent.results.window.location.href="<%=request.getContextPath()%>/pages/e/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0001D_LC?NameSearch=" + NameSearch + "@Type=" + Type + "@FromRecord=" + FromRecord + "@CusType=" + CusType + "'";

	} else {
		alert("Field in Blank");
	}
}
				...
				<tr>
					<td nowrap>
						<table  id="TBHELP" align="center" width="140" border="0" cellspacing="0" cellpadding="0">
							<tr>
                  				<th nowrap id="THHELP">Search By...</th>
							</tr>
							<tr>
								<td nowrap><input type="radio" name="Type" value="S" checked>Short Name</td>
							</tr>
							<tr>
								<td nowrap><input type="radio" name="Type" value="I">Customer ID</td>
							</tr>
							<tr>
								<td nowrap><input type="radio" name="Type" value="I">Long Name</td>
							</tr>
							<tr>
