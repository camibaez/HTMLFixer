...
<title>Vendors Help</title>
</head>
<%@ page import="datapro.eibs.master.Util" %>

<body>
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.bap.JSEWD0600&SCREEN=1">
...
<TABLE class="tableinfo" align="center" style="width:'95%'">
  ...
  <%
        ...
        while (msgHelp.getNextRow()) {
			datapro.eibs.beans.EWD0600DSMessage msg = (datapro.eibs.beans.EWD0600DSMessage) msgHelp.getRecord();
     	%>    
    <TR>
    ...
    <TR> 
      <TD WIDTH="50%" ALIGN=LEFT height="25"> 
       <% if ( msgHelp.getShowPrev() ) {
      		...
      		out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.bap.JSEWD0600?FromRecord=" + pos + "&type=" + userPO.getType() + "&selNew=" + userPO.getHeader18() + "\" > <img src=\""+request.getContextPath()+ "/images/e/previous_records.gif\" border=0></A>");
        }
%> </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> 
 	   <% if ( msgHelp.getShowNext() ) {
      		int pos = msgHelp.getLastRec();
      		out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.bap.JSEWD0600?FromRecord=" + pos +  "&type=" + userPO.getType() + "&selNew=" + userPO.getHeader18() + "\" ><img src=\""+request.getContextPath()+"/images/e/next_records.gif\" border=0></A>");
