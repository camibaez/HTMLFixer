...
function cardPrintPreview() {
	...
	var pg = "<%=request.getContextPath()%>/pages/e/ECC0090_card_print_preview.jsp?NAME=" + name;
...
<body>
<h3 align="center">Debit Card Assignment<BR>Print<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_print.jsp, ECC0090"></h3>
<hr size="4">
<% 
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECC0090">
  ...
  <BR>
<div align="center"> 
	   <INPUT type="button" name="EIBSBTN" id="EIBSBTN" value="Print" onClick="javascript:cardPrintPreview();">
  </div>
</form>
</body>
</html>
