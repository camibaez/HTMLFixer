...
<H3 align="center">Assignments Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="assignment_inq_enter.jsp, ECC0090"></H3>
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECC0090">
  ...
  <table class="tbenter" HEIGHT="25%" width="100%" border="0">
    ...
    <tr> 
    	<td nowrap ALIGN="right">
			<INPUT type="radio" name="search" value="C"
			onclick="document.forms[0].E01CCRNUM.focus()">
			<B>Card  Number :</B></td>
    	<td nowrap ALIGN="left"> 
        	<INPUT type="text" name="E01CCRNUM" size="20" maxlength="16" onclick="document.forms[0].search[1].click()" onkeypress="enterInteger()">
        	<a href="javascript:GetPlastic2('E01CCRNUM', '' ,'')"></a>     
    	</td>
    </tr> 
  </table>  
 <p align="center"> 
    <input id="EIBSBTN" type=button name="Submit" value="Submit" onClick="Check()">
  </p>  
<script language="JavaScript">
