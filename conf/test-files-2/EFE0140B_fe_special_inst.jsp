...
<%
if ( userPO.getHeader3().equals("SPT") ) {
%>
	builtNewMenu(sfm_bo_opt);
<%   
}
else if ( userPO.getHeader3().equals("FWR") ) {
%>
...
%> 
<h3 align="center">Special Instructions<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_special_inst,EDL0130"></h3>
<hr size="4">
