...
<form method="post" action="<%=request.getContextPath()%>/servlet/com.datapro.eibs.internet.JSLogTransSearch" >
	...
	<table border=0 style="border-collapse: collapse" CELLSPACING=0 CELLPADDING=0 width="100%" bgcolor="transparent" >
    	<tr>
			<td>
				<display:table  width="100%" name="lstTransactions" property="list" scope="session" pagesize="33" decorator="datapro.eibs.beans.DC_LOGWrapper">
	...
	<table class="tbenter" width=100% align=center>
		<tr> 
			...
			<td><div align="center"><input id="EIBSBTN" type=button name="Download" value="Download" onClick="window.location.href='<%=request.getContextPath()%>/pages/e/DCIBS_log_download_list.jsp'"></div></td>
	    </tr>
	</table>
