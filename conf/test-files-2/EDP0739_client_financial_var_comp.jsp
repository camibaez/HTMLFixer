...
<HEAD>
<TITLE>
Variation Financial Statements
</TITLE>
...
<h3 align="center">Absolute Variation & Relative Change Financial Statements<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="EDP0739_client_financial_var_comp.jsp,EDP0739"></h3>
<hr size="4">
      ...
      <TABLE  class="tableinfo">
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap width="12%"> 
             ...
             <th align=CENTER nowrap width="12%"> 
            	<div align="center">Variation<BR>Absolute
            	</div>
            </th>
             <th align=CENTER nowrap width="10%"> 
            	<div align="center">%Variation<BR>Relative
            	</div>
            </th>
             <th align=CENTER nowrap width="10%"> 
           ...
           %>
               <TR id=trclear>       			
				...
				<% if (!accList.getRecord(7).equals("Titulo")) { %>
      			...
      			<TD ALIGN=RIGHT width="12%" NOWRAP><%= datapro.eibs.master.Util.fcolorCCY(accList.getRecord(10)) %></TD>
