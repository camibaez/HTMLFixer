...
<h3 align="center">Investments - Customer Portfolio <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_enter_port_new, EIE0010"></h3>
<hr>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010" onSubmit="return(checkCust())">
    ...
    <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
      ...
      <tr> 
        <td width="40%"> 
        	<div align="right">Profile :</div> 
        </td>
        <td nowrap align="left"> 
          <INPUT type="text" name="E01PRFNUM" size="10" maxlength="9" onkeypress="enterInteger()">
        <a href="javascript:GetPortfolioNumDesc('E01PRFNUM','E01PRFCUN','',document.forms[0].E01PRFCUN.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a> 
