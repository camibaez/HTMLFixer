...
<body>
<h3 align="center">Card Fee<BR>Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_commissions_maint.jsp, ECD0005"> 
</h3>
<hr size="4">
<% 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="hidden" name="E05CDRFEE" size="5" maxlength="3" value="<%= msgCD.getE05CDRFEE() %>">
