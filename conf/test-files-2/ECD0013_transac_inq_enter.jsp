...
function validate() {
	if (document.forms[0].E02CDRTAR.value == "") {
		...
		document.forms[0].E02FDESDE.value =
			document.forms[0].E02FDESDE3.value +
			document.forms[0].E02FDESDE2.value +
			document.forms[0].E02FDESDE1.value
		document.forms[0].E02FHASTA.value =
			document.forms[0].E02FHASTA3.value +
			document.forms[0].E02FHASTA2.value +
			document.forms[0].E02FHASTA1.value
...
<body>
<h3 align="center">Transactions
Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="transac_inq_enter.jsp, ECD0013"> 
</h3>
<hr size="4">
<% 
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0013" onSubmit="return validate();">
  <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="2">
  <INPUT TYPE=HIDDEN NAME="E02FDESDE" VALUE="">
  <INPUT TYPE=HIDDEN NAME="E02FHASTA" VALUE="">
