...
<HTML>
<HEAD>
<TITLE>Letters of Credits Negotiation</TITLE>
...
<H3 align="center">Confirmation Clearance of Collection<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="coll_payment_conf.jsp, EDC0060"></H3>
<HR size="4">
<BR>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  <TR id="trdark">
     <TD align="center" width="5%"><B>Branch</B></TD>
     ...
     <TD align="center" width="5%"><B>Transfer Code</B></TD>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  <TR id="trdark">
     <TD align="right" width="70%"><B>Total</B></TD>
...
<P align="center">
  <INPUT id="EIBSBTN" type="submit" name="Submit0" value="Confirm" onClick="document.forms[0].H02FLGWK1.value='Y'">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
  <INPUT id="EIBSBTN" type="submit" name="Regresar" value="Modify" onClick="document.forms[0].H02FLGWK1.value='N'">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
</P>
</FORM>
