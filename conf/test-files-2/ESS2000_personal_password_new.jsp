...
<% String IUser = cusdata.getE01EUSUSR(); %>
...
<div id="Frame1">
 ...
 <INPUT TYPE=HIDDEN NAME="E01EUSUSR" VALUE="<%= IUser %>">
  ...
  <% }else{ %>
      <h2 align="center">To generate a user password Select :</h2>
      <h3 align="left">Printed Passord :</h3>
...
<P align="center">
   <input class="EIBSBTN" type=submit name="Submit" value="Continuar" onclick="document.forms[0].SCREEN.value='200'">
</div> 

<div id="FrameEml" style='display:none'>
<h3 align="center">Password sent to user email <BR></h3>
<P align="center">
   <input class="EIBSBTN" type=submit name="Submit" value="Cerrar" onclick="document.forms[0].SCREEN.value='200'">
</div> 
</form>
</body>
</html>
