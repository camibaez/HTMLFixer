...
<meta http-equiv="Refresh" CONTENT="5;url='<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEWD0308P?SCREEN=100'">
    ...
    <tr > 
      <td> 
        <table width="100%" height="100%">
          ...
          <td align=center> The instrument <b><%= userPO.getIdentifier()%></b> 
