...
<h3 align="center"><%if (userPO.getPurpose().equals("NEW")) out.print("Nuevo"); else out.print("Mantenimiento");%> Brokers, Insurance and Others
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="broker_maint.jsp,EFE0090"></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" >
          <tr id="trdark">
            ...
            <td nowrap colspan=3>
              ...
              <a href="javascript:GetCustomerDescId('E01FEBCUN','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0" ></a>
            </td>
			</tr>
        </table>
      </td>
    ...
    <tr >
      <td nowrap>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark">
            <td nowrap >
              <div align="right">Withholding/F-1099 :</div>
            </td>
            <td nowrap >
          ...
          <tr id="trclear">
            ...
            <td nowrap >
             <div align="right">Fix Commission :</div>
            </td>
            <td nowrap >
  ...
  <TR><TD>
   	...
   	<table cellspacing=2 cellpadding=2 width="100%" border="0">
    	 <tr id="trdark">
            ...
            <td nowrap align="CENTER"><b>G/L Acct.</b></td>
