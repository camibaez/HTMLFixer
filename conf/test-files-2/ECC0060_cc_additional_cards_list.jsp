...
%> 
<h3 align="center">Additional Cards<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" title="cc_additional_cards_list.jsp , ECC0060"></h3>
<hr size="4">
...
%> 
      ...
      <TD> 
        <div align="center"> 
          ...
          <p>&nbsp;</p>
          <p><font size="3"><b>This account has no Additional Credits Cards, please 
			   ...
			   <table id="dataTable">
			    ...
			    <TR> 
			      <TD ALIGN=CENTER NOWRAP> 
					...
					<INPUT TYPE="hidden" NAME="NUM_<%= appList.getCurrentRow() %>" VALUE="<%= appList.getRecord(0) %>">
			      </TD>
			      <TD ALIGN=LEFT NOWRAP><%= Util.formatCell(appList.getRecord(0)) %></TD>
			      <TD ALIGN=LEFT NOWRAP><%= Util.formatCell(appList.getRecord(39)) %></TD>
				  <TD ALIGN=CENTER NOWRAP><%= Util.formatDate(appList.getRecord(2),appList.getRecord(3),appList.getRecord(4)) %></TD>
			      <TD ALIGN=CENTER NOWRAP><%= Util.formatDate(appList.getRecord(5),appList.getRecord(6),appList.getRecord(7)) %></TD>
			      <TD ALIGN=CENTER NOWRAP><% if (appList.getRecord(40).equals("D")) out.print("Deleted"); else out.print(""); %></TD>
			    </TR>
			    <%
			                k++;
			                }
