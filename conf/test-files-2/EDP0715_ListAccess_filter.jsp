...
<h3 align="center">Maintenance List Access Routes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ListAccess_filter,EDP0715"></h3>
<hr size="4">
...
--%>
	...
	<tr id="trdclear">
		...
		<td nowrap align="left" width="70%">
			...
			<A href="javascript:GetCodeDescCNOFCPC('E01DPWRUT','E01DPWRDE','48')">
