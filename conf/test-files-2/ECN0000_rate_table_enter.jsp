...
<h3 align="center">Interest Rate VS Term/Amount<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rate_table_enter, ECN0000"></h3>
<hr size="4">
  ...
  <table  class="tbenter" width="100%" border="0" cellspacing=0 cellpadding=2>
	  ...
	  <tr>
	    <td width="50%">
	  	...
	  	<td>
	  	   ...
	  	   <a href="javascript:GetCurrency('E02CDRCCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"  ></a>
        </td>
	  </tr>
	  ...
	  <tr>
        <td width="50%" align=right>
          <br>
          <h4 style="text-align: right"> Copy rates from :</h4>
        </td>
        <td></td>
      </tr>
	  <tr>
	  ...
	  <tr>
	    <td width="50%">
	  	...
	  	<td>
	  	   ...
	  	   <a href="javascript:GetCurrency('E02CFRCCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0"  ></a>
        </td>
	  </tr>
      <% } %>
  </table>
