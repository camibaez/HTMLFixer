...
<h3 align="center">Incidence Percentage on Financial Line - New<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="cl_enter_maint, ELN0000">
</h3>
<hr>
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSELN0115" >
  <CENTER>
    ...
    <table cellspacing="0" cellpadding="2" class="tbenter" border=0   width=70% align="center" height="80%">
      ...
      <tr valign="middle">
        <td nowrap width=40% align="right" height="24">Bank :</td>
        <td nowrap width=40% align="left" height="24" >
          <input type="text" name="BANK" size="4" maxlength="9" onKeyPress="enterInteger()">
        </td>
      </tr>
      <tr valign="middle">
        <td nowrap width=40% align="right" height="24">Module :</td>
        <td nowrap width=40% align="left" height="24" >
          <input type="text" name="MODULE" size="4" maxlength="9">
          <a href="javascript:GetCodeCNOFC('MODULE','04')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
        </td>
      </tr>
      <tr valign="middle">
        <td nowrap width=40% align="right" height="24">Tenor Days From / To :</td>
        <td nowrap width=40% align="left" height="24" >
      ...
      <tr valign="middle">
        <td nowrap width=40% align="right" height="24">Incidence Percentage :</td>
        <td nowrap width=40% align="left" height="24" >
