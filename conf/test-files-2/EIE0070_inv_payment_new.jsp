...
%>
<div align="center">
  <h3>New Coupon Payment Schedule <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_payment_new.jsp,EIE0070">
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap colspan="3" width="82%" >
              ...
              Dividends <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" border="0"  ></td>
          </tr>
          <tr id="trclear">
            <td nowrap width="18%" >
