...
<H3 align="center">ACH Customer Authorizations<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ach_operators.jsp, EACH300"></H3>
<hr size="4">
  ...
  <table  class="tableinfo" width="100%">
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        ...
        <tr id="trdark"> 
            <td nowrap width="15%" align="right">Customer Code : </td>
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="15%" align="right">Company : </td>
			<td nowrap width="35%" align="left">
          ...
          <tr id="trclear"> 
			...
			<td nowrap width="35%" align="left"> 
              <SELECT name="E01ACASTS" <%= disabled %>>
					<OPTION <%= EACH300Record.getE01ACASTS().trim().equals("A")?"Selected":"" %> value="A">Active</OPTION>
					<OPTION <%= EACH300Record.getE01ACASTS().trim().equals("I")?"Selected":"" %> value="I">Inactive</OPTION>
				</SELECT>
	 		</td>
            <td nowrap width="15%" align="right"></td>
