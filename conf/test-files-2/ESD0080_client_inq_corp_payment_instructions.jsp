...
<html>
<head>
<title>Financial Transaction Inquiry</title>
...
<SCRIPT Language="Javascript">
  ...
  builtNewMenu(client_inq_corp_opt_pi);
                        ...
                        <div id="dataTab0"> 
                          <table width="94%" border="0">
                            ...
                            <tr> 
                              <td width="53%"> 
                                <div align="center"> 
                                <input type="text" name="E11PC1" size="36" maxlength="35" value="<%= pymInst.getE11PC1()%>" readonly>
                                </div>
                              </td>
                            </tr>
                            <tr> 
