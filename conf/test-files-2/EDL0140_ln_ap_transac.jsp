      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left"> 
                <input type="text" readonly  name="E03DEACUN" size="9" maxlength="9" value="<%= lnTransac.getE03DEACUN().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%" > 
            ...
            <td nowrap colspan="3" > 
              <div align="left"><font face="Arial"><font face="Arial"><font size="2"> 
                <input type="text" readonly  name="E03CUSNA1" size="45" maxlength="45" value="<%= lnTransac.getE03CUSNA1().trim()%>" >
                </font></font></font></div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left"> 
                <input type="text" readonly  name="E03DEAACC" size="12" maxlength="12" value="<%= lnTransac.getE03DEAACC().trim()%>" >
              </div>
            </td>
            <td nowrap width="16%"> 
            ...
            <td nowrap width="16%"> 
              <div align="left"><b> 
                <input type="text" readonly  name="E03DEACCY" size="3" maxlength="3" value="<%= lnTransac.getE03DEACCY().trim()%>" >
                </b> </div>
            </td>
            <td nowrap width="16%"> 
            ...
            <td nowrap width="16%"> 
              <div align="left"><b> 
                <input type="text" readonly  name="E03DEAPRO" size="4" maxlength="4" value="<%= lnTransac.getE03DEAPRO().trim()%>" >
                </b> </div>
            </td>
          </tr>
        </table>
      ...
      <td nowrap> 
        <table cellspacing=2 cellpadding=2 width="100%" border="0">
          ...
          <tr >
              ...
              <input type="text" readonly  name="E03DEALC1" size="2" maxlength="2" value="<%= lnTransac.getE03DEALC1().trim()%>" onkeypress="enterInteger()">
              <input type="text" readonly  name="E03DEALC2" size="2" maxlength="2" value="<%= lnTransac.getE03DEALC2().trim()%>" onkeypress="enterInteger()">
              <input type="text" readonly  name="E03DEALC3" size="2" maxlength="2" value="<%= lnTransac.getE03DEALC3().trim()%>" onkeypress="enterInteger()">
              </div>
            </td>
           </tr>
        	</table>
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="60%"> 
              <input type="text" readonly  name="E03TRNPRI" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE03TRNPRI())%>" onkeypress="enterDecimal()">
              <input type="hidden" name="E03TRNPRF" value="<%= lnTransac.getE03TRNPRF()%>">
              <input type="radio" disabled  name="CE03TRNPRF" value="0" 
              onClick="document.forms[0].E03TRNPRF.value='0'" 
			  <%if(lnTransac.getE03TRNPRF().equals("0")) out.print("checked");%> >
              Increase 
              <input type="radio" disabled  name="CE03TRNPRF" value="5" 
          ...
          <tr id="trclear"> 
            ...
            <td width="60%" height="27"> 
              <input type="text" readonly  name="E03TRNINT" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE03TRNINT())%>" onkeypress="enterDecimal()">
              <input type="hidden" name="E03TRNINF" value="<%= lnTransac.getE03TRNINF()%>">
              <input type="radio" disabled  name="CE03TRNINF" value="0"
			   onClick="document.forms[0].E03TRNINF.value='0'"
			   <%if(lnTransac.getE03TRNINF().equals("0")) out.print("checked");%>> Reverse <input type="radio" disabled  name="CE03TRNINF" value="5"
          ...
          <tr id="trdark"> 
            ...
            <td width="60%"> 
              <input type="text" readonly  name="E03TRNMOR" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE03TRNMOR())%>" onkeypress="enterDecimal()">
              <input type="hidden" name="E03TRNMOF" value="<%= lnTransac.getE03TRNMOF()%>">
              <input type="radio" disabled  name="CE03TRNMOF" value="0" 
              onClick="document.forms[0].E03TRNMOF.value='0'" 
			  <%if(lnTransac.getE03TRNMOF().equals("0")) out.print("checked");%>> Reverse <input type="radio" disabled  name="CE03TRNMOF" value="5" 
          ...
          <tr id="trclear"> 
            ...
            <td width="60%"> 
              <input type="text" readonly  name="E03TRNAIN" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE03TRNAIN())%>" onkeypress="enterDecimal()">
              <input type="hidden" name="E03TRNAIF" value="<%= lnTransac.getE03TRNAIF()%>">
              <input type="radio" disabled  name="CE03TRNAIF" value="0" 
              onClick="document.forms[0].E03TRNAIF.value='0'" 
			  <%if(lnTransac.getE03TRNAIF().equals("0")) out.print("checked");%>>
              Increase 
              <input type="radio" disabled  name="CE03TRNAIF" value="5" 
          ...
          <tr id="trdark"> 
            ...
            <td width="60%"> 
              <input type="text" readonly  name="E03TRNAMO" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE03TRNAMO())%>" onkeypress="enterDecimal()">
              <input type="hidden" name="E03TRNAMF" value="<%= lnTransac.getE03TRNAMF()%>">
              <input type="radio" disabled  name="CE03TRNAMF" value="0" 
              onClick="document.forms[0].E03TRNAMF.value='0'" 
			  <%if(lnTransac.getE03TRNAMF().equals("0")) out.print("checked");%>>
              Increase 
              <input type="radio" disabled  name="CE03TRNAMF" value="5" 
          ...
          <tr id="trdark">
            ...
            <td width="60%">
              <input type="text" readonly  name="E03TRNIVA" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE03TRNIVA())%>" onkeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly  name="E03TRNTOT" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE03TRNTOT())%>" onkeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly  name="E03TRNVD1" size="2" maxlength="2" value="<%= lnTransac.getE03TRNVD1().trim()%>" onkeypress="enterInteger()">
              <input type="text" readonly  name="E03TRNVD2" size="2" maxlength="2" value="<%= lnTransac.getE03TRNVD2().trim()%>" onkeypress="enterInteger()">
              <input type="text" readonly  name="E03TRNVD3" size="2" maxlength="2" value="<%= lnTransac.getE03TRNVD3().trim()%>" onkeypress="enterInteger()">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly  name="E03DEAEXR" size="11" maxlength="11" value="<%= lnTransac.getE03DEAEXR().trim()%>" onkeypress="enterDecimal()">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly  name="E03DEANR1" size="30" maxlength="30" value="<%= lnTransac.getE03DEANR1().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly  name="E03DEANR2" size="30" maxlength="30" value="<%= lnTransac.getE03DEANR2().trim()%>">
            </td>
          </tr>
        </table>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td width="31%" > 
              <div align="center" nowrap> 
                <input type="text" readonly name="E03TRNOPC" value="<%= lnTransac.getE03TRNOPC().trim()%>" size="3" maxlength="3">
                <input type=HIDDEN name="E03TRNGLN" value="<%= lnTransac.getE03TRNGLN().trim()%>">
                <input type="text" readonly  name="E03TRNCON" size="25" maxlength="25"  value="<%= lnTransac.getE03TRNCON().trim()%>">
              </div>
            </td>
            <td width="5%"> 
              <div align="center"> 
                <input type="text" readonly  name="E03TRNBNK" size="2" maxlength="2" value="<%= lnTransac.getE03TRNBNK().trim()%>" onkeypress="enterInteger()">
              </div>
            </td>
            <td width="13%" > 
              <div align="center"> 
                <input type="text" readonly  name="E03TRNBRN" size="3" maxlength="3" value="<%= lnTransac.getE03TRNBRN().trim()%>">
              </div>
            </td>
            <td width="12%" > 
              <div align="center">
                <input type="text" readonly  name="E03TRNCCY" size="3" maxlength="3" value="<%= lnTransac.getE03TRNCCY().trim()%>">
              </div>
            </td>
            <td width="21%" > 
              	<div align="center"> 
                 <input type="text" readonly  name="E03TRNACC" size="16" maxlength="9" value="<%= lnTransac.getE03TRNACC().trim()%>" >
					</div>
            </td>
          </tr>
        </table>
