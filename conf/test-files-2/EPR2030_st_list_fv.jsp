...
<h3 align="center">Transaction Inquiries<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="st_list_fv.jsp,EPR2030"> 
  </h3>
  <hr size="4">
 <FORM> 
...
%>
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td  width="32%" height="15"> 
              <div align="right"><b>Amount</b> <%= stBalances.getE02ACMCCY().trim()%><b>in Books :</b></div>
            </td>
  ...
  <table id=cfTable class="tableinfo">
    <tr id=trdark> 
      <th align=CENTER width="5%" nowrap>Value Date</th>
  ...
  <BR>
       ...
       <TD WIDTH="50%" ALIGN=LEFT>
        ...
        if ( cifList.getShowPrev() ) {
      			...
      			out.println("<A HREF=\"<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSECIF030?SCREEN=1&Pos=" + pos +"\"><img src=\"<%=request.getContextPath()%>/images/e/previous_records.gif\" border=0></A>");
        }
        %>
        </TD>
         ...
         if ( cifList.getShowNext() ) {
      			...
      			out.println("<A HREF=\"<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSECIF030?SCREEN=1&Pos=" + pos +"\"><img src=\"<%=request.getContextPath()%>/images/e/next_records.gif\" border=0></A>");
        }
         %>
         </TD>
 			</TR>
