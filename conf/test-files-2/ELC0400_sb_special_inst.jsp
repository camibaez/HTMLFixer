...
%> 
<H3 align="center">Stand By Letter Of Credit <%= (userPO.getPurpose().equals("NEW") ? "New" : "Maintenance") %> [Special Instructions]
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sb_special_inst.jsp, ELC0400"></h3>
<hr size="4">
