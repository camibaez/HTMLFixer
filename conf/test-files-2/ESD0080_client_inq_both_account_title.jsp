...
<html>
<head>
<title>Client Account Title</title>
...
<h3 align="center">Account Title<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_inq_both_account_title, ESD0080" ></h3>
<hr size="4">
