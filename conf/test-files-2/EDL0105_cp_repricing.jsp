...
<h3 align="center">Repricing<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cp_repricing.jsp, EDL0105"></h3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="61%">
              ...
              <a href="javascript:DatePicker(document.forms[0].E12CALDT1,document.forms[0].E12CALDT2,document.forms[0].E12CALDT3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"></a> 
          ...
          <tr id="trclear"> 
            ...
            <td width="61%" > 
              ...
              <a href="javascript:DatePicker(document.forms[0].E12PUTDT1,document.forms[0].E12PUTDT2,document.forms[0].E12PUTDT3)"><img src="<%=request.getContextPath()%>/images/calendar.gif" alt="help" align="absmiddle" border="0"></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="39%"> 
