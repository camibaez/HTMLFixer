      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <input type="text" readonly  name="E01SWFSID" size="30" maxlength="35" value="<%= swift.getE01SWFSID()%>" 
			  >
            </td>
            <td nowrap > 
            ...
            <td nowrap > 
              <input type="text" readonly  name="E01SWFRID" size="30" maxlength="35" value="<%= swift.getE01SWFRID()%>" 
			  >
            </td>
          </tr>
        </table>
