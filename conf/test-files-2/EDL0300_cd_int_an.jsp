...
<%
	if ( cifList.getNoResult() ) {
   		out.print("<center><h4>There is no result for your search criteria</h4></center>");
	}
	else {
%>
  <h3 align="center">Interest Analysis<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="cd_int_ant.jsp,EDL0300" width="32" height="32"> 
  </h3>
  <hr size="4">
  <BR>
  ...
  <TABLE class="tableinfo" >
    <TR id=trdark> 
      <TH ALIGN=CENTER  nowrap>Initial Date</TH>
...
<table class="tableinfo">
    <tr> 
      <td width="34%"> 
        <div align="left"><b>Calculated Interest</b></div>
      </td>
      <td width="21%"><b>Days :</b> <%= userPO.getHeader19().trim()%></td>
      <td width="45%"><b>Interest Value </b> : <%= userPO.getHeader20().trim()%></td>
    </tr>
  </table>
<BR>
