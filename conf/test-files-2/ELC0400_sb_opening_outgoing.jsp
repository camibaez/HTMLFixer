...
<BODY>
<H3 align="center">Outgoing Stand By Letter Of Credit <%= (userPO.getPurpose().equals("NEW") ? "New" : "Maintenance") %> [Basic Information]
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"	name="EIBS_GIF" alt="sb_opening_outgoing.jsp, ELC0400"></H3>
<HR size="4">
...
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo">
  ...
  <TR id="trdark">
    <TD align="right" nowrap><STRONG>Their Reference :</STRONG></TD>
    <TD><B>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    <TD align="right" nowrap>Customer  or  Account Number :</TD>
    <TD nowrap><SELECT name="E01LCMAF2">
        ...
        <A href="javascript: GetCustomerDetailsLC('E01LCMAPA','E01LCMAP1','E01LCMAP2','E01LCMAP3','E01LCMAP4','E01LCMAP5','E01LCMAP6','','')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF2.selectedIndex = 1" border="0"></A> 
		Customer or 
		<A href="javascript: GetAccByClient('E01LCMAPA','','RT','','E01LCMAP1')"> 
		<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help"	onclick="javascript: document.forms[0].E01LCMAF2.selectedIndex = 2"  border="0"></A> 
		Account
	</TD>
  </TR>
  <TR id="">
    <TD width="35%" align="right">Name :</TD>
    <TD align="left"><INPUT type="text" name="E01LCMAP1" size="45"	maxlength="35" value="<%=msg.getE01LCMAP1()%>">    </TD>
  </TR>
  <TR id="">
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF3">
        ...
        <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF3.selectedIndex = 1" border="0"></A> 
		Customer or 
		<A href="javascript: GetAccByClient('E01LCMBAC','','RT','','E01LCMBN1')"> 
		<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onclick="javascript: document.forms[0].E01LCMAF3.selectedIndex = 2" border="0"></A> 
		Account
	</TD>
  </TR>
  <TR id="">
  ...
  <TR id="">
    ...
    <TD align="left"><INPUT type="text" name="E01LCMBN5" size="2" maxlength="2"	value="<%=msg.getE01LCMBN5()%>">
      <A href="javascript:GetCodeCNOFC('E01LCMBN5','84')"> 
      <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0" ></A> 
      Zip Code :
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD  align="left" nowrap><INPUT type="text" name="E01LCMRBA" size="12" maxlength="12" value="<%=msg.getE01LCMRBA()%>">
		...
		<A href="javascript: GetAccByClient('E01LCMRBA','','RT','','E01LCMRB1')">
...
<TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF4">
        <OPTION value=""></OPTION>
        <OPTION value="C" <%if (msg.getE01LCMAF4().equals("C")) out.print("selected");%>>Customer</OPTION>
        <OPTION value="A" <%if (msg.getE01LCMAF4().equals("A")) out.print("selected");%>>Account</OPTION>
      </SELECT>
        <INPUT type="text" name="E01LCMABA" size="12" maxlength="12" value="<%=msg.getE01LCMABA()%>">
        <A href="javascript: GetCustomerDetailsLC('E01LCMABA','E01LCMAB1','E01LCMAB2','E01LCMAB3','E01LCMAB4','E01LCMAB5','E01LCMAB6','','C')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF4.selectedIndex = 1"  border="0"> </A> Customer or <A href="javascript: GetAccByClient('E01LCMABA','','RT','','E01LCMAB1')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF4.selectedIndex = 2"  border="0"></A> Account </TD>
  </TR>
  <TR id="">
    <TD width="35%" align="right" nowrap>Swift BIC :</TD>
    <TD align="left" nowrap><INPUT type="text" name="E01LCMABI" size="14" maxlength="12" value="<%=msg.getE01LCMABI()%>">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB1" size="45" maxlength="35" value="<%=msg.getE01LCMAB1()%>">
        <IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatory Field" border="0"></TD>
  </TR>
  <TR id="">
    <TD align="right" nowrap>Address :</TD>
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB2" size="45" maxlength="35" value="<%=msg.getE01LCMAB2()%>">    </TD>
  </TR>
  <TR id="">
    <TD nowrap></TD>
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB3" size="45" maxlength="35" value="<%=msg.getE01LCMAB3()%>">    </TD>
  </TR>
  <TR id="">
    <TD nowrap></TD>
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB4" size="45" maxlength="35" value="<%=msg.getE01LCMAB4()%>">    </TD>
  </TR>
  <TR id="">
    <TD align="right" valign="bottom" nowrap>State :</TD>
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB5" size="2" maxlength="2" value="<%=msg.getE01LCMAB5()%>">
        ...
        Zip Code :
      <INPUT type="text" name="E01LCMAB6" size="11" maxlength="10" value="<%=msg.getE01LCMAB6()%>">
      Country :
      <INPUT type="text" name="E01LCMAB7" size="4" maxlength="4" value="<%=msg.getE01LCMAB7()%>">
