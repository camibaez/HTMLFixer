...
<%}%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="generic_ap.jsp,E01SWF100"> 
    ...
    <tr id="trdark" > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFOB2" size="40" maxlength="35" value="<%= swift.getE01SWFOB2()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFIN2" size="40" maxlength="35" value="<%= swift.getE01SWFIN2()%>" 
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFOB3" size="40" maxlength="35" value="<%= swift.getE01SWFOB3()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFIN3" size="40" maxlength="35" value="<%= swift.getE01SWFIN3()%>" 
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFOB4" size="40" maxlength="35" value="<%= swift.getE01SWFOB4()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFIN4" size="40" maxlength="35" value="<%= swift.getE01SWFIN4()%>" 
			  >
              </div>
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFOR2" size="40" maxlength="35" value="<%= swift.getE01SWFOR2()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBB2" size="40" maxlength="35" value="<%= swift.getE01SWFBB2()%>" 
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFOR3" size="40" maxlength="35" value="<%= swift.getE01SWFOR3()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBB3" size="40" maxlength="35" value="<%= swift.getE01SWFBB3()%>" 
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFOR4" size="40" maxlength="35" value="<%= swift.getE01SWFOR4()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBB4" size="40" maxlength="35" value="<%= swift.getE01SWFBB4()%>" 
			  >
              </div>
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFSC2" size="40" maxlength="35" value="<%= swift.getE01SWFSC2()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBC2" size="40" maxlength="35" value="<%= swift.getE01SWFBC2()%>" 
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFSC3" size="40" maxlength="35" value="<%= swift.getE01SWFSC3()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBC3" size="40" maxlength="35" value="<%= swift.getE01SWFBC3()%>" 
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFSC4" size="40" maxlength="35" value="<%= swift.getE01SWFSC4()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBC4" size="40" maxlength="35" value="<%= swift.getE01SWFBC4()%>" 
			  >
              </div>
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBK1" size="40" maxlength="35" value="<%= swift.getE01SWFBK1()%>" 
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFRC2" size="40" maxlength="35" value="<%= swift.getE01SWFRC2()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBK2" size="40" maxlength="35" value="<%= swift.getE01SWFBK2()%>" 
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFRC3" size="40" maxlength="35" value="<%= swift.getE01SWFRC3()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBK3" size="40" maxlength="35" value="<%= swift.getE01SWFBK3()%>" 
			  >
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="26%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFRC4" size="40" maxlength="35" value="<%= swift.getE01SWFRC4()%>" 
			  >
              </div>
            </td>
            <td nowrap width="22%" > 
              <div align="right"> <input type="text" readonly  name="E01SWFBK4" size="40" maxlength="35" value="<%= swift.getE01SWFBK4()%>" 
			  >
              </div>
            </td>
          </tr>
