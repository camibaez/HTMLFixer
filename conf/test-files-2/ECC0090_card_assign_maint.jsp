	...
	if (i == -1) {
		...
		if (num == 1) {
			if (E02CCRAPC.value != "01" &&
				E02CCRAPC.value != "02" &&
				E02CCRAPC.value != "03") {
				alert("That account is not checking account");
			}
			else {
		...
		if (num == 2) {
			if (E02CCRAPC.value != "04") {
				...
				if (cap.value != "") {
					alert("There are assigned a saving account");
				}
				else {
		...
		if (num == 3) {
			if (E02CCRTYP.value != "CFAL") {
				...
				if (cfp.value != "") {
					alert("There are assigned a F.A.L. account");
				}
				else {
...
<body>
<h3 align="center">Debit Card Assignment<BR>Primary Card Maintenance<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_assign_maint.jsp, ECC0090"></h3>
<hr size="4">
<% 
	...
	<TR>
      <TD> 
	      <div align="center"> <font size="3"><b> <FONT size="3"><B><FONT
			size="3"><B><FONT size="3"><B>Customer don't have related accounts </B></FONT></B></FONT></B></FONT></b></font></div>
      </TD>
     </TR>
   	</TABLE>
<%
