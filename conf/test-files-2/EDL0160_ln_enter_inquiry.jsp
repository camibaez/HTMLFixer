...
<h3 align="center">Loan Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_enter_inquiry.jsp,EDL0160"></h3>
<hr size="4">
...
<form method="post"  action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0160">
 ...
 <!--<h4 align="center">Please Enter Certificate Number</h4>-->
