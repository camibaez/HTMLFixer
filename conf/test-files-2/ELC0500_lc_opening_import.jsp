...
<BODY>
<H3 align="center">Import Letter of Credit [New]
	<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"	name="EIBS_GIF" alt="ELC0500_lc_opening_import"></H3>
<HR size="4">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
          ...
          <TR id="">
            ...
            <TD nowrap>
            	<SELECT name="E01LCMAF2">
                	<OPTION value=" " <%if (!(msgLC.getE01LCMAF2().equals("C") || msgLC.getE01LCMAF2().equals("A"))) out.print("selected");%> selected></OPTION>
                	<OPTION value="C" <%if (msgLC.getE01LCMAF2().equals("C")) out.print("selected");%>>Customer</OPTION>
                	<OPTION value="A" <%if (msgLC.getE01LCMAF2().equals("A")) out.print("selected");%>>DDA</OPTION>
              	</SELECT>
                <INPUT type="text" name="E01LCMAPA" size="12" maxlength="12" value="<%=msgLC.getE01LCMAPA()%>">
          ...
          <TR id="">
            ...
            <TD align="left"><INPUT type="text" name="E01LCMAP1" size="45" maxlength="35" value="<%=msgLC.getE01LCMAP1()%>">
            </TD>
          </TR>
          <TR id="">
            <TD align="right">Address: </TD>
            <TD align="left"><INPUT type="text" name="E01LCMAP2" size="45" maxlength="35" value="<%=msgLC.getE01LCMAP2()%>">
            </TD>
          </TR>
          <TR id="">
            <TD></TD>
            <TD align="left"><INPUT type="text" name="E01LCMAP3" size="45" maxlength="35" value="<%=msgLC.getE01LCMAP3()%>">
            </TD>
          </TR>
          <TR id="">
            <TD></TD>
            <TD align="left"><INPUT type="text" name="E01LCMAP4" size="45" maxlength="35" value="<%=msgLC.getE01LCMAP4()%>">
            </TD>
          </TR>
          <TR id="">
            <TD align="right">State: </TD>
            <TD align="left"><INPUT type="text" name="E01LCMAP5" size="4" maxlength="4"  value="<%=msgLC.getE01LCMAP5()%>">
              <A href="javascript:GetCodeCNOFC('E01LCMAP5','84')"> 
              <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0" ></A>
              Zip Code: 
              <INPUT type="text" name="E01LCMAP6" size="11" maxlength="10" value="<%=msgLC.getE01LCMAP6()%>">
              Country: 
              <INPUT type="text" name="E01LCMAP7" size="4" maxlength="4" value="<%=msgLC.getE01LCMAP7()%>">
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
          ...
          <TR id="">
            <TD align="right"> Name: </TD>
            <TD align="left"><INPUT type="text" name="E01LCMBN1" size="45" maxlength="35" value="<%=msgLC.getE01LCMBN1()%>">
                <IMG src="<%=request.getContextPath()%>/images/Check.gif" alt="Mandatory Field" border="0"></TD>
          </TR>
          <TR id="">
            <TD align="right">Address: </TD>
            <TD align="left"><INPUT type="text" name="E01LCMBN2" size="45" maxlength="35" value="<%=msgLC.getE01LCMBN2()%>">
            </TD>
          </TR>
          <TR id="">
            <TD></TD>
            <TD align="left"><INPUT type="text" name="E01LCMBN3" size="45" maxlength="35" value="<%=msgLC.getE01LCMBN3()%>">
            </TD>
          </TR>
          <TR id="">
            <TD></TD>
            <TD align="left"><INPUT type="text" name="E01LCMBN4" size="45" maxlength="35" value="<%=msgLC.getE01LCMBN4()%>">
            </TD>
          </TR>
          <TR id="">
            <TD align="right">State: </TD>
            <TD align="left">
              <INPUT type="text" name="E01LCMBN5" size="2" maxlength="2" value="<%=msgLC.getE01LCMBN5()%>">
                ...
                Zip Code: 
              <INPUT type="text" name="E01LCMBN6" size="11" maxlength="10" value="<%=msgLC.getE01LCMBN6()%>">
                Country: 
...
<BR>
    <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
          ...
          <TR id="">
            ...
            <TD align="left" nowrap>
              <INPUT type="text" name="E01LCMCA5" size="2" maxlength="2" value="<%=msgLC.getE01LCMCA5()%>">
 ...
 <BR>
  ...
  <TR id="">
    <TD nowrap="nowrap" align="right">Customer Number: </TD>
    <TD  align="left" nowrap><INPUT type="text" name="E01LCMRBA" size="12" maxlength="12" value="<%=msgLC.getE01LCMRBA()%>">
		...
		<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></A> Customer or <A href="javascript: GetAccByClient('E01LCMRBA','','RT','','E01LCMRB1')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0"></A> Account </TD>
  </TR>
  <TR id="">
    <TD nowrap="nowrap" align="right">Swift Code: </TD>
...
<TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
  <TR id="trdark">
    <TD colspan="2" align="center" valign="middle"><FONT size="medium"><B>Correspondent/Confirming Bank</B></FONT></TD>
  </TR>
  <TR id="">
    ...
    <TD nowrap><SELECT name="E01LCMAF4">
      ...
      <OPTION value="A" <%if (msgLC.getE01LCMAF4().equals("A")) out.print("selected");%>>Account</OPTION>
		...
		<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF4.selectedIndex = 1"  border="0">
			...
			<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" onClick="javascript: document.forms[0].E01LCMAF4.selectedIndex = 2"  border="0"></A> Account</TD>
  </TR>
  <TR id="">
  ...
  <TR id="">
    <TD align="right" valign="bottom" nowrap>State<B> :</B></TD>
    <TD align="left" nowrap><INPUT type="text" name="E01LCMAB5" size="2" maxlength="2" value="<%=msgLC.getE01LCMAB5()%>">
        <A href="javascript:GetCodeCNOFC('E01LCMAB5','84')"> <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" align="bottom" border="0" ></A> 
        Zip Code: 
