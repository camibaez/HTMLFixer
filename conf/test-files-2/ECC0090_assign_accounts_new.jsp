...
<body>
<h3 align="center">Debit Card Assignment<br>New Assignment<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="assign_accounts_new.jsp,ECC0090"> - Primary Card</h3>
<hr size="4">
<% 
				...
				<TBODY>
					<TR id="trdark">
						...
						<DIV align="left"><INPUT type="text" name="E01CCRNUM" size="21"
							maxlength="20" value="">
							<A href="javascript:GetPlastic2('E01CCRNUM', 'D', 'N')">
