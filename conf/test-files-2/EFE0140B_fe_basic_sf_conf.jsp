...
%> 
<h3 align="center"> Foreign Exchange Spot (Back Office) - Confirmation</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap > <% if(fex.getE01WKFRVF().equals("3")) out.print("Accrual Basic");
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" > <% if(fex.getE01WKFNTF().equals("P")) out.print("Print Notification");
            ...
            <td nowrap > <% if(fex.getE01WKFBPV().equals("F")) out.print("Payment Via Fed");
