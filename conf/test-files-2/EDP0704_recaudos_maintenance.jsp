...
<H3 align="center">Maintenance Required Documents<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="recaudos_maintenance.jsp, EDP0704"></H3>
<P align="center">
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								<td nowrap width="30%">
									<DIV align="right">Code Product :</DIV>
								</TD>
								<td nowrap align="left" width="70%"> 
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<TR id="trclear">
								<td nowrap width="30%">
								    <DIV align="right">Type Document </DIV>
								</TD>
								<td nowrap align="left" width="70%">
								...
								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>
								    <option value=" " 
     								...
     								<option value="1" 
     								   <%if (brnDetails.getE01DPHTDO().equals("1")) { out.print("selected"); }%>>Required</option>
									<option value="2"
									   <%if (brnDetails.getE01DPHTDO().equals("2")) { out.print("selected"); }%>>Additional</option>
									<option value="3"
									   <%if (brnDetails.getE01DPHTDO().equals("3")) { out.print("selected"); }%>>Optional</option>	
								</SELECT>
								</TD>
							</tr>
						</TBODY>
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trdark">
								<td nowrap width="30%">
								<DIV align="right">Using the Document :</DIV>
								</td>
								<td nowrap align="left" width="70%">
								...
								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>
									...
									<option value="1"
										<%if (brnDetails.getE01DPHUDO().equals("1")) { out.print("selected"); }%>>Legal Person</option>
									<option value="2" 
									   <%if (brnDetails.getE01DPHUDO().equals("2")) { out.print("selected"); }%>>Natural Person</option>	
									<option value="3"
										<%if (brnDetails.getE01DPHUDO().equals("3")) { out.print("selected"); }%>>Both</option>
				...
				<TR>
					...
					<TABLE id="tbenter" width="100%" border="0" cellspacing="1" cellpadding="0">
						<TBODY>
							<tr id="trclear">
								<td nowrap width="30%">
								<DIV align="right">Status of Document :</DIV>
								</td>
								<td nowrap align="left" width="70%">
								...
								<% if(userPO.getHeader16().equals("5") || userPO.getHeader16().equals("3")){out.print("DISABLED");} %>>
									...
									<option value="A" 
									   <%if (brnDetails.getE01DPHEST().equals("A")) { out.print("selected"); }%>>Active</option>
									<option value="I"
										<%if (brnDetails.getE01DPHEST().equals("I")) { out.print("selected"); }%>>Inactive</option>
								</SELECT>								
								</td>
							</tr>
						</TBODY>
