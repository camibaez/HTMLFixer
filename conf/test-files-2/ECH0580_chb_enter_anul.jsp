...
<H3 align="center">Annul Checkbook or Check<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="chb_enter_anul.jsp,ECH0580"></H3>
<hr size="4">
<p>&nbsp;</p>
...
<INPUT type="hidden" name="SCREEN" value="200">
  ...
  <table class="tbenter" cellspacing=0 cellpadding=2 border="0">
    <tr> 
      ...
      <td nowrap width="50%"><input type="text" name="E01CHMACC" size="9" maxlength="12" onKeypress="enterInteger()">
     	 <a href="javascript:GetAccount('E01CHMACC','','RA','')">
