...
%> 
<h3 align="center">Special Instructions<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cl_ap_special_inst,ELN0040"></h3>
<hr size="4">
  ...
  <table class="tableinfo">
    <tr > 
      <td nowrap align="center"> 
          ...
          <input type="text" readonly name="EE5SC" size="80" maxlength="80" value="<%= clInst.getEE5DSC().trim()%>"><br>
