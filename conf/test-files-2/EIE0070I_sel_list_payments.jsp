...
<h3 align="center">Payment Schedule Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sel_instruments.jsp, EWD0308"></h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0070I" >
        ...
        <table id="headTable" width="100%" >
          <tr id="trdark"> 
            ...
            <th align=CENTER nowrap > 
              <div align="center">Payment<br> Type</div>
            </th>
            <th align=CENTER nowrap > 
              <div align="center">Payment<br> Date</div>
            </th>
            <th align=CENTER nowrap > 
              <div align="center">Payment<br> Amount</div>
            </th>
            <th align=CENTER nowrap > 
              <div align="center">Event<br> Type</div>
            </th>
