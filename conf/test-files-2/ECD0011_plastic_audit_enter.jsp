...
<body>
<h3 align="center"> Audit Inquiry<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_audit_enter.jsp, ECD0011"> 
</h3>
<hr size="4">
<% 
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.cards.JSECD0011" onSubmit="return validate();">
  <INPUT TYPE=HIDDEN NAME="SCREEN" VALUE="10">
	   ...
	   <table  id="TBHELP" align="center" width="370" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <td nowrap>
		  	<input type="radio" name="Type" id="Type" value="O" onclick="typeClick('O')" checked>Other 
		  </td>
		  <td nowrap width="140">
     	  </td>
		</tr>
		<tr>
		  <td nowrap ></td>
		  <td nowrap width="140">
		    <input type="radio" name="Type" id="Type" value="U" onclick="typeClick('U')">User
		  </td>		
		  <td nowrap ></td>
		</tr>
 	</table>
