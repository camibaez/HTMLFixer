...
<H3 align="center">System Reference Codes - <%= userPO.getHeader21() %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_generic_long_codes_details.jsp, ESD0030"></H3>
<hr size="4">
