...
<%
datapro.eibs.beans.EDL015601Message lnCost = new datapro.eibs.beans.EDL015601Message();
...
<body>
<h3 align="center">Loan Cost FASB 91<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_cost_new.jsp, EDL0156"></h3>
<hr size="4">
      ...
      <td nowrap>
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark">
            ...
            <td nowrap >
              <input type="text" name="E01DLEBNK" size="4" maxlength="2" value="<%= userPO.getBank() %>" readonly>
            </td>
            <td nowrap width="20%" align=right>
              <b>Product :</b>
            </td>
            <td nowrap >
               <input type="text" name="E01DLEPRO" size="5" maxlength="4" value="<%= lnCost.getE01DLEPRO()%>">
               <%if (userPO.getPurpose().equals("NEW")){%>
               		<a href="javascript:GetProductT('E01DLEPRO','','','LNS')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a>
			   <%}%>
            </td>
          </tr>
          <tr id="trclear">
