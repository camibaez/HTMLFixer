...
<h3 align="center">Direcciones de Correo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_inq_both_mail_address, ERQ0080" ></h3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
         ...
         <tr id="trdark"> 
            ...
            <td nowrap width="58%"> 
              ...
              From :
              <input type="text" name="E<%= name %>4DMF" maxlength="2" size="3" value="<%= mf %>" readonly>
              <input type="text" name="E<%= name %>4DDF" maxlength="2" size="3" value="<%= df %>" readonly>
              To :
              <input type="text" name="E<%= name %>4DMT" maxlength="2" size="3" value="<%= mt %>" readonly>
              <input type="text" name="E<%= name %>4DDT" maxlength="2" size="3" value="<%= dt %>" readonly>              
            </td>
          </tr>         
         </table>
      </td>
