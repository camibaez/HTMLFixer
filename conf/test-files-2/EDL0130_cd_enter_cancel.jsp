...
<h3 align="center">Prepayment of Certificates of Deposit<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_enter_cancel, EDL0130"></h3>
<hr size="4">
  ...
  <table class="tbenter" height="75%" width="100%" border="0">
    <tr>
          <td nowrap align="center">
              ...
              <a href="javascript:GetAccount('E07DEAACC','','CD','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Help" border="0" ></a>
            	 <br>
  <div align="center">
