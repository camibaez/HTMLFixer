...
<H3 ALIGN="center">Documents Control<IMG SRC="<%=request.getContextPath()%>/images/e_ibs.gif" ALIGN="left"
...
<TABLE CLASS="tbenter" WIDTH="100%" BORDER="0">
	<TR>
		<TD width="50%" align="right">Collection ID :</TD>
		<TD width="50%">
		   <DIV><INPUT TYPE="text" NAME="E01DCMACC" SIZE="13" MAXLENGTH="12" ONKEYPRESS="enterInteger()">
		    <A HREF="javascript:GetAccount('E01DCMACC','','51','')"> <IMG SRC="<%=request.getContextPath()%>/images/1b.gif" ALT="Help" BORDER="0"></A>
		   </DIV>
		</TD>
	</TR>
	<TR>
