...
public class ReadWriteTest {
    ...
    public void readTestProject(){
        Project project = ProjectAdministration.loadProject("conf\\readWriteTest.json");
    }
    ...
    public void createTestProject() throws FileNotFoundException {
        ...
        FilePrototype proto = new FilePrototype("*.txt", Arrays.asList(ConditionalPattern.compile("casa", 0, "+"), ConditionalPattern.compile("cass.*a", 2, "-")));
        Project project = new Project(proto, Arrays.asList(cleaner, cleaner));

        ProjectAdministration.saveProject(project, "conf\\readWriteTest.json");
